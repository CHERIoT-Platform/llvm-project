...
public:
  ...
  std::pair<QualType, PointerInterpretationKind> getKey() const { return {getPointeeType(), getPointerInterpretation()}; }
...
public:
  ...
  std::tuple<QualType, bool, PointerInterpretationKind> getKey() const {
    return {getPointeeTypeAsWritten(), isSpelledAsLValue(), getPointerInterpretation()};
  }
