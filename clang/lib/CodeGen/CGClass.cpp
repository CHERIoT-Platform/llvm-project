...
void CodeGenFunction::EmitInheritedCXXConstructorCall(
  ...
  CallArg ThisArg(RValue::get(getAsNaturalPointerTo(
                      This, D->getThisType()->getPointeeType()), This.getAlignment().getQuantity()),
                  D->getThisType());
...
void CodeGenFunction::EmitSynthesizedCXXCopyCtorCall(
  ...
  // Push the this ptr.
  Args.add(RValue::get(getAsNaturalPointerTo(This, D->getThisType()), This.getAlignment().getQuantity()),
           D->getThisType());
...
void CodeGenFunction::EmitDelegateCXXConstructorCall(
  ...
  DelegateArgs.add(RValue::get(getAsNaturalPointerTo(
                       This, (*I)->getType()->getPointeeType()), This.getAlignment().getQuantity()),
                   (*I)->getType());
  ++I;
...
void CodeGenFunction::EmitLambdaBlockInvokeBody() {
  ...
  CallArgs.add(
      RValue::get(getAsNaturalPointerTo(ThisPtr, ThisType), ThisPtr.getAlignment().getQuantity()),
      ThisType);
