...
llvm::Value *CodeGenFunction::EmitCXXNewExpr(const CXXNewExpr *E) {
  ...
  bool ReservedGlobalPlacement = allocator->isReservedGlobalPlacementOperator();
  if (ReservedGlobalPlacement) {
    ...
    if (getTarget().areAllPointersCapabilities() &&
      ...
      allocation = Address(
          setPointerBounds(allocation.getBasePointer(), allocSize, E->getExprLoc(),
                           "new.with.bounds",
