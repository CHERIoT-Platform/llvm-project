...
CGCallee ItaniumCXXABI::EmitLoadOfMemberFunctionPointer(
  ...
  if (IsCheriABI)
    NonVirtualFn = Builder.CreatePointerCast(FnPtr, CGF.DefaultPtrTy, "memptr.nonvirtualfn");
  else
    NonVirtualFn = Builder.CreateIntToPtr(FnPtr, CGF.DefaultPtrTy, "memptr.nonvirtualfn");
