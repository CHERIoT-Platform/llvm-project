...
CHECK-NEXT:	CHERICCall
CHECK-NEXT:	CHERICCallback
CHECK-NEXT:	CHERICCallee
CHECK-NEXT:	CHERICapability
CHECK-NEXT:	CHERICompartmentName
CHECK-NEXT:	CHERILibCall
CHECK-NEXT:	CHERIMethodClass
CHECK-NEXT:	CHERIMethodSuffix
CHECK-NEXT:	CHERINoProvenance
CHECK-NEXT:	CHERINoSubobjectBounds
CHECK-NEXT:	CHERISealedCapability
CHECK-NEXT:	CHERISubobjectBoundsUseRemainingSize
...
CHECK-NEXT:	MayAlias
CHECK-NEXT: MemoryAddress
CHECK-NEXT: MinimumStack
CHECK-NEXT:	Mips16
CHECK-NEXT:	Mode
CHECK-NEXT:	Naked
...
CHECK-NEXT:	PointerInterpretationCaps
