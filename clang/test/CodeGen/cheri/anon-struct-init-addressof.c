...
// CHECK-NEXT:    call addrspace(200) void @llvm.memset.p200.i64(ptr addrspace(200) align 4 [[ARRAYDECAY]], i8 0, i64 720, i1 false)
// CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr addrspace(200) [[PARENT_ADDR]], align 4
// CHECK-NEXT:    call addrspace(200) void @llvm.memset.p200.i64(ptr addrspace(200) align 16 [[DOTCOMPOUNDLITERAL]], i8 0, i64 80, i1 false)
...
// CHECK-NEXT:    [[CALL:%.*]] = call signext addrspace(200) i32 @procctl(i32 noundef signext 0, i32 noundef signext [[TMP0]], i32 noundef signext 22, ptr addrspace(200) noundef [[DOTCOMPOUNDLITERAL]])
