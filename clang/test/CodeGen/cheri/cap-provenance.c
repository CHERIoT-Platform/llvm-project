...
// NOTADD-NEXT:   [[RESULT:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) [[LHS]], i64 [[ARITH_RESULT]])
// CHECK-NEXT:    call addrspace(200) void @check(ptr addrspace(200) noundef [[RESULT]]) #4
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: (ptr addrspace(200) noundef [[LHS:%.*]], ptr addrspace(200) noundef [[RHS:%.*]]) local_unnamed_addr addrspace(200)
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[LHS_ADDR:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) [[LHS]])
// NOTADD-NEXT:   [[RHS_ADDR:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) [[RHS]])
// NOTADD-NEXT:   [[ARITH_RESULT:%.*]] = [[$ARITH_OP]] i64 [[RHS_ADDR]], [[LHS_ADDR]]
// ADD-NEXT:      [[RESULT:%.*]] = getelementptr i8, ptr addrspace(200) [[RHS]], i64 [[LHS_ADDR]]
// NOTADD-NEXT:   [[RESULT:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) [[RHS]], i64 [[ARITH_RESULT]])
// CHECK-NEXT:    call addrspace(200) void @check(ptr addrspace(200) noundef [[RESULT]]) #4
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) [[ARG:%.*]])
// CHECK-NEXT:    [[SUB:%.*]] = sub i64 0, [[TMP0]]
// CHECK-NEXT:    [[TMP1:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) [[ARG]], i64 [[SUB]])
// CHECK-NEXT:    call addrspace(200) void @check(ptr addrspace(200) noundef [[TMP1]]) #4
// CHECK-NEXT:    [[TMP2:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) [[ARG_PTR:%.*]])
// CHECK-NEXT:    [[SUB1:%.*]] = sub i64 0, [[TMP2]]
// CHECK-NEXT:    [[TMP3:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) [[ARG_PTR]], i64 [[SUB1]])
// CHECK-NEXT:    call addrspace(200) void @check(ptr addrspace(200) noundef [[TMP3]]) #4
// CHECK-NEXT:    call addrspace(200) void @check(ptr addrspace(200) noundef getelementptr (i8, ptr addrspace(200) null, i64 -5)) #4
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[TMP1:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) [[ARG]], i64 [[NEG]])
// CHECK-NEXT:    call addrspace(200) void @check(ptr addrspace(200) noundef [[TMP1]]) #4
// CHECK-NEXT:    [[TMP2:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) [[ARG_PTR:%.*]])
// CHECK-NEXT:    [[NEG1:%.*]] = xor i64 [[TMP2]], -1
// CHECK-NEXT:    [[TMP3:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) [[ARG_PTR]], i64 [[NEG1]])
// CHECK-NEXT:    call addrspace(200) void @check(ptr addrspace(200) noundef [[TMP3]]) #4
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    call addrspace(200) void @check(ptr addrspace(200) noundef [[TMP0]]) #4
...
// CHECK-SAME: (ptr addrspace(200) noundef [[ARG:%.*]], ptr addrspace(200) noundef [[ARG_PTR:%.*]]) local_unnamed_addr addrspace(200)
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call addrspace(200) void @check(ptr addrspace(200) noundef [[ARG:%.*]]) #4
// CHECK-NEXT:    call addrspace(200) void @check(ptr addrspace(200) noundef [[ARG_PTR:%.*]]) #4
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    call addrspace(200) void @check(ptr addrspace(200) noundef nonnull [[INCDEC_PTR]]) #4
// CHECK-NEXT:    call addrspace(200) void @check(ptr addrspace(200) noundef [[TMP0]]) #4
// CHECK-NEXT:    call addrspace(200) void @check(ptr addrspace(200) noundef nonnull [[INCDEC_PTR]]) #4
// CHECK-NEXT:    ret void
//
