...
void a(void) {
  ...
  // CHECK: call signext addrspace(200) i32 (ptr addrspace(200), ...) @printf(ptr addrspace(200) noundef @.str)
  // OPT: @str = private unnamed_addr addrspace(200) constant [6 x i8] c"Hello\00"
  // OPT: call addrspace(200) i32 @puts(ptr addrspace(200) nonnull dereferenceable(1) @str)
}
