...
// RV32-NEXT:  entry:
// RV32-NEXT:    [[TMP0:%.*]] = call addrspace(0) ptr addrspace(200) asm "", "=C,0"(ptr addrspace(200) [[P]]) #[[ATTR1:[0-9]+]], !srcloc [[META6:![0-9]+]]
...
// RV64-NEXT:  entry:
// RV64-NEXT:    [[TMP0:%.*]] = call addrspace(0) ptr addrspace(200) asm "", "=C,0"(ptr addrspace(200) [[P]]) #[[ATTR1:[0-9]+]], !srcloc [[META6:![0-9]+]]
