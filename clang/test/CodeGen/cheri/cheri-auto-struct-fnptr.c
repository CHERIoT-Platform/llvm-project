...
// CHECK-NEXT:    call addrspace(200) void @llvm.memcpy.p200.p200.i64(ptr addrspace(200) align 16 [[DTAB]], ptr addrspace(200) align 16 @__const.compat_setgrent.dtab, i64 32, i1 false)
// CHECK-NEXT:    ret void
//
