...
// RV32-NEXT:  entry:
// RV32-NEXT:    [[TMP0:%.*]] = call addrspace(200) i32 @llvm.cheri.cap.address.get.i32(ptr addrspace(200) [[BIT]])
...
// RV64-NEXT:  entry:
// RV64-NEXT:    [[TMP0:%.*]] = call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) [[BIT]])
