...
// MEMCPY-NEXT:  call addrspace(200) void @do_stuff_extern(ptr addrspace(200) nofree noundef align 8 dead_on_return dereferenceable(136) %byval-temp)
// MEMCPY-LABEL: declare void @do_stuff_extern(ptr addrspace(200) nofree noundef align 8 dead_on_return dereferenceable(136))
...
// N64-MEMCPY: call void @do_stuff_extern(ptr nofree noundef align 8 dead_on_return dereferenceable(72) %byval-temp)
// N64-MEMCPY-LABEL: declare void @do_stuff_extern(ptr nofree noundef align 8 dead_on_return dereferenceable(72))
