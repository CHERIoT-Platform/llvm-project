...
// MEMCPY:       call addrspace(200) void @llvm.memcpy.p200.p200.i64
// MEMCPY-NEXT:  call addrspace(200) void @do_stuff_extern(ptr addrspace(200) nofreeobj noundef align 8 dead_on_return dereferenceable(136) %byval-temp)
// MEMCPY-LABEL: declare void @do_stuff_extern(ptr addrspace(200) nofreeobj noundef align 8 dead_on_return dereferenceable(136))


// EXPANDED-LABEL: define dso_local void @foo()
// EXPANDED:       call addrspace(200) void @do_stuff_extern(i64 inreg
...
// N64-MEMCPY: call void @do_stuff_extern(ptr nofreeobj noundef align 8 dead_on_return dereferenceable(72) %byval-temp)
// N64-MEMCPY-LABEL: declare void @do_stuff_extern(ptr nofreeobj noundef align 8 dead_on_return dereferenceable(72))
