...
// CHECK-NEXT:    call addrspace(200) void @llvm.lifetime.start.p200(ptr addrspace(200) nonnull [[D]]) #[[ATTR4:[0-9]+]]
// CHECK-NEXT:    [[BCMP:%.*]] = call addrspace(200) i32 @bcmp(ptr addrspace(200) noundef nonnull dereferenceable(8) [[D]], ptr addrspace(200) noundef nonnull dereferenceable(8) @.str, i64 8)
// CHECK-NEXT:    [[TOBOOL_NOT:%.*]] = icmp eq i32 [[BCMP]], 0
// CHECK-NEXT:    [[DOT:%.*]] = zext i1 [[TOBOOL_NOT]] to i32
// CHECK-NEXT:    call addrspace(200) void @llvm.lifetime.end.p200(ptr addrspace(200) nonnull [[D]]) #[[ATTR4]]
