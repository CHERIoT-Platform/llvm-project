...
// CHECK-NEXT:    [[TMP4:%.*]] = load ptr addrspace(200), ptr getelementptr inbounds nuw (i8, ptr @def, i64 16), align 16
...
// CHECK-NEXT:    [[TMP11:%.*]] = load ptr addrspace(200), ptr getelementptr inbounds nuw (i8, ptr @def, i64 16), align 16
