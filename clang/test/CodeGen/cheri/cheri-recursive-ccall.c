...
// CHECK-NEXT:    [[CALL:%.*]] = tail call cheriot_compartmentcallcc signext addrspace(200) i32 @cheri_invoke(ptr addrspace(200) noundef [[TMP1]], ptr addrspace(200) noundef [[TMP2]], i64 noundef zeroext [[TMP0]]) #[[ATTR1:[0-9]+]]
