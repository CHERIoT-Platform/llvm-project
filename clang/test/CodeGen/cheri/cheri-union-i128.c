...
// CHECK-32-SAME: (ptr addrspace(200) nofree noundef align 16 dead_on_return dereferenceable(16) [[U:%.*]]) addrspace(200) #[[ATTR0]] {
// CHECK-32-NEXT:  entry:
...
// CHECK-32-NEXT:    [[CALL:%.*]] = call addrspace(200) i128 @arg128(ptr addrspace(200) nofree noundef align 16 dead_on_return dereferenceable(16) [[BYVAL_TEMP]])
// CHECK-32-NEXT:    ret void
//
...
// CHECK-32-SAME: (ptr addrspace(200) nofree noundef align 8 dead_on_return dereferenceable(16) [[U:%.*]]) addrspace(200) #[[ATTR0]] {
// CHECK-32-NEXT:  entry:
// CHECK-32-NEXT:    [[U_INDIRECT_ADDR:%.*]] = alloca ptr addrspace(200), align 8, addrspace(200)
// CHECK-32-NEXT:    store ptr addrspace(200) [[U]], ptr addrspace(200) [[U_INDIRECT_ADDR]], align 8
...
// CHECK-64-SAME: (ptr addrspace(200) nofree noundef align 16 dead_on_return dereferenceable(32) [[U:%.*]]) addrspace(200) #[[ATTR0]] {
// CHECK-64-NEXT:  entry:
...
// CHECK-32-NEXT:    [[CALL:%.*]] = call addrspace(200) i32 @arg_nested(ptr addrspace(200) nofree noundef align 8 dead_on_return dereferenceable(16) [[BYVAL_TEMP]])
// CHECK-32-NEXT:    ret void
//
...
// CHECK-64-NEXT:    [[CALL:%.*]] = call signext addrspace(200) i32 @arg_nested(ptr addrspace(200) nofree noundef align 16 dead_on_return dereferenceable(32) [[BYVAL_TEMP]])
// CHECK-64-NEXT:    ret void
//
