...
// PTRS: ret i1 false
// PTRS: define dso_local noundef zeroext i1 @cheri_tag_get_temporal(ptr nocapture noundef readnone
// PTRS: ret i1 false
...
// PTRS: ret ptr
// PTRS: define dso_local noundef ptr @cheri_seal(ptr noundef readnone returned{{( %.+)?}}, ptr nocapture noundef readnone
// PTRS: ret ptr
// PTRS: define dso_local noundef ptr @cheri_unseal(ptr noundef readnone returned{{( %.+)?}}, ptr nocapture noundef readnone
// PTRS: ret ptr
