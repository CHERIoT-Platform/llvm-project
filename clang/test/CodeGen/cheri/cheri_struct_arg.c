...
// CHECK: define dso_local ptr addrspace(200) @f(ptr addrspace(200) noundef readnone captures(none) %a, i64 inreg %b.coerce0, i64 inreg %b.coerce1, i64 inreg %b.coerce2, i64 inreg %b.coerce3)
