...
// HYBRID:  @global_cap_const = global ptr addrspace(200) inttoptr (i64 1234 to ptr addrspace(200)), align 16
// PURECAP: @global_cap_const = addrspace(200) global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 1234), align 16
...
// HYBRID-NEXT: @global_ptr_const = global ptr inttoptr (i64 1234 to ptr), align 8
// PURECAP-NEXT: @global_ptr_const = addrspace(200) global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 1234), align 16
...
// HYBRID-NEXT: @global_ptr_data = global ptr @extern_data, align 8
// PURECAP-NEXT: @global_ptr_data = addrspace(200) global ptr addrspace(200) @extern_data, align 16
...
// HYBRID-NEXT: @global_cap_data_implicit = global ptr addrspace(200) addrspacecast (ptr @extern_data to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_cap_data_implicit = addrspace(200) global ptr addrspace(200) @extern_data, align 16
...
// HYBRID-NEXT: @global_cap_data_default = global ptr addrspace(200) addrspacecast (ptr @extern_data to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_cap_data_default = addrspace(200) global ptr addrspace(200) @extern_data, align 16
...
// HYBRID-NEXT: @global_cap_data_tocap = global ptr addrspace(200) addrspacecast (ptr @extern_data to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_cap_data_tocap = addrspace(200) global ptr addrspace(200) @extern_data, align 16
...
// HYBRID-NEXT: @global_cap_data_via_uintcap_explicit = global ptr addrspace(200) addrspacecast (ptr @extern_data to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_cap_data_via_uintcap_explicit = addrspace(200) global ptr addrspace(200) @extern_data, align 16
...
// HYBRID-NEXT: @global_cap_data_via_uintcap_default = global ptr addrspace(200) addrspacecast (ptr @extern_data to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_cap_data_via_uintcap_default = addrspace(200) global ptr addrspace(200) @extern_data, align 16
...
// HYBRID-NEXT: @global_cap_data_addr_long = global ptr addrspace(200) addrspacecast (ptr @extern_data to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_cap_data_addr_long = addrspace(200) global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 ptrtoint (ptr addrspace(200) @extern_data to i64)), align 16
...
// purecap-warning@-1{{cast from provenance-free integer type to pointer type will give pointer that can not be dereferenced}}
// HYBRID-NEXT: @global_cap_data_via_long = global ptr addrspace(200) addrspacecast (ptr @extern_data to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_cap_data_via_long = addrspace(200) global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 ptrtoint (ptr addrspace(200) @extern_data to i64)), align 16
...
// HYBRID-NEXT: @global_fnptr = global ptr @extern_fn, align 8
// PURECAP-NEXT: @global_fnptr = addrspace(200) global ptr addrspace(200) @extern_fn, align 16
...
// HYBRID-NEXT: @global_fncap_default = global ptr addrspace(200) addrspacecast (ptr @extern_fn to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_fncap_default = addrspace(200) global ptr addrspace(200) @extern_fn, align 16
...
// HYBRID-NEXT: @global_fncap_tocap = global ptr addrspace(200) addrspacecast (ptr @extern_fn to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_fncap_tocap = addrspace(200) global ptr addrspace(200) @extern_fn, align 16
...
// HYBRID-NEXT: @global_intcap_data_default = global ptr addrspace(200) addrspacecast (ptr @extern_data to ptr addrspace(200)), align 16
...
// HYBRID-NEXT: @global_intcap_fn = global ptr addrspace(200) addrspacecast (ptr @extern_fn to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_intcap_fn = addrspace(200) global ptr addrspace(200) @extern_fn, align 16
...
// HYBRID-NEXT: @global_intcap_fn_cast_tocap = global ptr addrspace(200) addrspacecast (ptr @extern_fn to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_intcap_fn_cast_tocap = addrspace(200) global ptr addrspace(200) @extern_fn, align 16
...
// HYBRID-NEXT: @global_intcap_fn_plus_two_intcap = global ptr addrspace(200) addrspacecast (ptr getelementptr (i8, ptr @extern_fn, i64 2) to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_intcap_fn_plus_two_intcap = addrspace(200) global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) @extern_fn, i64 2), align 16
...
// HYBRID-NEXT: @global_intcap_fn_plus_two_intcap_addr_long = global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 ptrtoint (ptr getelementptr (i8, ptr @extern_fn, i64 2) to i64)), align 16
// PURECAP-NEXT: @global_intcap_fn_plus_two_intcap_addr_long = addrspace(200) global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 ptrtoint (ptr addrspace(200) getelementptr (i8, ptr addrspace(200) @extern_fn, i64 2) to i64)), align 16
...
// HYBRID-NEXT: @global_intcap_fn_plus_two_intcap_tocap = global ptr addrspace(200) addrspacecast (ptr getelementptr (i8, ptr @extern_fn, i64 2) to ptr addrspace(200)), align 16
// PURECAP-NEXT: @global_intcap_fn_plus_two_intcap_tocap = addrspace(200) global ptr addrspace(200) getelementptr (i8, ptr addrspace(200) @extern_fn, i64 2), align 16
