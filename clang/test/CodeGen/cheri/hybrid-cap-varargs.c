...
// MIPS-NEXT:    call void (i64, ...) @callee(i64 noundef signext 1, ptr nofreeobj noundef align 16 dead_on_return dereferenceable(16) [[BYVAL_TEMP4]])
// MIPS-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 16 [[BYVAL_TEMP5]], ptr align 16 @double_cap, i64 32, i1 false)
// MIPS-NEXT:    call void (i64, ...) @callee(i64 noundef signext 2, ptr nofreeobj noundef align 16 dead_on_return dereferenceable(32) [[BYVAL_TEMP5]])
// MIPS-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 16 [[BYVAL_TEMP6]], ptr align 16 @single_cap_array, i64 16, i1 false)
// MIPS-NEXT:    call void (i64, ...) @callee(i64 noundef signext 3, ptr nofreeobj noundef align 16 dead_on_return dereferenceable(16) [[BYVAL_TEMP6]])
// MIPS-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 16 [[BYVAL_TEMP7]], ptr align 16 @double_cap_array, i64 32, i1 false)
// MIPS-NEXT:    call void (i64, ...) @callee(i64 noundef signext 4, ptr nofreeobj noundef align 16 dead_on_return dereferenceable(32) [[BYVAL_TEMP7]])
// MIPS-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 16 [[BYVAL_TEMP8]], ptr align 16 @mixed, i64 32, i1 false)
// MIPS-NEXT:    call void (i64, ...) @callee(i64 noundef signext 5, ptr nofreeobj noundef align 16 dead_on_return dereferenceable(32) [[BYVAL_TEMP8]])
// MIPS-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 16 [[BYVAL_TEMP9]], ptr align 16 @int_or_cap, i64 16, i1 false)
// MIPS-NEXT:    call void (i64, ...) @callee(i64 noundef signext 6, ptr nofreeobj noundef align 16 dead_on_return dereferenceable(16) [[BYVAL_TEMP9]])
// MIPS-NEXT:    ret void
//
...
// RV32IXCHERI-NEXT:    call void (i32, ...) @callee(i32 noundef 2, ptr nofreeobj noundef align 8 dead_on_return dereferenceable(16) [[BYVAL_TEMP4]])
...
// RV32IXCHERI-NEXT:    call void (i32, ...) @callee(i32 noundef 4, ptr nofreeobj noundef align 8 dead_on_return dereferenceable(16) [[BYVAL_TEMP5]])
// RV32IXCHERI-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 8 [[BYVAL_TEMP6]], ptr align 8 @mixed, i32 16, i1 false)
// RV32IXCHERI-NEXT:    call void (i32, ...) @callee(i32 noundef 5, ptr nofreeobj noundef align 8 dead_on_return dereferenceable(16) [[BYVAL_TEMP6]])
...
// RV64IXCHERI-NEXT:    call void (i64, ...) @callee(i64 noundef 2, ptr nofreeobj noundef align 16 dead_on_return dereferenceable(32) [[BYVAL_TEMP4]])
...
// RV64IXCHERI-NEXT:    call void (i64, ...) @callee(i64 noundef 4, ptr nofreeobj noundef align 16 dead_on_return dereferenceable(32) [[BYVAL_TEMP5]])
// RV64IXCHERI-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 16 [[BYVAL_TEMP6]], ptr align 16 @mixed, i64 32, i1 false)
// RV64IXCHERI-NEXT:    call void (i64, ...) @callee(i64 noundef 5, ptr nofreeobj noundef align 16 dead_on_return dereferenceable(32) [[BYVAL_TEMP6]])
