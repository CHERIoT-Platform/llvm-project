...
// MIPS64C128-NEXT:    store ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 -6148914691236517206), ptr [[CAP]], align 16, !annotation [[META1:![0-9]+]]
...
// RISCV32-NEXT:    store ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i32 -1), ptr [[CAP]], align 8, !annotation [[META5:![0-9]+]]
...
// RISCV64-NEXT:    store ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 -6148914691236517206), ptr [[CAP]], align 16, !annotation [[META5:![0-9]+]]
...
// MIPS64C128-NEXT:  entry:
// MIPS64C128-NEXT:    call void @llvm.memset.p0.i64(ptr align 16 [[AGG_RESULT:%.*]], i8 0, i64 64, i1 false), !annotation [[META1]]
// MIPS64C128-NEXT:    [[TMP0:%.*]] = getelementptr inbounds [[STRUCT_S:%.*]], ptr [[AGG_RESULT]], i32 0, i32 0
// MIPS64C128-NEXT:    store ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 -6148914691236517206), ptr [[TMP0]], align 16, !annotation [[META1]]
...
// MIPS64C128-NEXT:    store ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 -6148914691236517206), ptr [[TMP2]], align 16, !annotation [[META1]]
// MIPS64C128-NEXT:    [[TMP3:%.*]] = getelementptr inbounds [2 x ptr addrspace(200)], ptr [[TMP1]], i32 0, i32 1
// MIPS64C128-NEXT:    store ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 -6148914691236517206), ptr [[TMP3]], align 16, !annotation [[META1]]
...
// MIPS64C128-NEXT:    store ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 -6148914691236517206), ptr [[TMP5]], align 16, !annotation [[META1]]
...
// RISCV32-NEXT:    call void @llvm.memcpy.p0.p0.i32(ptr align 8 [[AGG_RESULT]], ptr align 8 @__const.get_uninitialised_struct.s, i32 32, i1 false), !annotation [[META5]]
...
// RISCV64-NEXT:    call void @llvm.memset.p0.i64(ptr align 16 [[AGG_RESULT]], i8 0, i64 64, i1 false), !annotation [[META5]]
// RISCV64-NEXT:    [[TMP0:%.*]] = getelementptr inbounds [[STRUCT_S:%.*]], ptr [[AGG_RESULT]], i32 0, i32 0
// RISCV64-NEXT:    store ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 -6148914691236517206), ptr [[TMP0]], align 16, !annotation [[META5]]
...
// RISCV64-NEXT:    store ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 -6148914691236517206), ptr [[TMP2]], align 16, !annotation [[META5]]
// RISCV64-NEXT:    [[TMP3:%.*]] = getelementptr inbounds [2 x ptr addrspace(200)], ptr [[TMP1]], i32 0, i32 1
// RISCV64-NEXT:    store ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 -6148914691236517206), ptr [[TMP3]], align 16, !annotation [[META5]]
...
// RISCV64-NEXT:    store ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 -6148914691236517206), ptr [[TMP5]], align 16, !annotation [[META5]]
