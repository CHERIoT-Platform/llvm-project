...
// CHECK-NEXT:    call void @llvm.lifetime.start.p200(ptr addrspace(200) nonnull [[P]]) #[[ATTR4:[0-9]+]]
...
// CHECK:       [[ATOMIC_CONT]]:
// CHECK-NEXT:    call void @llvm.lifetime.end.p200(ptr addrspace(200) nonnull [[P]]) #[[ATTR4]]
// CHECK-NEXT:    ret void
//
void test1() {
