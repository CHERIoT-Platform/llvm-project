...
// CHECK-IL32PC64-SAME: (ptr addrspace(200) dead_on_unwind noalias writable sret([[STRUCT_S:%.*]]) align 1 [[AGG_RESULT:%.*]], ptr addrspace(200) noundef align 1 dead_on_return [[S:%.*]]) addrspace(200) #[[ATTR0]] {
// CHECK-IL32PC64-NEXT:  entry:
...
// CHECK-IL32PC64-NEXT:    call addrspace(200) void (ptr addrspace(200), i32, ...) @callee_S(ptr addrspace(200) dead_on_unwind writable sret([[STRUCT_S]]) align 1 [[AGG_RESULT]], i32 noundef 4, i32 noundef 1, i32 noundef 2, i32 noundef 3, ptr addrspace(200) noundef align 1 dead_on_return [[BYVAL_TEMP]])
// CHECK-IL32PC64-NEXT:    ret void
//
// CHECK-L64PC128-LABEL: define {{[^@]+}}@caller_S
// CHECK-L64PC128-SAME: (ptr addrspace(200) dead_on_unwind noalias writable sret([[STRUCT_S:%.*]]) align 1 [[AGG_RESULT:%.*]], ptr addrspace(200) noundef align 1 dead_on_return [[S:%.*]]) addrspace(200) #[[ATTR0]] {
// CHECK-L64PC128-NEXT:  entry:
...
// CHECK-L64PC128-NEXT:    call addrspace(200) void (ptr addrspace(200), i32, ...) @callee_S(ptr addrspace(200) dead_on_unwind writable sret([[STRUCT_S]]) align 1 [[AGG_RESULT]], i32 noundef signext 4, i32 noundef signext 1, i32 noundef signext 2, i32 noundef signext 3, ptr addrspace(200) noundef align 1 dead_on_return [[BYVAL_TEMP]])
// CHECK-L64PC128-NEXT:    ret void
//
