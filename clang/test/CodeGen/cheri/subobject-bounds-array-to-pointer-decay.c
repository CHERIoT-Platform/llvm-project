...
// RUN: %cheri_purecap_cc1 -cheri-bounds=subobject-safe -O2 -emit-llvm %s -o - -Rcheri-subobject-bounds -mllvm -stats 2>%t.dbg | FileCheck %s
...
// CHECK-NEXT:    tail call addrspace(200) void @overflow_buffer(ptr addrspace(200) noundef [[TMP0]]) #[[ATTR5:[0-9]+]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull [[BUFFER]], i64 48)
// CHECK-NEXT:    call addrspace(200) void @overflow_buffer(ptr addrspace(200) noundef [[TMP0]]) #[[ATTR5]]
// CHECK-NEXT:    call addrspace(200) void @llvm.lifetime.end.p200(ptr addrspace(200) nonnull [[BUFFER]]) #[[ATTR5]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    call addrspace(200) void @llvm.lifetime.start.p200(ptr addrspace(200) nonnull [[BUFFER]]) #[[ATTR5]]
// CHECK-NEXT:    [[TMP0:%.*]] = call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull [[BUFFER]], i64 84)
// CHECK-NEXT:    call addrspace(200) void @llvm.lifetime.end.p200(ptr addrspace(200) nonnull [[BUFFER]]) #[[ATTR5]]
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull @global_buffer, i64 400)
...
// CHECK-NEXT:    [[CUR_ADDR:%.*]] = call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) nonnull [[VLA]])
// CHECK-NEXT:    [[REMAINING_BYTES:%.*]] = sub i64 [[CUR_TOP]], [[CUR_ADDR]]
// CHECK-NEXT:    [[TMP0:%.*]] = call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull [[VLA]], i64 [[REMAINING_BYTES]])
// CHECK-NEXT:    call addrspace(200) void @overflow_buffer(ptr addrspace(200) noundef [[TMP0]]) #[[ATTR5]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[CUR_TOP:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.top.get.i64(ptr addrspace(200) nonnull [[FAKE_VLA]])
// CHECK-NEXT:    [[CUR_ADDR:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) nonnull [[FAKE_VLA]])
// CHECK-NEXT:    [[REMAINING_BYTES:%.*]] = sub i64 [[CUR_TOP]], [[CUR_ADDR]]
// CHECK-NEXT:    [[TMP0:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull [[FAKE_VLA]], i64 [[REMAINING_BYTES]])
// CHECK-NEXT:    tail call addrspace(200) void @overflow_buffer(ptr addrspace(200) noundef [[TMP0]]) #[[ATTR5]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[CUR_TOP:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.top.get.i64(ptr addrspace(200) nonnull [[FAKE_VLA2]])
// CHECK-NEXT:    [[CUR_ADDR:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) nonnull [[FAKE_VLA2]])
// CHECK-NEXT:    [[REMAINING_BYTES:%.*]] = sub i64 [[CUR_TOP]], [[CUR_ADDR]]
// CHECK-NEXT:    [[TMP0:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull [[FAKE_VLA2]], i64 [[REMAINING_BYTES]])
// CHECK-NEXT:    tail call addrspace(200) void @overflow_buffer(ptr addrspace(200) noundef [[TMP0]]) #[[ATTR5]]
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[CUR_TOP:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.top.get.i64(ptr addrspace(200) nonnull @bhnd_sprom_layouts)
// CHECK-NEXT:    [[CUR_ADDR:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) nonnull @bhnd_sprom_layouts)
// CHECK-NEXT:    [[REMAINING_BYTES:%.*]] = sub i64 [[CUR_TOP]], [[CUR_ADDR]]
// CHECK-NEXT:    [[TMP0:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull @bhnd_sprom_layouts, i64 [[REMAINING_BYTES]])
// CHECK-NEXT:    tail call addrspace(200) void @overflow_buffer(ptr addrspace(200) noundef [[TMP0]]) #[[ATTR5]]
// CHECK-NEXT:    ret void
//
