...
// CLEAR-PERM2-NEXT:    call void @llvm.lifetime.start.p200(ptr addrspace(200) nonnull [[F]]) #[[ATTR4:[0-9]+]]
...
// CLEAR-PERM2-NEXT:    [[TMP3:%.*]] = call ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull [[F]], i64 2)
// CLEAR-PERM2-NEXT:    [[NEW_LEN3:%.*]] = call i64 @llvm.cheri.cap.length.get.i64(ptr addrspace(200) [[TMP3]])
// CLEAR-PERM2-NEXT:    [[NEW_LEN4:%.*]] = call ptr addrspace(200) @llvm.cheri.cap.perms.and.i64(ptr addrspace(200) [[TMP3]], i64 -131073)
...
// CLEAR-PERM2-NEXT:    [[TMP4:%.*]] = call ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull @.str, i64 20)
// CLEAR-PERM2-NEXT:    [[CUR_LEN7:%.*]] = call i64 @llvm.cheri.cap.length.get.i64(ptr addrspace(200) nonnull @.str)
// CLEAR-PERM2-NEXT:    [[NEW_LEN8:%.*]] = call i64 @llvm.cheri.cap.length.get.i64(ptr addrspace(200) [[TMP4]])
// CLEAR-PERM2-NEXT:    [[NEW_LEN9:%.*]] = call ptr addrspace(200) @llvm.cheri.cap.perms.and.i64(ptr addrspace(200) [[TMP4]], i64 -131073)
...
// CLEAR-PERM2-NEXT:    [[TMP5:%.*]] = call ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull @.str.1, i64 22)
// CLEAR-PERM2-NEXT:    [[CUR_LEN12:%.*]] = call i64 @llvm.cheri.cap.length.get.i64(ptr addrspace(200) nonnull @.str.1)
// CLEAR-PERM2-NEXT:    [[NEW_LEN13:%.*]] = call i64 @llvm.cheri.cap.length.get.i64(ptr addrspace(200) [[TMP5]])
// CLEAR-PERM2-NEXT:    [[NEW_LEN14:%.*]] = call ptr addrspace(200) @llvm.cheri.cap.perms.and.i64(ptr addrspace(200) [[TMP5]], i64 -131073)
...
// CLEAR-PERM2-NEXT:    call void @llvm.lifetime.end.p200(ptr addrspace(200) nonnull [[F]]) #[[ATTR4]]
