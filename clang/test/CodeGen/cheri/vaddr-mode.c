...
// ADDR-NEXT:  entry:
// ADDR-NEXT:    [[TMP0:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) [[CAP:%.*]])
// ADDR-NEXT:    ret i64 [[TMP0]]
//
// OFFSET-LABEL: @uintcap_to_long(
// OFFSET-NEXT:  entry:
// OFFSET-NEXT:    [[TMP0:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) [[CAP:%.*]])
...
// BOTH-NEXT:  entry:
// BOTH-NEXT:    [[TMP0:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) [[CAP:%.*]])
...
// OFFSET-NEXT:    [[TMP1:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) [[CAP]], i64 [[AND]])
// OFFSET-NEXT:    [[TMP2:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) [[TMP1]])
...
// ADDR-NEXT:    [[TMP0:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) [[CAP:%.*]])
// ADDR-NEXT:    [[AND:%.*]] = and i64 [[TMP0]], 3
// ADDR-NEXT:    [[TMP1:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) [[CAP]], i64 [[AND]])
...
// ADDR-LABEL: @xor_self(
// ADDR-NEXT:  entry:
// ADDR-NEXT:    [[TMP0:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) [[CAP:%.*]], i64 0)
// ADDR-NEXT:    ret ptr addrspace(200) [[TMP0]]
//
// OFFSET-LABEL: @xor_self(
// OFFSET-NEXT:  entry:
// OFFSET-NEXT:    [[TMP0:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) [[CAP:%.*]], i64 0)
...
// ADDR-NEXT:  entry:
// ADDR-NEXT:    [[TMP0:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) [[CAP:%.*]])
// ADDR-NEXT:    [[TMP1:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) [[CAP2:%.*]])
// ADDR-NEXT:    [[XOR:%.*]] = xor i64 [[TMP1]], [[TMP0]]
// ADDR-NEXT:    [[TMP2:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) [[CAP]], i64 [[XOR]])
// ADDR-NEXT:    ret ptr addrspace(200) [[TMP2]]
//
// OFFSET-LABEL: @xor_uintcap(
// OFFSET-NEXT:  entry:
// OFFSET-NEXT:    [[TMP0:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) [[CAP:%.*]])
// OFFSET-NEXT:    [[TMP1:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) [[CAP2:%.*]])
// OFFSET-NEXT:    [[XOR:%.*]] = xor i64 [[TMP1]], [[TMP0]]
// OFFSET-NEXT:    [[TMP2:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) [[CAP]], i64 [[XOR]])
...
// OFFSET-NEXT:    [[XOR:%.*]] = xor i64 [[TMP1]], [[TMP0]]
// OFFSET-NEXT:    [[TMP2:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) [[CAP]], i64 [[XOR]])
// OFFSET-NEXT:    [[TMP3:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) [[TMP2]])
...
// ADDR-NEXT:    [[TMP1:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) [[CAP]], i64 [[REM]])
// ADDR-NEXT:    ret ptr addrspace(200) [[TMP1]]
//
...
// OFFSET-NEXT:    [[TMP1:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) [[CAP]], i64 [[REM]])
// OFFSET-NEXT:    ret ptr addrspace(200) [[TMP1]]
//
...
// ADDR-NEXT:  entry:
// ADDR-NEXT:    [[TMP0:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) [[MTX:%.*]])
// ADDR-NEXT:    [[AND:%.*]] = and i64 [[TMP0]], 1
// ADDR-NEXT:    [[TMP1:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) [[MTX]], i64 [[AND]])
...
// ADDR:       if.then:
// ADDR-NEXT:    tail call addrspace(200) void @do_unlock() #[[ATTR6:[0-9]+]]
...
// OFFSET-NEXT:  entry:
// OFFSET-NEXT:    [[TMP0:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) [[MTX:%.*]])
// OFFSET-NEXT:    [[AND:%.*]] = and i64 [[TMP0]], 1
// OFFSET-NEXT:    [[TMP1:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) [[MTX]], i64 [[AND]])
...
// OFFSET:       if.then:
// OFFSET-NEXT:    tail call addrspace(200) void @do_unlock() #[[ATTR6:[0-9]+]]
