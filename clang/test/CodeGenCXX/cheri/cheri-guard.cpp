...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = load atomic i8, ptr addrspace(200) @_ZGVZ1fvE1x acquire, align 8
...
// UTC_ARGS: --disable
// CHECK: declare i32 @__cxa_guard_acquire(ptr addrspace(200))
// CHECK: declare void @__cxa_guard_release(ptr addrspace(200))
