...
// RISCV64-PURECAP-SAME: (ptr addrspace(200) dead_on_unwind noalias nofree writable writeonly sret({ ptr addrspace(200), i64 }) align 16 captures(none) initializes((0, 32)) [[AGG_RESULT:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR0:[0-9]+]] {
// RISCV64-PURECAP-NEXT:  entry:
// RISCV64-PURECAP-NEXT:    store { ptr addrspace(200), i64 } { ptr addrspace(200) @_ZN1A3fooEv, i64 0 }, ptr addrspace(200) [[AGG_RESULT]], align 16, !tbaa [[TBAA10:![0-9]+]]
...
// RISCV64-PURECAP-SAME: (ptr addrspace(200) dead_on_unwind noalias nofree writable writeonly sret({ ptr addrspace(200), i64 }) align 16 captures(none) initializes((0, 32)) [[AGG_RESULT:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR0]] {
// RISCV64-PURECAP-NEXT:  entry:
// RISCV64-PURECAP-NEXT:    tail call addrspace(200) void @llvm.memset.p200.i64(ptr addrspace(200) noundef nonnull align 16 dereferenceable(32) [[AGG_RESULT]], i8 0, i64 32, i1 false)
// RISCV64-PURECAP-NEXT:    ret void
//
...
// RISCV64-PURECAP-SAME: (ptr addrspace(200) dead_on_unwind noalias nofree writable writeonly sret({ ptr addrspace(200), i64 }) align 16 captures(none) initializes((0, 32)) [[AGG_RESULT:%.*]], ptr addrspace(200) nofreeobj noundef readonly align 16 captures(none) dead_on_return dereferenceable(32) [[TMP0:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR2:[0-9]+]] {
// RISCV64-PURECAP-NEXT:  entry:
