...
// RISCV64-PURECAP-SAME: (ptr addrspace(200) dead_on_unwind noalias nofree writable writeonly sret({ ptr addrspace(200), i64 }) align 16 captures(none) initializes((0, 32)) [[AGG_RESULT:%.*]], ptr addrspace(200) nofree noundef readonly align 16 captures(none) dead_on_return dereferenceable(32) [[TMP0:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR2:[0-9]+]] {
// RISCV64-PURECAP-NEXT:  entry:
