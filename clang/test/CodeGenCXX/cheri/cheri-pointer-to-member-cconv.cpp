...
// RISCV64-PURECAP-SAME: (ptr addrspace(200) dead_on_unwind noalias nocapture writable writeonly sret({ ptr addrspace(200), i64 }) align 16 initializes((0, 32)) [[AGG_RESULT:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR2:[0-9]+]] {
// RISCV64-PURECAP-NEXT:  entry:
...
// RISCV64-PURECAP-SAME: (ptr addrspace(200) dead_on_unwind noalias nocapture writable writeonly sret({ ptr addrspace(200), i64 }) align 16 initializes((0, 32)) [[AGG_RESULT:%.*]], ptr addrspace(200) nocapture noundef readonly [[TMP0:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR3:[0-9]+]] {
// RISCV64-PURECAP-NEXT:  entry:
