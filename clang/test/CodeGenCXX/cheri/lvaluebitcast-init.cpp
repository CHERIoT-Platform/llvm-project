...
// CHECK-SAME: (ptr addrspace(200) noundef [[TYPES:%.*]], i32 noundef signext [[METATYPE:%.*]]) addrspace(200) #[[ATTR0:[0-9]+]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TYPES_ADDR:%.*]] = alloca ptr addrspace(200), align 16, addrspace(200)
...
// NOCHERI-SAME: (ptr noundef [[TYPES:%.*]], i32 noundef [[METATYPE:%.*]]) #[[ATTR0:[0-9]+]] {
// NOCHERI-NEXT:  entry:
// NOCHERI-NEXT:    [[TYPES_ADDR:%.*]] = alloca ptr, align 8
// NOCHERI-NEXT:    [[METATYPE_ADDR:%.*]] = alloca i32, align 4
// NOCHERI-NEXT:    [[MT:%.*]] = alloca [[CLASS_QMETATYPE:%.*]], align 8
// NOCHERI-NEXT:    store ptr [[TYPES]], ptr [[TYPES_ADDR]], align 8
// NOCHERI-NEXT:    store i32 [[METATYPE]], ptr [[METATYPE_ADDR]], align 4
// NOCHERI-NEXT:    [[TMP0:%.*]] = load i32, ptr [[METATYPE_ADDR]], align 4
// NOCHERI-NEXT:    call void @_ZN9QMetaTypeC1Ei(ptr noundef nonnull align 8 dereferenceable(8) [[MT]], i32 noundef [[TMP0]])
// NOCHERI-NEXT:    [[TMP1:%.*]] = load ptr, ptr [[MT]], align 8
// NOCHERI-NEXT:    [[TMP2:%.*]] = load ptr, ptr [[TYPES_ADDR]], align 8
// NOCHERI-NEXT:    store ptr [[TMP1]], ptr [[TMP2]], align 8
...
// CHECK-NEXT:    store i32 1, ptr addrspace(200) [[FOO]], align 4
// CHECK-NEXT:    [[TMP0:%.*]] = load i8, ptr addrspace(200) [[FOO]], align 4
// CHECK-NEXT:    [[CONV:%.*]] = sext i8 [[TMP0]] to i32
// CHECK-NEXT:    store i32 [[CONV]], ptr addrspace(200) [[BAR]], align 4
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr addrspace(200) [[BAR]], align 4
...
// NOCHERI-NEXT:    store i32 1, ptr [[FOO]], align 4
// NOCHERI-NEXT:    [[TMP0:%.*]] = load i8, ptr [[FOO]], align 4
// NOCHERI-NEXT:    [[CONV:%.*]] = sext i8 [[TMP0]] to i32
// NOCHERI-NEXT:    store i32 [[CONV]], ptr [[BAR]], align 4
// NOCHERI-NEXT:    [[TMP1:%.*]] = load i32, ptr [[BAR]], align 4
// NOCHERI-NEXT:    ret i32 [[TMP1]]
//
int test2() {
  int foo = 1;
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    %0 = load i8, ptr addrspace(200) @global_foo, align 4
// CHECK-NEXT:    %conv = sext i8 %0 to i32
// CHECK-NEXT:    store i32 %conv, ptr addrspace(200) @global_bar, align 4
// CHECK-NEXT:    ret void
// CHECK-NEXT:  }
//
...
// NOCHERI-NEXT:  entry:
// NOCHERI-NEXT:    %0 = load i8, ptr @global_foo, align 4
// NOCHERI-NEXT:    %conv = sext i8 %0 to i32
// NOCHERI-NEXT:    store i32 %conv, ptr @global_bar, align 4
// NOCHERI-NEXT:    ret void
// NOCHERI-NEXT:  }
//
