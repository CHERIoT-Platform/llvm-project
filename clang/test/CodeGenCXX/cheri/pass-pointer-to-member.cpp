...
// RISCV64-PURECAP-SAME: (ptr addrspace(200) noundef [[A:%.*]], ptr addrspace(200) nofree noundef readonly align 16 captures(none) dead_on_return dereferenceable(32) [[TMP0:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR0:[0-9]+]] {
...
// RISCV64-PURECAP-NEXT:    [[CALL:%.*]] = call noundef addrspace(200) i64 @_Z12use_p2m_implP1AMS_FlvE(ptr addrspace(200) noundef [[A]], ptr addrspace(200) nofree noundef nonnull align 16 dead_on_return dereferenceable(32) [[BYVAL_TEMP]]) #[[ATTR4]]
...
// RISCV32-PURECAP-SAME: (ptr addrspace(200) noundef [[A:%.*]], ptr addrspace(200) nofree noundef readonly align 8 captures(none) dead_on_return dereferenceable(16) [[TMP0:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR0:[0-9]+]] {
...
// RISCV32-PURECAP-NEXT:    [[CALL:%.*]] = call noundef addrspace(200) i32 @_Z12use_p2m_implP1AMS_FlvE(ptr addrspace(200) noundef [[A]], ptr addrspace(200) nofree noundef nonnull align 8 dead_on_return dereferenceable(16) [[BYVAL_TEMP]]) #[[ATTR4]]
...
// RISCV64-PURECAP-NEXT:    [[CALL:%.*]] = call noundef addrspace(200) i64 @_Z7use_p2mP1AMS_FlvE(ptr addrspace(200) noundef null, ptr addrspace(200) nofree noundef nonnull align 16 dead_on_return dereferenceable(32) [[BYVAL_TEMP]])
// RISCV64-PURECAP-NEXT:    call addrspace(200) void @llvm.lifetime.end.p200(ptr addrspace(200) nonnull [[BYVAL_TEMP]]) #[[ATTR4]]
// RISCV64-PURECAP-NEXT:    ret i64 [[CALL]]
//
...
// RISCV32-PURECAP-NEXT:    [[CALL:%.*]] = call noundef addrspace(200) i32 @_Z7use_p2mP1AMS_FlvE(ptr addrspace(200) noundef null, ptr addrspace(200) nofree noundef nonnull align 8 dead_on_return dereferenceable(16) [[BYVAL_TEMP]])
// RISCV32-PURECAP-NEXT:    call addrspace(200) void @llvm.lifetime.end.p200(ptr addrspace(200) nonnull [[BYVAL_TEMP]]) #[[ATTR4]]
// RISCV32-PURECAP-NEXT:    ret i32 [[CALL]]
//
long pass_p2m() {
