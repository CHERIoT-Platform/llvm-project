...
__attribute__((__aligned__(2))) struct { int *__capability i; } with_cap_global_align2; // expected-warning-re{{alignment (2) of 'struct (unnamed at {{.+}}' is less than the required capability alignment}}
// expected-note@-1{{if you are certain that this is correct you can silence the warning by adding __attribute__((annotate("underaligned_capability")))}}
