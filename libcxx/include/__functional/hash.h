...
template <>
struct __hash_impl<__intcap_t> : __scalar_hash<__intcap_t>
{
  _LIBCPP_HIDE_FROM_ABI size_t operator()(__intcap_t x) const _NOEXCEPT {
    return __scalar_hash<ptraddr_t>()(static_cast<ptraddr_t>(x));
  }
};

template <>
struct __hash_impl<__uintcap_t> : __scalar_hash<__uintcap_t>
{
