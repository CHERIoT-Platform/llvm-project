...
constexpr uint32_t INTERNAL_RISCV_CHERIOT_COMPARTMENT_HI =
    INTERNAL_RISCV_VENDOR_CHERIOT1 | llvm::ELF::R_RISCV_CHERIOT_COMPARTMENT_HI;
constexpr uint32_t INTERNAL_RISCV_CHERIOT_COMPARTMENT_LO_I =
    INTERNAL_RISCV_VENDOR_CHERIOT1 | llvm::ELF::R_RISCV_CHERIOT_COMPARTMENT_LO_I;
constexpr uint32_t INTERNAL_RISCV_CHERIOT_COMPARTMENT_LO_S =
    INTERNAL_RISCV_VENDOR_CHERIOT1 | llvm::ELF::R_RISCV_CHERIOT_COMPARTMENT_LO_S;
constexpr uint32_t INTERNAL_RISCV_CHERIOT_COMPARTMENT_SIZE =
    INTERNAL_RISCV_VENDOR_CHERIOT1 | llvm::ELF::R_RISCV_CHERIOT_COMPARTMENT_SIZE;
