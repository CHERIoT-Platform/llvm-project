...
constexpr uint32_t INTERNAL_RISCV_VENDOR_XCHERIOT1 = 3 << 9;
...
constexpr uint32_t INTERNAL_RISCV_CHERIOT_COMPARTMENT_HI =
    INTERNAL_RISCV_VENDOR_XCHERIOT1 | llvm::ELF::R_RISCV_CHERIOT_COMPARTMENT_HI;
constexpr uint32_t INTERNAL_RISCV_CHERIOT_COMPARTMENT_LO_I =
    INTERNAL_RISCV_VENDOR_XCHERIOT1 | llvm::ELF::R_RISCV_CHERIOT_COMPARTMENT_LO_I;
constexpr uint32_t INTERNAL_RISCV_CHERIOT_COMPARTMENT_LO_S =
    INTERNAL_RISCV_VENDOR_XCHERIOT1 | llvm::ELF::R_RISCV_CHERIOT_COMPARTMENT_LO_S;
constexpr uint32_t INTERNAL_RISCV_CHERIOT_COMPARTMENT_SIZE =
    INTERNAL_RISCV_VENDOR_XCHERIOT1 | llvm::ELF::R_RISCV_CHERIOT_COMPARTMENT_SIZE;

constexpr uint32_t INTERNAL_RISCV_CHERIOT_COMPARTMENT_PCCREL_LO_I =
    INTERNAL_RISCV_VENDOR_XCHERIOT1 |  256;
constexpr uint32_t INTERNAL_RISCV_CHERIOT_COMPARTMENT_PCCREL_HI =
    INTERNAL_RISCV_VENDOR_XCHERIOT1 |  257;
