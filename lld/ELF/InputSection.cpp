...
struct RISCVPCRel {
  ...
  static bool isHiReloc(uint32_t type) {
    return is_contained<uint32_t>(
        {R_RISCV_PCREL_HI20, R_RISCV_GOT_HI20, R_RISCV_TLS_GD_HI20,
         R_RISCV_TLS_GOT_HI20, R_RISCV_CHERI_TLS_TGOT_GOT_HI20,
         R_RISCV_CHERI_TLS_TGOT_GD_HI20,
         INTERNAL_RISCV_CHERIOT1_COMPARTMENT_CODE_HI,
         INTERNAL_RISCV_CHERIOT1_COMPARTMENT_DATA_HI,
...
struct LoongArchPCAdd {
  ...
  static bool isHiReloc(uint32_t type) {
    return is_contained(
        {R_LARCH_PCADD_HI20, R_LARCH_GOT_PCADD_HI20, R_LARCH_TLS_IE_PCADD_HI20,
         R_LARCH_TLS_LD_PCADD_HI20, R_LARCH_TLS_GD_PCADD_HI20,
