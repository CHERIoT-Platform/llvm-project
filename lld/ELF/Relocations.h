...
enum RelExpr {
  ...
  RE_CHERIOT1_COMPARTMENT_CGPREL_HI,
  RE_CHERIOT1_COMPARTMENT_CGPREL_LO,
  RE_CHERIOT1_COMPARTMENT_SIZE,
...
void printLocation(ELFSyncStream &s, const InputSectionBase &sec, const Symbol &sym,
                   uint64_t off);
...
void printLocationMessage(ELFSyncStream &stream, const InputSectionBase &s,
