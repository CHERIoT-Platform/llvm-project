...
void RelocationBaseSection::maybeAddRISCVendorRelocation(const DynamicReloc &reloc, SmallVector<DynamicReloc, 0> &outRelocs) {
...
void SymbolTableBaseSection::addSymbol(Symbol *b) {
  ...
  bool hashIt = b->isLocal() && ctx.arg.compartment;
