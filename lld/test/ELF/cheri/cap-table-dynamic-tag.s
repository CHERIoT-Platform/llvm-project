...
# LAZY-SEGMENTS-NEXT:   01 __cap_relocs .MIPS.abiflags .MIPS.options .dynsym .hash .dynamic .dynstr {{$}}
...
# WITH-TABLE-LAZY-NEXT:    0x0000000000000006 SYMTAB               0x268
...
# WITH-TABLE-LAZY-NEXT:    0x000000007000C003 MIPS_CHERI_CAPTABLE  0x20{{.+}}
# WITH-TABLE-LAZY-NEXT:    0x000000007000C004 MIPS_CHERI_CAPTABLESZ 0x10
# WITH-TABLE-LAZY-NEXT:    0x000000007000C000 MIPS_CHERI___CAPRELOCS 0x{{.+}}
...
# WITH-TABLE-NOW-NEXT:    0x0000000000000006 SYMTAB               0x2D8
...
# WITH-TABLE-NOW-NEXT:    0x000000007000C000 MIPS_CHERI___CAPRELOCS 0x270
# WITH-TABLE-NOW-NEXT:    0x000000007000C001 MIPS_CHERI___CAPRELOCSSZ 0x28
# WITH-TABLE-NOW-NEXT:    0x0000000000000000 NULL                 0x0
# WITH-TABLE-NOW-NEXT:  ]

# EMPTY-TABLE-LABEL: DynamicSection [ (16 entries)
# EMPTY-TABLE-NEXT:    Tag                Type                 Name/Value
# EMPTY-TABLE-NEXT:    0x000000006FFFFFFB FLAGS_1              PIE
...
# EMPTY-TABLE-NEXT:    0x0000000000000003 PLTGOT               0x20{{.+}}
