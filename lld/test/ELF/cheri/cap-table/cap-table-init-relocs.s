...
# LEGACY-BOTH-CAPRELOCS: 9 .captable    00000020 00000000000204f0 DATA
# LEGACY-BOTH-CAPRELOCS: 12 __cap_relocs  00000050 0000000000030520 DATA
# LEGACY-BOTH-CAPRELOCS-LABEL: SYMBOL TABLE:
# LEGACY-BOTH-CAPRELOCS:       00000000000204f0 l     O .captable              0000000000000010 preemptible_var@CAPTABLE
# LEGACY-BOTH-CAPRELOCS:       0000000000020500 l     O .captable              0000000000000010 local_var@CAPTABLE
# LEGACY-BOTH-CAPRELOCS-LABEL: CAPABILITY RELOCATION RECORDS:
# LEGACY-BOTH-CAPRELOCS-NEXT: 0x00000000000204f0	Base: <Unnamed symbol> (0x0000000000000000)	Offset: 0x0000000000000000	Length: 0x0000000000000000	Permissions: 0x00000000
# LEGACY-BOTH-CAPRELOCS-NEXT: 0x0000000000020500	Base: local_var (0x0000000000030518)	Offset: 0x0000000000000000	Length: 0x0000000000000008	Permissions: 0x00000000
# LEGACY-BOTH-CAPRELOCS-EMPTY:

# One load address relocation for the local var base. And ABSPTR+SIZE for the preemptible one
# LEGACY-BOTH-ELF-RELOCS:      Relocations [
# LEGACY-BOTH-ELF-RELOCS-NEXT:   Section (7) .rel.dyn {
# LEGACY-BOTH-ELF-RELOCS-NEXT:     0x30550 R_MIPS_REL32/R_MIPS_64/R_MIPS_NONE -{{$}}
# LEGACY-BOTH-ELF-RELOCS-NEXT:     0x30528 R_MIPS_CHERI_ABSPTR/R_MIPS_64/R_MIPS_NONE preemptible_var{{$}}
# LEGACY-BOTH-ELF-RELOCS-NEXT:     0x30538 R_MIPS_CHERI_SIZE/R_MIPS_64/R_MIPS_NONE preemptible_var{{$}}
