...
# CHECK-NEXT: Base: .L.str.123 (0x0000000000040340)	Offset: 0x0000000000000000	Length: 0x0000000000000006	Permissions: 0x00000000
# CHECK-NEXT: Base: .L.duplicate_local (0x0000000000040346)	Offset: 0x0000000000000000	Length: 0x0000000000000008	Permissions: 0x00000000
# CHECK-NEXT: Base: duplicate_local_without_prefix (0x000000000004034e)	Offset: 0x0000000000000000	Length: 0x0000000000000008	Permissions: 0x00000000
# CHECK-NEXT:	Base: duplicate_global (0x0000000000040356)	Offset: 0x0000000000000000	Length: 0x0000000000000008	Permissions: 0x00000000
# CHECK-NEXT: Base: local_with_same_name_as_global (0x000000000004035e)	Offset: 0x0000000000000000	Length: 0x0000000000000008	Permissions: 0x00000000
# CHECK-NEXT: Base: .L.duplicate_local (0x0000000000040370)	Offset: 0x0000000000000000	Length: 0x0000000000000008	Permissions: 0x00000000
# CHECK-NEXT: Base: duplicate_local_without_prefix (0x0000000000040378)	Offset: 0x0000000000000000	Length: 0x0000000000000008	Permissions: 0x00000000
# CHECK-NEXT: Base: g (0x0000000000040380)	Offset: 0x0000000000000000	Length: 0x0000000000000008	Permissions: 0x00000000
# CHECK-NEXT: Base: local_with_same_name_as_global (0x0000000000040388)	Offset: 0x0000000000000000	Length: 0x0000000000000008	Permissions: 0x00000000
