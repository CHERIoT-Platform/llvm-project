...
// PER-FILE-NEXT:     0x20A50 R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE global_int{{$}}
// PER-FILE-NEXT:     0x20A80 R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE global_int{{$}}
// PER-FILE-NEXT:     0x20AA0 R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE global_int{{$}}
// PER-FILE-NEXT:   }
// PER-FILE-NEXT:   Section ({{.+}}) .rel.plt {
// PER-FILE-NEXT:     0x20A20 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_void_ptr{{$}}
// PER-FILE-NEXT:     0x20A30 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_char_ptr{{$}}
// PER-FILE-NEXT:     0x20A40 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_int{{$}}
// PER-FILE-NEXT:     0x20A70 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_char_ptr{{$}}
// PER-FILE-NEXT:     0x20A90 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_char_ptr{{$}}
// PER-FILE-NEXT:   }
// PER-FILE-NEXT: ]
// PER-FILE-NEXT: CHERI Capability Relocations [
// PER-FILE-NEXT:   Section ({{.+}}) __cap_relocs {
// PER-FILE-NEXT:     0x20A60 FUNC - 0x10930 [0x10930-0x10988]
// PER-FILE-NEXT:   }
// PER-FILE-NEXT: ]
...
// GLOBAL-NEXT:     0x20900 R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE global_int{{$}}
// GLOBAL-NEXT:   }
// GLOBAL-NEXT:   Section (9) .rel.plt {
// GLOBAL-NEXT:     0x208D0 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_void_ptr{{$}}
// GLOBAL-NEXT:     0x208E0 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_char_ptr{{$}}
// GLOBAL-NEXT:     0x208F0 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_int{{$}}
// GLOBAL-NEXT:   }
// GLOBAL-NEXT: ]
// GLOBAL-NEXT: CHERI Capability Relocations [
// GLOBAL-NEXT:   Section ({{.+}}) __cap_relocs {
// GLOBAL-NEXT:     0x20910 FUNC - 0x107E0 [0x107E0-0x10838]
// GLOBAL-NEXT:   }
// GLOBAL-NEXT: ]
