...
// CHECK: [[LIBC_INT_ADDR:[0-9a-f]+]]  l     O .data           0000000000000540 .hidden __libc_interposing
// CHECK: [[LIBC_INT_CTAB:[0-9a-f]+]]  l     O .captable       0000000000000020 __libc_interposing@CAPTABLE
