...
# DYN-RELOCS: 0x000000007000C000 MIPS_CHERI___CAPRELOCS 0x300
...
# DYN-RELOCS-NEXT:      0x{{205F0|20590}} R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE foo{{$}}
# DYN-RELOCS-NEXT:      0x{{205D0|305A0}} R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE foo{{$}}
# DYN-RELOCS-NEXT:   }

# DYN-RELOCS-LABEL: CHERI Capability Relocations [
# DYN-RELOCS-NEXT:    Section ({{.+}}) __cap_relocs {
# DYN-RELOCS-NEXT:      0x205B0 FUNC - 0x10580 [0x300-0x20700]
# DYN-RELOCS-NEXT:      0x205F0 FUNC - 0x10584 [0x300-0x20700]
# DYN-RELOCS-NEXT:    }
# DYN-RELOCS-NEXT:  ]
...
# DUMP-NEXT:  00000000000205b0 FUNC    0000000000010580 [0000000000000300-0000000000020700]
# DUMP-NEXT:  00000000000205f0 FUNC    0000000000010584 [0000000000000300-0000000000020700]
# DUMP-EMPTY
