...
# DYN-RELOCS-OLD: 0x000000007000C000 MIPS_CHERI___CAPRELOCS 0x204D0
...
# DYN-RELOCS-OLD-NEXT:  0x204D8 R_MIPS_REL32/R_MIPS_64/R_MIPS_NONE -{{$}}
# DYN-RELOCS-OLD-NEXT:  0x20500 R_MIPS_REL32/R_MIPS_64/R_MIPS_NONE -{{$}}
# DYN-RELOCS-NEXT:      0x{{20450|20490}} R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE foo{{$}}
# DYN-RELOCS-NEXT:      0x{{20490|204D0}} R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE foo{{$}}
# DYN-RELOCS-NEXT:   }
...
# DYN-RELOCS-OLD-NEXT:   0x020470 (local_ref) Base: 0x10440 (bar+0) Length: 8 Perms: Function
# DYN-RELOCS-OLD-NEXT:   0x0204b0 (local_ref_with_addend) Base: 0x10440 (bar+4) Length: 8 Perms: Function
# DYN-RELOCS-NEXT:  ]
...
# DUMP-OLD-NEXT: 0x0000000000020470	Base: bar (0x0000000000010440)	Offset: 0x0000000000000000	Length: 0x0000000000000008	Permissions: 0x8000000000000000 (Function)
# DUMP-OLD-NEXT: 0x00000000000204b0	Base: bar (0x0000000000010440)	Offset: 0x0000000000000004	Length: 0x0000000000000008	Permissions: 0x8000000000000000 (Function)
# DUMP-EMPTY
