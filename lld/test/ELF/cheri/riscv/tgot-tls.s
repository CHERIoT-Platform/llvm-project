...
# RV32-DIS:      111f0: auipcc a0, 0x1
# RV32-DIS-NEXT:        cincoffset a0, a0, 0xb0

# 0x12298 - 0x111f8 = 0x10a0 (IE evar)
# RV32-DIS:      111f8: auipcc a0, 0x1
# RV32-DIS-NEXT:        lw a0, 0xa0(a0)

# 0x122b0 - 0x11200 = 0x10b0 (GD lvar)
# RV32-DIS:      11200: auipcc a0, 0x1
# RV32-DIS-NEXT:        cincoffset a0, a0, 0xb0

# 0x122a8 - 0x11208 = 0x10a0 (IE lvar)
# RV32-DIS:      11208: auipcc a0, 0x1
# RV32-DIS-NEXT:        lw a0, 0xa0(a0)
...
# RV32-SO-DIS:      1244: auipcc a0, 0x1
# RV32-SO-DIS-NEXT:       cincoffset a0, a0, 0xbc

# 0x22f8 - 0x124c = 0x10ac (IE evar)
# RV32-SO-DIS:      124c: auipcc a0, 0x1
# RV32-SO-DIS-NEXT:       lw a0, 0xac(a0)

# 0x2310 - 0x1254 = 0x10bc (GD lvar)
# RV32-SO-DIS:      1254: auipcc a0, 0x1
# RV32-SO-DIS-NEXT:       cincoffset a0, a0, 0xbc

# 0x2308 - 0x125c = 0x10ac (IE lvar)
# RV32-SO-DIS:      125c: auipcc a0, 0x1
# RV32-SO-DIS-NEXT:       lw a0, 0xac(a0)
...
# RV64-SO-DIS:      13b0: auipcc a0, 0x1
# RV64-SO-DIS-NEXT:       cincoffset a0, a0, 0x150

# 0x24f0 - 0x13b8 = 0x1138 (IE evar)
# RV64-SO-DIS:      13b8: auipcc a0, 0x1
# RV64-SO-DIS-NEXT:       ld a0, 0x138(a0)

# 0x2520 - 0x13c0 = 0x1160 (GD lvar)
# RV64-SO-DIS:      13c0: auipcc a0, 0x1
# RV64-SO-DIS-NEXT:       cincoffset a0, a0, 0x160

# 0x2510 - 0x13c8 = 0x1148 (IE lvar)
# RV64-SO-DIS:      13c8: auipcc a0, 0x1
# RV64-SO-DIS-NEXT:       ld a0, 0x148(a0)
