...
# RUN: llvm-objdump -d --no-show-raw-insn --print-imm-hex=false %t.32.so | FileCheck --check-prefix=RV32-SO-DIS %s
...
# RV32-DIS-NEXT:        cincoffset a0, a0, 148

# 0x12250 - 0x111bc = 0x1094 (IE evar)
# RV32-DIS:      111bc: auipcc a0, 1
# RV32-DIS-NEXT:        clw a0, 148(a0)
...
# RV32-SO-DIS:      11f0: auipcc a0, 1
# RV32-SO-DIS-NEXT:       cincoffset a0, a0, 136

# 0x2280 - 0x11f8 = 0x1088 (IE evar)
# RV32-SO-DIS:      11f8: auipcc a0, 1
# RV32-SO-DIS-NEXT:       clw a0, 136(a0)

# 0x2288 - 0x1200 = 0x1088 (GD lvar)
# RV32-SO-DIS:      1200: auipcc a0, 1
# RV32-SO-DIS-NEXT:       cincoffset a0, a0, 136

# 0x2290 - 0x1208 = 0x1088 (IE lvar)
# RV32-SO-DIS:      1208: auipcc a0, 1
# RV32-SO-DIS-NEXT:       clw a0, 136(a0)
...
# RV64-SO-DIS:      1318: auipcc a0, 1
# RV64-SO-DIS-NEXT:       cincoffset a0, a0, 248

# 0x2420 - 0x1320 = 0x1100 (IE evar)
# RV64-SO-DIS:      1320: auipcc a0, 1
# RV64-SO-DIS-NEXT:       cld a0, 256(a0)

# 0x2430 - 0x1328 = 0x1108 (GD lvar)
# RV64-SO-DIS:      1328: auipcc a0, 1
# RV64-SO-DIS-NEXT:       cincoffset a0, a0, 264

# 0x2440 - 0x1330 = 0x1110 (IE lvar)
# RV64-SO-DIS:      1330: auipcc a0, 1
# RV64-SO-DIS-NEXT:       cld a0, 272(a0)
