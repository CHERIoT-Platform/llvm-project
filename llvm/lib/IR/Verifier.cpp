...
void Verifier::visitAtomicRMWInst(AtomicRMWInst &RMWI) {
  ...
  if (Op == AtomicRMWInst::Xchg) {
    ...
    Check((ElTy->isIntOrIntVectorTy() && !isa<ScalableVectorType>(ElTy)) || ElTy->isPointerTy(), "atomicrmw " +
           AtomicRMWInst::getOperationName(Op) +
           " operand must have integer or fixed vector of integer or pointer type!",
           &RMWI, ElTy);
  }
