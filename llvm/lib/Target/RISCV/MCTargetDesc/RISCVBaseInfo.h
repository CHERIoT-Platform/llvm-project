...
enum {
  ...
  MO_TGOT_TPREL_LO = 18,
  MO_TGOT_TPREL_HI = 19,
  MO_TGOT_TPREL_ADD = 20,
  MO_TLS_TGOT_GOT_HI = 21,
  MO_TLS_TGOT_GD_HI = 22,
  MO_CHERIOT1_COMPARTMENT_CODE_HI = 23,
  MO_CHERIOT1_COMPARTMENT_DATA_HI = 24,
  MO_CHERIOT1_COMPARTMENT_LO_I = 25,
  MO_CHERIOT1_COMPARTMENT_LO_S = 26,
  MO_CHERIOT1_COMPARTMENT_SIZE = 27,
