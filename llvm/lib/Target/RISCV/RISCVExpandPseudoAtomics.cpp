...
class RISCVExpandPseudoAtomicsImpl final : public RISCVExpandPseudoImplBase {
  ...
  bool expandAtomicMinMaxOp(MachineBasicBlock &MBB,
                            ...
                            AtomicRMWInst::BinOp, bool IsMasked,
...
unsigned RISCVExpandPseudoAtomicsImpl::getLRForRMW32(
...
unsigned RISCVExpandPseudoAtomicsImpl::getSCForRMW32(
    bool PtrIsCap, AtomicOrdering Ordering, const RISCVSubtarget *STI) const {
  switch (Ordering) {
  default:
    llvm_unreachable("Unexpected AtomicOrdering");
...
unsigned RISCVExpandPseudoAtomicsImpl::getLRForRMW64(
    bool PtrIsCap, AtomicOrdering Ordering, const RISCVSubtarget *STI) const {
  switch (Ordering) {
  default:
    llvm_unreachable("Unexpected AtomicOrdering");
...
unsigned
RISCVExpandPseudoAtomicsImpl::getLRForRMWCap64(bool PtrIsCap,
...
unsigned
RISCVExpandPseudoAtomicsImpl::getSCForRMWCap64(bool PtrIsCap,
                                              AtomicOrdering Ordering) const {
  switch (Ordering) {
  default:
    llvm_unreachable("Unexpected AtomicOrdering");
...
unsigned
RISCVExpandPseudoAtomicsImpl::getLRForRMWCap128(bool PtrIsCap, AtomicOrdering Ordering) const {
  switch (Ordering) {
  default:
    llvm_unreachable("Unexpected AtomicOrdering");
  case AtomicOrdering::Monotonic:
...
unsigned
RISCVExpandPseudoAtomicsImpl::getSCForRMWCap128(bool PtrIsCap, AtomicOrdering Ordering) const {
  switch (Ordering) {
  default:
    llvm_unreachable("Unexpected AtomicOrdering");
  case AtomicOrdering::Monotonic:
...
unsigned RISCVExpandPseudoAtomicsImpl::getSCForRMW64(
    bool PtrIsCap, AtomicOrdering Ordering, const RISCVSubtarget *STI) const {
  switch (Ordering) {
  default:
    llvm_unreachable("Unexpected AtomicOrdering");
...
unsigned RISCVExpandPseudoAtomicsImpl::getLRForRMW(
...
unsigned RISCVExpandPseudoAtomicsImpl::getSCForRMW(
    bool PtrIsCap, AtomicOrdering Ordering, MVT VT,
    const RISCVSubtarget *Subtarget) const {
  if (VT == MVT::i8)
