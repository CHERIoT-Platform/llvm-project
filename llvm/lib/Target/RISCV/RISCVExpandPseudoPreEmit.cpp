...
public:
  RISCVExpandPseudoPreEmitImpl(CHERIoTImportedObjectSet &Imports)
...
public:
  ...
  bool runOnMachineFunction(MachineFunction &MF) override {
    ...
    return RISCVExpandPseudoPreEmitImpl(RMFI->getCheriotImportedObjects()).run(MF);
  }
...
MachineBasicBlock *RISCVExpandPseudoPreEmitImpl::insertLoadOfImportTable(
    MachineBasicBlock &MBB, MachineBasicBlock::iterator MBBI,
...
bool RISCVExpandPseudoPreEmitImpl::expandCompartmentCall(MachineBasicBlock &MBB,
    MachineBasicBlock::iterator MBBI,
    MachineBasicBlock::iterator &NextMBBI) const {
...
bool RISCVExpandPseudoPreEmitImpl::expandLibraryCall(
    MachineBasicBlock &MBB, MachineBasicBlock::iterator MBBI,
    MachineBasicBlock::iterator &NextMBBI) const {
...
bool RISCVExpandPseudoPreEmitImpl::expandAuicgpInstPair(
    MachineBasicBlock &MBB, MachineBasicBlock::iterator MBBI,
...
bool RISCVExpandPseudoPreEmitImpl::expandAuipccInstPair(
    MachineBasicBlock &MBB, MachineBasicBlock::iterator MBBI,
...
bool RISCVExpandPseudoPreEmitImpl::expandCapLoadLocalCap(
    MachineBasicBlock &MBB, MachineBasicBlock::iterator MBBI,
...
bool RISCVExpandPseudoPreEmitImpl::expandDerefCapLoadLocalCap(
    MachineBasicBlock &MBB, MachineBasicBlock::iterator MBBI,
...
bool RISCVExpandPseudoPreEmitImpl::expandCapLoadGlobalCap(
    MachineBasicBlock &MBB, MachineBasicBlock::iterator MBBI,
    MachineBasicBlock::iterator &NextMBBI) const {
  MachineFunction *MF = MBB.getParent();
...
bool RISCVExpandPseudoPreEmitImpl::expandCapLoadTLSIEAddress(
    MachineBasicBlock &MBB, MachineBasicBlock::iterator MBBI,
    MachineBasicBlock::iterator &NextMBBI) const {
  MachineFunction *MF = MBB.getParent();
...
bool RISCVExpandPseudoPreEmitImpl::expandCapLoadTLSGDCap(
    MachineBasicBlock &MBB, MachineBasicBlock::iterator MBBI,
    MachineBasicBlock::iterator &NextMBBI) const {
  assert(!STI->hasVendorXCheriot() && "TLS is not supported on XCheriot!");
  unsigned FlagsHi;
...
bool RISCVExpandPseudoPreEmitImpl::expandCGetAddr(MachineBasicBlock &MBB,
                                       MachineBasicBlock::iterator MBBI) const {
...
RISCVExpandPseudoPreEmitPass::run(MachineFunction &MF,
  ...
  auto *RMFI = MF.getInfo<RISCVMachineFunctionInfo>();
  bool Changed = RISCVExpandPseudoPreEmitImpl(RMFI->getCheriotImportedObjects()).run(MF);
  if (!Changed)
