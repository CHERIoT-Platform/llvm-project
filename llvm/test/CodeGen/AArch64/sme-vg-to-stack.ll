...
; FP-CHECK-NEXT:    ret
;
; NO-SVE-CHECK-LABEL: vg_unwind_simple:
; NO-SVE-CHECK:       // %bb.0:
...
; OUTLINER-CHECK:       // %bb.0:
; OUTLINER-CHECK-NEXT:    stp d15, d14, [sp, #-80]! // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    .cfi_def_cfa_offset 80
; OUTLINER-CHECK-NEXT:    cntd x9
; OUTLINER-CHECK-NEXT:    stp d13, d12, [sp, #16] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    stp d11, d10, [sp, #32] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    stp d9, d8, [sp, #48] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    stp x30, x9, [sp, #64] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    .cfi_offset w30, -16
; OUTLINER-CHECK-NEXT:    .cfi_offset b8, -24
; OUTLINER-CHECK-NEXT:    .cfi_offset b9, -32
; OUTLINER-CHECK-NEXT:    .cfi_offset b10, -40
; OUTLINER-CHECK-NEXT:    .cfi_offset b11, -48
; OUTLINER-CHECK-NEXT:    .cfi_offset b12, -56
; OUTLINER-CHECK-NEXT:    .cfi_offset b13, -64
; OUTLINER-CHECK-NEXT:    .cfi_offset b14, -72
; OUTLINER-CHECK-NEXT:    .cfi_offset b15, -80
; OUTLINER-CHECK-NEXT:    .cfi_offset vg, -8
; OUTLINER-CHECK-NEXT:    smstop sm
; OUTLINER-CHECK-NEXT:    bl callee
; OUTLINER-CHECK-NEXT:    smstart sm
; OUTLINER-CHECK-NEXT:    .cfi_restore vg
; OUTLINER-CHECK-NEXT:    ldp d9, d8, [sp, #48] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr x30, [sp, #64] // 8-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d11, d10, [sp, #32] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d13, d12, [sp, #16] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d15, d14, [sp], #80 // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    .cfi_def_cfa_offset 0
; OUTLINER-CHECK-NEXT:    .cfi_restore w30
; OUTLINER-CHECK-NEXT:    .cfi_restore b8
; OUTLINER-CHECK-NEXT:    .cfi_restore b9
; OUTLINER-CHECK-NEXT:    .cfi_restore b10
; OUTLINER-CHECK-NEXT:    .cfi_restore b11
; OUTLINER-CHECK-NEXT:    .cfi_restore b12
; OUTLINER-CHECK-NEXT:    .cfi_restore b13
; OUTLINER-CHECK-NEXT:    .cfi_restore b14
; OUTLINER-CHECK-NEXT:    .cfi_restore b15
; OUTLINER-CHECK-NEXT:    ret
  call void @callee();
  ret void;
}
...
; FP-CHECK-NEXT:    ret
;
; NO-SVE-CHECK-LABEL: vg_unwind_needs_gap:
; NO-SVE-CHECK:       // %bb.0:
; NO-SVE-CHECK-NEXT:    stp d15, d14, [sp, #-96]! // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa_offset 96
; NO-SVE-CHECK-NEXT:    stp d13, d12, [sp, #16] // 16-byte Folded Spill
...
; NO-SVE-CHECK-NEXT:    stp x29, x30, [sp, #64] // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    bl __arm_get_current_vg
; NO-SVE-CHECK-NEXT:    stp x0, x20, [sp, #80] // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    add x29, sp, #64
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa w29, 32
; NO-SVE-CHECK-NEXT:    .cfi_offset w20, -8
; NO-SVE-CHECK-NEXT:    .cfi_offset w30, -24
; NO-SVE-CHECK-NEXT:    .cfi_offset w29, -32
; NO-SVE-CHECK-NEXT:    .cfi_offset b8, -40
; NO-SVE-CHECK-NEXT:    .cfi_offset b9, -48
...
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa wsp, 96
; NO-SVE-CHECK-NEXT:    ldp x29, x30, [sp, #64] // 16-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldr x20, [sp, #88] // 8-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldp d9, d8, [sp, #48] // 16-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldp d11, d10, [sp, #32] // 16-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldp d13, d12, [sp, #16] // 16-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldp d15, d14, [sp], #96 // 16-byte Folded Reload
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa_offset 0
; NO-SVE-CHECK-NEXT:    .cfi_restore w20
; NO-SVE-CHECK-NEXT:    .cfi_restore w30
; NO-SVE-CHECK-NEXT:    .cfi_restore w29
; NO-SVE-CHECK-NEXT:    .cfi_restore b8
; NO-SVE-CHECK-NEXT:    .cfi_restore b9
...
; OUTLINER-CHECK:       // %bb.0:
; OUTLINER-CHECK-NEXT:    stp d15, d14, [sp, #-96]! // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    .cfi_def_cfa_offset 96
; OUTLINER-CHECK-NEXT:    cntd x9
; OUTLINER-CHECK-NEXT:    stp d13, d12, [sp, #16] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    stp d11, d10, [sp, #32] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    stp d9, d8, [sp, #48] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    stp x30, x9, [sp, #64] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    str x20, [sp, #80] // 8-byte Folded Spill
; OUTLINER-CHECK-NEXT:    .cfi_offset w20, -16
; OUTLINER-CHECK-NEXT:    .cfi_offset w30, -32
; OUTLINER-CHECK-NEXT:    .cfi_offset b8, -40
; OUTLINER-CHECK-NEXT:    .cfi_offset b9, -48
; OUTLINER-CHECK-NEXT:    .cfi_offset b10, -56
; OUTLINER-CHECK-NEXT:    .cfi_offset b11, -64
; OUTLINER-CHECK-NEXT:    .cfi_offset b12, -72
; OUTLINER-CHECK-NEXT:    .cfi_offset b13, -80
...
; OUTLINER-CHECK-NEXT:    .cfi_restore vg
; OUTLINER-CHECK-NEXT:    ldp d9, d8, [sp, #48] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr x20, [sp, #80] // 8-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d11, d10, [sp, #32] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr x30, [sp, #64] // 8-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d13, d12, [sp, #16] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d15, d14, [sp], #96 // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    .cfi_def_cfa_offset 0
; OUTLINER-CHECK-NEXT:    .cfi_restore w20
; OUTLINER-CHECK-NEXT:    .cfi_restore w30
; OUTLINER-CHECK-NEXT:    .cfi_restore b8
; OUTLINER-CHECK-NEXT:    .cfi_restore b9
; OUTLINER-CHECK-NEXT:    .cfi_restore b10
...
; FP-CHECK-NEXT:    ret
;
; NO-SVE-CHECK-LABEL: vg_unwind_with_fixed_args:
; NO-SVE-CHECK:       // %bb.0:
; NO-SVE-CHECK-NEXT:    sub sp, sp, #112
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa_offset 112
...
; NO-SVE-CHECK-NEXT:    bl __arm_get_current_vg
; NO-SVE-CHECK-NEXT:    str x0, [sp, #96] // 8-byte Folded Spill
...
; NO-SVE-CHECK-NEXT:    .cfi_offset b14, -88
; NO-SVE-CHECK-NEXT:    .cfi_offset b15, -96
; NO-SVE-CHECK-NEXT:    str q0, [sp] // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    .cfi_offset vg, -16
; NO-SVE-CHECK-NEXT:    smstop sm
; NO-SVE-CHECK-NEXT:    ldr q0, [sp] // 16-byte Folded Reload
; NO-SVE-CHECK-NEXT:    bl fixed_callee
; NO-SVE-CHECK-NEXT:    smstart sm
; NO-SVE-CHECK-NEXT:    .cfi_restore vg
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa wsp, 112
...
; NO-SVE-CHECK-NEXT:    add sp, sp, #112
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa_offset 0
; NO-SVE-CHECK-NEXT:    .cfi_restore w30
; NO-SVE-CHECK-NEXT:    .cfi_restore w29
; NO-SVE-CHECK-NEXT:    .cfi_restore b8
...
; OUTLINER-CHECK:       // %bb.0:
; OUTLINER-CHECK-NEXT:    sub sp, sp, #96
; OUTLINER-CHECK-NEXT:    .cfi_def_cfa_offset 96
; OUTLINER-CHECK-NEXT:    cntd x9
; OUTLINER-CHECK-NEXT:    stp d15, d14, [sp, #16] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    stp d13, d12, [sp, #32] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    stp d11, d10, [sp, #48] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    stp d9, d8, [sp, #64] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    stp x30, x9, [sp, #80] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    .cfi_offset w30, -16
; OUTLINER-CHECK-NEXT:    .cfi_offset b8, -24
; OUTLINER-CHECK-NEXT:    .cfi_offset b9, -32
; OUTLINER-CHECK-NEXT:    .cfi_offset b10, -40
...
; OUTLINER-CHECK-NEXT:    .cfi_offset b14, -72
; OUTLINER-CHECK-NEXT:    .cfi_offset b15, -80
; OUTLINER-CHECK-NEXT:    str q0, [sp] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    .cfi_offset vg, -8
; OUTLINER-CHECK-NEXT:    smstop sm
; OUTLINER-CHECK-NEXT:    ldr q0, [sp] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    bl fixed_callee
; OUTLINER-CHECK-NEXT:    smstart sm
; OUTLINER-CHECK-NEXT:    .cfi_restore vg
; OUTLINER-CHECK-NEXT:    ldp d9, d8, [sp, #64] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr x30, [sp, #80] // 8-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d11, d10, [sp, #48] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d13, d12, [sp, #32] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d15, d14, [sp, #16] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    add sp, sp, #96
; OUTLINER-CHECK-NEXT:    .cfi_def_cfa_offset 0
; OUTLINER-CHECK-NEXT:    .cfi_restore w30
; OUTLINER-CHECK-NEXT:    .cfi_restore b8
; OUTLINER-CHECK-NEXT:    .cfi_restore b9
...
; FP-CHECK-NEXT:    ret
;
; NO-SVE-CHECK-LABEL: vg_unwind_with_sve_args:
; NO-SVE-CHECK:       // %bb.0:
; NO-SVE-CHECK-NEXT:    stp x29, x30, [sp, #-48]! // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa_offset 48
; NO-SVE-CHECK-NEXT:    bl __arm_get_current_vg
; NO-SVE-CHECK-NEXT:    str x0, [sp, #16] // 8-byte Folded Spill
; NO-SVE-CHECK-NEXT:    stp x28, x27, [sp, #32] // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    mov x29, sp
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa w29, 48
; NO-SVE-CHECK-NEXT:    .cfi_offset w27, -8
; NO-SVE-CHECK-NEXT:    .cfi_offset w28, -16
; NO-SVE-CHECK-NEXT:    .cfi_offset w30, -40
; NO-SVE-CHECK-NEXT:    .cfi_offset w29, -48
; NO-SVE-CHECK-NEXT:    addvl sp, sp, #-18
; NO-SVE-CHECK-NEXT:    str p8, [sp, #11, mul vl] // 2-byte Folded Spill
; NO-SVE-CHECK-NEXT:    ptrue pn8.b
; NO-SVE-CHECK-NEXT:    str p15, [sp, #4, mul vl] // 2-byte Folded Spill
; NO-SVE-CHECK-NEXT:    st1b { z22.b, z23.b }, pn8, [sp, #2, mul vl] // 32-byte Folded Spill
; NO-SVE-CHECK-NEXT:    st1b { z20.b, z21.b }, pn8, [sp, #4, mul vl] // 32-byte Folded Spill
; NO-SVE-CHECK-NEXT:    str p14, [sp, #5, mul vl] // 2-byte Folded Spill
; NO-SVE-CHECK-NEXT:    st1b { z18.b, z19.b }, pn8, [sp, #6, mul vl] // 32-byte Folded Spill
; NO-SVE-CHECK-NEXT:    st1b { z16.b, z17.b }, pn8, [sp, #8, mul vl] // 32-byte Folded Spill
; NO-SVE-CHECK-NEXT:    str p13, [sp, #6, mul vl] // 2-byte Folded Spill
; NO-SVE-CHECK-NEXT:    st1b { z14.b, z15.b }, pn8, [sp, #10, mul vl] // 32-byte Folded Spill
; NO-SVE-CHECK-NEXT:    st1b { z12.b, z13.b }, pn8, [sp, #12, mul vl] // 32-byte Folded Spill
; NO-SVE-CHECK-NEXT:    str p12, [sp, #7, mul vl] // 2-byte Folded Spill
; NO-SVE-CHECK-NEXT:    st1b { z10.b, z11.b }, pn8, [sp, #14, mul vl] // 32-byte Folded Spill
; NO-SVE-CHECK-NEXT:    str p11, [sp, #8, mul vl] // 2-byte Folded Spill
; NO-SVE-CHECK-NEXT:    str p10, [sp, #9, mul vl] // 2-byte Folded Spill
; NO-SVE-CHECK-NEXT:    str p9, [sp, #10, mul vl] // 2-byte Folded Spill
; NO-SVE-CHECK-NEXT:    str p7, [sp, #12, mul vl] // 2-byte Folded Spill
; NO-SVE-CHECK-NEXT:    str p6, [sp, #13, mul vl] // 2-byte Folded Spill
; NO-SVE-CHECK-NEXT:    str p5, [sp, #14, mul vl] // 2-byte Folded Spill
; NO-SVE-CHECK-NEXT:    str p4, [sp, #15, mul vl] // 2-byte Folded Spill
; NO-SVE-CHECK-NEXT:    str z9, [sp, #16, mul vl] // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    str z8, [sp, #17, mul vl] // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    .cfi_escape 0x10, 0x48, 0x0a, 0x11, 0x50, 0x22, 0x11, 0x78, 0x92, 0x2e, 0x00, 0x1e, 0x22 // $d8 @ cfa - 48 - 8 * VG
; NO-SVE-CHECK-NEXT:    .cfi_escape 0x10, 0x49, 0x0a, 0x11, 0x50, 0x22, 0x11, 0x70, 0x92, 0x2e, 0x00, 0x1e, 0x22 // $d9 @ cfa - 48 - 16 * VG
; NO-SVE-CHECK-NEXT:    .cfi_escape 0x10, 0x4a, 0x0a, 0x11, 0x50, 0x22, 0x11, 0x68, 0x92, 0x2e, 0x00, 0x1e, 0x22 // $d10 @ cfa - 48 - 24 * VG
; NO-SVE-CHECK-NEXT:    .cfi_escape 0x10, 0x4b, 0x0a, 0x11, 0x50, 0x22, 0x11, 0x60, 0x92, 0x2e, 0x00, 0x1e, 0x22 // $d11 @ cfa - 48 - 32 * VG
; NO-SVE-CHECK-NEXT:    .cfi_escape 0x10, 0x4c, 0x0a, 0x11, 0x50, 0x22, 0x11, 0x58, 0x92, 0x2e, 0x00, 0x1e, 0x22 // $d12 @ cfa - 48 - 40 * VG
; NO-SVE-CHECK-NEXT:    .cfi_escape 0x10, 0x4d, 0x0a, 0x11, 0x50, 0x22, 0x11, 0x50, 0x92, 0x2e, 0x00, 0x1e, 0x22 // $d13 @ cfa - 48 - 48 * VG
; NO-SVE-CHECK-NEXT:    .cfi_escape 0x10, 0x4e, 0x0a, 0x11, 0x50, 0x22, 0x11, 0x48, 0x92, 0x2e, 0x00, 0x1e, 0x22 // $d14 @ cfa - 48 - 56 * VG
; NO-SVE-CHECK-NEXT:    .cfi_escape 0x10, 0x4f, 0x0a, 0x11, 0x50, 0x22, 0x11, 0x40, 0x92, 0x2e, 0x00, 0x1e, 0x22 // $d15 @ cfa - 48 - 64 * VG
; NO-SVE-CHECK-NEXT:    addvl sp, sp, #-1
; NO-SVE-CHECK-NEXT:    str z0, [x29, #-19, mul vl] // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    //APP
; NO-SVE-CHECK-NEXT:    //NO_APP
; NO-SVE-CHECK-NEXT:    .cfi_offset vg, -32
; NO-SVE-CHECK-NEXT:    smstop sm
...
; NO-SVE-CHECK-NEXT:    addvl sp, sp, #1
; NO-SVE-CHECK-NEXT:    ptrue pn8.b
; NO-SVE-CHECK-NEXT:    ldr z9, [sp, #16, mul vl] // 16-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldr z8, [sp, #17, mul vl] // 16-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ld1b { z22.b, z23.b }, pn8/z, [sp, #2, mul vl] // 32-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ld1b { z20.b, z21.b }, pn8/z, [sp, #4, mul vl] // 32-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ld1b { z18.b, z19.b }, pn8/z, [sp, #6, mul vl] // 32-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ld1b { z16.b, z17.b }, pn8/z, [sp, #8, mul vl] // 32-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ld1b { z14.b, z15.b }, pn8/z, [sp, #10, mul vl] // 32-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ld1b { z12.b, z13.b }, pn8/z, [sp, #12, mul vl] // 32-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ld1b { z10.b, z11.b }, pn8/z, [sp, #14, mul vl] // 32-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldr p15, [sp, #4, mul vl] // 2-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldr p14, [sp, #5, mul vl] // 2-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldr p13, [sp, #6, mul vl] // 2-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldr p12, [sp, #7, mul vl] // 2-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldr p11, [sp, #8, mul vl] // 2-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldr p10, [sp, #9, mul vl] // 2-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldr p9, [sp, #10, mul vl] // 2-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldr p8, [sp, #11, mul vl] // 2-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldr p7, [sp, #12, mul vl] // 2-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldr p6, [sp, #13, mul vl] // 2-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldr p5, [sp, #14, mul vl] // 2-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldr p4, [sp, #15, mul vl] // 2-byte Folded Reload
; NO-SVE-CHECK-NEXT:    addvl sp, sp, #18
; NO-SVE-CHECK-NEXT:    .cfi_restore z8
; NO-SVE-CHECK-NEXT:    .cfi_restore z9
; NO-SVE-CHECK-NEXT:    .cfi_restore z10
; NO-SVE-CHECK-NEXT:    .cfi_restore z11
; NO-SVE-CHECK-NEXT:    .cfi_restore z12
; NO-SVE-CHECK-NEXT:    .cfi_restore z13
; NO-SVE-CHECK-NEXT:    .cfi_restore z14
; NO-SVE-CHECK-NEXT:    .cfi_restore z15
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa wsp, 48
; NO-SVE-CHECK-NEXT:    ldp x28, x27, [sp, #32] // 16-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldp x29, x30, [sp], #48 // 16-byte Folded Reload
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa_offset 0
; NO-SVE-CHECK-NEXT:    .cfi_restore w27
; NO-SVE-CHECK-NEXT:    .cfi_restore w28
; NO-SVE-CHECK-NEXT:    .cfi_restore w30
; NO-SVE-CHECK-NEXT:    .cfi_restore w29
; NO-SVE-CHECK-NEXT:    ret
;
...
; OUTLINER-CHECK:       // %bb.0:
; OUTLINER-CHECK-NEXT:    stp x29, x30, [sp, #-32]! // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    .cfi_def_cfa_offset 32
; OUTLINER-CHECK-NEXT:    cntd x9
; OUTLINER-CHECK-NEXT:    stp x9, x28, [sp, #16] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    .cfi_offset w28, -8
; OUTLINER-CHECK-NEXT:    .cfi_offset w30, -24
; OUTLINER-CHECK-NEXT:    .cfi_offset w29, -32
; OUTLINER-CHECK-NEXT:    addvl sp, sp, #-18
; OUTLINER-CHECK-NEXT:    .cfi_escape 0x0f, 0x0d, 0x8f, 0x00, 0x11, 0x20, 0x22, 0x11, 0x90, 0x01, 0x92, 0x2e, 0x00, 0x1e, 0x22 // sp + 32 + 144 * VG
; OUTLINER-CHECK-NEXT:    str p8, [sp, #11, mul vl] // 2-byte Folded Spill
; OUTLINER-CHECK-NEXT:    ptrue pn8.b
; OUTLINER-CHECK-NEXT:    str p15, [sp, #4, mul vl] // 2-byte Folded Spill
; OUTLINER-CHECK-NEXT:    st1b { z22.b, z23.b }, pn8, [sp, #2, mul vl] // 32-byte Folded Spill
; OUTLINER-CHECK-NEXT:    st1b { z20.b, z21.b }, pn8, [sp, #4, mul vl] // 32-byte Folded Spill
; OUTLINER-CHECK-NEXT:    str p14, [sp, #5, mul vl] // 2-byte Folded Spill
; OUTLINER-CHECK-NEXT:    st1b { z18.b, z19.b }, pn8, [sp, #6, mul vl] // 32-byte Folded Spill
; OUTLINER-CHECK-NEXT:    st1b { z16.b, z17.b }, pn8, [sp, #8, mul vl] // 32-byte Folded Spill
; OUTLINER-CHECK-NEXT:    str p13, [sp, #6, mul vl] // 2-byte Folded Spill
; OUTLINER-CHECK-NEXT:    st1b { z14.b, z15.b }, pn8, [sp, #10, mul vl] // 32-byte Folded Spill
; OUTLINER-CHECK-NEXT:    st1b { z12.b, z13.b }, pn8, [sp, #12, mul vl] // 32-byte Folded Spill
; OUTLINER-CHECK-NEXT:    str p12, [sp, #7, mul vl] // 2-byte Folded Spill
; OUTLINER-CHECK-NEXT:    st1b { z10.b, z11.b }, pn8, [sp, #14, mul vl] // 32-byte Folded Spill
; OUTLINER-CHECK-NEXT:    str p11, [sp, #8, mul vl] // 2-byte Folded Spill
; OUTLINER-CHECK-NEXT:    str p10, [sp, #9, mul vl] // 2-byte Folded Spill
; OUTLINER-CHECK-NEXT:    str p9, [sp, #10, mul vl] // 2-byte Folded Spill
; OUTLINER-CHECK-NEXT:    str p7, [sp, #12, mul vl] // 2-byte Folded Spill
; OUTLINER-CHECK-NEXT:    str p6, [sp, #13, mul vl] // 2-byte Folded Spill
; OUTLINER-CHECK-NEXT:    str p5, [sp, #14, mul vl] // 2-byte Folded Spill
; OUTLINER-CHECK-NEXT:    str p4, [sp, #15, mul vl] // 2-byte Folded Spill
; OUTLINER-CHECK-NEXT:    str z9, [sp, #16, mul vl] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    str z8, [sp, #17, mul vl] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    .cfi_escape 0x10, 0x48, 0x0a, 0x11, 0x60, 0x22, 0x11, 0x78, 0x92, 0x2e, 0x00, 0x1e, 0x22 // $d8 @ cfa - 32 - 8 * VG
; OUTLINER-CHECK-NEXT:    .cfi_escape 0x10, 0x49, 0x0a, 0x11, 0x60, 0x22, 0x11, 0x70, 0x92, 0x2e, 0x00, 0x1e, 0x22 // $d9 @ cfa - 32 - 16 * VG
; OUTLINER-CHECK-NEXT:    .cfi_escape 0x10, 0x4a, 0x0a, 0x11, 0x60, 0x22, 0x11, 0x68, 0x92, 0x2e, 0x00, 0x1e, 0x22 // $d10 @ cfa - 32 - 24 * VG
; OUTLINER-CHECK-NEXT:    .cfi_escape 0x10, 0x4b, 0x0a, 0x11, 0x60, 0x22, 0x11, 0x60, 0x92, 0x2e, 0x00, 0x1e, 0x22 // $d11 @ cfa - 32 - 32 * VG
; OUTLINER-CHECK-NEXT:    .cfi_escape 0x10, 0x4c, 0x0a, 0x11, 0x60, 0x22, 0x11, 0x58, 0x92, 0x2e, 0x00, 0x1e, 0x22 // $d12 @ cfa - 32 - 40 * VG
; OUTLINER-CHECK-NEXT:    .cfi_escape 0x10, 0x4d, 0x0a, 0x11, 0x60, 0x22, 0x11, 0x50, 0x92, 0x2e, 0x00, 0x1e, 0x22 // $d13 @ cfa - 32 - 48 * VG
; OUTLINER-CHECK-NEXT:    .cfi_escape 0x10, 0x4e, 0x0a, 0x11, 0x60, 0x22, 0x11, 0x48, 0x92, 0x2e, 0x00, 0x1e, 0x22 // $d14 @ cfa - 32 - 56 * VG
; OUTLINER-CHECK-NEXT:    .cfi_escape 0x10, 0x4f, 0x0a, 0x11, 0x60, 0x22, 0x11, 0x40, 0x92, 0x2e, 0x00, 0x1e, 0x22 // $d15 @ cfa - 32 - 64 * VG
; OUTLINER-CHECK-NEXT:    addvl sp, sp, #-1
; OUTLINER-CHECK-NEXT:    .cfi_escape 0x0f, 0x0d, 0x8f, 0x00, 0x11, 0x20, 0x22, 0x11, 0x98, 0x01, 0x92, 0x2e, 0x00, 0x1e, 0x22 // sp + 32 + 152 * VG
; OUTLINER-CHECK-NEXT:    str z0, [sp] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    //APP
; OUTLINER-CHECK-NEXT:    //NO_APP
; OUTLINER-CHECK-NEXT:    .cfi_offset vg, -16
; OUTLINER-CHECK-NEXT:    smstop sm
; OUTLINER-CHECK-NEXT:    ldr z0, [sp] // 16-byte Folded Reload
...
; OUTLINER-CHECK-NEXT:    .cfi_escape 0x0f, 0x0d, 0x8f, 0x00, 0x11, 0x20, 0x22, 0x11, 0x90, 0x01, 0x92, 0x2e, 0x00, 0x1e, 0x22 // sp + 32 + 144 * VG
; OUTLINER-CHECK-NEXT:    ptrue pn8.b
; OUTLINER-CHECK-NEXT:    ldr z9, [sp, #16, mul vl] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr z8, [sp, #17, mul vl] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ld1b { z22.b, z23.b }, pn8/z, [sp, #2, mul vl] // 32-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ld1b { z20.b, z21.b }, pn8/z, [sp, #4, mul vl] // 32-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ld1b { z18.b, z19.b }, pn8/z, [sp, #6, mul vl] // 32-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ld1b { z16.b, z17.b }, pn8/z, [sp, #8, mul vl] // 32-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ld1b { z14.b, z15.b }, pn8/z, [sp, #10, mul vl] // 32-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ld1b { z12.b, z13.b }, pn8/z, [sp, #12, mul vl] // 32-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ld1b { z10.b, z11.b }, pn8/z, [sp, #14, mul vl] // 32-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr p15, [sp, #4, mul vl] // 2-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr p14, [sp, #5, mul vl] // 2-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr p13, [sp, #6, mul vl] // 2-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr p12, [sp, #7, mul vl] // 2-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr p11, [sp, #8, mul vl] // 2-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr p10, [sp, #9, mul vl] // 2-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr p9, [sp, #10, mul vl] // 2-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr p8, [sp, #11, mul vl] // 2-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr p7, [sp, #12, mul vl] // 2-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr p6, [sp, #13, mul vl] // 2-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr p5, [sp, #14, mul vl] // 2-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr p4, [sp, #15, mul vl] // 2-byte Folded Reload
; OUTLINER-CHECK-NEXT:    addvl sp, sp, #18
; OUTLINER-CHECK-NEXT:    .cfi_def_cfa wsp, 32
; OUTLINER-CHECK-NEXT:    .cfi_restore z8
; OUTLINER-CHECK-NEXT:    .cfi_restore z9
; OUTLINER-CHECK-NEXT:    .cfi_restore z10
; OUTLINER-CHECK-NEXT:    .cfi_restore z11
; OUTLINER-CHECK-NEXT:    .cfi_restore z12
; OUTLINER-CHECK-NEXT:    .cfi_restore z13
; OUTLINER-CHECK-NEXT:    .cfi_restore z14
; OUTLINER-CHECK-NEXT:    .cfi_restore z15
; OUTLINER-CHECK-NEXT:    ldr x28, [sp, #24] // 8-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp x29, x30, [sp], #32 // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    .cfi_def_cfa_offset 0
; OUTLINER-CHECK-NEXT:    .cfi_restore w28
; OUTLINER-CHECK-NEXT:    .cfi_restore w30
; OUTLINER-CHECK-NEXT:    .cfi_restore w29
; OUTLINER-CHECK-NEXT:    ret
...
; FP-CHECK-NEXT:    ret
;
; NO-SVE-CHECK-LABEL: vg_unwind_multiple_scratch_regs:
; NO-SVE-CHECK:       // %bb.0: // %entry
; NO-SVE-CHECK-NEXT:    stp d15, d14, [sp, #-96]! // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa_offset 96
; NO-SVE-CHECK-NEXT:    stp d13, d12, [sp, #16] // 16-byte Folded Spill
...
; NO-SVE-CHECK-NEXT:    stp x29, x30, [sp, #64] // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    bl __arm_get_current_vg
; NO-SVE-CHECK-NEXT:    stp x0, x28, [sp, #80] // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    mov x0, x9
; NO-SVE-CHECK-NEXT:    add x29, sp, #64
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa w29, 32
; NO-SVE-CHECK-NEXT:    .cfi_offset w28, -8
; NO-SVE-CHECK-NEXT:    .cfi_offset w30, -24
; NO-SVE-CHECK-NEXT:    .cfi_offset w29, -32
; NO-SVE-CHECK-NEXT:    .cfi_offset b8, -40
; NO-SVE-CHECK-NEXT:    .cfi_offset b9, -48
...
; NO-SVE-CHECK-NEXT:    .cfi_offset b14, -88
; NO-SVE-CHECK-NEXT:    .cfi_offset b15, -96
; NO-SVE-CHECK-NEXT:    sub x9, sp, #80, lsl #12 // =327680
...
; NO-SVE-CHECK-NEXT:    str x8, [x0]
; NO-SVE-CHECK-NEXT:    .cfi_offset vg, -16
; NO-SVE-CHECK-NEXT:    smstop sm
; NO-SVE-CHECK-NEXT:    bl callee
; NO-SVE-CHECK-NEXT:    smstart sm
; NO-SVE-CHECK-NEXT:    .cfi_restore vg
; NO-SVE-CHECK-NEXT:    add sp, sp, #80, lsl #12 // =327680
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa wsp, 96
; NO-SVE-CHECK-NEXT:    ldp x29, x30, [sp, #64] // 16-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldr x28, [sp, #88] // 8-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldp d9, d8, [sp, #48] // 16-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldp d11, d10, [sp, #32] // 16-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldp d13, d12, [sp, #16] // 16-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldp d15, d14, [sp], #96 // 16-byte Folded Reload
...
; OUTLINER-CHECK-NEXT:    stp d11, d10, [sp, #32] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    stp d9, d8, [sp, #48] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    stp x29, x30, [sp, #64] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    str x9, [sp, #80] // 8-byte Folded Spill
; OUTLINER-CHECK-NEXT:    .cfi_offset w30, -24
; OUTLINER-CHECK-NEXT:    .cfi_offset w29, -32
; OUTLINER-CHECK-NEXT:    .cfi_offset b8, -40
; OUTLINER-CHECK-NEXT:    .cfi_offset b9, -48
...
; OUTLINER-CHECK-NEXT:    .cfi_offset b14, -88
; OUTLINER-CHECK-NEXT:    .cfi_offset b15, -96
; OUTLINER-CHECK-NEXT:    sub x9, sp, #80, lsl #12 // =327680
; OUTLINER-CHECK-NEXT:    .cfi_def_cfa w9, 327776
...
; OUTLINER-CHECK-NEXT:    mov x8, sp
; OUTLINER-CHECK-NEXT:    str x8, [x0]
; OUTLINER-CHECK-NEXT:    .cfi_offset vg, -16
; OUTLINER-CHECK-NEXT:    smstop sm
; OUTLINER-CHECK-NEXT:    bl callee
; OUTLINER-CHECK-NEXT:    smstart sm
; OUTLINER-CHECK-NEXT:    .cfi_restore vg
; OUTLINER-CHECK-NEXT:    add sp, sp, #80, lsl #12 // =327680
; OUTLINER-CHECK-NEXT:    .cfi_def_cfa_offset 96
; OUTLINER-CHECK-NEXT:    ldp x29, x30, [sp, #64] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d9, d8, [sp, #48] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d11, d10, [sp, #32] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d13, d12, [sp, #16] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d15, d14, [sp], #96 // 16-byte Folded Reload
...
; FP-CHECK-NEXT:    ret
;
; NO-SVE-CHECK-LABEL: vg_locally_streaming_fn:
; NO-SVE-CHECK:       // %bb.0:
; NO-SVE-CHECK-NEXT:    stp d15, d14, [sp, #-96]! // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa_offset 96
; NO-SVE-CHECK-NEXT:    rdsvl x9, #1
; NO-SVE-CHECK-NEXT:    stp d13, d12, [sp, #16] // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    lsr x9, x9, #3
; NO-SVE-CHECK-NEXT:    stp d11, d10, [sp, #32] // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    stp d9, d8, [sp, #48] // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    stp x29, x30, [sp, #64] // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    str x9, [sp, #80] // 8-byte Folded Spill
; NO-SVE-CHECK-NEXT:    bl __arm_get_current_vg
; NO-SVE-CHECK-NEXT:    str x0, [sp, #88] // 8-byte Folded Spill
; NO-SVE-CHECK-NEXT:    add x29, sp, #64
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa w29, 32
...
; OUTLINER-CHECK-NEXT:    stp d15, d14, [sp, #-96]! // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    .cfi_def_cfa_offset 96
; OUTLINER-CHECK-NEXT:    rdsvl x9, #1
; OUTLINER-CHECK-NEXT:    stp d13, d12, [sp, #16] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    lsr x9, x9, #3
; OUTLINER-CHECK-NEXT:    stp d11, d10, [sp, #32] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    stp d9, d8, [sp, #48] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    stp x30, x9, [sp, #64] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    cntd x9
...
; OUTLINER-CHECK-NEXT:    smstart sm
; OUTLINER-CHECK-NEXT:    .cfi_restore vg
; OUTLINER-CHECK-NEXT:    bl streaming_callee
; OUTLINER-CHECK-NEXT:    .cfi_offset vg, -24
; OUTLINER-CHECK-NEXT:    smstop sm
; OUTLINER-CHECK-NEXT:    bl callee
; OUTLINER-CHECK-NEXT:    ldp d9, d8, [sp, #48] // 16-byte Folded Reload
...
; FP-CHECK-NEXT:    ret
;
; NO-SVE-CHECK-LABEL: streaming_compatible_to_streaming:
; NO-SVE-CHECK:       // %bb.0:
; NO-SVE-CHECK-NEXT:    stp d15, d14, [sp, #-96]! // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa_offset 96
; NO-SVE-CHECK-NEXT:    stp d13, d12, [sp, #16] // 16-byte Folded Spill
...
; OUTLINER-CHECK-NEXT:    stp d9, d8, [sp, #48] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    stp x30, x9, [sp, #64] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    str x19, [sp, #80] // 8-byte Folded Spill
; OUTLINER-CHECK-NEXT:    .cfi_offset w19, -16
; OUTLINER-CHECK-NEXT:    .cfi_offset w30, -32
; OUTLINER-CHECK-NEXT:    .cfi_offset b8, -40
; OUTLINER-CHECK-NEXT:    .cfi_offset b9, -48
; OUTLINER-CHECK-NEXT:    .cfi_offset b10, -56
...
; OUTLINER-CHECK-NEXT:    smstart sm
; OUTLINER-CHECK-NEXT:  .LBB6_2:
; OUTLINER-CHECK-NEXT:    bl streaming_callee
; OUTLINER-CHECK-NEXT:    tbnz w19, #0, .LBB6_4
; OUTLINER-CHECK-NEXT:  // %bb.3:
; OUTLINER-CHECK-NEXT:    smstop sm
; OUTLINER-CHECK-NEXT:  .LBB6_4:
; OUTLINER-CHECK-NEXT:    .cfi_restore vg
; OUTLINER-CHECK-NEXT:    ldp d9, d8, [sp, #48] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr x19, [sp, #80] // 8-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d11, d10, [sp, #32] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr x30, [sp, #64] // 8-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d13, d12, [sp, #16] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d15, d14, [sp], #96 // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    .cfi_def_cfa_offset 0
; OUTLINER-CHECK-NEXT:    .cfi_restore w19
; OUTLINER-CHECK-NEXT:    .cfi_restore w30
; OUTLINER-CHECK-NEXT:    .cfi_restore b8
; OUTLINER-CHECK-NEXT:    .cfi_restore b9
; OUTLINER-CHECK-NEXT:    .cfi_restore b10
...
; FP-CHECK-NEXT:    ret
;
; NO-SVE-CHECK-LABEL: streaming_compatible_to_non_streaming:
; NO-SVE-CHECK:       // %bb.0:
; NO-SVE-CHECK-NEXT:    stp d15, d14, [sp, #-96]! // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa_offset 96
; NO-SVE-CHECK-NEXT:    stp d13, d12, [sp, #16] // 16-byte Folded Spill
...
; NO-SVE-CHECK-NEXT:  // %bb.1:
; NO-SVE-CHECK-NEXT:    smstop sm
; NO-SVE-CHECK-NEXT:  .LBB7_2:
; NO-SVE-CHECK-NEXT:    bl callee
; NO-SVE-CHECK-NEXT:    tbz w19, #0, .LBB7_4
; NO-SVE-CHECK-NEXT:  // %bb.3:
; NO-SVE-CHECK-NEXT:    smstart sm
; NO-SVE-CHECK-NEXT:  .LBB7_4:
; NO-SVE-CHECK-NEXT:    .cfi_restore vg
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa wsp, 96
; NO-SVE-CHECK-NEXT:    ldp x29, x30, [sp, #64] // 16-byte Folded Reload
; NO-SVE-CHECK-NEXT:    ldr x19, [sp, #88] // 8-byte Folded Reload
...
; OUTLINER-CHECK-NEXT:  // %bb.1:
; OUTLINER-CHECK-NEXT:    smstop sm
; OUTLINER-CHECK-NEXT:  .LBB7_2:
; OUTLINER-CHECK-NEXT:    bl callee
; OUTLINER-CHECK-NEXT:    tbz w19, #0, .LBB7_4
; OUTLINER-CHECK-NEXT:  // %bb.3:
; OUTLINER-CHECK-NEXT:    smstart sm
; OUTLINER-CHECK-NEXT:  .LBB7_4:
; OUTLINER-CHECK-NEXT:    .cfi_restore vg
; OUTLINER-CHECK-NEXT:    ldp d9, d8, [sp, #48] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr x19, [sp, #80] // 8-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d11, d10, [sp, #32] // 16-byte Folded Reload
...
; CHECK-LABEL: streaming_compatible_no_sve:
; CHECK:       // %bb.0:
; CHECK-NEXT:    stp d15, d14, [sp, #-96]! // 16-byte Folded Spill
; CHECK-NEXT:    .cfi_def_cfa_offset 96
; CHECK-NEXT:    cntd x9
...
; CHECK-NEXT:    bl streaming_callee_with_arg
; CHECK-NEXT:    tbnz w19, #0, .LBB8_4
; CHECK-NEXT:  // %bb.3:
; CHECK-NEXT:    smstop sm
; CHECK-NEXT:  .LBB8_4:
; CHECK-NEXT:    .cfi_restore vg
...
; CHECK-NEXT:    ret
;
; FP-CHECK-LABEL: streaming_compatible_no_sve:
; FP-CHECK:       // %bb.0:
; FP-CHECK-NEXT:    stp d15, d14, [sp, #-96]! // 16-byte Folded Spill
; FP-CHECK-NEXT:    .cfi_def_cfa_offset 96
; FP-CHECK-NEXT:    cntd x9
...
; FP-CHECK-NEXT:  // %bb.1:
; FP-CHECK-NEXT:    smstart sm
; FP-CHECK-NEXT:  .LBB8_2:
; FP-CHECK-NEXT:    mov w0, w8
; FP-CHECK-NEXT:    bl streaming_callee_with_arg
; FP-CHECK-NEXT:    tbnz w19, #0, .LBB8_4
; FP-CHECK-NEXT:  // %bb.3:
; FP-CHECK-NEXT:    smstop sm
; FP-CHECK-NEXT:  .LBB8_4:
; FP-CHECK-NEXT:    .cfi_restore vg
; FP-CHECK-NEXT:    .cfi_def_cfa wsp, 96
; FP-CHECK-NEXT:    ldp x29, x30, [sp, #64] // 16-byte Folded Reload
; FP-CHECK-NEXT:    ldr x19, [sp, #88] // 8-byte Folded Reload
...
; OUTLINER-CHECK-NEXT:  // %bb.1:
; OUTLINER-CHECK-NEXT:    smstart sm
; OUTLINER-CHECK-NEXT:  .LBB8_2:
; OUTLINER-CHECK-NEXT:    mov w0, w8
; OUTLINER-CHECK-NEXT:    bl streaming_callee_with_arg
; OUTLINER-CHECK-NEXT:    tbnz w19, #0, .LBB8_4
; OUTLINER-CHECK-NEXT:  // %bb.3:
; OUTLINER-CHECK-NEXT:    smstop sm
; OUTLINER-CHECK-NEXT:  .LBB8_4:
; OUTLINER-CHECK-NEXT:    .cfi_restore vg
; OUTLINER-CHECK-NEXT:    ldp d9, d8, [sp, #48] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr x19, [sp, #80] // 8-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d11, d10, [sp, #32] // 16-byte Folded Reload
...
; CHECK-LABEL: test_rdsvl_right_after_prologue:
; CHECK:       // %bb.0:
; CHECK-NEXT:    sub sp, sp, #96
; CHECK-NEXT:    cntd x9
...
; CHECK-NEXT:    ret
;
; FP-CHECK-LABEL: test_rdsvl_right_after_prologue:
; FP-CHECK:       // %bb.0:
; FP-CHECK-NEXT:    stp d15, d14, [sp, #-96]! // 16-byte Folded Spill
; FP-CHECK-NEXT:    cntd x9
...
; FP-CHECK-NEXT:    add x29, sp, #64
; FP-CHECK-NEXT:    str x9, [sp, #80] // 8-byte Folded Spill
; FP-CHECK-NEXT:    mov x1, x0
; FP-CHECK-NEXT:    smstart sm
; FP-CHECK-NEXT:    mov x0, x8
; FP-CHECK-NEXT:    bl bar
; FP-CHECK-NEXT:    smstop sm
; FP-CHECK-NEXT:    ldp x29, x30, [sp, #64] // 16-byte Folded Reload
; FP-CHECK-NEXT:    ldp d9, d8, [sp, #48] // 16-byte Folded Reload
; FP-CHECK-NEXT:    ldp d11, d10, [sp, #32] // 16-byte Folded Reload
...
; NO-SVE-CHECK-NEXT:    ret
;
; OUTLINER-CHECK-LABEL: test_rdsvl_right_after_prologue:
; OUTLINER-CHECK:       // %bb.0:
; OUTLINER-CHECK-NEXT:    sub sp, sp, #96
; OUTLINER-CHECK-NEXT:    cntd x9
; OUTLINER-CHECK-NEXT:    rdsvl x8, #1
; OUTLINER-CHECK-NEXT:    stp d15, d14, [sp, #16] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    stp d13, d12, [sp, #32] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    lsr x8, x8, #3
; OUTLINER-CHECK-NEXT:    stp d11, d10, [sp, #48] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    stp d9, d8, [sp, #64] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    stp x30, x9, [sp, #80] // 16-byte Folded Spill
; OUTLINER-CHECK-NEXT:    mov x1, x0
; OUTLINER-CHECK-NEXT:    smstart sm
; OUTLINER-CHECK-NEXT:    mov x0, x8
; OUTLINER-CHECK-NEXT:    bl bar
; OUTLINER-CHECK-NEXT:    smstop sm
; OUTLINER-CHECK-NEXT:    ldp d9, d8, [sp, #64] // 16-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldr x30, [sp, #80] // 8-byte Folded Reload
; OUTLINER-CHECK-NEXT:    ldp d11, d10, [sp, #48] // 16-byte Folded Reload
...
; FP-CHECK-NEXT:    ret
;
; NO-SVE-CHECK-LABEL: vg_unwind_noasync:
; NO-SVE-CHECK:       // %bb.0:
; NO-SVE-CHECK-NEXT:    stp d15, d14, [sp, #-96]! // 16-byte Folded Spill
; NO-SVE-CHECK-NEXT:    .cfi_def_cfa_offset 96
; NO-SVE-CHECK-NEXT:    stp d13, d12, [sp, #16] // 16-byte Folded Spill
