...
; RUN: opt -S -mtriple=amdgpu12.00-- -amdgpu-lower-exec-sync < %s 2>&1 | FileCheck %s
; RUN: llc < %s -enable-new-pm -stop-after=amdgpu-lower-exec-sync -mtriple=amdgpu12.00-amd-amdhsa | FileCheck %s
...
; CHECK: attributes #[[ATTR1:[0-9]+]] = { convergent hassideeffects nocallback nofree nounwind willreturn }
;.
