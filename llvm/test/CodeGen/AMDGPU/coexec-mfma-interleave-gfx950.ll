...
; CHECK-NEXT:    v_mul_hi_i32_i24_e32 v3, -12, v2
; CHECK-NEXT:    v_mul_i32_i24_e32 v2, -12, v2
; CHECK-NEXT:    v_lshl_add_u64 v[14:15], v[0:1], 0, v[2:3]
...
; CHECK-NEXT:    v_lshl_add_u64 v[18:19], s[0:1], 0, v[14:15]
