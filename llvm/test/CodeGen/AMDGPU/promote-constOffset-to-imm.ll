...
; GFX8-NEXT:    v_and_b32_e32 v16, 0xffff8000, v1
...
; GFX8-NEXT:    v_mov_b32_e32 v17, s35
...
; GFX8-NEXT:    flat_load_dwordx2 v[8:9], v[0:1]
...
; GFX8-NEXT:    v_add_u32_e32 v14, vcc, s0, v0
...
; GFX8-NEXT:    v_add_u32_e32 v16, vcc, s34, v16
; GFX8-NEXT:    v_addc_u32_e32 v17, vcc, 0, v17, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(6)
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v2, v8
; GFX8-NEXT:    v_addc_u32_e32 v3, vcc, v3, v9, vcc
...
; GFX8-NEXT:    v_addc_u32_e32 v3, vcc, v13, v3, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(1)
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v14, v2
; GFX8-NEXT:    v_addc_u32_e32 v3, vcc, v15, v3, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, v0, v2
; GFX8-NEXT:    v_addc_u32_e32 v1, vcc, v1, v3, vcc
; GFX8-NEXT:    flat_store_dwordx2 v[16:17], v[0:1]
; GFX8-NEXT:    s_endpgm
;
...
; GFX9-NEXT:    v_and_b32_e32 v1, 0xff, v0
; GFX9-NEXT:    v_lshlrev_b32_e32 v0, 7, v0
; GFX9-NEXT:    v_and_b32_e32 v18, 0xffff8000, v0
; GFX9-NEXT:    v_lshl_or_b32 v4, v1, 3, v18
; GFX9-NEXT:    v_mov_b32_e32 v0, s35
; GFX9-NEXT:    v_add_co_u32_e32 v16, vcc, s34, v4
; GFX9-NEXT:    v_addc_co_u32_e32 v17, vcc, 0, v0, vcc
; GFX9-NEXT:    s_movk_i32 s1, 0x2000
; GFX9-NEXT:    global_load_dwordx2 v[0:1], v4, s[34:35]
; GFX9-NEXT:    global_load_dwordx2 v[2:3], v4, s[34:35] offset:2048
; GFX9-NEXT:    v_add_co_u32_e32 v4, vcc, s1, v16
; GFX9-NEXT:    v_addc_co_u32_e32 v5, vcc, 0, v17, vcc
; GFX9-NEXT:    global_load_dwordx2 v[6:7], v[4:5], off offset:-4096
; GFX9-NEXT:    s_movk_i32 s0, 0x1000
; GFX9-NEXT:    v_add_co_u32_e32 v8, vcc, s0, v16
; GFX9-NEXT:    v_addc_co_u32_e32 v9, vcc, 0, v17, vcc
; GFX9-NEXT:    global_load_dwordx2 v[10:11], v[8:9], off offset:2048
; GFX9-NEXT:    global_load_dwordx2 v[12:13], v[4:5], off
; GFX9-NEXT:    global_load_dwordx2 v[14:15], v[4:5], off offset:2048
; GFX9-NEXT:    s_movk_i32 s0, 0x3000
; GFX9-NEXT:    v_add_co_u32_e32 v4, vcc, s0, v16
; GFX9-NEXT:    v_addc_co_u32_e32 v5, vcc, 0, v17, vcc
...
; GFX10-NEXT:    v_lshl_or_b32 v6, v0, 3, v20
; GFX10-NEXT:    v_add_co_u32 v16, s0, s34, v6
; GFX10-NEXT:    v_add_co_ci_u32_e64 v17, s0, s35, 0, s0
...
; GFX11-NEXT:    v_lshl_or_b32 v2, v0, 3, v16
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_u32 v12, s0, s34, v2
; GFX11-NEXT:    v_add_co_ci_u32_e64 v13, null, s35, 0, s0
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b64 v[0:1], v2, s[34:35]
; GFX11-NEXT:    global_load_b64 v[2:3], v2, s[34:35] offset:2048
; GFX11-NEXT:    v_add_co_u32 v4, vcc_lo, v12, 0x2000
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_ci_u32_e64 v5, null, 0, v13, vcc_lo
; GFX11-NEXT:    v_add_co_u32 v6, vcc_lo, 0x1000, v12
; GFX11-NEXT:    v_add_co_ci_u32_e64 v7, null, 0, v13, vcc_lo
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b64 v[8:9], v[4:5], off offset:-4096
; GFX11-NEXT:    global_load_b64 v[6:7], v[6:7], off offset:2048
; GFX11-NEXT:    v_add_co_u32 v10, vcc_lo, 0x2000, v12
; GFX11-NEXT:    global_load_b64 v[4:5], v[4:5], off
; GFX11-NEXT:    v_add_co_ci_u32_e64 v11, null, 0, v13, vcc_lo
; GFX11-NEXT:    v_add_co_u32 v12, vcc_lo, 0x3000, v12
...
; GFX11-NEXT:    global_load_b64 v[14:15], v[12:13], off
...
; GFX11-NEXT:    v_add_co_u32 v0, vcc_lo, v14, v0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, null, v15, v1, vcc_lo
...
; GFX8-NEXT:    v_addc_u32_e32 v15, vcc, 0, v1, vcc
; GFX8-NEXT:    s_movk_i32 s0, 0x2000
; GFX8-NEXT:    flat_load_dword v18, v[0:1]
; GFX8-NEXT:    flat_load_dword v19, v[2:3]
; GFX8-NEXT:    flat_load_dword v4, v[4:5]
; GFX8-NEXT:    flat_load_dword v5, v[6:7]
; GFX8-NEXT:    flat_load_dword v6, v[8:9]
; GFX8-NEXT:    flat_load_dword v7, v[10:11]
; GFX8-NEXT:    flat_load_dword v8, v[12:13]
; GFX8-NEXT:    flat_load_dword v9, v[14:15]
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, s0, v0
; GFX8-NEXT:    v_addc_u32_e32 v3, vcc, 0, v1, vcc
...
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, s34, v16
; GFX8-NEXT:    v_addc_u32_e32 v1, vcc, 0, v17, vcc
; GFX8-NEXT:    s_waitcnt vmcnt(8)
; GFX8-NEXT:    v_add_u32_e32 v10, vcc, v19, v18
...
; GFX9-NEXT:    v_lshl_or_b32 v3, v1, 2, v2
; GFX9-NEXT:    v_mov_b32_e32 v0, s35
; GFX9-NEXT:    v_add_co_u32_e32 v4, vcc, s34, v3
; GFX9-NEXT:    v_addc_co_u32_e32 v5, vcc, 0, v0, vcc
; GFX9-NEXT:    s_movk_i32 s0, 0x1000
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, s0, v4
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v5, vcc
; GFX9-NEXT:    global_load_dword v6, v3, s[34:35]
; GFX9-NEXT:    global_load_dword v7, v3, s[34:35] offset:1024
; GFX9-NEXT:    global_load_dword v8, v3, s[34:35] offset:2048
; GFX9-NEXT:    global_load_dword v9, v3, s[34:35] offset:3072
; GFX9-NEXT:    global_load_dword v10, v[0:1], off
; GFX9-NEXT:    global_load_dword v11, v[0:1], off offset:1024
; GFX9-NEXT:    global_load_dword v12, v[0:1], off offset:2048
; GFX9-NEXT:    global_load_dword v13, v[0:1], off offset:3072
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, 0x2000, v4
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v5, vcc
; GFX9-NEXT:    global_load_dword v3, v[0:1], off
; GFX9-NEXT:    global_load_dword v4, v[0:1], off offset:1024
; GFX9-NEXT:    s_waitcnt vmcnt(8)
; GFX9-NEXT:    v_add_u32_e32 v0, v7, v6
; GFX9-NEXT:    s_waitcnt vmcnt(6)
; GFX9-NEXT:    v_add3_u32 v0, v8, v0, v9
; GFX9-NEXT:    s_waitcnt vmcnt(4)
; GFX9-NEXT:    v_add3_u32 v0, v10, v0, v11
; GFX9-NEXT:    s_waitcnt vmcnt(2)
; GFX9-NEXT:    v_add3_u32 v0, v12, v0, v13
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_add3_u32 v0, v3, v0, v4
; GFX9-NEXT:    global_store_dword v2, v0, s[34:35]
; GFX9-NEXT:    s_endpgm
;
...
; GFX10-NEXT:    v_lshl_or_b32 v0, v0, 2, v8
; GFX10-NEXT:    s_clause 0x1
; GFX10-NEXT:    global_load_dword v11, v0, s[34:35]
; GFX10-NEXT:    global_load_dword v12, v0, s[34:35] offset:1024
; GFX10-NEXT:    v_add_co_u32 v9, s0, s34, v0
; GFX10-NEXT:    v_add_co_ci_u32_e64 v10, s0, s35, 0, s0
...
; GFX10-NEXT:    s_clause 0x1
; GFX10-NEXT:    global_load_dword v13, v[2:3], off offset:-2048
...
; GFX10-NEXT:    global_load_dword v15, v[2:3], off
...
; GFX10-NEXT:    global_load_dword v6, v[2:3], off offset:1024
; GFX10-NEXT:    s_waitcnt vmcnt(8)
...
; GFX11-NEXT:    v_lshl_or_b32 v5, v0, 2, v4
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b32 v8, v5, s[34:35]
; GFX11-NEXT:    global_load_b32 v9, v5, s[34:35] offset:1024
; GFX11-NEXT:    v_add_co_u32 v6, s0, s34, v5
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_add_co_ci_u32_e64 v7, null, s35, 0, s0
; GFX11-NEXT:    v_add_co_u32 v0, vcc_lo, 0x1000, v6
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v7, vcc_lo
; GFX11-NEXT:    v_add_co_u32 v2, vcc_lo, v6, 0x2000
; GFX11-NEXT:    v_add_co_ci_u32_e64 v3, null, 0, v7, vcc_lo
; GFX11-NEXT:    s_clause 0x5
; GFX11-NEXT:    global_load_b32 v10, v5, s[34:35] offset:2048
; GFX11-NEXT:    global_load_b32 v5, v5, s[34:35] offset:3072
; GFX11-NEXT:    global_load_b32 v11, v[2:3], off offset:-4096
; GFX11-NEXT:    global_load_b32 v12, v[0:1], off offset:1024
; GFX11-NEXT:    global_load_b32 v13, v[0:1], off offset:2048
; GFX11-NEXT:    global_load_b32 v14, v[0:1], off offset:3072
; GFX11-NEXT:    v_add_co_u32 v0, vcc_lo, 0x2000, v6
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v7, vcc_lo
; GFX11-NEXT:    s_clause 0x1
...
; GFX11-NEXT:    s_waitcnt vmcnt(6)
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add3_u32 v1, v10, v1, v5
; GFX11-NEXT:    s_waitcnt vmcnt(4)
; GFX11-NEXT:    v_add3_u32 v1, v11, v1, v12
; GFX11-NEXT:    s_waitcnt vmcnt(2)
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add3_u32 v1, v13, v1, v14
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_add3_u32 v0, v2, v1, v0
...
; GFX8-NEXT:    s_swappc_b64 s[30:31], s[4:5]
; GFX8-NEXT:    v_lshlrev_b32_e32 v1, 7, v0
; GFX8-NEXT:    v_and_b32_e32 v8, 0xffff8000, v1
; GFX8-NEXT:    v_mov_b32_e32 v1, 3
; GFX8-NEXT:    v_lshlrev_b32_sdwa v0, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
...
; GFX8-NEXT:    flat_load_dwordx2 v[0:1], v[0:1]
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, s34, v8
...
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, v0, v2
; GFX8-NEXT:    v_addc_u32_e32 v1, vcc, v1, v3, vcc
; GFX8-NEXT:    flat_store_dwordx2 v[8:9], v[0:1]
; GFX8-NEXT:    s_endpgm
;
...
; GFX900-NEXT:    v_and_b32_e32 v9, 0xffff8000, v0
; GFX900-NEXT:    v_lshl_or_b32 v10, v1, 3, v9
; GFX900-NEXT:    v_mov_b32_e32 v1, s35
; GFX900-NEXT:    v_add_co_u32_e32 v0, vcc, s34, v10
; GFX900-NEXT:    v_addc_co_u32_e32 v11, vcc, 0, v1, vcc
; GFX900-NEXT:    v_add_co_u32_e32 v1, vcc, 0xfffff000, v0
; GFX900-NEXT:    v_addc_co_u32_e32 v2, vcc, 0, v11, vcc
; GFX900-NEXT:    global_load_dwordx2 v[3:4], v10, s[34:35]
; GFX900-NEXT:    global_load_dwordx2 v[5:6], v[1:2], off
; GFX900-NEXT:    global_load_dwordx2 v[7:8], v[1:2], off offset:2048
; GFX900-NEXT:    v_add_u32_e32 v1, 1, v11
...
; GFX10-NEXT:    v_lshl_or_b32 v1, v0, 3, v12
; GFX10-NEXT:    v_add_co_u32 v0, s0, s34, v1
; GFX10-NEXT:    v_add_co_ci_u32_e64 v8, s0, s35, 0, s0
...
; GFX90A-NEXT:    v_and_b32_e32 v10, 0xffff8000, v0
; GFX90A-NEXT:    v_lshl_or_b32 v1, v1, 3, v10
; GFX90A-NEXT:    v_mov_b32_e32 v2, s35
; GFX90A-NEXT:    v_add_co_u32_e32 v0, vcc, s34, v1
; GFX90A-NEXT:    v_addc_co_u32_e32 v11, vcc, 0, v2, vcc
; GFX90A-NEXT:    v_add_co_u32_e32 v2, vcc, 0xfffff000, v0
; GFX90A-NEXT:    v_addc_co_u32_e32 v3, vcc, 0, v11, vcc
; GFX90A-NEXT:    global_load_dwordx2 v[4:5], v1, s[34:35]
; GFX90A-NEXT:    global_load_dwordx2 v[6:7], v[2:3], off
; GFX90A-NEXT:    global_load_dwordx2 v[8:9], v[2:3], off offset:2048
; GFX90A-NEXT:    v_add_u32_e32 v1, 1, v11
...
; GFX11-NEXT:    v_lshl_or_b32 v1, v0, 3, v8
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_u32 v0, s0, s34, v1
; GFX11-NEXT:    v_add_co_ci_u32_e64 v9, null, s35, 0, s0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX8-NEXT:    s_swappc_b64 s[30:31], s[4:5]
; GFX8-NEXT:    v_lshlrev_b32_e32 v1, 7, v0
; GFX8-NEXT:    v_and_b32_e32 v6, 0xffff8000, v1
; GFX8-NEXT:    v_mov_b32_e32 v1, 2
; GFX8-NEXT:    v_lshlrev_b32_sdwa v0, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
; GFX8-NEXT:    v_or_b32_e32 v0, v6, v0
; GFX8-NEXT:    v_mov_b32_e32 v7, s35
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, s34, v0
...
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, s0, v0
; GFX8-NEXT:    v_addc_u32_e32 v5, vcc, 0, v1, vcc
; GFX8-NEXT:    flat_load_dword v8, v[0:1]
; GFX8-NEXT:    flat_load_dword v2, v[2:3]
...
; GFX9-NEXT:    v_and_b32_e32 v1, 0xff, v0
; GFX9-NEXT:    v_lshlrev_b32_e32 v0, 7, v0
; GFX9-NEXT:    v_and_b32_e32 v4, 0xffff8000, v0
; GFX9-NEXT:    v_lshl_or_b32 v5, v1, 2, v4
; GFX9-NEXT:    v_mov_b32_e32 v0, s35
; GFX9-NEXT:    v_add_co_u32_e32 v2, vcc, s34, v5
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, 0, v0, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, 0x7ffff000, v2
...
; GFX10-NEXT:    v_lshl_or_b32 v5, v0, 2, v4
; GFX10-NEXT:    v_add_co_u32 v2, s0, s34, v5
; GFX10-NEXT:    v_add_co_ci_u32_e64 v3, s0, s35, 0, s0
; GFX10-NEXT:    v_add_co_u32 v0, vcc_lo, v2, 0x80000000
; GFX10-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, 0, v3, vcc_lo
; GFX10-NEXT:    v_add_co_u32 v2, vcc_lo, 0x7ffff800, v2
; GFX10-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, 0, v3, vcc_lo
; GFX10-NEXT:    s_clause 0x3
; GFX10-NEXT:    global_load_dword v6, v5, s[34:35]
...
; GFX11-NEXT:    v_lshl_or_b32 v5, v0, 2, v4
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_u32 v2, s0, s34, v5
; GFX11-NEXT:    v_add_co_ci_u32_e64 v3, null, s35, 0, s0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_u32 v0, vcc_lo, 0x7ffff000, v2
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v3, vcc_lo
; GFX11-NEXT:    v_add_co_u32 v2, vcc_lo, 0x80000000, v2
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_ci_u32_e64 v3, null, 0, v3, vcc_lo
; GFX11-NEXT:    s_clause 0x3
; GFX11-NEXT:    global_load_b32 v5, v5, s[34:35]
...
; GFX9-NEXT:    v_and_b32_e32 v1, 0xff, v0
; GFX9-NEXT:    v_lshlrev_b32_e32 v0, 7, v0
; GFX9-NEXT:    v_and_b32_e32 v20, 0xffff8000, v0
; GFX9-NEXT:    v_lshl_or_b32 v21, v1, 3, v20
; GFX9-NEXT:    v_mov_b32_e32 v0, s35
; GFX9-NEXT:    v_add_co_u32_e32 v10, vcc, s34, v21
; GFX9-NEXT:    v_addc_co_u32_e32 v11, vcc, 0, v0, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, 0x3000, v10
; GFX9-NEXT:    v_addc_co_u32_e32 v1, vcc, 0, v11, vcc
; GFX9-NEXT:    global_load_dwordx2 v[2:3], v21, s[34:35]
...
; GFX9-NEXT:    v_add_co_u32_e32 v10, vcc, 0x1000, v10
...
; GFX9-NEXT:    global_load_dwordx2 v[16:17], v[10:11], off offset:2048
; GFX9-NEXT:    global_load_dwordx2 v[18:19], v21, s[34:35] offset:2048
; GFX9-NEXT:    s_waitcnt vmcnt(6)
...
; GFX10-NEXT:    v_and_b32_e32 v0, 0xff, v0
; GFX10-NEXT:    v_and_b32_e32 v20, 0xffff8000, v1
; GFX10-NEXT:    v_lshl_or_b32 v8, v0, 3, v20
; GFX10-NEXT:    v_add_co_u32 v14, s0, s34, v8
; GFX10-NEXT:    v_add_co_ci_u32_e64 v15, s0, s35, 0, s0
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_and_b32_e32 v16, 0xffff8000, v1
; GFX11-NEXT:    v_lshl_or_b32 v14, v0, 3, v16
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_u32 v8, s0, s34, v14
; GFX11-NEXT:    v_add_co_ci_u32_e64 v9, null, s35, 0, s0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_u32 v0, vcc_lo, 0x3000, v8
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, null, 0, v9, vcc_lo
; GFX11-NEXT:    v_add_co_u32 v6, vcc_lo, 0x2000, v8
; GFX11-NEXT:    s_clause 0x2
; GFX11-NEXT:    global_load_b64 v[2:3], v14, s[34:35]
; GFX11-NEXT:    global_load_b64 v[4:5], v[0:1], off offset:2048
; GFX11-NEXT:    global_load_b64 v[0:1], v[0:1], off
; GFX11-NEXT:    v_add_co_ci_u32_e64 v7, null, 0, v9, vcc_lo
; GFX11-NEXT:    v_add_co_u32 v8, vcc_lo, 0x1000, v8
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_ci_u32_e64 v9, null, 0, v9, vcc_lo
; GFX11-NEXT:    s_clause 0x4
; GFX11-NEXT:    global_load_b64 v[10:11], v[6:7], off offset:2048
; GFX11-NEXT:    global_load_b64 v[12:13], v[8:9], off
; GFX11-NEXT:    global_load_b64 v[6:7], v[6:7], off
; GFX11-NEXT:    global_load_b64 v[8:9], v[8:9], off offset:2048
; GFX11-NEXT:    global_load_b64 v[14:15], v14, s[34:35] offset:2048
; GFX11-NEXT:    s_waitcnt vmcnt(6)
...
; GFX8-NEXT:    s_swappc_b64 s[30:31], s[4:5]
; GFX8-NEXT:    v_lshlrev_b32_e32 v1, 7, v0
; GFX8-NEXT:    v_and_b32_e32 v4, 0xffff8000, v1
; GFX8-NEXT:    v_mov_b32_e32 v1, 3
; GFX8-NEXT:    v_lshlrev_b32_sdwa v0, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
...
; GFX8-NEXT:    s_movk_i32 s0, 0x800
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, s0, v0
; GFX8-NEXT:    v_addc_u32_e32 v3, vcc, -1, v1, vcc
; GFX8-NEXT:    v_add_u32_e32 v1, vcc, -1, v1
; GFX8-NEXT:    flat_load_dwordx2 v[2:3], v[2:3]
; GFX8-NEXT:    flat_load_dwordx2 v[0:1], v[0:1]
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, s34, v4
...
; GFX9-NEXT:    v_and_b32_e32 v1, 0xff, v0
; GFX9-NEXT:    v_lshlrev_b32_e32 v0, 7, v0
; GFX9-NEXT:    v_and_b32_e32 v8, 0xffff8000, v0
; GFX9-NEXT:    v_lshl_or_b32 v0, v1, 3, v8
; GFX9-NEXT:    v_mov_b32_e32 v1, s35
; GFX9-NEXT:    v_add_co_u32_e32 v0, vcc, s34, v0
...
; GFX10-NEXT:    v_and_b32_e32 v0, 0xff, v0
; GFX10-NEXT:    v_and_b32_e32 v8, 0xffff8000, v1
; GFX10-NEXT:    v_lshl_or_b32 v0, v0, 3, v8
; GFX10-NEXT:    v_add_co_u32 v0, s0, s34, v0
; GFX10-NEXT:    v_add_co_ci_u32_e64 v1, s0, s35, 0, s0
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_and_b32_e32 v4, 0xffff8000, v1
; GFX11-NEXT:    v_lshl_or_b32 v0, v0, 3, v4
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    v_add_co_u32 v0, s0, s34, v0
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, null, s35, 0, s0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
