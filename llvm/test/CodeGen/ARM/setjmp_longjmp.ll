...
; Run instruction size verification via -filetype=obj.
; RUN: llc -mtriple=armv7-linux -exception-model sjlj -simplifycfg-require-and-preserve-domtree=1 %s -o - -filetype=obj | llvm-objdump -d -
; RUN: llc -mtriple=thumbv7-linux -exception-model sjlj -simplifycfg-require-and-preserve-domtree=1 %s -o - -filetype=obj | llvm-objdump -d -
; RUN: llc -mtriple=thumbv7-win32 -exception-model sjlj -simplifycfg-require-and-preserve-domtree=1 %s -o - -filetype=obj | llvm-objdump -d -
