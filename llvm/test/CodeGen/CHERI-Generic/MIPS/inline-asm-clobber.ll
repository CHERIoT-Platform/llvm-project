...
; MIR-NEXT:   INLINEASM &"syscall\0A", sideeffect attdialect, clobber, implicit-def dead early-clobber $a0, clobber, implicit-def dead early-clobber $c2, clobber, implicit-def dead early-clobber $at
