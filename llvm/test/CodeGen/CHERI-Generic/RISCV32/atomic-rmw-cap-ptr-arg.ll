...
; HYBRID-NEXT:    sc a0, 8(sp) # 8-byte Folded Spill
; HYBRID-NEXT:    lc.cap a3, (a0)
; HYBRID-NEXT:    sc a1, 0(sp) # 8-byte Folded Spill
...
; HYBRID-NEXT:    sc a3, 16(sp)
; HYBRID-NEXT:    addi a1, sp, 16
; HYBRID-NEXT:    li a3, 5
; HYBRID-NEXT:    li a4, 5
; HYBRID-NEXT:    lc a0, 8(sp) # 8-byte Folded Reload
; HYBRID-NEXT:    call __atomic_compare_exchange_cap_c
; HYBRID-NEXT:    lc a3, 16(sp)
...
; HYBRID-NEXT:    lc.cap a3, (a0)
; HYBRID-NEXT:    sc a1, 8(sp) # 8-byte Folded Spill
...
; HYBRID-NEXT:    # in Loop: Header=BB12_2 Depth=1
; HYBRID-NEXT:    lc a2, 8(sp) # 8-byte Folded Reload
