...
; PURECAP-LIBCALLS:       # %bb.0:
; PURECAP-LIBCALLS-NEXT:    cincoffset sp, sp, -48
; PURECAP-LIBCALLS-NEXT:    csc ra, 40(sp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    csc s0, 32(sp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    csc s1, 24(sp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    csc s2, 16(sp) # 8-byte Folded Spill
...
; PURECAP-LIBCALLS-NEXT:    csc a1, 8(sp)
...
; PURECAP-LIBCALLS-NEXT:    clc a1, 8(sp)
; PURECAP-LIBCALLS-NEXT:    beqz a0, .LBB6_1
; PURECAP-LIBCALLS-NEXT:  # %bb.2: # %atomicrmw.end
; PURECAP-LIBCALLS-NEXT:    cmove a0, a1
; PURECAP-LIBCALLS-NEXT:    clc ra, 40(sp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    clc s0, 32(sp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    clc s1, 24(sp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    clc s2, 16(sp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    cincoffset sp, sp, 48
; PURECAP-LIBCALLS-NEXT:    cret
;
; HYBRID-ATOMICS-LABEL: atomic_cap_ptr_add:
; HYBRID-ATOMICS:       # %bb.0:
; HYBRID-ATOMICS-NEXT:    addi sp, sp, -32
; HYBRID-ATOMICS-NEXT:    sw ra, 28(sp) # 4-byte Folded Spill
; HYBRID-ATOMICS-NEXT:    sc a0, 8(sp) # 8-byte Folded Spill
; HYBRID-ATOMICS-NEXT:    lc.cap a3, (a0)
; HYBRID-ATOMICS-NEXT:    sc a1, 0(sp) # 8-byte Folded Spill
; HYBRID-ATOMICS-NEXT:  .LBB6_1: # %atomicrmw.start
; HYBRID-ATOMICS-NEXT:    # =>This Inner Loop Header: Depth=1
; HYBRID-ATOMICS-NEXT:    lc a0, 0(sp) # 8-byte Folded Reload
; HYBRID-ATOMICS-NEXT:    add a0, a3, a0
; HYBRID-ATOMICS-NEXT:    csetaddr a2, a3, a0
; HYBRID-ATOMICS-NEXT:    sc a3, 16(sp)
; HYBRID-ATOMICS-NEXT:    addi a1, sp, 16
; HYBRID-ATOMICS-NEXT:    li a3, 5
; HYBRID-ATOMICS-NEXT:    li a4, 5
; HYBRID-ATOMICS-NEXT:    lc a0, 8(sp) # 8-byte Folded Reload
; HYBRID-ATOMICS-NEXT:    call __atomic_compare_exchange_cap_c
; HYBRID-ATOMICS-NEXT:    lc a3, 16(sp)
; HYBRID-ATOMICS-NEXT:    beqz a0, .LBB6_1
; HYBRID-ATOMICS-NEXT:  # %bb.2: # %atomicrmw.end
; HYBRID-ATOMICS-NEXT:    cmove a0, a3
; HYBRID-ATOMICS-NEXT:    lw ra, 28(sp) # 4-byte Folded Reload
; HYBRID-ATOMICS-NEXT:    addi sp, sp, 32
...
; HYBRID-LIBCALLS-NEXT:    sc a1, 8(sp) # 8-byte Folded Spill
; HYBRID-LIBCALLS-NEXT:    sc a0, 0(sp) # 8-byte Folded Spill
...
; HYBRID-LIBCALLS-NEXT:    lc a0, 8(sp) # 8-byte Folded Reload
; HYBRID-LIBCALLS-NEXT:    add a0, a1, a0
; HYBRID-LIBCALLS-NEXT:    csetaddr a2, a1, a0
; HYBRID-LIBCALLS-NEXT:    sc a1, 16(sp)
; HYBRID-LIBCALLS-NEXT:    addi a1, sp, 16
; HYBRID-LIBCALLS-NEXT:    li a3, 5
; HYBRID-LIBCALLS-NEXT:    li a4, 5
; HYBRID-LIBCALLS-NEXT:    lc a0, 0(sp) # 8-byte Folded Reload
; HYBRID-LIBCALLS-NEXT:    call __atomic_compare_exchange_cap_c
; HYBRID-LIBCALLS-NEXT:    lc a1, 16(sp)
...
; HYBRID-ATOMICS-NEXT:    addi sp, sp, -32
; HYBRID-ATOMICS-NEXT:    sw ra, 28(sp) # 4-byte Folded Spill
; HYBRID-ATOMICS-NEXT:    sc a0, 0(sp) # 8-byte Folded Spill
; HYBRID-ATOMICS-NEXT:    lc.cap a3, (a0)
; HYBRID-ATOMICS-NEXT:    sc a1, 8(sp) # 8-byte Folded Spill
...
; HYBRID-ATOMICS-NEXT:    # in Loop: Header=BB12_2 Depth=1
; HYBRID-ATOMICS-NEXT:    lc a2, 8(sp) # 8-byte Folded Reload
...
; HYBRID-LIBCALLS-NEXT:    # in Loop: Header=BB12_2 Depth=1
; HYBRID-LIBCALLS-NEXT:    lc a2, 8(sp) # 8-byte Folded Reload
