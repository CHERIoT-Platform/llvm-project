...
define internal i8 addrspace(200)* @test(i8 addrspace(200)* addrspace(200)* %ptr, i8 addrspace(200)* %cap, i32 %offset) addrspace(200) nounwind {
; PURECAP-LABEL: test:
; PURECAP:       # %bb.0: # %entry
...
define internal i8 addrspace(200)* @cap_from_ptr_ddc(i8 addrspace(200)* addrspace(200)* %ptr, i32 %offset) addrspace(200) nounwind {
...
define internal i8 addrspace(200)* @cap_from_ptr_null(i8 addrspace(200)* addrspace(200)* %ptr, i32 %offset) addrspace(200) nounwind {
