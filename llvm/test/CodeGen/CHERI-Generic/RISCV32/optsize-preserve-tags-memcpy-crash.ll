...
; DO NOT EDIT -- This file was generated from test/CodeGen/CHERI-Generic/Inputs/optsize-preserve-tags-memcpy-rash.ll
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    clb a2, 30(a1)
; CHECK-NEXT:    csb a2, 30(a0)
; CHECK-NEXT:    clh a2, 28(a1)
; CHECK-NEXT:    csh a2, 28(a0)
; CHECK-NEXT:    clw a2, 24(a1)
; CHECK-NEXT:    csw a2, 24(a0)
...
; CHECK-NEXT:    clh a6, 28(a1)
; CHECK-NEXT:    clb a1, 30(a1)
; CHECK-NEXT:    csb a1, 30(a0)
; CHECK-NEXT:    csh a6, 28(a0)
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    clw a2, 24(a1)
; CHECK-NEXT:    clc a3, 0(a1)
; CHECK-NEXT:    clh a4, 28(a1)
; CHECK-NEXT:    clc a5, 16(a1)
; CHECK-NEXT:    clb a6, 30(a1)
; CHECK-NEXT:    csc a3, 0(a0)
; CHECK-NEXT:    clc a1, 8(a1)
; CHECK-NEXT:    csc a5, 16(a0)
; CHECK-NEXT:    csb a6, 30(a0)
; CHECK-NEXT:    csh a4, 28(a0)
