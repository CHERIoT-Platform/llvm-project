...
; RUN: llc -mtriple=riscv32 --relocation-model=pic -target-abi il32pc64f -mattr=+xcheri,+xcheripurecap,+f < %s | FileCheck %s --check-prefix=PURECAP
...
; PURECAP-NEXT:    srli a1, a1, 14
; PURECAP-NEXT:    addi a1, a1, 4
; PURECAP-NEXT:    cincoffset a0, a0, a1
...
; PURECAP-NEXT:    cincoffset a0, a0, a2
; PURECAP-NEXT:    clw a0, 0(a0)
; PURECAP-NEXT:    cret
;
