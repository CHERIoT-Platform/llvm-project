...
; RUN: llc -mtriple=riscv32 --relocation-model=pic -target-abi il32pc64f -mattr=+xcheri,+xcheripurecap,+f %s -o - < %s | FileCheck %s --check-prefix=PURECAP
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    clhu a0, 0(a0)
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: trunc_load_zext:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    lhu.cap a0, (a0)
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    clhu a0, 2(a0)
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: trunc_lshr_load_zext:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    cincoffset a0, a0, 2
; HYBRID-NEXT:    lhu.cap a0, (a0)
; HYBRID-NEXT:    ret
  %1 = load i32, i32 addrspace(200)* %p
  %2 = lshr i32 %1, 16
