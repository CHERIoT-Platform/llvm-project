...
; CHECK-NEXT:    cincoffset ca4, ca2, 4
; CHECK-NEXT:    sb.cap a1, (ca4)
; CHECK-NEXT:    srli a1, a0, 16
; CHECK-NEXT:    srli a4, a0, 8
; CHECK-NEXT:    sb.cap a0, (ca2)
; CHECK-NEXT:    cincoffset ca0, ca2, 3
; CHECK-NEXT:    sb.cap a3, (ca0)
; CHECK-NEXT:    cincoffset ca0, ca2, 2
...
; CHECK-NEXT:    cincoffset ca0, ca2, 6
; CHECK-NEXT:    sh.cap a3, (ca0)
; CHECK-NEXT:    cincoffset ca0, ca2, 4
; CHECK-NEXT:    cincoffset ca2, ca2, 2
; CHECK-NEXT:    sh.cap a1, (ca0)
; CHECK-NEXT:    sh.cap a4, (ca2)
; CHECK-NEXT:    ret
