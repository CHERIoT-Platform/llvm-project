...
; CHECK-NEXT:    auipcc a2, %captab_pcrel_hi(a1)
...
; CHECK-NEXT:    auipcc a2, %captab_pcrel_hi(a2)
...
; CHECK-NEXT:    auipcc a2, %captab_pcrel_hi(a4)
...
; CHECK-NEXT:    auipcc a2, %captab_pcrel_hi(a8)
