...
; PURECAP-LABEL: main:
; PURECAP:       # %bb.0: # %entry
; PURECAP-NEXT:    cincoffset sp, sp, -64
; PURECAP-NEXT:    csc ra, 48(sp) # 16-byte Folded Spill
; PURECAP-NEXT:    csc s0, 32(sp) # 16-byte Folded Spill
; PURECAP-NEXT:    cincoffset s0, sp, 64
; PURECAP-NEXT:    andi a2, sp, -32
; PURECAP-NEXT:    csetaddr sp, sp, a2
; PURECAP-NEXT:    mv a2, a0
; PURECAP-NEXT:    li a0, 0
; PURECAP-NEXT:  .LBB0_1: # %entry
; PURECAP-NEXT:    # Label of block must be emitted
; PURECAP-NEXT:    auipcc a3, %got_pcrel_hi(x)
; PURECAP-NEXT:    clc a3, %pcrel_lo(.LBB0_1)(a3)
; PURECAP-NEXT:    cld a4, 0(a3)
; PURECAP-NEXT:    li a5, -1
; PURECAP-NEXT:    slli a5, a5, 32
; PURECAP-NEXT:    addi a5, a5, 1
; PURECAP-NEXT:    csw a2, 24(sp)
; PURECAP-NEXT:    and a4, a4, a5
; PURECAP-NEXT:    csc a1, 0(sp)
; PURECAP-NEXT:    addi a4, a4, 2
; PURECAP-NEXT:    csw zero, 28(sp)
; PURECAP-NEXT:    csd a4, 0(a3)
; PURECAP-NEXT:    cincoffset sp, s0, -64
; PURECAP-NEXT:    clc ra, 48(sp) # 16-byte Folded Reload
; PURECAP-NEXT:    clc s0, 32(sp) # 16-byte Folded Reload
; PURECAP-NEXT:    cincoffset sp, sp, 64
; PURECAP-NEXT:    cret
entry:
