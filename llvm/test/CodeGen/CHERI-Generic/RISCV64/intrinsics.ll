...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    cgetperm a0, a0
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: perms_get:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    cgetperm a0, a0
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    cgettype a0, a0
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: type_get:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    cgettype a0, a0
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    cgetbase a0, a0
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: base_get:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    cgetbase a0, a0
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    cgetlen a0, a0
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: length_get:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    cgetlen a0, a0
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    cgettag a0, a0
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: tag_get:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    cgettag a0, a0
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    cgetsealed a0, a0
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: sealed_get:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    cgetsealed a0, a0
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    cgetoffset a0, a0
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: offset_get:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    cgetoffset a0, a0
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    cgetflags a0, a0
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: flags_get:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    cgetflags a0, a0
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    cgethigh a0, a0
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: high_get:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    cgethigh a0, a0
; HYBRID-NEXT:    ret
...
; PURECAP-LABEL: seal:
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    cseal a0, a0, a1
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: seal:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    cseal a0, a0, a1
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    cunseal a0, a0, a1
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: unseal:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    cunseal a0, a0, a1
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    candperm a0, a0, a1
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: perms_and:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    candperm a0, a0, a1
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    csetflags a0, a0, a1
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: flags_set:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    csetflags a0, a0, a1
; HYBRID-NEXT:    ret
...
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    csetoffset a0, a0, a1
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    csetbounds a0, a0, a1
; PURECAP-NEXT:    cret
;
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    csetboundsexact a0, a0, a1
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: bounds_set_exact:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    csetboundsexact a0, a0, a1
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    csethigh a0, a0, a1
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: high_set:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    csethigh a0, a0, a1
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    csetbounds a0, a0, 42
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: bounds_set_immediate:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    csetbounds a0, a0, 42
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    ccleartag a0, a0
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: tag_clear:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    ccleartag a0, a0
; HYBRID-NEXT:    ret
...
; PURECAP-LABEL: build:
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    cbuildcap a0, a0, a1
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: build:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    cbuildcap a0, a0, a1
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    ccopytype a0, a0, a1
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: type_copy:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    ccopytype a0, a0, a1
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    ccseal a0, a0, a1
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: conditional_seal:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    ccseal a0, a0, a1
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    csealentry a0, a0
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: seal_entry:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    csealentry a0, a0
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    cspecialr a1, ddc
; PURECAP-NEXT:    bnez a0, .LBB29_2
; PURECAP-NEXT:  # %bb.1:
; PURECAP-NEXT:    cmove a0, zero
; PURECAP-NEXT:    cret
; PURECAP-NEXT:  .LBB29_2:
; PURECAP-NEXT:    csetaddr a0, a1, a0
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: from_ddc:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    cspecialr a1, ddc
; HYBRID-NEXT:    bnez a0, .LBB29_2
; HYBRID-NEXT:  # %bb.1:
; HYBRID-NEXT:    cmove a0, zero
; HYBRID-NEXT:    ret
; HYBRID-NEXT:  .LBB29_2:
; HYBRID-NEXT:    csetaddr a0, a1, a0
; HYBRID-NEXT:    ret
  %ddc = call i8 addrspace(200)* @llvm.cheri.ddc.get()
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    auipcc a0, 0
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: pcc_get:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    cspecialr a0, pcc
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    ctestsubset a0, a0, a1
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: subset_test:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    ctestsubset a0, a0, a1
; HYBRID-NEXT:    ret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    cseqx a0, a0, a1
; PURECAP-NEXT:    cret
;
; HYBRID-LABEL: equal_exact:
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    cseqx a0, a0, a1
; HYBRID-NEXT:    ret
