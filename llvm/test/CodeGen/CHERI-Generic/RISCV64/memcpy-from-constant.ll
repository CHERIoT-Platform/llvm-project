...
; RUN: llc -mtriple=riscv64 --relocation-model=pic -target-abi l64pc128d -mattr=+xcheri,+xcheripurecap,+f,+d < %s -o - | FileCheck %s
...
; CHECK-NEXT:    auipcc a1, %got_pcrel_hi(constant_ptrs)
