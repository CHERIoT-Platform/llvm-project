...
; RUN: opt -S -passes=instcombine -o - %s | llc -mtriple=riscv64 --relocation-model=pic -target-abi l64pc128d -mattr=+xcheri,+xcheripurecap,+f,+d -O1 - -o - | %cheri_FileCheck %s --check-prefix ASM
...
; ASM-NEXT:    csc ra, 0(sp) # 16-byte Folded Spill
; ASM-NEXT:    lui a0, 30
; ASM-NEXT:    addi a0, a0, 576
; ASM-NEXT:    ccall check_fold
; ASM-NEXT:    clc ra, 0(sp) # 16-byte Folded Reload
; ASM-NEXT:    cincoffset sp, sp, 16
; ASM-NEXT:    cret
; CHECK-LABEL: define void @infer_values_from_null_set_offset
; CHECK-SAME: () addrspace(200) #[[ATTR1:[0-9]+]] {
; CHECK-NEXT:    [[OFFSET_CHECK:%.*]] = call addrspace(200) i64 @check_fold(i64 123456)
; CHECK-NEXT:    ret void
;
  %with_offset = call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) null, i64 123456)
  %offset = call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) nonnull %with_offset)
  %offset_check = call addrspace(200) i64 @check_fold(i64 %offset)
  ret void
}
...
; ASM-NEXT:    csc s0, 0(sp) # 16-byte Folded Spill
; ASM-NEXT:    lui a0, 30
; ASM-NEXT:    addi a0, a0, 576
...
; ASM-NEXT:    clc s0, 0(sp) # 16-byte Folded Reload
; ASM-NEXT:    cincoffset sp, sp, 32
; ASM-NEXT:    cret
; CHECK-LABEL: define void @multiple_uses_big_constant
; CHECK-SAME: () addrspace(200) #[[ATTR1]] {
; CHECK-NEXT:    call addrspace(200) void @check_fold_i8ptr(ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 123456))
; CHECK-NEXT:    call addrspace(200) void @check_fold_i8ptr(ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 123456))
; CHECK-NEXT:    call addrspace(200) void @check_fold_i8ptr(ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 123456))
; CHECK-NEXT:    ret void
;
...
; CHECK-SAME: () addrspace(200) #[[ATTR1]] {
; CHECK-NEXT:    call addrspace(200) void @check_fold_i8ptr(ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 123))
; CHECK-NEXT:    call addrspace(200) void @check_fold_i8ptr(ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 123))
; CHECK-NEXT:    call addrspace(200) void @check_fold_i8ptr(ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 123))
; CHECK-NEXT:    ret void
;
  %with_offset = call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) null, i64 123)
  call addrspace(200) void @check_fold_i8ptr(ptr addrspace(200) %with_offset)
  call addrspace(200) void @check_fold_i8ptr(ptr addrspace(200) %with_offset)
  call addrspace(200) void @check_fold_i8ptr(ptr addrspace(200) %with_offset)
  ret void
