...
; CHECK-NEXT:    csc s0, 32(sp) # 16-byte Folded Spill
; CHECK-NEXT:    csc s1, 16(sp) # 16-byte Folded Spill
; CHECK-NEXT:    cincoffset a0, sp, 12
...
; CHECK-NEXT:    clc s0, 32(sp) # 16-byte Folded Reload
; CHECK-NEXT:    clc s1, 16(sp) # 16-byte Folded Reload
; CHECK-NEXT:    cincoffset sp, sp, 64
; CHECK-NEXT:    cret
;
