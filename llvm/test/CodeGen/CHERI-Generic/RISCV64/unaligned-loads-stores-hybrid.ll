...
; CHECK-NEXT:    cincoffset ca4, ca0, 5
; CHECK-NEXT:    lbu.cap a2, (ca2)
; CHECK-NEXT:    lbu.cap a4, (ca4)
...
; CHECK-NEXT:    srli a3, a0, 8
; CHECK-NEXT:    sb.cap a0, (ca1)
; CHECK-NEXT:    cincoffset ca0, ca1, 2
; CHECK-NEXT:    cincoffset ca1, ca1, 1
; CHECK-NEXT:    sb.cap a2, (ca0)
...
; CHECK-NEXT:    sh.cap a2, (ca0)
; CHECK-NEXT:    sh.cap a3, (ca1)
; CHECK-NEXT:    ret
