...
entry:
  ...
  ; MIR: INLINEASM &"syscall\0A", sideeffect attdialect, clobber, implicit-def dead early-clobber $a0, clobber, implicit-def dead early-clobber $c2, clobber, implicit-def dead early-clobber $at
  ; MIR: PseudoReturnCap
...
entry:
  ...
  ; MIR: INLINEASM &"syscall\0A", sideeffect attdialect, clobber, implicit-def dead early-clobber $a0, clobber, implicit-def early-clobber $c3, clobber, implicit-def dead early-clobber $at
  ; MIR: PseudoReturnCap
  %0 = load volatile i8, ptr addrspace(200) %ptrval, align 1
  %1 = load volatile i8, ptr addrspace(200) %ptrval2, align 1
  %conv = sext i8 %0 to i32
...
entry:
  ...
  ; MIR: INLINEASM &"syscall\0A", sideeffect attdialect, clobber, implicit-def dead early-clobber $a0, clobber, implicit-def early-clobber $c4, clobber, implicit-def dead early-clobber $at
  ; MIR: PseudoReturnCap
  %0 = load volatile i8, ptr addrspace(200) %ptrval, align 1
  %1 = load volatile i8, ptr addrspace(200) %ptrval2, align 1
  %conv = sext i8 %0 to i32
...
entry:
  ...
  ; MIR: INLINEASM &"syscall\0A", sideeffect attdialect, clobber, implicit-def dead early-clobber $a0, clobber, implicit-def early-clobber $c3, clobber, implicit-def early-clobber $c4, clobber, implicit-def dead early-clobber $at
  ; MIR: PseudoReturnCap
  %0 = load volatile i8, ptr addrspace(200) %ptrval, align 1
  %1 = load volatile i8, ptr addrspace(200) %ptrval2, align 1
  %conv = sext i8 %0 to i32
