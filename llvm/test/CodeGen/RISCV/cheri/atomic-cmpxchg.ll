...
define void @cmpxchg_i8_monotonic_monotonic(ptr addrspace(200) %ptr, i8 %cmp, i8 %val) addrspace(200) nounwind {
...
; RV32IXCHERI-NEXT:    cincoffset a3, sp, 7
; RV32IXCHERI-NEXT:    csb a1, 7(sp)
; RV32IXCHERI-NEXT:    csetbounds a1, a3, 1
...
; RV64IXCHERI-NEXT:    cincoffset a3, sp, 15
; RV64IXCHERI-NEXT:    csb a1, 15(sp)
; RV64IXCHERI-NEXT:    csetbounds a1, a3, 1
...
; RV64IAXCHERI-NEXT:    clr.b a3, (a0)
; RV64IAXCHERI-NEXT:    bne a3, a1, .LBB0_3
; RV64IAXCHERI-NEXT:  # %bb.2: # in Loop: Header=BB0_1 Depth=1
; RV64IAXCHERI-NEXT:    csc.b a4, a2, (a0)
; RV64IAXCHERI-NEXT:    bnez a4, .LBB0_1
; RV64IAXCHERI-NEXT:  .LBB0_3:
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i8 %cmp, i8 %val monotonic monotonic, align 1
  ret void
}

define void @cmpxchg_i8_acquire_monotonic(ptr addrspace(200) %ptr, i8 %cmp, i8 %val) addrspace(200) nounwind {
...
; RV32IAXCHERI-NEXT:    clr.b.aq a3, (a0)
...
; RV64IAXCHERI-NEXT:    clr.b.aq a3, (a0)
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i8 %cmp, i8 %val acquire monotonic, align 1
  ret void
}

define void @cmpxchg_i8_acquire_acquire(ptr addrspace(200) %ptr, i8 %cmp, i8 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i8 %cmp, i8 %val acquire acquire, align 1
  ret void
}

define void @cmpxchg_i8_release_monotonic(ptr addrspace(200) %ptr, i8 %cmp, i8 %val) addrspace(200) nounwind {
...
; RV32IAXCHERI-NEXT:    csc.b.rl a4, a2, (a0)
...
; RV64IAXCHERI-NEXT:    csc.b.rl a4, a2, (a0)
; RV64IAXCHERI-NEXT:    bnez a4, .LBB3_1
; RV64IAXCHERI-NEXT:  .LBB3_3:
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i8 %cmp, i8 %val release monotonic, align 1
  ret void
}

define void @cmpxchg_i8_release_acquire(ptr addrspace(200) %ptr, i8 %cmp, i8 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i8 %cmp, i8 %val release acquire, align 1
  ret void
}

define void @cmpxchg_i8_acq_rel_monotonic(ptr addrspace(200) %ptr, i8 %cmp, i8 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i8 %cmp, i8 %val acq_rel monotonic, align 1
  ret void
}

define void @cmpxchg_i8_acq_rel_acquire(ptr addrspace(200) %ptr, i8 %cmp, i8 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i8 %cmp, i8 %val acq_rel acquire, align 1
  ret void
}

define void @cmpxchg_i8_seq_cst_monotonic(ptr addrspace(200) %ptr, i8 %cmp, i8 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    clr.b.aqrl a3, (a0)
; RV64IAXCHERI-NEXT:    bne a3, a1, .LBB7_3
; RV64IAXCHERI-NEXT:  # %bb.2: # in Loop: Header=BB7_1 Depth=1
; RV64IAXCHERI-NEXT:    csc.b.aqrl a4, a2, (a0)
; RV64IAXCHERI-NEXT:    bnez a4, .LBB7_1
; RV64IAXCHERI-NEXT:  .LBB7_3:
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i8 %cmp, i8 %val seq_cst monotonic, align 1
  ret void
}

define void @cmpxchg_i8_seq_cst_acquire(ptr addrspace(200) %ptr, i8 %cmp, i8 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i8 %cmp, i8 %val seq_cst acquire, align 1
  ret void
}

define void @cmpxchg_i8_seq_cst_seq_cst(ptr addrspace(200) %ptr, i8 %cmp, i8 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i8 %cmp, i8 %val seq_cst seq_cst, align 1
  ret void
}

define void @cmpxchg_i16_monotonic_monotonic(ptr addrspace(200) %ptr, i16 %cmp, i16 %val) addrspace(200) nounwind {
; RV32IXCHERI-LABEL: cmpxchg_i16_monotonic_monotonic:
; RV32IXCHERI:       # %bb.0:
; RV32IXCHERI-NEXT:    cincoffset sp, sp, -16
; RV32IXCHERI-NEXT:    csc ra, 8(sp) # 8-byte Folded Spill
; RV32IXCHERI-NEXT:    cincoffset a3, sp, 6
; RV32IXCHERI-NEXT:    csh a1, 6(sp)
; RV32IXCHERI-NEXT:    csetbounds a1, a3, 2
; RV32IXCHERI-NEXT:    li a3, 0
; RV32IXCHERI-NEXT:    li a4, 0
...
; RV64IXCHERI-NEXT:    cincoffset sp, sp, -32
; RV64IXCHERI-NEXT:    csc ra, 16(sp) # 16-byte Folded Spill
; RV64IXCHERI-NEXT:    cincoffset a3, sp, 14
; RV64IXCHERI-NEXT:    csh a1, 14(sp)
; RV64IXCHERI-NEXT:    csetbounds a1, a3, 2
; RV64IXCHERI-NEXT:    li a3, 0
; RV64IXCHERI-NEXT:    li a4, 0
...
; RV64IAXCHERI-NEXT:    clr.h a3, (a0)
; RV64IAXCHERI-NEXT:    bne a3, a1, .LBB10_3
; RV64IAXCHERI-NEXT:  # %bb.2: # in Loop: Header=BB10_1 Depth=1
; RV64IAXCHERI-NEXT:    csc.h a4, a2, (a0)
; RV64IAXCHERI-NEXT:    bnez a4, .LBB10_1
; RV64IAXCHERI-NEXT:  .LBB10_3:
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i16 %cmp, i16 %val monotonic monotonic, align 2
  ret void
}

define void @cmpxchg_i16_acquire_monotonic(ptr addrspace(200) %ptr, i16 %cmp, i16 %val) addrspace(200) nounwind {
...
; RV32IAXCHERI-NEXT:    clr.h.aq a3, (a0)
...
; RV64IAXCHERI-NEXT:    clr.h.aq a3, (a0)
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i16 %cmp, i16 %val acquire monotonic, align 2
  ret void
}

define void @cmpxchg_i16_acquire_acquire(ptr addrspace(200) %ptr, i16 %cmp, i16 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i16 %cmp, i16 %val acquire acquire, align 2
  ret void
}

define void @cmpxchg_i16_release_monotonic(ptr addrspace(200) %ptr, i16 %cmp, i16 %val) addrspace(200) nounwind {
...
; RV32IAXCHERI-NEXT:    csc.h.rl a4, a2, (a0)
...
; RV64IAXCHERI-NEXT:    csc.h.rl a4, a2, (a0)
; RV64IAXCHERI-NEXT:    bnez a4, .LBB13_1
; RV64IAXCHERI-NEXT:  .LBB13_3:
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i16 %cmp, i16 %val release monotonic, align 2
  ret void
}

define void @cmpxchg_i16_release_acquire(ptr addrspace(200) %ptr, i16 %cmp, i16 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i16 %cmp, i16 %val release acquire, align 2
  ret void
}

define void @cmpxchg_i16_acq_rel_monotonic(ptr addrspace(200) %ptr, i16 %cmp, i16 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i16 %cmp, i16 %val acq_rel monotonic, align 2
  ret void
}

define void @cmpxchg_i16_acq_rel_acquire(ptr addrspace(200) %ptr, i16 %cmp, i16 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i16 %cmp, i16 %val acq_rel acquire, align 2
  ret void
}

define void @cmpxchg_i16_seq_cst_monotonic(ptr addrspace(200) %ptr, i16 %cmp, i16 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    clr.h.aqrl a3, (a0)
; RV64IAXCHERI-NEXT:    bne a3, a1, .LBB17_3
; RV64IAXCHERI-NEXT:  # %bb.2: # in Loop: Header=BB17_1 Depth=1
; RV64IAXCHERI-NEXT:    csc.h.aqrl a4, a2, (a0)
; RV64IAXCHERI-NEXT:    bnez a4, .LBB17_1
; RV64IAXCHERI-NEXT:  .LBB17_3:
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i16 %cmp, i16 %val seq_cst monotonic, align 2
  ret void
}

define void @cmpxchg_i16_seq_cst_acquire(ptr addrspace(200) %ptr, i16 %cmp, i16 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i16 %cmp, i16 %val seq_cst acquire, align 2
  ret void
}

define void @cmpxchg_i16_seq_cst_seq_cst(ptr addrspace(200) %ptr, i16 %cmp, i16 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i16 %cmp, i16 %val seq_cst seq_cst, align 2
  ret void
}

define void @cmpxchg_i32_monotonic_monotonic(ptr addrspace(200) %ptr, i32 %cmp, i32 %val) addrspace(200) nounwind {
; RV32IXCHERI-LABEL: cmpxchg_i32_monotonic_monotonic:
; RV32IXCHERI:       # %bb.0:
; RV32IXCHERI-NEXT:    cincoffset sp, sp, -16
; RV32IXCHERI-NEXT:    csc ra, 8(sp) # 8-byte Folded Spill
; RV32IXCHERI-NEXT:    cincoffset a3, sp, 4
; RV32IXCHERI-NEXT:    csw a1, 4(sp)
; RV32IXCHERI-NEXT:    csetbounds a1, a3, 4
; RV32IXCHERI-NEXT:    li a3, 0
; RV32IXCHERI-NEXT:    li a4, 0
...
; RV64IXCHERI-NEXT:    cincoffset sp, sp, -32
; RV64IXCHERI-NEXT:    csc ra, 16(sp) # 16-byte Folded Spill
; RV64IXCHERI-NEXT:    cincoffset a3, sp, 12
; RV64IXCHERI-NEXT:    csw a1, 12(sp)
; RV64IXCHERI-NEXT:    csetbounds a1, a3, 4
; RV64IXCHERI-NEXT:    li a3, 0
; RV64IXCHERI-NEXT:    li a4, 0
...
; RV64IAXCHERI-NEXT:    clr.w a3, (a0)
; RV64IAXCHERI-NEXT:    bne a3, a1, .LBB20_3
; RV64IAXCHERI-NEXT:  # %bb.2: # in Loop: Header=BB20_1 Depth=1
; RV64IAXCHERI-NEXT:    csc.w a4, a2, (a0)
; RV64IAXCHERI-NEXT:    bnez a4, .LBB20_1
; RV64IAXCHERI-NEXT:  .LBB20_3:
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i32 %cmp, i32 %val monotonic monotonic, align 4
  ret void
}

define void @cmpxchg_i32_acquire_monotonic(ptr addrspace(200) %ptr, i32 %cmp, i32 %val) addrspace(200) nounwind {
...
; RV32IAXCHERI-NEXT:    clr.w.aq a3, (a0)
...
; RV64IAXCHERI-NEXT:    clr.w.aq a3, (a0)
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i32 %cmp, i32 %val acquire monotonic, align 4
  ret void
}

define void @cmpxchg_i32_acquire_acquire(ptr addrspace(200) %ptr, i32 %cmp, i32 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i32 %cmp, i32 %val acquire acquire, align 4
  ret void
}

define void @cmpxchg_i32_release_monotonic(ptr addrspace(200) %ptr, i32 %cmp, i32 %val) addrspace(200) nounwind {
...
; RV32IAXCHERI-NEXT:    csc.w.rl a4, a2, (a0)
...
; RV64IAXCHERI-NEXT:    csc.w.rl a4, a2, (a0)
; RV64IAXCHERI-NEXT:    bnez a4, .LBB23_1
; RV64IAXCHERI-NEXT:  .LBB23_3:
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i32 %cmp, i32 %val release monotonic, align 4
  ret void
}

define void @cmpxchg_i32_release_acquire(ptr addrspace(200) %ptr, i32 %cmp, i32 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i32 %cmp, i32 %val release acquire, align 4
  ret void
}

define void @cmpxchg_i32_acq_rel_monotonic(ptr addrspace(200) %ptr, i32 %cmp, i32 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i32 %cmp, i32 %val acq_rel monotonic, align 4
  ret void
}

define void @cmpxchg_i32_acq_rel_acquire(ptr addrspace(200) %ptr, i32 %cmp, i32 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i32 %cmp, i32 %val acq_rel acquire, align 4
  ret void
}

define void @cmpxchg_i32_seq_cst_monotonic(ptr addrspace(200) %ptr, i32 %cmp, i32 %val) addrspace(200) nounwind {
...
; RV32IAXCHERI-NEXT:    clr.w.aqrl a3, (a0)
...
; RV64IAXCHERI-NEXT:    clr.w.aqrl a3, (a0)
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i32 %cmp, i32 %val seq_cst monotonic, align 4
  ret void
}

define void @cmpxchg_i32_seq_cst_acquire(ptr addrspace(200) %ptr, i32 %cmp, i32 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i32 %cmp, i32 %val seq_cst acquire, align 4
  ret void
}

define void @cmpxchg_i32_seq_cst_seq_cst(ptr addrspace(200) %ptr, i32 %cmp, i32 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i32 %cmp, i32 %val seq_cst seq_cst, align 4
  ret void
}

define void @cmpxchg_i64_monotonic_monotonic(ptr addrspace(200) %ptr, i64 %cmp, i64 %val) addrspace(200) nounwind {
; RV32IXCHERI-LABEL: cmpxchg_i64_monotonic_monotonic:
; RV32IXCHERI:       # %bb.0:
; RV32IXCHERI-NEXT:    cincoffset sp, sp, -16
; RV32IXCHERI-NEXT:    csc ra, 8(sp) # 8-byte Folded Spill
; RV32IXCHERI-NEXT:    csw a2, 4(sp)
; RV32IXCHERI-NEXT:    cincoffset a2, sp, 0
; RV32IXCHERI-NEXT:    csw a1, 0(sp)
; RV32IXCHERI-NEXT:    csetbounds a1, a2, 8
...
; RV32IAXCHERI:       # %bb.0:
; RV32IAXCHERI-NEXT:    cincoffset sp, sp, -16
; RV32IAXCHERI-NEXT:    csc ra, 8(sp) # 8-byte Folded Spill
; RV32IAXCHERI-NEXT:    csw a2, 4(sp)
; RV32IAXCHERI-NEXT:    cincoffset a2, sp, 0
; RV32IAXCHERI-NEXT:    csw a1, 0(sp)
; RV32IAXCHERI-NEXT:    csetbounds a1, a2, 8
...
; RV32IAXCHERI-NEXT:    clc ra, 8(sp) # 8-byte Folded Reload
; RV32IAXCHERI-NEXT:    cincoffset sp, sp, 16
; RV32IAXCHERI-NEXT:    cret
;
...
; RV64IXCHERI-NEXT:    cincoffset sp, sp, -32
; RV64IXCHERI-NEXT:    csc ra, 16(sp) # 16-byte Folded Spill
; RV64IXCHERI-NEXT:    cincoffset a3, sp, 8
; RV64IXCHERI-NEXT:    csd a1, 8(sp)
; RV64IXCHERI-NEXT:    csetbounds a1, a3, 8
; RV64IXCHERI-NEXT:    li a3, 0
; RV64IXCHERI-NEXT:    li a4, 0
...
; RV64IAXCHERI-NEXT:    clr.d a3, (a0)
; RV64IAXCHERI-NEXT:    bne a3, a1, .LBB30_3
; RV64IAXCHERI-NEXT:  # %bb.2: # in Loop: Header=BB30_1 Depth=1
; RV64IAXCHERI-NEXT:    csc.d a4, a2, (a0)
; RV64IAXCHERI-NEXT:    bnez a4, .LBB30_1
; RV64IAXCHERI-NEXT:  .LBB30_3:
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i64 %cmp, i64 %val monotonic monotonic, align 8
  ret void
}

define void @cmpxchg_i64_acquire_monotonic(ptr addrspace(200) %ptr, i64 %cmp, i64 %val) addrspace(200) nounwind {
; RV32IXCHERI-LABEL: cmpxchg_i64_acquire_monotonic:
; RV32IXCHERI:       # %bb.0:
; RV32IXCHERI-NEXT:    cincoffset sp, sp, -16
; RV32IXCHERI-NEXT:    csc ra, 8(sp) # 8-byte Folded Spill
; RV32IXCHERI-NEXT:    mv a5, a4
; RV32IXCHERI-NEXT:    csw a2, 4(sp)
; RV32IXCHERI-NEXT:    cincoffset a2, sp, 0
; RV32IXCHERI-NEXT:    csw a1, 0(sp)
; RV32IXCHERI-NEXT:    csetbounds a1, a2, 8
...
; RV64IAXCHERI-NEXT:    clr.d.aq a3, (a0)
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i64 %cmp, i64 %val acquire monotonic, align 8
  ret void
}

define void @cmpxchg_i64_acquire_acquire(ptr addrspace(200) %ptr, i64 %cmp, i64 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i64 %cmp, i64 %val acquire acquire, align 8
  ret void
}

define void @cmpxchg_i64_release_monotonic(ptr addrspace(200) %ptr, i64 %cmp, i64 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    csc.d.rl a4, a2, (a0)
; RV64IAXCHERI-NEXT:    bnez a4, .LBB33_1
; RV64IAXCHERI-NEXT:  .LBB33_3:
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i64 %cmp, i64 %val release monotonic, align 8
  ret void
}

define void @cmpxchg_i64_release_acquire(ptr addrspace(200) %ptr, i64 %cmp, i64 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i64 %cmp, i64 %val release acquire, align 8
  ret void
}

define void @cmpxchg_i64_acq_rel_monotonic(ptr addrspace(200) %ptr, i64 %cmp, i64 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i64 %cmp, i64 %val acq_rel monotonic, align 8
  ret void
}

define void @cmpxchg_i64_acq_rel_acquire(ptr addrspace(200) %ptr, i64 %cmp, i64 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i64 %cmp, i64 %val acq_rel acquire, align 8
  ret void
}

define void @cmpxchg_i64_seq_cst_monotonic(ptr addrspace(200) %ptr, i64 %cmp, i64 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    clr.d.aqrl a3, (a0)
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i64 %cmp, i64 %val seq_cst monotonic, align 8
  ret void
}

define void @cmpxchg_i64_seq_cst_acquire(ptr addrspace(200) %ptr, i64 %cmp, i64 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i64 %cmp, i64 %val seq_cst acquire, align 8
  ret void
}

define void @cmpxchg_i64_seq_cst_seq_cst(ptr addrspace(200) %ptr, i64 %cmp, i64 %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, i64 %cmp, i64 %val seq_cst seq_cst, align 8
  ret void
}

define void @cmpxchg_cap_monotonic_monotonic(ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val) addrspace(200) nounwind {
; RV32IXCHERI-LABEL: cmpxchg_cap_monotonic_monotonic:
; RV32IXCHERI:       # %bb.0:
; RV32IXCHERI-NEXT:    cincoffset sp, sp, -16
; RV32IXCHERI-NEXT:    csc ra, 8(sp) # 8-byte Folded Spill
; RV32IXCHERI-NEXT:    cincoffset a3, sp, 0
; RV32IXCHERI-NEXT:    csc a1, 0(sp)
; RV32IXCHERI-NEXT:    csetbounds a1, a3, 8
; RV32IXCHERI-NEXT:    li a3, 0
; RV32IXCHERI-NEXT:    li a4, 0
...
; RV64IXCHERI-NEXT:    cincoffset sp, sp, -32
; RV64IXCHERI-NEXT:    csc ra, 16(sp) # 16-byte Folded Spill
; RV64IXCHERI-NEXT:    cincoffset a3, sp, 0
; RV64IXCHERI-NEXT:    csc a1, 0(sp)
; RV64IXCHERI-NEXT:    csetbounds a1, a3, 16
; RV64IXCHERI-NEXT:    li a3, 0
; RV64IXCHERI-NEXT:    li a4, 0
...
; RV64IAXCHERI-NEXT:    clr.c a3, (a0)
; RV64IAXCHERI-NEXT:    bne a3, a1, .LBB40_3
; RV64IAXCHERI-NEXT:  # %bb.2: # in Loop: Header=BB40_1 Depth=1
; RV64IAXCHERI-NEXT:    csc.c a4, a2, (a0)
; RV64IAXCHERI-NEXT:    bnez a4, .LBB40_1
; RV64IAXCHERI-NEXT:  .LBB40_3:
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val monotonic monotonic, align 16
  ret void
}

define void @cmpxchg_cap_acquire_monotonic(ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    clr.c.aq a3, (a0)
; RV64IAXCHERI-NEXT:    bne a3, a1, .LBB41_3
; RV64IAXCHERI-NEXT:  # %bb.2: # in Loop: Header=BB41_1 Depth=1
; RV64IAXCHERI-NEXT:    csc.c.aq a4, a2, (a0)
; RV64IAXCHERI-NEXT:    bnez a4, .LBB41_1
; RV64IAXCHERI-NEXT:  .LBB41_3:
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val acquire monotonic, align 16
  ret void
}

define void @cmpxchg_cap_acquire_acquire(ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val acquire acquire, align 16
  ret void
}

define void @cmpxchg_cap_release_monotonic(ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val) addrspace(200) nounwind {
...
; RV32IAXCHERI-NEXT:    clr.c.rl a3, (a0)
...
; RV64IAXCHERI-NEXT:    clr.c.rl a3, (a0)
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val release monotonic, align 16
  ret void
}

define void @cmpxchg_cap_release_acquire(ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val release acquire, align 16
  ret void
}

define void @cmpxchg_cap_acq_rel_monotonic(ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val acq_rel monotonic, align 16
  ret void
}

define void @cmpxchg_cap_acq_rel_acquire(ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val acq_rel acquire, align 16
  ret void
}

define void @cmpxchg_cap_seq_cst_monotonic(ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    clr.c.aqrl a3, (a0)
; RV64IAXCHERI-NEXT:    bne a3, a1, .LBB47_3
; RV64IAXCHERI-NEXT:  # %bb.2: # in Loop: Header=BB47_1 Depth=1
; RV64IAXCHERI-NEXT:    csc.c.aqrl a4, a2, (a0)
; RV64IAXCHERI-NEXT:    bnez a4, .LBB47_1
; RV64IAXCHERI-NEXT:  .LBB47_3:
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val seq_cst monotonic, align 16
  ret void
}

define void @cmpxchg_cap_seq_cst_acquire(ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val seq_cst acquire, align 16
  ret void
}

define void @cmpxchg_cap_seq_cst_seq_cst(ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val) addrspace(200) nounwind {
...
; RV64IAXCHERI-NEXT:    cret
  %res = cmpxchg ptr addrspace(200) %ptr, ptr addrspace(200) %cmp, ptr addrspace(200) %val seq_cst seq_cst, align 16
  ret void
}
