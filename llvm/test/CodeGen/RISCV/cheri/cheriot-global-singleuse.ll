...
; CHECK-NEXT:    auicgp a0, %cheriot_compartment_hi(gv_u8)
...
; CHECK-NEXT:    # Label of block must be emitted
; CHECK-NEXT:    ct.auicgp a1, %cheriot_compartment_hi(gv_u8)
...
; CHECK-NEXT:    # Label of block must be emitted
; CHECK-NEXT:    auicgp a0, %cheriot_compartment_hi(gv_s8)
...
; CHECK-NEXT:    # Label of block must be emitted
; CHECK-NEXT:    ct.auicgp a1, %cheriot_compartment_hi(gv_s8)
...
; CHECK-NEXT:    # Label of block must be emitted
; CHECK-NEXT:    auicgp a0, %cheriot_compartment_hi(gv_u16)
...
; CHECK-NEXT:    # Label of block must be emitted
; CHECK-NEXT:    ct.auicgp a1, %cheriot_compartment_hi(gv_u16)
...
; CHECK-NEXT:    # Label of block must be emitted
; CHECK-NEXT:    auicgp a0, %cheriot_compartment_hi(gv_s16)
...
; CHECK-NEXT:    # Label of block must be emitted
; CHECK-NEXT:    ct.auicgp a1, %cheriot_compartment_hi(gv_s16)
...
; CHECK-NEXT:    # Label of block must be emitted
; CHECK-NEXT:    auicgp a0, %cheriot_compartment_hi(gv_u32)
...
; CHECK-NEXT:    # Label of block must be emitted
; CHECK-NEXT:    ct.auicgp a1, %cheriot_compartment_hi(gv_u32)
...
; CHECK-NEXT:    # Label of block must be emitted
; CHECK-NEXT:    auicgp a0, %cheriot_compartment_hi(gv_s32)
...
; CHECK-NEXT:    # Label of block must be emitted
; CHECK-NEXT:    ct.auicgp a1, %cheriot_compartment_hi(gv_s32)
...
; CHECK-NEXT:    # Label of block must be emitted
; CHECK-NEXT:    ct.auicgp a0, %cheriot_compartment_hi(gv_cap)
