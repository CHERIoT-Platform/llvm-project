...
define dso_local cheriot_compartmentcalleecc void @_Z9usesStackv() addrspace(200) #0 {
...
; Function Attrs: noinline nounwind optnone
define dso_local cheriot_compartmentcalleecc void @_Z13usesHugeStackv() addrspace(200) #0 {
