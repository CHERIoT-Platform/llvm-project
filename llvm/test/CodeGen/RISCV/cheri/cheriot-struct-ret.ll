...
entry:
  ...
  ;; CHECK:     auicgp.relaxable	        s0, %cheriot_compartment_cgp_hi(dummies)
...
entry:
  ...
  ;; CHECK: auicgp.relaxable	a1, %cheriot_compartment_cgp_hi(force_use)
...
entry:
  ...
  ;; CHECK:  	auicgp.relaxable	a1, %cheriot_compartment_cgp_hi(dummies)
...
entry:
  ...
  ;; CHECK:  	auicgp.relaxable	a0, %cheriot_compartment_cgp_hi(force_use)
...
entry:
  ...
  ;; CHECK: auicgp.relaxable	a3, %cheriot_compartment_cgp_hi(dummies)
