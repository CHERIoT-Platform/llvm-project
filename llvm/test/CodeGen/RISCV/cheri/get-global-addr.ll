...
; L64PC128-NEXT:    auipcc a0, %pcrel_hi(.LCPI0_0)
; L64PC128-NEXT:    cincoffset a0, a0, %pcrel_lo(.LBB0_1)
; L64PC128-NEXT:    cfld fa5, 0(a0)
...
; L64PC128-NEXT:    auipcc a0, %pcrel_hi(.Ltmp0)
; L64PC128-NEXT:    cincoffset a0, a0, %pcrel_lo(.LBB1_2)
; L64PC128-NEXT:    cret
entry:
  br label %block
block:
