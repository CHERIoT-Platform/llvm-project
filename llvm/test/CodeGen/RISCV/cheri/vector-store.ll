...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    cld a2, 0(a1)
; PURECAP-NEXT:    cld a1, 8(a1)
; PURECAP-NEXT:    csd a1, 8(a0)
; PURECAP-NEXT:    csd a2, 0(a0)
; PURECAP-NEXT:    cret
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    csw a0, 4(a1)
; PURECAP-NEXT:    csw zero, 0(a1)
; PURECAP-NEXT:    csd zero, 8(a1)
; PURECAP-NEXT:    cret
