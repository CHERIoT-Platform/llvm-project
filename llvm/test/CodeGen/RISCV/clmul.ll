...
; RV32IM-NEXT:    andi t6, a2, 1
; RV32IM-NEXT:    andi s0, a2, 4
; RV32IM-NEXT:    andi s1, a2, 8
; RV32IM-NEXT:    andi s2, a2, 16
; RV32IM-NEXT:    andi s3, a2, 32
; RV32IM-NEXT:    andi s4, a2, 128
; RV32IM-NEXT:    andi t5, a2, 256
; RV32IM-NEXT:    andi a4, a3, 2
; RV32IM-NEXT:    andi a5, a3, 1
; RV32IM-NEXT:    andi s7, a3, 4
; RV32IM-NEXT:    andi s8, a3, 8
; RV32IM-NEXT:    mul a6, t2, t4
; RV32IM-NEXT:    mul a7, t2, t6
; RV32IM-NEXT:    mul s5, t2, s0
; RV32IM-NEXT:    mul s6, t2, s1
; RV32IM-NEXT:    mul s9, t2, s2
; RV32IM-NEXT:    xor a6, a7, a6
; RV32IM-NEXT:    mul s10, t2, s3
; RV32IM-NEXT:    xor a7, s5, s6
; RV32IM-NEXT:    mul s6, t2, s4
; RV32IM-NEXT:    xor s5, s9, s10
; RV32IM-NEXT:    mul s9, t2, t5
...
; RV32IM-NEXT:    and t3, a2, s10
; RV32IM-NEXT:    xor a6, s5, s3
; RV32IM-NEXT:    sw a6, 200(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a6, t2, a1
; RV32IM-NEXT:    xor a7, s6, t0
; RV32IM-NEXT:    sw a7, 196(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a7, t2, t3
; RV32IM-NEXT:    xor a6, a6, a7
; RV32IM-NEXT:    sw a6, 192(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui s5, 128
; RV32IM-NEXT:    and t0, a2, s5
; RV32IM-NEXT:    lui s6, 256
; RV32IM-NEXT:    and t1, a2, s6
; RV32IM-NEXT:    mul a6, t2, t0
; RV32IM-NEXT:    mul a7, t2, t1
; RV32IM-NEXT:    xor a6, a6, a7
...
; RV32IM-NEXT:    mul s4, t2, a7
; RV32IM-NEXT:    xor s3, s3, s4
; RV32IM-NEXT:    sw s3, 180(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    and a4, a3, s5
; RV32IM-NEXT:    mul a4, a0, a4
; RV32IM-NEXT:    and a5, a3, s6
; RV32IM-NEXT:    mul a5, a0, a5
; RV32IM-NEXT:    xor a4, a4, a5
...
; RV32IM-NEXT:    srli a5, t1, 2
; RV32IM-NEXT:    and a6, t1, t4
; RV32IM-NEXT:    and a5, a5, t4
; RV32IM-NEXT:    slli a6, a6, 2
...
; RV64IM-NEXT:    lui t6, 16384
; RV64IM-NEXT:    lui t5, 32768
...
; RV64IM-NEXT:    slli t1, a2, 11
; RV64IM-NEXT:    sd t1, 208(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and s7, a1, s7
; RV64IM-NEXT:    lui t1, 2
; RV64IM-NEXT:    and t1, a1, t1
; RV64IM-NEXT:    sd t1, 296(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and s0, a1, s0
; RV64IM-NEXT:    and s1, a1, s1
; RV64IM-NEXT:    and t1, a1, s2
; RV64IM-NEXT:    sd t1, 280(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and t1, a1, s3
; RV64IM-NEXT:    sd t1, 272(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and t1, a1, s4
; RV64IM-NEXT:    sd t1, 264(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and t1, a1, s5
; RV64IM-NEXT:    and s2, a1, s6
; RV64IM-NEXT:    and s8, a1, s8
; RV64IM-NEXT:    and s3, a1, s9
; RV64IM-NEXT:    sd s3, 256(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and s3, a1, s10
; RV64IM-NEXT:    sd s3, 248(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and s3, a1, s11
; RV64IM-NEXT:    sd s3, 240(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and s3, a1, ra
; RV64IM-NEXT:    and t6, a1, t6
; RV64IM-NEXT:    and t5, a1, t5
; RV64IM-NEXT:    and t3, a1, t3
; RV64IM-NEXT:    sd t3, 232(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and t0, a1, t0
; RV64IM-NEXT:    sd t0, 224(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and a6, a1, a6
; RV64IM-NEXT:    sd a6, 216(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    xor a5, t2, a5
; RV64IM-NEXT:    sd a5, 336(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s4, a2, 32
; RV64IM-NEXT:    xor a3, a4, a3
; RV64IM-NEXT:    sd a3, 328(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s5, a2, 33
; RV64IM-NEXT:    xor a3, a7, t4
; RV64IM-NEXT:    sd a3, 320(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s6, a2, 34
; RV64IM-NEXT:    mul a3, a0, s0
; RV64IM-NEXT:    mul a4, a0, s1
; RV64IM-NEXT:    xor a3, a3, a4
; RV64IM-NEXT:    sd a3, 312(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s0, a2, 35
; RV64IM-NEXT:    mul a3, a0, t1
; RV64IM-NEXT:    mul a4, a0, s2
; RV64IM-NEXT:    xor a3, a3, a4
; RV64IM-NEXT:    sd a3, 304(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s1, a2, 36
; RV64IM-NEXT:    mul a3, a0, s3
; RV64IM-NEXT:    mul a4, a0, t6
; RV64IM-NEXT:    xor a3, a3, a4
; RV64IM-NEXT:    sd a3, 288(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli t6, a2, 37
; RV64IM-NEXT:    slli s2, a2, 38
; RV64IM-NEXT:    slli s3, a2, 39
...
; RV64IM-NEXT:    and t2, a1, s4
; RV64IM-NEXT:    sd t2, 112(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and t4, a1, s5
; RV64IM-NEXT:    and t2, a1, s6
; RV64IM-NEXT:    sd t2, 104(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and s0, a1, s0
; RV64IM-NEXT:    sd s0, 96(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and s1, a1, s1
; RV64IM-NEXT:    sd s1, 88(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and s1, a1, t6
; RV64IM-NEXT:    and t2, a1, s2
...
; RV64IM-NEXT:    sd a7, 56(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and a6, a1, a6
; RV64IM-NEXT:    and a5, a1, a5
...
; RV64IM-NEXT:    mul a4, a0, a4
; RV64IM-NEXT:    ld a6, 40(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    mul a6, a0, a6
; RV64IM-NEXT:    ld t1, 32(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    mul t1, a0, t1
; RV64IM-NEXT:    ld t6, 24(sp) # 8-byte Folded Reload
...
; RV64IM-NEXT:    ld s7, 288(sp) # 8-byte Folded Reload
...
; RV64IM-NEXT:    ld s2, 16(sp) # 8-byte Folded Reload
...
; RV64IM-NEXT:    ld a2, 208(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a2, a5, a2
; RV64IM-NEXT:    ld a3, 200(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a3, s0, a3
; RV64IM-NEXT:    ld a5, 224(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a5, t2, a5
; RV64IM-NEXT:    ld t2, 112(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a7, a7, t2
...
; RV64IM-NEXT:    ld a4, 216(sp) # 8-byte Folded Reload
...
; RV32IM-NEXT:    lui t5, 349525
; RV32IM-NEXT:    srli a6, a1, 8
; RV32IM-NEXT:    srli t4, a1, 24
; RV32IM-NEXT:    slli a2, a1, 24
; RV32IM-NEXT:    li s8, 1
...
; RV32IM-NEXT:    sw a1, 80(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and a1, a0, s6
; RV32IM-NEXT:    sw a1, 76(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and a1, a0, s7
; RV32IM-NEXT:    sw a1, 72(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and s9, a0, s9
; RV32IM-NEXT:    and a1, a0, s10
; RV32IM-NEXT:    sw a1, 68(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and a1, a0, s11
; RV32IM-NEXT:    sw a1, 64(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and a1, a0, ra
; RV32IM-NEXT:    sw a1, 60(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui a1, 2048
...
; RV32IM-NEXT:    sw t6, 8(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul s11, a5, t4
; RV32IM-NEXT:    mul a1, a5, a1
; RV32IM-NEXT:    sw a1, 4(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul s7, a5, a2
; RV32IM-NEXT:    mul s6, a5, a3
; RV32IM-NEXT:    mul s5, a5, a4
; RV32IM-NEXT:    mul a1, a5, a6
; RV32IM-NEXT:    sw a1, 12(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a1, a5, a7
; RV32IM-NEXT:    sw a1, 88(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul s1, a5, t0
; RV32IM-NEXT:    mul t6, a5, t1
; RV32IM-NEXT:    mul ra, a5, a0
; RV32IM-NEXT:    mul a0, a5, s3
; RV32IM-NEXT:    sw a0, 16(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a0, a5, s8
; RV32IM-NEXT:    sw a0, 20(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw a0, 84(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul t1, a5, a0
; RV32IM-NEXT:    mul a7, a5, s2
; RV32IM-NEXT:    mul s2, a5, s0
...
; RV32IM-NEXT:    lw s10, 24(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a5, a5, s10
...
; RV64IM-NEXT:    andi t6, a1, 64
; RV64IM-NEXT:    andi t1, a1, 128
; RV64IM-NEXT:    andi t3, a1, 256
; RV64IM-NEXT:    andi s0, a1, 512
; RV64IM-NEXT:    andi s3, a1, 1024
; RV64IM-NEXT:    li a0, 1
; RV64IM-NEXT:    lui a2, 1
; RV64IM-NEXT:    lui a3, 2
; RV64IM-NEXT:    lui t5, 4
; RV64IM-NEXT:    lui ra, 4096
; RV64IM-NEXT:    lui s9, 8192
; RV64IM-NEXT:    lui s8, 16384
; RV64IM-NEXT:    srli s2, a7, 32
; RV64IM-NEXT:    mul a7, s2, t2
; RV64IM-NEXT:    mul t2, s2, t4
; RV64IM-NEXT:    xor a7, t2, a7
; RV64IM-NEXT:    sd a7, 0(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    lui s7, 32768
; RV64IM-NEXT:    mul a6, s2, a6
; RV64IM-NEXT:    mul t0, s2, t0
; RV64IM-NEXT:    xor s11, a6, t0
; RV64IM-NEXT:    lui s6, 65536
; RV64IM-NEXT:    mul a4, s2, a4
; RV64IM-NEXT:    mul a5, s2, a5
; RV64IM-NEXT:    xor s10, a4, a5
; RV64IM-NEXT:    lui s4, 131072
; RV64IM-NEXT:    mul a5, s2, t1
; RV64IM-NEXT:    mul t1, s2, t3
; RV64IM-NEXT:    xor s5, a5, t1
; RV64IM-NEXT:    lui s1, 262144
; RV64IM-NEXT:    slli t3, a0, 11
; RV64IM-NEXT:    and a0, a1, a2
; RV64IM-NEXT:    and a2, a1, a3
; RV64IM-NEXT:    and a3, a1, t5
...
; RV64IM-NEXT:    and t1, a1, t1
; RV64IM-NEXT:    lui t2, 512
; RV64IM-NEXT:    and t2, a1, t2
; RV64IM-NEXT:    lui t4, 1024
; RV64IM-NEXT:    and t4, a1, t4
; RV64IM-NEXT:    lui t5, 2048
; RV64IM-NEXT:    and t5, a1, t5
...
; RV64IM-NEXT:    mul t6, s2, t6
; RV64IM-NEXT:    mul s0, s2, s0
; RV64IM-NEXT:    mul s3, s2, s3
; RV64IM-NEXT:    mul a0, s2, a0
; RV64IM-NEXT:    mul a2, s2, a2
; RV64IM-NEXT:    mul a3, s2, a3
; RV64IM-NEXT:    mul a4, s2, a4
; RV64IM-NEXT:    mul a5, s2, a5
; RV64IM-NEXT:    mul a6, s2, a6
; RV64IM-NEXT:    mul a7, s2, a7
; RV64IM-NEXT:    mul t0, s2, t0
; RV64IM-NEXT:    mul t1, s2, t1
; RV64IM-NEXT:    mul t2, s2, t2
; RV64IM-NEXT:    mul t4, s2, t4
; RV64IM-NEXT:    mul t5, s2, t5
; RV64IM-NEXT:    mul ra, s2, ra
; RV64IM-NEXT:    mul s9, s2, s9
; RV64IM-NEXT:    mul s8, s2, s8
; RV64IM-NEXT:    mul s7, s2, s7
; RV64IM-NEXT:    mul s6, s2, s6
; RV64IM-NEXT:    mul s4, s2, s4
; RV64IM-NEXT:    mul s1, s2, s1
; RV64IM-NEXT:    mul a1, s2, a1
; RV64IM-NEXT:    mul t3, s2, t3
; RV64IM-NEXT:    xor a4, a4, a5
; RV64IM-NEXT:    xor a5, t2, t4
; RV64IM-NEXT:    xor t2, s6, s4
; RV64IM-NEXT:    ld t4, 0(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t4, t4, s11
; RV64IM-NEXT:    xor t6, s10, t6
; RV64IM-NEXT:    xor s0, s5, s0
; RV64IM-NEXT:    xor a0, t3, a0
; RV64IM-NEXT:    xor a4, a4, a6
; RV64IM-NEXT:    xor a5, a5, t5
; RV64IM-NEXT:    xor a6, t2, s1
; RV64IM-NEXT:    xor t2, t4, t6
; RV64IM-NEXT:    xor t3, s0, s3
; RV64IM-NEXT:    xor a0, a0, a2
; RV64IM-NEXT:    xor a2, a4, a7
; RV64IM-NEXT:    xor a4, a5, ra
; RV64IM-NEXT:    xor a5, t2, t3
; RV64IM-NEXT:    xor a0, a0, a3
; RV64IM-NEXT:    xor a2, a2, t0
; RV64IM-NEXT:    xor a3, a4, s9
; RV64IM-NEXT:    xor a0, a5, a0
; RV64IM-NEXT:    xor a2, a2, t1
; RV64IM-NEXT:    xor a3, a3, s8
; RV64IM-NEXT:    xor a0, a0, a2
; RV64IM-NEXT:    xor a2, a3, s7
; RV64IM-NEXT:    xor a0, a0, a2
...
; RV32IM-NEXT:    addi s2, a4, -256
; RV32IM-NEXT:    sw s2, 80(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and t0, t0, s2
; RV32IM-NEXT:    or t1, t0, t1
; RV32IM-NEXT:    lui t0, 65536
; RV32IM-NEXT:    and t3, t3, s2
; RV32IM-NEXT:    or t4, t3, t4
...
; RV32IM-NEXT:    addi s2, a6, 819
; RV32IM-NEXT:    or a2, a2, t1
; RV32IM-NEXT:    addi a3, t5, 1365
...
; RV32IM-NEXT:    andi a0, a0, 1024
; RV32IM-NEXT:    mul s11, a6, t4
; RV32IM-NEXT:    mul s9, a6, a1
; RV32IM-NEXT:    mul s8, a6, a2
; RV32IM-NEXT:    mul s6, a6, a3
; RV32IM-NEXT:    mul s5, a6, a4
; RV32IM-NEXT:    mul s3, a6, a5
...
; RV32IM-NEXT:    mul a3, a6, s0
; RV32IM-NEXT:    lw a0, 56(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a2, a6, a0
; RV32IM-NEXT:    mul a5, a6, s4
; RV32IM-NEXT:    lw a0, 52(sp) # 4-byte Folded Reload
...
; RV64IM-NEXT:    sd a5, 728(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    sd a4, 720(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    mv t2, a3
; RV64IM-NEXT:    mv a3, a2
; RV64IM-NEXT:    andi t1, a2, 2
; RV64IM-NEXT:    andi t4, a2, 1
; RV64IM-NEXT:    andi a2, a2, 4
; RV64IM-NEXT:    andi t5, a3, 8
; RV64IM-NEXT:    andi a5, a3, 16
; RV64IM-NEXT:    andi a7, a3, 32
; RV64IM-NEXT:    andi a6, a3, 64
; RV64IM-NEXT:    andi t0, a3, 128
; RV64IM-NEXT:    andi t3, a3, 256
; RV64IM-NEXT:    andi t6, a3, 512
; RV64IM-NEXT:    andi s0, a3, 1024
; RV64IM-NEXT:    li a4, 1
; RV64IM-NEXT:    lui s6, 4
; RV64IM-NEXT:    lui s7, 8
; RV64IM-NEXT:    lui s8, 128
; RV64IM-NEXT:    lui ra, 256
...
; RV64IM-NEXT:    andi s5, t2, 16
; RV64IM-NEXT:    mul t1, a0, t1
; RV64IM-NEXT:    mul t4, a0, t4
; RV64IM-NEXT:    xor t1, t4, t1
; RV64IM-NEXT:    andi t4, t2, 32
; RV64IM-NEXT:    mul a2, a0, a2
; RV64IM-NEXT:    mul t5, a0, t5
; RV64IM-NEXT:    xor a2, a2, t5
; RV64IM-NEXT:    andi t5, t2, 128
; RV64IM-NEXT:    mul a5, a0, a5
; RV64IM-NEXT:    mul a7, a0, a7
; RV64IM-NEXT:    xor a5, a5, a7
; RV64IM-NEXT:    andi a7, t2, 256
; RV64IM-NEXT:    mul a6, a0, a6
; RV64IM-NEXT:    mul t0, a0, t0
; RV64IM-NEXT:    mul t3, a0, t3
; RV64IM-NEXT:    mul t6, a0, t6
; RV64IM-NEXT:    mul s0, a0, s0
; RV64IM-NEXT:    sd s0, 712(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    xor t0, t0, t3
; RV64IM-NEXT:    slli t3, a4, 11
; RV64IM-NEXT:    sd t3, 760(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    mul t3, a1, s1
; RV64IM-NEXT:    mul s0, a1, s2
; RV64IM-NEXT:    xor t3, s0, t3
; RV64IM-NEXT:    sd t3, 280(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and t3, a3, s6
; RV64IM-NEXT:    mul s0, a1, s3
; RV64IM-NEXT:    mul s1, a1, s4
; RV64IM-NEXT:    xor s0, s0, s1
; RV64IM-NEXT:    sd s0, 272(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and s0, a3, s7
; RV64IM-NEXT:    mul s1, a1, s5
; RV64IM-NEXT:    mul t4, a1, t4
; RV64IM-NEXT:    xor t4, s1, t4
; RV64IM-NEXT:    sd t4, 264(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and t4, a3, s8
; RV64IM-NEXT:    mul t5, a1, t5
; RV64IM-NEXT:    mul a7, a1, a7
; RV64IM-NEXT:    xor a7, t5, a7
; RV64IM-NEXT:    sd a7, 256(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and a7, a3, ra
; RV64IM-NEXT:    xor t1, t1, a2
; RV64IM-NEXT:    sd t1, 704(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and t1, a3, s10
; RV64IM-NEXT:    xor a5, a5, a6
; RV64IM-NEXT:    sd a5, 696(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and a5, a3, s11
; RV64IM-NEXT:    xor a6, t0, t6
...
; RV64IM-NEXT:    sd a6, 680(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli a2, a4, 32
; RV64IM-NEXT:    sd a2, 736(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    mul a6, a0, t4
; RV64IM-NEXT:    mul a7, a0, a7
; RV64IM-NEXT:    xor a6, a6, a7
; RV64IM-NEXT:    sd a6, 672(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli a2, a4, 33
; RV64IM-NEXT:    sd a2, 744(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    mul a6, a0, t1
; RV64IM-NEXT:    mul a5, a0, a5
; RV64IM-NEXT:    xor a5, a6, a5
; RV64IM-NEXT:    sd a5, 664(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli t3, a4, 34
; RV64IM-NEXT:    sd t3, 88(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli t4, a4, 35
; RV64IM-NEXT:    sd t4, 96(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s3, a4, 36
; RV64IM-NEXT:    sd s3, 104(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s9, a4, 37
; RV64IM-NEXT:    sd s9, 112(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli a6, a4, 38
; RV64IM-NEXT:    sd a6, 120(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli a7, a4, 39
; RV64IM-NEXT:    sd a7, 128(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli t5, a4, 40
; RV64IM-NEXT:    sd t5, 136(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli t6, a4, 41
; RV64IM-NEXT:    sd t6, 144(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s0, a4, 42
; RV64IM-NEXT:    sd s0, 152(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s1, a4, 43
; RV64IM-NEXT:    sd s1, 160(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s2, a4, 44
; RV64IM-NEXT:    sd s2, 168(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s4, a4, 45
; RV64IM-NEXT:    sd s4, 176(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s5, a4, 46
; RV64IM-NEXT:    sd s5, 184(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s6, a4, 47
; RV64IM-NEXT:    sd s6, 192(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s7, a4, 48
; RV64IM-NEXT:    sd s7, 200(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s8, a4, 49
; RV64IM-NEXT:    sd s8, 216(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s10, a4, 50
; RV64IM-NEXT:    sd s10, 224(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s11, a4, 51
; RV64IM-NEXT:    sd s11, 232(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli ra, a4, 52
; RV64IM-NEXT:    sd ra, 240(sp) # 8-byte Folded Spill
...
; RV64IM-NEXT:    and a4, a3, a4
; RV64IM-NEXT:    mul a4, a0, a4
; RV64IM-NEXT:    sd a4, 512(sp) # 8-byte Folded Spill
...
; RV64IM-NEXT:    and a4, a3, a4
; RV64IM-NEXT:    ld a5, 752(sp) # 8-byte Folded Reload
...
; RV64IM-NEXT:    and t3, a3, t4
; RV64IM-NEXT:    and t4, a3, s3
; RV64IM-NEXT:    and s3, a3, s9
; RV64IM-NEXT:    and s9, a3, a6
; RV64IM-NEXT:    and a6, a3, a7
; RV64IM-NEXT:    and a7, a3, t5
; RV64IM-NEXT:    and t5, a3, t6
; RV64IM-NEXT:    and t6, a3, s0
; RV64IM-NEXT:    and s0, a3, s1
; RV64IM-NEXT:    and s1, a3, s2
; RV64IM-NEXT:    and s2, a3, s4
; RV64IM-NEXT:    and s4, a3, s5
; RV64IM-NEXT:    and s5, a3, s6
; RV64IM-NEXT:    and s6, a3, s7
; RV64IM-NEXT:    and s7, a3, s8
; RV64IM-NEXT:    and s8, a3, s10
; RV64IM-NEXT:    and s10, a3, s11
; RV64IM-NEXT:    and s11, a3, ra
...
; RV64IM-NEXT:    and a2, a3, a2
; RV64IM-NEXT:    sd a2, 440(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    ld a2, 808(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    and a2, a3, a2
; RV64IM-NEXT:    sd a2, 408(sp) # 8-byte Folded Spill
...
; RV64IM-NEXT:    ld a3, 584(sp) # 8-byte Folded Reload
...
; RV64IM-NEXT:    ld a3, 480(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    mul a3, a0, a3
; RV64IM-NEXT:    sd a3, 296(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    ld a3, 440(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    mul a3, a0, a3
; RV64IM-NEXT:    sd a3, 288(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    ld a3, 408(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    mul a3, a0, a3
; RV64IM-NEXT:    sd a3, 336(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    ld a3, 384(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    mul a3, a0, a3
...
; RV64IM-NEXT:    sd a0, 496(sp) # 8-byte Folded Spill
...
; RV64IM-NEXT:    and a0, t2, a0
; RV64IM-NEXT:    sd a0, 736(sp) # 8-byte Folded Spill
...
; RV64IM-NEXT:    ld a0, 840(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    and a2, t2, a0
; RV64IM-NEXT:    ld a0, 832(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    and a0, t2, a0
...
; RV64IM-NEXT:    mul s11, a1, t4
; RV64IM-NEXT:    mul a3, a1, a6
; RV64IM-NEXT:    sd a3, 64(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    mul a3, a1, t6
...
; RV64IM-NEXT:    ld a3, 744(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    mul s2, a1, a3
; RV64IM-NEXT:    ld a3, 736(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    mul a3, a1, a3
; RV64IM-NEXT:    sd a3, 80(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    ld a3, 96(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    mul a3, a1, a3
; RV64IM-NEXT:    sd a3, 96(sp) # 8-byte Folded Spill
...
; RV64IM-NEXT:    ld a2, 456(sp) # 8-byte Folded Reload
...
; RV64IM-NEXT:    ld a4, 320(sp) # 8-byte Folded Reload
...
; RV64IM-NEXT:    ld a6, 288(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a6, a0, a6
; RV64IM-NEXT:    ld a0, 280(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    ld a7, 272(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a7, a0, a7
; RV64IM-NEXT:    ld a0, 264(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    ld s8, 16(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a0, a0, s8
; RV64IM-NEXT:    ld s8, 8(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor s1, s1, s8
; RV64IM-NEXT:    ld s8, 256(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor s11, s8, s11
; RV64IM-NEXT:    ld s8, 248(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor s7, s8, s7
; RV64IM-NEXT:    ld s8, 208(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor s6, s8, s6
; RV64IM-NEXT:    xor s2, s3, s2
; RV64IM-NEXT:    xor t4, t6, t4
; RV64IM-NEXT:    xor t2, t3, t2
; RV64IM-NEXT:    xor t3, s9, ra
; RV64IM-NEXT:    xor t1, t1, t5
; RV64IM-NEXT:    ld t5, 624(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t5, s0, t5
; RV64IM-NEXT:    ld t6, 616(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t0, t0, t6
; RV64IM-NEXT:    ld t6, 600(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a1, a1, t6
; RV64IM-NEXT:    ld t6, 528(sp) # 8-byte Folded Reload
...
; RV64IM-NEXT:    ld t6, 368(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a5, a5, t6
; RV64IM-NEXT:    ld t6, 336(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a6, a6, t6
; RV64IM-NEXT:    xor a0, a7, a0
; RV64IM-NEXT:    ld a7, 72(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a7, s1, a7
; RV64IM-NEXT:    ld t6, 64(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t6, s11, t6
; RV64IM-NEXT:    ld s0, 48(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor s0, s7, s0
; RV64IM-NEXT:    ld s1, 24(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor s1, s6, s1
; RV64IM-NEXT:    ld s3, 80(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor s2, s2, s3
; RV64IM-NEXT:    ld s3, 144(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t4, t4, s3
; RV64IM-NEXT:    xor t2, t2, s5
; RV64IM-NEXT:    xor t3, t3, s4
; RV64IM-NEXT:    xor t1, t1, t5
; RV64IM-NEXT:    ld t5, 648(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t0, t0, t5
; RV64IM-NEXT:    ld t5, 632(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a1, a1, t5
; RV64IM-NEXT:    ld t5, 608(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a2, a2, t5
; RV64IM-NEXT:    ld t5, 424(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a3, a3, t5
; RV64IM-NEXT:    ld t5, 416(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a4, a4, t5
; RV64IM-NEXT:    ld t5, 400(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a5, a5, t5
; RV64IM-NEXT:    ld t5, 384(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a6, a6, t5
; RV64IM-NEXT:    xor a0, a0, a7
; RV64IM-NEXT:    ld a7, 240(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a7, t6, a7
...
; RV64IM-NEXT:    ld t1, 656(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a1, a1, t1
; RV64IM-NEXT:    ld t1, 640(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a2, a2, t1
; RV64IM-NEXT:    ld t1, 472(sp) # 8-byte Folded Reload
...
; RV64IM-NEXT:    ld t1, 408(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a6, a6, t1
; RV64IM-NEXT:    xor a0, a0, a7
; RV64IM-NEXT:    ld a7, 792(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a7, t5, a7
; RV64IM-NEXT:    ld t1, 776(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t1, t6, t1
; RV64IM-NEXT:    ld t5, 752(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t5, s0, t5
; RV64IM-NEXT:    ld t6, 224(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t4, t4, t6
...
; RV64IM-NEXT:    ld t0, 552(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a2, a2, t0
; RV64IM-NEXT:    ld t0, 520(sp) # 8-byte Folded Reload
...
; RV64IM-NEXT:    xor a5, a5, t0
; RV64IM-NEXT:    ld t0, 440(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a6, a6, t0
; RV64IM-NEXT:    xor a0, a0, a7
; RV64IM-NEXT:    ld a7, 824(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a7, t1, a7
; RV64IM-NEXT:    ld t0, 800(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t0, t5, t0
; RV64IM-NEXT:    ld t1, 760(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t1, t4, t1
; RV64IM-NEXT:    ld t4, 736(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t2, t2, t4
; RV64IM-NEXT:    ld t4, 200(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t3, t3, t4
; RV64IM-NEXT:    xor a1, a1, a2
; RV64IM-NEXT:    ld a2, 568(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a2, a3, a2
; RV64IM-NEXT:    ld a3, 536(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a3, a4, a3
; RV64IM-NEXT:    ld a4, 504(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a4, a5, a4
; RV64IM-NEXT:    ld a5, 480(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a5, a6, a5
; RV64IM-NEXT:    xor a0, a0, a7
; RV64IM-NEXT:    ld a6, 840(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a6, t0, a6
; RV64IM-NEXT:    ld a7, 816(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a7, t1, a7
; RV64IM-NEXT:    ld t0, 784(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t0, t2, t0
; RV64IM-NEXT:    ld t1, 744(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t1, t3, t1
; RV64IM-NEXT:    xor a1, a1, a2
; RV64IM-NEXT:    ld a2, 592(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a2, a3, a2
...
; RV64IM-NEXT:    xor a7, t1, a7
; RV64IM-NEXT:    xor a1, a1, a2
; RV64IM-NEXT:    ld a2, 584(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a2, a3, a2
; RV64IM-NEXT:    xor a0, a0, a5
...
; RV64IM-NEXT:    ld a2, 728(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    sd a1, 0(a2)
; RV64IM-NEXT:    sd a0, 8(a2)
...
; RV32IM:       # %bb.0:
; RV32IM-NEXT:    addi sp, sp, -768
; RV32IM-NEXT:    sw ra, 764(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    sw s0, 760(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    sw s1, 756(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    sw s2, 752(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    sw s3, 748(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    sw s4, 744(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    sw s5, 740(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    sw s6, 736(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    sw s7, 732(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    sw s8, 728(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    sw s9, 724(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    sw s10, 720(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    sw s11, 716(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    sw a3, 660(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    sw a2, 656(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw a2, 0(a0)
; RV32IM-NEXT:    lw s6, 4(a0)
; RV32IM-NEXT:    lw t1, 8(a0)
...
; RV32IM-NEXT:    or t6, a7, t6
; RV32IM-NEXT:    srli a7, a2, 8
; RV32IM-NEXT:    slli s1, s1, 8
; RV32IM-NEXT:    or s1, s3, s1
; RV32IM-NEXT:    srli s4, a2, 24
; RV32IM-NEXT:    and a6, a6, s10
; RV32IM-NEXT:    or s3, a6, a3
; RV32IM-NEXT:    and a6, a2, s10
; RV32IM-NEXT:    slli a3, a2, 24
; RV32IM-NEXT:    slli s2, s2, 8
; RV32IM-NEXT:    or s2, s6, s2
; RV32IM-NEXT:    srli s5, s0, 8
; RV32IM-NEXT:    and a0, a0, s10
; RV32IM-NEXT:    or a0, a0, a4
; RV32IM-NEXT:    srli s7, s0, 24
; RV32IM-NEXT:    slli a1, a1, 8
; RV32IM-NEXT:    or a1, a5, a1
; RV32IM-NEXT:    and s6, s0, s10
; RV32IM-NEXT:    slli s8, s0, 24
; RV32IM-NEXT:    and a2, a7, s10
; RV32IM-NEXT:    or a2, a2, s4
; RV32IM-NEXT:    srli a7, t4, 8
; RV32IM-NEXT:    slli a4, a6, 8
; RV32IM-NEXT:    or a4, a3, a4
; RV32IM-NEXT:    srli a3, t4, 24
; RV32IM-NEXT:    and a5, s5, s10
; RV32IM-NEXT:    or a5, a5, s7
; RV32IM-NEXT:    and s0, t4, s10
; RV32IM-NEXT:    slli t4, t4, 24
; RV32IM-NEXT:    slli s6, s6, 8
; RV32IM-NEXT:    or a6, s8, s6
; RV32IM-NEXT:    srli s4, t3, 8
; RV32IM-NEXT:    and a7, a7, s10
; RV32IM-NEXT:    or a3, a7, a3
; RV32IM-NEXT:    srli s5, t3, 24
; RV32IM-NEXT:    slli s0, s0, 8
; RV32IM-NEXT:    or a7, t4, s0
; RV32IM-NEXT:    and s0, t3, s10
; RV32IM-NEXT:    slli t3, t3, 24
; RV32IM-NEXT:    and t4, s4, s10
; RV32IM-NEXT:    or t4, t4, s5
; RV32IM-NEXT:    srli s4, t1, 8
; RV32IM-NEXT:    slli s0, s0, 8
; RV32IM-NEXT:    or s0, t3, s0
; RV32IM-NEXT:    srli t3, t1, 24
; RV32IM-NEXT:    and s4, s4, s10
; RV32IM-NEXT:    or s4, s4, t3
; RV32IM-NEXT:    and t3, t1, s10
; RV32IM-NEXT:    sw s10, 712(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    slli t1, t1, 24
; RV32IM-NEXT:    slli t3, t3, 8
; RV32IM-NEXT:    or s5, t1, t3
; RV32IM-NEXT:    or t6, s1, t6
; RV32IM-NEXT:    or s1, s2, s3
; RV32IM-NEXT:    or a0, a1, a0
; RV32IM-NEXT:    or a2, a4, a2
; RV32IM-NEXT:    or a1, a6, a5
; RV32IM-NEXT:    addi t2, t2, -241
; RV32IM-NEXT:    sw t2, 700(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    addi t1, t5, 819
; RV32IM-NEXT:    or a3, a7, a3
; RV32IM-NEXT:    addi t0, t0, 1365
; RV32IM-NEXT:    or a4, s0, t4
; RV32IM-NEXT:    or a5, s5, s4
; RV32IM-NEXT:    srli a6, t6, 4
; RV32IM-NEXT:    and a7, t6, t2
; RV32IM-NEXT:    srli t4, s1, 4
; RV32IM-NEXT:    and t5, s1, t2
...
; RV32IM-NEXT:    sw t1, 704(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    mv t1, t0
; RV32IM-NEXT:    sw t0, 708(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and a5, a6, t0
; RV32IM-NEXT:    srli a7, t4, 1
...
; RV32IM-NEXT:    and a7, a7, t0
; RV32IM-NEXT:    slli a2, a2, 1
; RV32IM-NEXT:    or a7, a7, a2
; RV32IM-NEXT:    srli a2, t5, 1
; RV32IM-NEXT:    and t4, t5, t0
; RV32IM-NEXT:    and a0, a0, t0
...
; RV32IM-NEXT:    and a2, a2, t0
; RV32IM-NEXT:    slli t4, t4, 1
; RV32IM-NEXT:    or t0, a2, t4
; RV32IM-NEXT:    srli t4, t6, 1
; RV32IM-NEXT:    and t5, t6, t1
; RV32IM-NEXT:    and a1, a1, t1
; RV32IM-NEXT:    slli a4, a4, 1
; RV32IM-NEXT:    and t4, t4, t1
...
; RV32IM-NEXT:    and s4, a7, a2
; RV32IM-NEXT:    sw s4, 504(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui s6, 256
; RV32IM-NEXT:    and s4, a7, s6
; RV32IM-NEXT:    sw s4, 496(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui s6, 512
; RV32IM-NEXT:    and s4, a7, s6
; RV32IM-NEXT:    sw s4, 484(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui s8, 1024
; RV32IM-NEXT:    and s4, a7, s8
; RV32IM-NEXT:    sw s4, 476(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and s4, a7, s7
; RV32IM-NEXT:    sw s4, 472(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and s4, a7, s10
; RV32IM-NEXT:    sw s4, 468(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and t5, a7, t5
; RV32IM-NEXT:    sw t5, 464(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and t5, a7, t6
; RV32IM-NEXT:    sw t5, 460(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and t5, a7, s0
; RV32IM-NEXT:    sw t5, 456(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and t1, a7, t1
; RV32IM-NEXT:    sw t1, 452(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and t1, a7, s11
; RV32IM-NEXT:    sw t1, 448(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and t1, a7, s2
; RV32IM-NEXT:    sw t1, 444(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and a7, a7, t4
; RV32IM-NEXT:    sw a7, 440(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    andi s6, a5, 2
; RV32IM-NEXT:    sw s6, 336(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    andi s7, a5, 1
; RV32IM-NEXT:    andi s0, a5, 4
; RV32IM-NEXT:    sw s0, 416(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    andi t6, a5, 8
; RV32IM-NEXT:    sw t6, 420(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    andi s8, a5, 16
; RV32IM-NEXT:    andi ra, a5, 32
; RV32IM-NEXT:    andi t1, a5, 64
; RV32IM-NEXT:    sw t1, 316(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    andi s10, a5, 128
; RV32IM-NEXT:    andi t4, a5, 256
; RV32IM-NEXT:    andi t5, a5, 512
; RV32IM-NEXT:    sw t5, 424(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    andi s9, a5, 1024
; RV32IM-NEXT:    sw s9, 324(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and s11, a5, s5
; RV32IM-NEXT:    and s2, a5, s1
; RV32IM-NEXT:    sw s2, 300(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and s1, a5, t3
; RV32IM-NEXT:    sw s1, 304(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and a7, a5, s3
; RV32IM-NEXT:    sw a7, 268(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui a7, 8
; RV32IM-NEXT:    and s4, a5, a7
; RV32IM-NEXT:    sw s4, 296(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and s5, a5, t2
; RV32IM-NEXT:    sw s5, 292(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui a7, 32
; RV32IM-NEXT:    and a7, a5, a7
; RV32IM-NEXT:    sw a7, 272(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui a7, 64
; RV32IM-NEXT:    and a7, a5, a7
; RV32IM-NEXT:    sw a7, 320(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and t2, a5, a2
; RV32IM-NEXT:    sw t2, 312(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui a2, 256
; RV32IM-NEXT:    and t3, a5, a2
; RV32IM-NEXT:    sw t3, 308(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui a2, 512
; RV32IM-NEXT:    and s3, a5, a2
; RV32IM-NEXT:    sw s3, 288(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    and a2, a5, a2
; RV32IM-NEXT:    sw a2, 260(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    sw a2, 436(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a2, a3, s7
; RV32IM-NEXT:    sw a2, 428(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a2, a3, s0
; RV32IM-NEXT:    sw a2, 692(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a2, a3, t6
; RV32IM-NEXT:    sw a2, 688(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    lw s2, 268(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a2, a3, s2
...
; RV32IM-NEXT:    sw a2, 432(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw s1, 272(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a2, a3, s1
...
; RV32IM-NEXT:    mul a2, a3, a7
; RV32IM-NEXT:    sw a2, 408(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw s4, 240(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a2, a3, s4
...
; RV32IM-NEXT:    lw t1, 260(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a2, a3, t1
; RV32IM-NEXT:    sw a2, 576(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw t2, 256(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a2, a3, t2
; RV32IM-NEXT:    sw a2, 612(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw t5, 252(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a2, a3, t5
; RV32IM-NEXT:    sw a2, 644(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw t6, 248(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a2, a3, t6
; RV32IM-NEXT:    sw a2, 652(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw s0, 244(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a2, a3, s0
...
; RV32IM-NEXT:    lw s6, 228(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a2, a3, s6
...
; RV32IM-NEXT:    mul a2, a6, a2
; RV32IM-NEXT:    sw a2, 488(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    mul a2, a6, s8
; RV32IM-NEXT:    sw a2, 280(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul ra, a6, ra
; RV32IM-NEXT:    lw a2, 316(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a2, a6, a2
; RV32IM-NEXT:    sw a2, 468(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a2, a6, s10
; RV32IM-NEXT:    sw a2, 568(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul s9, a6, t4
; RV32IM-NEXT:    lw a2, 424(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a2, a6, a2
; RV32IM-NEXT:    lw t3, 324(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul t4, a6, t3
; RV32IM-NEXT:    sw t4, 464(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul t4, a6, s11
; RV32IM-NEXT:    sw t4, 512(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw t3, 300(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul t4, a6, t3
; RV32IM-NEXT:    sw t4, 560(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw t3, 304(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul s8, a6, t3
; RV32IM-NEXT:    mul s11, a6, s2
; RV32IM-NEXT:    lw t3, 296(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul t3, a6, t3
; RV32IM-NEXT:    sw t3, 460(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw t3, 292(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul t3, a6, t3
; RV32IM-NEXT:    sw t3, 504(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul t3, a6, s1
; RV32IM-NEXT:    sw t3, 552(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw t3, 320(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul t3, a6, t3
; RV32IM-NEXT:    sw t3, 600(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw t3, 312(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul s7, a6, t3
; RV32IM-NEXT:    lw t3, 308(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul t4, a6, t3
; RV32IM-NEXT:    lw t3, 288(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul t3, a6, t3
; RV32IM-NEXT:    sw t3, 456(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul t3, a6, a7
; RV32IM-NEXT:    sw t3, 496(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul t3, a6, s4
; RV32IM-NEXT:    sw t3, 544(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul s1, a6, s3
; RV32IM-NEXT:    mul t3, a6, t1
; RV32IM-NEXT:    mul s2, a6, t2
; RV32IM-NEXT:    sw s2, 452(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul s2, a6, t5
; RV32IM-NEXT:    sw s2, 484(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul s2, a6, t6
; RV32IM-NEXT:    sw s2, 528(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul s2, a6, s0
; RV32IM-NEXT:    sw s2, 580(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul s2, a6, s5
; RV32IM-NEXT:    sw s2, 608(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul s2, a6, s6
; RV32IM-NEXT:    sw s2, 624(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    slli s3, a6, 24
; RV32IM-NEXT:    lw s10, 712(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    and a6, a6, s10
; RV32IM-NEXT:    slli a6, a6, 8
; RV32IM-NEXT:    or a6, s3, a6
; RV32IM-NEXT:    sw a6, 448(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    srli a6, a5, 8
; RV32IM-NEXT:    and a6, a6, s10
; RV32IM-NEXT:    srli s3, a5, 24
; RV32IM-NEXT:    or a6, a6, s3
; RV32IM-NEXT:    sw a6, 444(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    lw a5, 436(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    lw a6, 688(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a5, a5, a6
; RV32IM-NEXT:    sw a5, 428(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw a5, 684(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw a6, 680(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a5, a5, a6
; RV32IM-NEXT:    sw a5, 424(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw a5, 676(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw a6, 672(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a5, a5, a6
; RV32IM-NEXT:    sw a5, 420(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw a5, 668(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw a6, 664(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a5, a5, a6
...
; RV32IM-NEXT:    sw a3, 364(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    xor a2, s9, a2
; RV32IM-NEXT:    sw a2, 360(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    xor a2, s8, s11
; RV32IM-NEXT:    sw a2, 356(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    xor a2, s7, t4
; RV32IM-NEXT:    sw a2, 352(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    xor a2, s1, t3
; RV32IM-NEXT:    sw a2, 348(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    lw a2, 696(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    andi a4, t0, 8
; RV32IM-NEXT:    sw a4, 672(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    andi a4, t0, 16
; RV32IM-NEXT:    sw a4, 684(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    andi a4, t0, 32
; RV32IM-NEXT:    sw a4, 680(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    andi a4, t0, 64
; RV32IM-NEXT:    sw a4, 688(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    andi a4, t0, 128
; RV32IM-NEXT:    sw a4, 692(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    andi s3, t0, 256
; RV32IM-NEXT:    sw s3, 24(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    andi s4, t0, 512
; RV32IM-NEXT:    andi s2, t0, 1024
; RV32IM-NEXT:    sw s2, 28(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    and t5, t0, a6
; RV32IM-NEXT:    sw t5, 48(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and t6, t0, a7
; RV32IM-NEXT:    and t4, t0, t4
; RV32IM-NEXT:    sw t4, 56(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui a2, 16
; RV32IM-NEXT:    and a7, t0, a2
; RV32IM-NEXT:    sw a7, 60(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui a2, 32
; RV32IM-NEXT:    and a6, t0, a2
...
; RV32IM-NEXT:    and a4, t0, s11
; RV32IM-NEXT:    and ra, t0, ra
; RV32IM-NEXT:    and s11, t0, s9
; RV32IM-NEXT:    and s9, t0, s7
; RV32IM-NEXT:    and s7, t0, s8
; RV32IM-NEXT:    and s8, t0, t3
; RV32IM-NEXT:    and t3, t0, t2
; RV32IM-NEXT:    and t2, t0, t1
; RV32IM-NEXT:    and t1, t0, s5
; RV32IM-NEXT:    and s5, t0, s10
; RV32IM-NEXT:    and s10, t0, s6
; RV32IM-NEXT:    and s6, t0, a3
...
; RV32IM-NEXT:    lw a3, 684(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a3, a1, a3
; RV32IM-NEXT:    sw a3, 244(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw a3, 680(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a3, a1, a3
; RV32IM-NEXT:    sw a3, 240(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw a3, 688(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a3, a1, a3
; RV32IM-NEXT:    sw a3, 188(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw a3, 692(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a3, a1, a3
...
; RV32IM-NEXT:    sw a3, 332(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    mv a7, s5
; RV32IM-NEXT:    mul a3, a1, s10
; RV32IM-NEXT:    sw a3, 156(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mv a6, s10
; RV32IM-NEXT:    mul a1, a1, s6
; RV32IM-NEXT:    sw a1, 136(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mv a5, s6
; RV32IM-NEXT:    lw a1, 328(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a1, a0, a1
...
; RV32IM-NEXT:    mul a1, a0, a1
; RV32IM-NEXT:    sw a1, 328(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    mul a1, a0, a1
; RV32IM-NEXT:    sw a1, 80(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw a1, 684(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a1, a0, a1
; RV32IM-NEXT:    sw a1, 76(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    lw a1, 692(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a1, a0, a1
; RV32IM-NEXT:    sw a1, 680(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    sw a1, 672(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a1, a0, a6
; RV32IM-NEXT:    sw a1, 684(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    and a0, a0, t4
; RV32IM-NEXT:    srli a2, t0, 24
; RV32IM-NEXT:    or a6, a0, a2
; RV32IM-NEXT:    slli a2, t0, 24
...
; RV32IM-NEXT:    xor s2, s4, s5
; RV32IM-NEXT:    lw a0, 96(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor s4, s10, a0
; RV32IM-NEXT:    lw a0, 88(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw a1, 664(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t6, a1, a0
; RV32IM-NEXT:    lw a0, 84(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw a1, 80(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    sw a0, 404(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw a0, 236(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a0, s4, a0
; RV32IM-NEXT:    sw a0, 532(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    xor a0, t6, s5
; RV32IM-NEXT:    sw a0, 400(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    xor s9, s10, s6
; RV32IM-NEXT:    lw a0, 244(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor s10, a0, s3
; RV32IM-NEXT:    lw a0, 240(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    xor t6, a0, a1
; RV32IM-NEXT:    lw a0, 512(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw s0, 464(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor s0, s0, a0
; RV32IM-NEXT:    lw a0, 504(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw s1, 460(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor s1, s1, a0
; RV32IM-NEXT:    lw a0, 496(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    lw a3, 408(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a2, a3, a2
; RV32IM-NEXT:    lw a3, 280(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw a4, 404(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a3, a4, a3
...
; RV32IM-NEXT:    lw s6, 604(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor s5, s5, s6
; RV32IM-NEXT:    sw s5, 604(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw s5, 628(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw s6, 596(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor s6, s6, s5
; RV32IM-NEXT:    lw s5, 620(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    lw t2, 572(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t2, t5, t2
; RV32IM-NEXT:    lw t5, 568(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t6, t6, t5
; RV32IM-NEXT:    lw t5, 560(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    sw t5, 628(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    lw a0, 668(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    lw t6, 608(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    lw a6, 628(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t2, t4, a6
; RV32IM-NEXT:    lw t3, 624(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t3, t6, t3
...
; RV32IM-NEXT:    lw t4, 664(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a5, a5, t4
...
; RV32IM-NEXT:    lw t5, 540(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t0, t0, t5
; RV32IM-NEXT:    lw t5, 532(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a1, a1, t5
...
; RV32IM-NEXT:    lw t1, 712(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    mul a0, a1, t6
; RV32IM-NEXT:    sw a0, 616(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw a0, 672(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a0, a1, a0
; RV32IM-NEXT:    sw a0, 640(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    sw t0, 500(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul t0, t5, s0
; RV32IM-NEXT:    sw t0, 496(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    lw s5, 700(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    and a1, a1, s5
; RV32IM-NEXT:    and a0, a0, s5
; RV32IM-NEXT:    slli a1, a1, 4
; RV32IM-NEXT:    or a0, a0, a1
; RV32IM-NEXT:    lw a1, 500(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw t5, 496(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a1, t5, a1
; RV32IM-NEXT:    lw t5, 488(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t6, t5, t6
; RV32IM-NEXT:    xor t4, s3, t4
; RV32IM-NEXT:    xor t1, s0, t1
; RV32IM-NEXT:    xor t0, s1, t0
; RV32IM-NEXT:    xor t3, s2, t3
; RV32IM-NEXT:    xor s0, s9, s10
; RV32IM-NEXT:    lw s2, 684(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    xor a2, a2, t3
; RV32IM-NEXT:    lw t3, 644(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a3, a3, t3
; RV32IM-NEXT:    lw t3, 636(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a4, a4, t3
...
; RV32IM-NEXT:    lw t3, 552(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a1, a1, t3
...
; RV32IM-NEXT:    slli t4, t4, 2
; RV32IM-NEXT:    or t3, t3, t4
; RV32IM-NEXT:    lw t4, 676(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a3, a3, t4
; RV32IM-NEXT:    lw t4, 652(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a5, a5, t4
; RV32IM-NEXT:    lw t4, 696(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t0, t0, t4
; RV32IM-NEXT:    lw t4, 524(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t2, t2, t4
...
; RV32IM-NEXT:    lw a2, 672(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t2, a3, a2
; RV32IM-NEXT:    srli a3, a0, 1
; RV32IM-NEXT:    xor t1, a5, t1
; RV32IM-NEXT:    srli a2, t3, 1
; RV32IM-NEXT:    lw t5, 708(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    and a0, a0, t5
; RV32IM-NEXT:    and a5, t3, t5
; RV32IM-NEXT:    lw a4, 492(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    srli a1, a1, 1
; RV32IM-NEXT:    lw a7, 692(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a6, a6, a7
; RV32IM-NEXT:    lw a7, 688(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a1, a1, a7
...
; RV32IM-NEXT:    sw a0, 8(a2)
; RV32IM-NEXT:    sw a5, 12(a2)
; RV32IM-NEXT:    lw ra, 764(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw s0, 760(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw s1, 756(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw s2, 752(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw s3, 748(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw s4, 744(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw s5, 740(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw s6, 736(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw s7, 732(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw s8, 728(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw s9, 724(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw s10, 720(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw s11, 716(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    addi sp, sp, 768
; RV32IM-NEXT:    ret
;
...
; RV64IM-NEXT:    sd a5, 976(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    sd a4, 968(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    mv s5, a0
; RV64IM-NEXT:    srli a7, a2, 24
; RV64IM-NEXT:    lui s10, 4080
...
; RV64IM-NEXT:    lui s0, 61681
; RV64IM-NEXT:    lui ra, 209715
; RV64IM-NEXT:    lui s4, 349525
; RV64IM-NEXT:    srli t2, s5, 24
; RV64IM-NEXT:    srli s3, s5, 8
; RV64IM-NEXT:    srli a6, s5, 40
; RV64IM-NEXT:    srli t6, s5, 56
; RV64IM-NEXT:    srliw s1, s5, 24
; RV64IM-NEXT:    slli t3, s5, 56
; RV64IM-NEXT:    li t5, 1
...
; RV64IM-NEXT:    slli s2, t4, 24
; RV64IM-NEXT:    and t0, t0, s2
; RV64IM-NEXT:    or a7, t0, a7
; RV64IM-NEXT:    addi a0, s11, -256
; RV64IM-NEXT:    and a4, a4, a0
; RV64IM-NEXT:    or a5, a4, a5
; RV64IM-NEXT:    and a4, a2, s10
; RV64IM-NEXT:    slli t1, t1, 32
; RV64IM-NEXT:    addi t0, s0, -241
; RV64IM-NEXT:    addi t4, ra, 819
; RV64IM-NEXT:    addi s0, s4, 1365
; RV64IM-NEXT:    slli a4, a4, 24
; RV64IM-NEXT:    or a4, a4, t1
; RV64IM-NEXT:    slli t1, t0, 32
; RV64IM-NEXT:    add ra, t0, t1
; RV64IM-NEXT:    slli t0, t4, 32
; RV64IM-NEXT:    add s11, t4, t0
; RV64IM-NEXT:    slli t0, s0, 32
; RV64IM-NEXT:    add s4, s0, t0
; RV64IM-NEXT:    srliw t1, a3, 24
; RV64IM-NEXT:    and t0, t2, s10
; RV64IM-NEXT:    and t2, s3, s2
; RV64IM-NEXT:    or t0, t2, t0
; RV64IM-NEXT:    srli t2, a1, 24
; RV64IM-NEXT:    and a6, a6, a0
; RV64IM-NEXT:    or t4, a6, t6
; RV64IM-NEXT:    and a6, s5, s10
; RV64IM-NEXT:    slli s1, s1, 32
; RV64IM-NEXT:    slli a6, a6, 24
; RV64IM-NEXT:    or a6, a6, s1
; RV64IM-NEXT:    srli t6, a1, 8
; RV64IM-NEXT:    and s0, s7, s10
; RV64IM-NEXT:    mv s7, s2
; RV64IM-NEXT:    sd s2, 960(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and s1, s9, s2
; RV64IM-NEXT:    or s0, s1, s0
; RV64IM-NEXT:    srli s1, a1, 40
; RV64IM-NEXT:    and s2, s6, a0
; RV64IM-NEXT:    or s2, s2, s8
; RV64IM-NEXT:    and s3, a3, s10
; RV64IM-NEXT:    slli t1, t1, 32
; RV64IM-NEXT:    slli s3, s3, 24
; RV64IM-NEXT:    or t1, s3, t1
; RV64IM-NEXT:    srli s3, a1, 56
; RV64IM-NEXT:    and t2, t2, s10
; RV64IM-NEXT:    and t6, t6, s7
; RV64IM-NEXT:    or t2, t6, t2
; RV64IM-NEXT:    srliw t6, a1, 24
; RV64IM-NEXT:    mv s6, a0
; RV64IM-NEXT:    sd a0, 944(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and s1, s1, a0
; RV64IM-NEXT:    or s1, s1, s3
; RV64IM-NEXT:    and s3, a1, s10
; RV64IM-NEXT:    slli t6, t6, 32
; RV64IM-NEXT:    slli s3, s3, 24
; RV64IM-NEXT:    or t6, s3, t6
; RV64IM-NEXT:    slli s3, a3, 56
; RV64IM-NEXT:    or a5, a7, a5
; RV64IM-NEXT:    slli a7, a1, 56
; RV64IM-NEXT:    and a2, a2, a0
; RV64IM-NEXT:    slli a2, a2, 40
; RV64IM-NEXT:    ld a0, 1088(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    or a2, a0, a2
; RV64IM-NEXT:    slli a0, t5, 11
; RV64IM-NEXT:    sd a0, 984(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    or t0, t0, t4
; RV64IM-NEXT:    slli a0, t5, 31
; RV64IM-NEXT:    sd a0, 1040(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and a0, s5, s6
; RV64IM-NEXT:    slli a0, a0, 40
; RV64IM-NEXT:    or a0, t3, a0
; RV64IM-NEXT:    slli t3, t5, 32
; RV64IM-NEXT:    sd t3, 1032(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    or t3, s0, s2
; RV64IM-NEXT:    slli t4, t5, 33
; RV64IM-NEXT:    sd t4, 1024(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and a3, a3, s6
; RV64IM-NEXT:    slli a3, a3, 40
; RV64IM-NEXT:    or a3, s3, a3
; RV64IM-NEXT:    slli t4, t5, 34
; RV64IM-NEXT:    sd t4, 1000(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    or t2, t2, s1
; RV64IM-NEXT:    slli t4, t5, 35
; RV64IM-NEXT:    sd t4, 1016(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and a1, a1, s6
; RV64IM-NEXT:    slli a1, a1, 40
; RV64IM-NEXT:    or a1, a7, a1
; RV64IM-NEXT:    slli a7, t5, 36
; RV64IM-NEXT:    sd a7, 992(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    or a2, a2, a4
; RV64IM-NEXT:    slli a4, t5, 37
; RV64IM-NEXT:    sd a4, 1008(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    or a0, a0, a6
; RV64IM-NEXT:    slli a4, t5, 38
; RV64IM-NEXT:    sd a4, 1048(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    or a3, a3, t1
; RV64IM-NEXT:    slli a4, t5, 39
; RV64IM-NEXT:    sd a4, 1056(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    or a1, a1, t6
; RV64IM-NEXT:    slli a4, t5, 40
; RV64IM-NEXT:    sd a4, 1072(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    or a2, a2, a5
; RV64IM-NEXT:    slli a4, t5, 41
; RV64IM-NEXT:    sd a4, 1064(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    or a0, a0, t0
; RV64IM-NEXT:    slli a4, t5, 42
; RV64IM-NEXT:    sd a4, 1080(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    or a3, a3, t3
; RV64IM-NEXT:    slli a4, t5, 43
; RV64IM-NEXT:    sd a4, 1088(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    or a1, a1, t2
; RV64IM-NEXT:    srli a4, a2, 4
; RV64IM-NEXT:    sd ra, 952(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and a2, a2, ra
; RV64IM-NEXT:    and a4, a4, ra
; RV64IM-NEXT:    slli a2, a2, 4
; RV64IM-NEXT:    or a2, a4, a2
; RV64IM-NEXT:    srli a4, a0, 4
...
; RV64IM-NEXT:    slli s8, t5, 44
; RV64IM-NEXT:    sd s8, 408(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s7, t5, 45
; RV64IM-NEXT:    sd s7, 416(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s6, t5, 46
; RV64IM-NEXT:    sd s6, 424(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s5, t5, 47
; RV64IM-NEXT:    sd s5, 432(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s4, t5, 48
; RV64IM-NEXT:    sd s4, 440(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    slli s3, t5, 49
; RV64IM-NEXT:    slli s2, t5, 50
; RV64IM-NEXT:    slli s1, t5, 51
; RV64IM-NEXT:    slli s0, t5, 52
; RV64IM-NEXT:    slli t6, t5, 53
; RV64IM-NEXT:    slli t4, t5, 54
; RV64IM-NEXT:    slli t3, t5, 55
; RV64IM-NEXT:    slli t2, t5, 56
; RV64IM-NEXT:    slli t1, t5, 57
; RV64IM-NEXT:    slli t0, t5, 58
; RV64IM-NEXT:    slli a7, t5, 59
; RV64IM-NEXT:    slli a5, t5, 60
; RV64IM-NEXT:    slli a3, t5, 61
; RV64IM-NEXT:    slli t5, t5, 62
; RV64IM-NEXT:    li a1, -1
; RV64IM-NEXT:    slli a2, a1, 63
; RV64IM-NEXT:    lui ra, 2
; RV64IM-NEXT:    lui s10, 4
; RV64IM-NEXT:    lui s9, 8
...
; RV64IM-NEXT:    and a1, a6, a1
; RV64IM-NEXT:    sd a1, 776(sp) # 8-byte Folded Spill
...
; RV64IM-NEXT:    mul a7, a4, a1
; RV64IM-NEXT:    sd a7, 872(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    ld a1, 856(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    mul t6, a4, a1
; RV64IM-NEXT:    ld a1, 848(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    mul s0, a4, a1
...
; RV64IM-NEXT:    mul a7, a4, a1
; RV64IM-NEXT:    sd a7, 768(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    ld a1, 824(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    mul a7, a4, a1
; RV64IM-NEXT:    sd a7, 848(sp) # 8-byte Folded Spill
...
; RV64IM-NEXT:    mul a7, a4, a1
; RV64IM-NEXT:    sd a7, 744(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    mul a7, a4, s9
; RV64IM-NEXT:    sd a7, 824(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    mul a7, a4, s10
; RV64IM-NEXT:    sd a7, 896(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    mul a1, a4, ra
...
; RV64IM-NEXT:    ld a1, 776(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    mul a1, a4, a1
...
; RV64IM-NEXT:    ld a1, 752(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    mul a1, a4, a1
; RV64IM-NEXT:    sd a1, 800(sp) # 8-byte Folded Spill
...
; RV64IM-NEXT:    mul a1, a4, a1
; RV64IM-NEXT:    sd a1, 712(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    ld a1, 680(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    mul a1, a4, a1
; RV64IM-NEXT:    sd a1, 792(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    ld a1, 664(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    mul a1, a4, a1
; RV64IM-NEXT:    sd a1, 856(sp) # 8-byte Folded Spill
...
; RV64IM-NEXT:    mul a1, a4, a1
; RV64IM-NEXT:    sd a1, 592(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    ld a1, 520(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    mul a1, a4, a1
; RV64IM-NEXT:    sd a1, 680(sp) # 8-byte Folded Spill
...
; RV64IM-NEXT:    mul a1, a4, a1
; RV64IM-NEXT:    sd a1, 776(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    mul a1, a4, a6
; RV64IM-NEXT:    sd a1, 832(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    ld a1, 984(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    and s9, s11, a1
; RV64IM-NEXT:    lui a1, 1
...
; RV64IM-NEXT:    sd a1, 984(sp) # 8-byte Folded Spill
...
; RV64IM-NEXT:    sd a0, 1024(sp) # 8-byte Folded Spill
...
; RV64IM-NEXT:    ld a0, 584(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    ld a1, 568(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t6, a0, a1
; RV64IM-NEXT:    ld a0, 552(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    ld s0, 544(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor s0, a0, s0
; RV64IM-NEXT:    ld a0, 536(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    ld a5, 528(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a5, a0, a5
; RV64IM-NEXT:    ld a0, 512(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    ld a1, 504(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a6, a0, a1
; RV64IM-NEXT:    ld a0, 488(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    ld a1, 480(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a7, a0, a1
; RV64IM-NEXT:    ld a0, 472(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    ld a1, 464(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t0, a0, a1
; RV64IM-NEXT:    ld a0, 456(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    ld a1, 448(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t1, a0, a1
; RV64IM-NEXT:    ld a0, 104(sp) # 8-byte Folded Reload
...
; RV64IM-NEXT:    ld s1, 704(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t4, t4, s1
; RV64IM-NEXT:    ld s1, 688(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t5, t5, s1
; RV64IM-NEXT:    ld s1, 672(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t6, t6, s1
; RV64IM-NEXT:    ld s1, 656(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor s0, s0, s1
; RV64IM-NEXT:    ld s1, 640(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a5, a5, s1
; RV64IM-NEXT:    ld s1, 592(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a6, a6, s1
; RV64IM-NEXT:    ld s1, 560(sp) # 8-byte Folded Reload
...
; RV64IM-NEXT:    xor t3, t3, t4
; RV64IM-NEXT:    ld t4, 768(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t4, t5, t4
; RV64IM-NEXT:    ld t5, 744(sp) # 8-byte Folded Reload
...
; RV64IM-NEXT:    xor a5, a5, s0
; RV64IM-NEXT:    ld s0, 680(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a6, a6, s0
; RV64IM-NEXT:    ld s0, 648(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a7, a7, s0
; RV64IM-NEXT:    ld s0, 600(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t0, t0, s0
; RV64IM-NEXT:    ld s0, 576(sp) # 8-byte Folded Reload
...
; RV64IM-NEXT:    ld t3, 848(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t3, t4, t3
; RV64IM-NEXT:    ld t4, 824(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t4, t5, t4
; RV64IM-NEXT:    ld t5, 800(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t5, t6, t5
; RV64IM-NEXT:    ld t6, 792(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a5, a5, t6
; RV64IM-NEXT:    ld t6, 760(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a6, a6, t6
; RV64IM-NEXT:    ld t6, 728(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a7, a7, t6
; RV64IM-NEXT:    ld t6, 696(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t0, t0, t6
; RV64IM-NEXT:    ld t6, 664(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t1, t1, t6
; RV64IM-NEXT:    ld t6, 440(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a0, a0, t6
; RV64IM-NEXT:    ld t6, 432(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a2, a2, t6
...
; RV64IM-NEXT:    ld t6, 376(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t6, s0, t6
; RV64IM-NEXT:    ld s0, 408(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor s0, s1, s0
; RV64IM-NEXT:    ld s1, 352(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor s1, s3, s1
; RV64IM-NEXT:    ld s3, 336(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor s2, s2, s3
; RV64IM-NEXT:    ld s3, 896(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t4, t4, s3
; RV64IM-NEXT:    ld s3, 856(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a5, a5, s3
; RV64IM-NEXT:    ld s3, 816(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a6, a6, s3
; RV64IM-NEXT:    ld s3, 784(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a7, a7, s3
; RV64IM-NEXT:    ld s3, 752(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t0, t0, s3
; RV64IM-NEXT:    ld s3, 720(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t1, t1, s3
; RV64IM-NEXT:    ld s3, 1064(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a3, a3, s3
; RV64IM-NEXT:    ld s3, 984(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t2, t2, s3
; RV64IM-NEXT:    ld s3, 1016(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t6, t6, s3
; RV64IM-NEXT:    ld s3, 1000(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor s0, s0, s3
; RV64IM-NEXT:    ld s3, 424(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor s1, s1, s3
; RV64IM-NEXT:    ld s3, 416(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor s2, s2, s3
; RV64IM-NEXT:    xor t3, a1, t3
; RV64IM-NEXT:    xor t3, t3, t4
; RV64IM-NEXT:    ld t4, 904(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a5, a5, t4
; RV64IM-NEXT:    ld t4, 880(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a6, a6, t4
; RV64IM-NEXT:    ld t4, 840(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a7, a7, t4
; RV64IM-NEXT:    ld t4, 808(sp) # 8-byte Folded Reload
...
; RV64IM-NEXT:    ld t2, 1048(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t2, t6, t2
; RV64IM-NEXT:    ld t4, 1032(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t4, s0, t4
; RV64IM-NEXT:    ld t6, 1008(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t6, s1, t6
; RV64IM-NEXT:    ld s0, 992(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor s0, s2, s0
; RV64IM-NEXT:    xor t3, t3, t5
; RV64IM-NEXT:    ld t5, 920(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a5, a5, t5
; RV64IM-NEXT:    ld t5, 912(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a6, a6, t5
; RV64IM-NEXT:    ld t5, 888(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor a7, a7, t5
; RV64IM-NEXT:    ld t5, 864(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t0, t0, t5
; RV64IM-NEXT:    ld t5, 832(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t1, t1, t5
; RV64IM-NEXT:    xor a2, a2, a4
...
; RV64IM-NEXT:    xor t4, t6, t4
; RV64IM-NEXT:    ld t5, 1024(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    xor t5, s0, t5
...
; RV64IM-NEXT:    ld t6, 944(sp) # 8-byte Folded Reload
...
; RV64IM-NEXT:    ld a6, 960(sp) # 8-byte Folded Reload
...
; RV64IM-NEXT:    srli a0, a0, 1
; RV64IM-NEXT:    ld a2, 968(sp) # 8-byte Folded Reload
; RV64IM-NEXT:    sd a1, 0(a2)
; RV64IM-NEXT:    sd a0, 8(a2)
...
; RV32IM-NEXT:    srli s1, s2, 24
; RV32IM-NEXT:    and a3, s2, s10
...
; RV32IM-NEXT:    and a0, a0, s10
; RV32IM-NEXT:    or a0, a0, s1
; RV32IM-NEXT:    srli s1, a5, 8
; RV32IM-NEXT:    slli a3, a3, 8
; RV32IM-NEXT:    or a3, s2, a3
; RV32IM-NEXT:    srli s4, a5, 24
; RV32IM-NEXT:    and a4, a4, s10
; RV32IM-NEXT:    or a4, a4, a6
; RV32IM-NEXT:    and a6, a5, s10
; RV32IM-NEXT:    slli s2, a5, 24
...
; RV32IM-NEXT:    and a1, s1, s10
; RV32IM-NEXT:    or a1, a1, s4
; RV32IM-NEXT:    srli t6, a2, 8
; RV32IM-NEXT:    slli a6, a6, 8
; RV32IM-NEXT:    or t4, s2, a6
...
; RV32IM-NEXT:    srli s6, t3, 24
; RV32IM-NEXT:    slli a6, a6, 8
; RV32IM-NEXT:    or s0, s2, a6
; RV32IM-NEXT:    and s1, t3, s10
; RV32IM-NEXT:    slli t3, t3, 24
; RV32IM-NEXT:    and a6, s4, s10
; RV32IM-NEXT:    or a6, a6, s6
; RV32IM-NEXT:    srli s2, t1, 8
; RV32IM-NEXT:    slli s1, s1, 8
; RV32IM-NEXT:    or s1, t3, s1
; RV32IM-NEXT:    srli t3, t1, 24
; RV32IM-NEXT:    and s2, s2, s10
; RV32IM-NEXT:    or s2, s2, t3
; RV32IM-NEXT:    and t3, t1, s10
; RV32IM-NEXT:    sw s10, 744(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    slli t1, t1, 24
; RV32IM-NEXT:    slli t3, t3, 8
; RV32IM-NEXT:    or s4, t1, t3
; RV32IM-NEXT:    or a0, a3, a0
; RV32IM-NEXT:    or a4, a5, a4
; RV32IM-NEXT:    or a3, t0, a7
; RV32IM-NEXT:    or a1, t4, a1
; RV32IM-NEXT:    or a2, a2, t5
; RV32IM-NEXT:    addi t3, t2, -241
; RV32IM-NEXT:    sw t3, 732(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    addi t2, s3, 819
; RV32IM-NEXT:    or a5, s0, t6
; RV32IM-NEXT:    addi t1, s11, 1365
; RV32IM-NEXT:    or a6, s1, a6
; RV32IM-NEXT:    or a7, s4, s2
...
; RV32IM-NEXT:    sw t2, 736(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and a0, a0, t2
...
; RV32IM-NEXT:    srli a2, a0, 1
; RV32IM-NEXT:    sw t1, 740(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and a0, a0, t1
...
; RV32IM-NEXT:    srli a3, t0, 1
; RV32IM-NEXT:    and t0, t0, t1
; RV32IM-NEXT:    and a0, a7, t1
; RV32IM-NEXT:    slli t5, t5, 1
...
; RV32IM-NEXT:    and t1, a0, s7
; RV32IM-NEXT:    sw t1, 528(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui s2, 32
; RV32IM-NEXT:    and t1, a0, s2
; RV32IM-NEXT:    sw t1, 524(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui t6, 64
; RV32IM-NEXT:    and t1, a0, t6
; RV32IM-NEXT:    sw t1, 520(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui s10, 128
; RV32IM-NEXT:    and t1, a0, s10
...
; RV32IM-NEXT:    and t1, a0, t5
; RV32IM-NEXT:    sw t1, 508(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui t1, 1024
; RV32IM-NEXT:    and s1, a0, t1
; RV32IM-NEXT:    sw s1, 504(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and s1, a0, s8
; RV32IM-NEXT:    sw s1, 500(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and s1, a0, s4
; RV32IM-NEXT:    sw s1, 496(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and s1, a0, s5
; RV32IM-NEXT:    lui s8, 8192
; RV32IM-NEXT:    sw s1, 492(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and s1, a0, s9
; RV32IM-NEXT:    sw s1, 488(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and s1, a0, ra
; RV32IM-NEXT:    sw s1, 484(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and s1, a0, s3
; RV32IM-NEXT:    sw s1, 480(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and s1, a0, s6
; RV32IM-NEXT:    sw s1, 476(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui s1, 262144
; RV32IM-NEXT:    and s1, a0, s1
; RV32IM-NEXT:    sw s1, 472(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    sw a0, 724(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and s1, a4, t0
; RV32IM-NEXT:    sw s1, 540(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and ra, a4, s0
; RV32IM-NEXT:    and s4, a4, t2
; RV32IM-NEXT:    and s5, a4, t3
; RV32IM-NEXT:    and s3, a4, t4
; RV32IM-NEXT:    and s9, a4, s7
; RV32IM-NEXT:    and s6, a4, s2
; RV32IM-NEXT:    and s0, a4, t6
; RV32IM-NEXT:    and s10, a4, s10
; RV32IM-NEXT:    and s11, a4, s11
; RV32IM-NEXT:    and t6, a4, t5
; RV32IM-NEXT:    and t5, a4, t1
; RV32IM-NEXT:    lui a0, 2048
; RV32IM-NEXT:    and t4, a4, a0
; RV32IM-NEXT:    lui a0, 4096
; RV32IM-NEXT:    and t2, a4, a0
; RV32IM-NEXT:    and t3, a4, s8
; RV32IM-NEXT:    lui a0, 16384
...
; RV32IM-NEXT:    sw a0, 420(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui a0, 131072
; RV32IM-NEXT:    and s8, a4, a0
; RV32IM-NEXT:    lui a0, 262144
; RV32IM-NEXT:    and s7, a4, a0
; RV32IM-NEXT:    lui a0, 524288
; RV32IM-NEXT:    and s2, a4, a0
; RV32IM-NEXT:    lw a0, 688(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a0, a1, a0
; RV32IM-NEXT:    sw a0, 428(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    andi s2, a7, 256
; RV32IM-NEXT:    andi s11, a7, 512
; RV32IM-NEXT:    andi s1, a7, 1024
; RV32IM-NEXT:    and t5, a7, a0
; RV32IM-NEXT:    and a0, a7, t3
; RV32IM-NEXT:    sw a0, 704(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and t3, a7, t6
; RV32IM-NEXT:    and t6, a7, s0
; RV32IM-NEXT:    and s3, a7, s5
; RV32IM-NEXT:    and s0, a7, t4
; RV32IM-NEXT:    and s5, a7, s6
; RV32IM-NEXT:    and s6, a7, s7
; RV32IM-NEXT:    and t4, a7, s8
; RV32IM-NEXT:    and a0, a7, s10
; RV32IM-NEXT:    sw a0, 8(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui a0, 512
...
; RV32IM-NEXT:    mv a4, s10
; RV32IM-NEXT:    sw a0, 428(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a0, a6, s9
; RV32IM-NEXT:    mv a2, s9
; RV32IM-NEXT:    sw a0, 440(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw a0, 716(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a0, a6, a0
; RV32IM-NEXT:    sw a0, 168(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    sw a0, 48(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a0, a3, s1
; RV32IM-NEXT:    sw a0, 104(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a0, a3, t5
; RV32IM-NEXT:    sw a0, 216(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw a0, 704(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a0, a3, a0
; RV32IM-NEXT:    sw a0, 280(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul t5, a3, a5
; RV32IM-NEXT:    mul s1, a3, t3
; RV32IM-NEXT:    mul t3, a3, t6
; RV32IM-NEXT:    mul a0, a3, s0
; RV32IM-NEXT:    sw a0, 192(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a0, a3, s3
; RV32IM-NEXT:    sw a0, 264(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a0, a3, s5
; RV32IM-NEXT:    sw a0, 704(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul t4, a3, t4
; RV32IM-NEXT:    mul t6, a3, t1
; RV32IM-NEXT:    mul a5, a3, s6
; RV32IM-NEXT:    mul a0, a3, t2
; RV32IM-NEXT:    sw a0, 144(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw a0, 724(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a0, a3, a0
; RV32IM-NEXT:    sw a0, 244(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul t2, a3, s4
; RV32IM-NEXT:    lw a0, 720(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    or a0, a2, a0
; RV32IM-NEXT:    sw a0, 580(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    or a0, a4, a3
; RV32IM-NEXT:    sw a0, 584(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    xor a2, a6, s3
; RV32IM-NEXT:    lw a0, 140(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a3, s4, a0
; RV32IM-NEXT:    lw a0, 124(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a4, s5, a0
; RV32IM-NEXT:    lw a0, 92(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a6, s6, a0
; RV32IM-NEXT:    lw a0, 88(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a0, s11, a0
; RV32IM-NEXT:    sw a0, 544(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw a0, 292(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    sw a0, 512(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw a0, 456(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor s9, a0, s7
; RV32IM-NEXT:    lw a0, 104(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor s10, s2, a0
; RV32IM-NEXT:    xor s11, t5, t3
; RV32IM-NEXT:    xor ra, t4, a5
; RV32IM-NEXT:    xor s5, t2, t1
...
; RV32IM-NEXT:    lw a1, 548(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor s3, a1, a0
; RV32IM-NEXT:    xor s4, a2, a3
; RV32IM-NEXT:    lw a0, 188(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t2, a4, a0
; RV32IM-NEXT:    lw a0, 176(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t3, a6, a0
; RV32IM-NEXT:    lw a0, 172(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw a1, 544(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t4, a1, a0
; RV32IM-NEXT:    lw a0, 156(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    lw a3, 420(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a2, a3, a2
...
; RV32IM-NEXT:    lw t1, 216(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor s10, s10, t1
; RV32IM-NEXT:    lw t1, 192(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor s11, s11, t1
; RV32IM-NEXT:    lw t1, 144(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    xor t3, t3, s4
; RV32IM-NEXT:    lw s4, 324(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor s4, t4, s4
...
; RV32IM-NEXT:    lw a1, 436(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t3, s4, a1
; RV32IM-NEXT:    lw a1, 428(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t4, t4, a1
; RV32IM-NEXT:    xor a1, t6, t5
; RV32IM-NEXT:    lw t5, 336(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a2, a2, t5
; RV32IM-NEXT:    lw t5, 332(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a3, a3, t5
; RV32IM-NEXT:    lw t5, 700(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a6, a6, t5
; RV32IM-NEXT:    lw t5, 684(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t0, t0, t5
; RV32IM-NEXT:    lw t5, 704(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t6, s10, t5
; RV32IM-NEXT:    lw t5, 716(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t1, t1, t5
; RV32IM-NEXT:    xor s4, s5, s6
; RV32IM-NEXT:    lw t5, 672(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor s5, s7, t5
; RV32IM-NEXT:    xor s0, s0, s1
; RV32IM-NEXT:    lw t5, 660(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor s1, s2, t5
; RV32IM-NEXT:    xor t2, t2, t3
...
; RV32IM-NEXT:    xor a5, a6, a5
; RV32IM-NEXT:    lw a6, 724(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a6, t0, a6
; RV32IM-NEXT:    srli t0, s11, 2
; RV32IM-NEXT:    lw s1, 736(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    and t3, s11, s1
...
; RV32IM-NEXT:    lw t1, 656(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t1, s0, t1
; RV32IM-NEXT:    srli t4, s3, 2
; RV32IM-NEXT:    and t5, s3, s1
; RV32IM-NEXT:    and t4, t4, s1
; RV32IM-NEXT:    slli t5, t5, 2
; RV32IM-NEXT:    or t4, t4, t5
; RV32IM-NEXT:    srli t5, s8, 2
; RV32IM-NEXT:    and t6, s8, s1
; RV32IM-NEXT:    and t5, t5, s1
; RV32IM-NEXT:    slli t6, t6, 2
; RV32IM-NEXT:    or t6, t5, t6
; RV32IM-NEXT:    lw t5, 708(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor t2, t2, t5
; RV32IM-NEXT:    lw t5, 592(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a1, a1, t5
; RV32IM-NEXT:    xor a0, t1, a0
; RV32IM-NEXT:    sw a0, 724(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    and a6, a6, t1
; RV32IM-NEXT:    slli a7, a7, 1
; RV32IM-NEXT:    or t5, a6, a7
; RV32IM-NEXT:    srli a6, t6, 1
; RV32IM-NEXT:    and a7, t6, t1
; RV32IM-NEXT:    and a6, a6, t1
; RV32IM-NEXT:    slli a7, a7, 1
; RV32IM-NEXT:    or s11, a6, a7
; RV32IM-NEXT:    or a3, a4, a3
; RV32IM-NEXT:    sw a3, 704(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    or a1, a1, a2
; RV32IM-NEXT:    sw a1, 716(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    andi a1, a5, 2
; RV32IM-NEXT:    sw a1, 712(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    andi a2, a5, 1
; RV32IM-NEXT:    andi a3, a5, 4
; RV32IM-NEXT:    andi a4, a5, 8
; RV32IM-NEXT:    andi a6, a5, 16
; RV32IM-NEXT:    andi a7, a5, 32
; RV32IM-NEXT:    andi t0, a5, 64
; RV32IM-NEXT:    andi t1, a5, 128
; RV32IM-NEXT:    andi t2, a5, 256
; RV32IM-NEXT:    andi t3, a5, 512
; RV32IM-NEXT:    andi t4, a5, 1024
; RV32IM-NEXT:    lw s1, 728(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    and a1, a5, s1
; RV32IM-NEXT:    sw a1, 708(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui t6, 1
; RV32IM-NEXT:    and s2, a5, t6
; RV32IM-NEXT:    lui t6, 2
; RV32IM-NEXT:    and s4, a5, t6
; RV32IM-NEXT:    lui t6, 4
; RV32IM-NEXT:    and s7, a5, t6
; RV32IM-NEXT:    lui t6, 8
; RV32IM-NEXT:    and s8, a5, t6
; RV32IM-NEXT:    lui t6, 16
; RV32IM-NEXT:    and s10, a5, t6
...
; RV32IM-NEXT:    lui s5, 256
; RV32IM-NEXT:    and s5, a5, s5
; RV32IM-NEXT:    lui a1, 512
; RV32IM-NEXT:    and s6, a5, a1
; RV32IM-NEXT:    lui a1, 1024
; RV32IM-NEXT:    and s9, a5, a1
; RV32IM-NEXT:    lui ra, 2048
; RV32IM-NEXT:    and ra, a5, ra
; RV32IM-NEXT:    lui a1, 4096
; RV32IM-NEXT:    and a1, a5, a1
; RV32IM-NEXT:    sw a1, 700(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lui a1, 8192
...
; RV32IM-NEXT:    mul a2, a0, t4
; RV32IM-NEXT:    sw a2, 648(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw a1, 708(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a2, a0, a1
; RV32IM-NEXT:    sw a2, 672(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a2, a0, s2
; RV32IM-NEXT:    sw a2, 688(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    sw a2, 640(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a2, a0, s10
; RV32IM-NEXT:    sw a2, 664(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a2, a0, t6
; RV32IM-NEXT:    sw a2, 684(sp) # 4-byte Folded Spill
...
; RV32IM-NEXT:    mul a2, a0, a1
; RV32IM-NEXT:    sw a2, 700(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a0, a0, a5
; RV32IM-NEXT:    sw a0, 708(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    and s4, s11, s1
; RV32IM-NEXT:    lui a0, 1
; RV32IM-NEXT:    and a7, s11, a0
; RV32IM-NEXT:    lui a0, 2
...
; RV32IM-NEXT:    and a0, s11, a0
; RV32IM-NEXT:    sw a0, 512(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    andi t3, s11, 2
; RV32IM-NEXT:    andi t4, s11, 1
; RV32IM-NEXT:    andi s1, s11, 4
...
; RV32IM-NEXT:    andi a5, s11, 256
; RV32IM-NEXT:    andi a6, s11, 512
; RV32IM-NEXT:    andi s11, s11, 1024
; RV32IM-NEXT:    mul s3, t5, t3
; RV32IM-NEXT:    mul s2, t5, t4
; RV32IM-NEXT:    mul s1, t5, s1
; RV32IM-NEXT:    mul t6, t5, a0
; RV32IM-NEXT:    mul t4, t5, a1
; RV32IM-NEXT:    mul t3, t5, a2
; RV32IM-NEXT:    mul a0, t5, a3
; RV32IM-NEXT:    sw a0, 540(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a0, t5, a4
; RV32IM-NEXT:    sw a0, 564(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul t2, t5, a5
; RV32IM-NEXT:    mul t1, t5, a6
; RV32IM-NEXT:    mul a0, t5, s11
; RV32IM-NEXT:    sw a0, 536(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a0, t5, s4
; RV32IM-NEXT:    sw a0, 552(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a0, t5, a7
; RV32IM-NEXT:    sw a0, 560(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul t0, t5, t0
; RV32IM-NEXT:    lw a0, 728(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul a7, t5, a0
; RV32IM-NEXT:    lw a0, 580(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    mul a0, t5, a0
; RV32IM-NEXT:    sw a0, 556(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a0, t5, s0
; RV32IM-NEXT:    sw a0, 728(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    lw a0, 548(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul s0, t5, a0
; RV32IM-NEXT:    mul s5, t5, s5
; RV32IM-NEXT:    mul s6, t5, s6
; RV32IM-NEXT:    mul a0, t5, s7
; RV32IM-NEXT:    sw a0, 532(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul a0, t5, s8
; RV32IM-NEXT:    sw a0, 548(sp) # 4-byte Folded Spill
; RV32IM-NEXT:    mul s9, t5, s9
; RV32IM-NEXT:    mul s10, t5, s10
; RV32IM-NEXT:    mul s4, t5, ra
; RV32IM-NEXT:    lw a0, 528(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul s7, t5, a0
; RV32IM-NEXT:    lw a0, 524(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul s8, t5, a0
; RV32IM-NEXT:    lw a0, 520(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    mul ra, t5, a0
...
; RV32IM-NEXT:    xor a4, a4, a5
; RV32IM-NEXT:    lw a5, 576(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    lw t5, 572(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    lw s0, 704(sp) # 4-byte Folded Reload
...
; RV32IM-NEXT:    srli s0, s1, 4
; RV32IM-NEXT:    and s1, s1, s3
; RV32IM-NEXT:    and s0, s0, s3
; RV32IM-NEXT:    slli s1, s1, 4
...
; RV32IM-NEXT:    xor a5, a5, t2
; RV32IM-NEXT:    lw t2, 560(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    xor a6, a6, t2
...
; RV32IM-NEXT:    srli t2, t4, 2
; RV32IM-NEXT:    lw t6, 736(sp) # 4-byte Folded Reload
; RV32IM-NEXT:    and t3, t4, t6
; RV32IM-NEXT:    and t2, t2, t6
; RV32IM-NEXT:    slli t3, t3, 2
; RV32IM-NEXT:    or t2, t2, t3
; RV32IM-NEXT:    srli t3, s0, 2
; RV32IM-NEXT:    and t4, s0, t6
; RV32IM-NEXT:    and t3, t3, t6
; RV32IM-NEXT:    slli t4, t4, 2
; RV32IM-NEXT:    or t3, t3, t4
; RV32IM-NEXT:    lw t4, 712(sp) # 4-byte Folded Reload
...
; RV64IM-NEXT:    sd a0, 1088(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    lui s0, 61681
; RV64IM-NEXT:    lui s4, 209715
; RV64IM-NEXT:    lui ra, 349525
; RV64IM-NEXT:    srli t2, s5, 24
; RV64IM-NEXT:    srli s1, s5, 8
; RV64IM-NEXT:    srli a6, s5, 40
; RV64IM-NEXT:    srli t6, s5, 56
; RV64IM-NEXT:    srliw s2, s5, 24
; RV64IM-NEXT:    slli t3, s5, 56
; RV64IM-NEXT:    li t5, 1
; RV64IM-NEXT:    srli s7, a3, 24
; RV64IM-NEXT:    srli s9, a3, 8
...
; RV64IM-NEXT:    slli t1, t1, 32
; RV64IM-NEXT:    addi t0, s0, -241
; RV64IM-NEXT:    addi t4, s4, 819
; RV64IM-NEXT:    addi s0, ra, 1365
; RV64IM-NEXT:    slli a4, a4, 24
; RV64IM-NEXT:    or a4, a4, t1
; RV64IM-NEXT:    slli t1, t0, 32
; RV64IM-NEXT:    add s4, t0, t1
; RV64IM-NEXT:    slli t0, t4, 32
; RV64IM-NEXT:    add ra, t4, t0
; RV64IM-NEXT:    slli t0, s0, 32
; RV64IM-NEXT:    add s11, s0, t0
; RV64IM-NEXT:    srliw t1, a3, 24
; RV64IM-NEXT:    and t0, t2, s10
; RV64IM-NEXT:    and t2, s1, s3
; RV64IM-NEXT:    or t0, t2, t0
; RV64IM-NEXT:    srli t2, a1, 24
; RV64IM-NEXT:    and a6, a6, a0
; RV64IM-NEXT:    or t4, a6, t6
...
; RV64IM-NEXT:    srli t6, a1, 8
; RV64IM-NEXT:    and s0, s7, s10
; RV64IM-NEXT:    mv s7, s3
; RV64IM-NEXT:    sd s3, 960(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and s1, s9, s3
; RV64IM-NEXT:    or s0, s1, s0
; RV64IM-NEXT:    srli s1, a1, 40
; RV64IM-NEXT:    and s2, s6, a0
; RV64IM-NEXT:    or s2, s2, s8
...
; RV64IM-NEXT:    or a1, a1, t2
; RV64IM-NEXT:    srli a4, a2, 4
; RV64IM-NEXT:    sd s4, 952(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and a2, a2, s4
; RV64IM-NEXT:    and a4, a4, s4
; RV64IM-NEXT:    slli a2, a2, 4
; RV64IM-NEXT:    or a2, a4, a2
...
; RV64IM-NEXT:    or a1, a4, a1
; RV64IM-NEXT:    srli a4, a2, 1
; RV64IM-NEXT:    sd s11, 928(sp) # 8-byte Folded Spill
; RV64IM-NEXT:    and a2, a2, s11
; RV64IM-NEXT:    and a4, a4, s11
; RV64IM-NEXT:    slli a2, a2, 1
; RV64IM-NEXT:    or a4, a4, a2
...
; RV64IM-NEXT:    xor a1, a1, a2
; RV64IM-NEXT:    xor a0, a0, a3
; RV64IM-NEXT:    xor s1, a1, a4
; RV64IM-NEXT:    xor s2, a0, a7
