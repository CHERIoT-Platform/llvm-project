...
; RV32IMZBS-NEXT:    or a1, a5, a3
; RV32IMZBS-NEXT:    or a3, a6, t0
; RV32IMZBS-NEXT:    srli a5, a3, 1
; RV32IMZBS-NEXT:    and a3, a3, s9
; RV32IMZBS-NEXT:    and a5, a5, s9
; RV32IMZBS-NEXT:    slli a3, a3, 1
...
; RV32IMZBS-NEXT:    and a3, a6, t2
; RV32IMZBS-NEXT:    slli a5, t3, 1
; RV32IMZBS-NEXT:    andi a6, a2, 2
...
; RV32IMZBS-NEXT:    and a6, t0, t3
; RV32IMZBS-NEXT:    slli t0, t3, 2
; RV32IMZBS-NEXT:    andi t1, a2, 4
; RV32IMZBS-NEXT:    seqz t1, t1
; RV32IMZBS-NEXT:    andi t4, a2, 8
; RV32IMZBS-NEXT:    addi s0, t1, -1
; RV32IMZBS-NEXT:    sw s0, 192(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    seqz t1, t4
; RV32IMZBS-NEXT:    slli t4, t3, 3
; RV32IMZBS-NEXT:    addi t1, t1, -1
; RV32IMZBS-NEXT:    sw t1, 188(sp) # 4-byte Folded Spill
...
; RV32IMZBS-NEXT:    slli t0, t3, 4
; RV32IMZBS-NEXT:    seqz a6, a6
; RV32IMZBS-NEXT:    addi t1, a6, -1
; RV32IMZBS-NEXT:    sw t1, 184(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    andi a6, a2, 32
; RV32IMZBS-NEXT:    and t0, t1, t0
; RV32IMZBS-NEXT:    seqz a6, a6
; RV32IMZBS-NEXT:    slli t1, t3, 5
; RV32IMZBS-NEXT:    addi a6, a6, -1
; RV32IMZBS-NEXT:    sw a6, 180(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    and a6, a6, t1
; RV32IMZBS-NEXT:    andi t1, a2, 64
; RV32IMZBS-NEXT:    xor a6, t0, a6
; RV32IMZBS-NEXT:    seqz t0, t1
; RV32IMZBS-NEXT:    slli t1, t3, 6
; RV32IMZBS-NEXT:    addi t0, t0, -1
...
; RV32IMZBS-NEXT:    seqz a5, a5
; RV32IMZBS-NEXT:    slli t0, a1, 6
; RV32IMZBS-NEXT:    addi a5, a5, -1
; RV32IMZBS-NEXT:    sw a5, 176(sp) # 4-byte Folded Spill
