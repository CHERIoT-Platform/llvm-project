...
; RV32IMZBS-NEXT:    srli s0, a1, 4
; RV32IMZBS-NEXT:    and a1, a1, a7
; RV32IMZBS-NEXT:    and s0, s0, a7
; RV32IMZBS-NEXT:    slli a1, a1, 4
; RV32IMZBS-NEXT:    slli a3, a3, 4
; RV32IMZBS-NEXT:    or a1, s0, a1
; RV32IMZBS-NEXT:    srli s0, a1, 2
...
; RV32IMZBS-NEXT:    and s1, s2, a1
; RV32IMZBS-NEXT:    slli s2, a1, 2
; RV32IMZBS-NEXT:    andi s3, t4, 4
; RV32IMZBS-NEXT:    seqz s3, s3
; RV32IMZBS-NEXT:    andi s4, t4, 8
; RV32IMZBS-NEXT:    addi s5, s3, -1
; RV32IMZBS-NEXT:    sw s5, 440(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    seqz s3, s4
; RV32IMZBS-NEXT:    slli s4, a1, 3
; RV32IMZBS-NEXT:    addi s3, s3, -1
; RV32IMZBS-NEXT:    sw s3, 436(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    and s2, s5, s2
; RV32IMZBS-NEXT:    and s3, s3, s4
; RV32IMZBS-NEXT:    xor t6, s1, t6
; RV32IMZBS-NEXT:    xor s1, s2, s3
; RV32IMZBS-NEXT:    xor s1, t6, s1
; RV32IMZBS-NEXT:    andi t6, t4, 16
; RV32IMZBS-NEXT:    slli s2, a1, 4
; RV32IMZBS-NEXT:    seqz t6, t6
; RV32IMZBS-NEXT:    addi s3, t6, -1
; RV32IMZBS-NEXT:    sw s3, 432(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    andi t6, t4, 32
; RV32IMZBS-NEXT:    and s2, s3, s2
; RV32IMZBS-NEXT:    seqz t6, t6
; RV32IMZBS-NEXT:    slli s3, a1, 5
; RV32IMZBS-NEXT:    addi t6, t6, -1
; RV32IMZBS-NEXT:    sw t6, 428(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    and t6, t6, s3
; RV32IMZBS-NEXT:    andi s3, t4, 64
; RV32IMZBS-NEXT:    xor t6, s2, t6
; RV32IMZBS-NEXT:    seqz s2, s3
; RV32IMZBS-NEXT:    slli s3, a1, 6
; RV32IMZBS-NEXT:    addi s2, s2, -1
; RV32IMZBS-NEXT:    sw s2, 424(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    and a3, a3, a5
; RV32IMZBS-NEXT:    and s2, s2, s3
; RV32IMZBS-NEXT:    slli a3, a3, 2
; RV32IMZBS-NEXT:    xor s2, t6, s2
; RV32IMZBS-NEXT:    or t6, s0, a3
; RV32IMZBS-NEXT:    xor a3, s1, s2
; RV32IMZBS-NEXT:    slli s0, a1, 7
; RV32IMZBS-NEXT:    andi s1, t4, 128
; RV32IMZBS-NEXT:    seqz s1, s1
; RV32IMZBS-NEXT:    andi s2, t4, 256
; RV32IMZBS-NEXT:    addi s3, s1, -1
; RV32IMZBS-NEXT:    sw s3, 420(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    seqz s1, s2
; RV32IMZBS-NEXT:    and s0, s3, s0
; RV32IMZBS-NEXT:    addi s3, s1, -1
; RV32IMZBS-NEXT:    sw s3, 416(sp) # 4-byte Folded Spill
; RV32IMZBS-NEXT:    slli s1, a1, 8
