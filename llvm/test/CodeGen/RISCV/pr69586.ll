...
; NOREMAT-NEXT:    slli t1, a2, 10
; NOREMAT-NEXT:    sd t1, 608(sp) # 8-byte Folded Spill
; NOREMAT-NEXT:    vle32.v v0, (a6)
; NOREMAT-NEXT:    vle32.v v12, (a6)
; NOREMAT-NEXT:    add a4, a0, s1
; NOREMAT-NEXT:    vle32.v v2, (a7)
; NOREMAT-NEXT:    vle32.v v4, (a7)
; NOREMAT-NEXT:    add a5, a0, s2
...
; NOREMAT-NEXT:    li t1, 13
; NOREMAT-NEXT:    slli a3, t1, 10
...
; REMAT-NEXT:    vl2r.v v2, (a5) # Unknown-size Folded Reload
...
; REMAT-NEXT:    sf.vc.vv 3, 0, v0, v12
; REMAT-NEXT:    vle32.v v12, (a2)
; REMAT-NEXT:    add a2, a0, a4
; REMAT-NEXT:    vle32.v v0, (a2)
; REMAT-NEXT:    sf.vc.vv 3, 0, v20, v14
; REMAT-NEXT:    vle32.v v20, (a2)
...
; REMAT-NEXT:    add a2, a0, ra
; REMAT-NEXT:    vle32.v v28, (a2)
; REMAT-NEXT:    sf.vc.vv 3, 0, v24, v30
; REMAT-NEXT:    vle32.v v18, (a2)
; REMAT-NEXT:    csrr a2, vlenb
; REMAT-NEXT:    li a3, 6
; REMAT-NEXT:    mul a2, a2, a3
...
; REMAT-NEXT:    add a2, a0, a2
; REMAT-NEXT:    vle32.v v30, (a2)
; REMAT-NEXT:    sf.vc.vv 3, 0, v26, v6
; REMAT-NEXT:    vle32.v v18, (a2)
; REMAT-NEXT:    csrr a2, vlenb
...
; REMAT-NEXT:    vl2r.v v20, (a3) # Unknown-size Folded Reload
