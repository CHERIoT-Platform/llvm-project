...
; RV32V-NEXT:    li s8, 512
; RV32V-NEXT:    li s10, 1024
; RV32V-NEXT:    lui a3, 1
; RV32V-NEXT:    lui ra, 2
; RV32V-NEXT:    lui s11, 4
; RV32V-NEXT:    lui s9, 8
; RV32V-NEXT:    lui s0, 16
; RV32V-NEXT:    lui t6, 32
; RV32V-NEXT:    lui t5, 64
...
; RV32V-NEXT:    vand.vi v24, v12, 2
; RV32V-NEXT:    vand.vi v28, v12, 1
...
; RV32V-NEXT:    vand.vx v4, v12, s10
; RV32V-NEXT:    addi s10, sp, 216
; RV32V-NEXT:    slli s7, s7, 11
; RV32V-NEXT:    vmul.vv v16, v8, v16
...
; RV32V-NEXT:    addi s3, sp, 208
; RV32V-NEXT:    vmul.vv v20, v8, v20
; RV32V-NEXT:    vxor.vv v0, v0, v20
; RV32V-NEXT:    vand.vx v20, v12, ra
; RV32V-NEXT:    sw zero, 160(sp)
; RV32V-NEXT:    sw ra, 164(sp)
; RV32V-NEXT:    addi ra, sp, 200
; RV32V-NEXT:    vmul.vv v24, v8, v24
; RV32V-NEXT:    vxor.vv v0, v0, v24
; RV32V-NEXT:    vand.vx v24, v12, s11
; RV32V-NEXT:    sw zero, 152(sp)
...
; RV32V-NEXT:    vlse64.v v4, (s6), zero
...
; RV32V-NEXT:    add s8, sp, s8
; RV32V-NEXT:    addi s8, s8, 288
; RV32V-NEXT:    vs4r.v v16, (s8) # vscale x 32-byte Folded Spill
...
; RV32V-NEXT:    vlse64.v v4, (s3), zero
; RV32V-NEXT:    vand.vv v16, v12, v20
; RV32V-NEXT:    csrr s3, vlenb
; RV32V-NEXT:    slli s3, s3, 2
; RV32V-NEXT:    mv s8, s3
; RV32V-NEXT:    slli s3, s3, 2
; RV32V-NEXT:    add s3, s3, s8
; RV32V-NEXT:    add s3, sp, s3
; RV32V-NEXT:    addi s3, s3, 288
; RV32V-NEXT:    vs4r.v v16, (s3) # vscale x 32-byte Folded Spill
; RV32V-NEXT:    vand.vv v16, v12, v24
; RV32V-NEXT:    csrr s3, vlenb
; RV32V-NEXT:    slli s3, s3, 2
; RV32V-NEXT:    mv s8, s3
; RV32V-NEXT:    slli s3, s3, 2
; RV32V-NEXT:    add s8, s8, s3
...
; RV32V-NEXT:    addi a0, a0, 288
; RV32V-NEXT:    vs4r.v v16, (a0) # vscale x 32-byte Folded Spill
; RV32V-NEXT:    vlse64.v v28, (s0), zero
; RV32V-NEXT:    vlse64.v v4, (t6), zero
; RV32V-NEXT:    vlse64.v v0, (t5), zero
; RV32V-NEXT:    vlse64.v v16, (t4), zero
; RV32V-NEXT:    vand.vv v20, v12, v28
; RV32V-NEXT:    csrr a0, vlenb
; RV32V-NEXT:    slli a0, a0, 2
; RV32V-NEXT:    mv t4, a0
; RV32V-NEXT:    slli a0, a0, 1
; RV32V-NEXT:    add a0, a0, t4
; RV32V-NEXT:    add a0, sp, a0
; RV32V-NEXT:    addi a0, a0, 288
...
; RV32V-NEXT:    vlse64.v v20, (t1), zero
...
; RV32V-NEXT:    vlse64.v v20, (a6), zero
...
; RV32V-NEXT:    sw zero, 168(sp)
; RV32V-NEXT:    lui a5, 1
; RV32V-NEXT:    sw a5, 172(sp)
; RV32V-NEXT:    sw zero, 160(sp)
; RV32V-NEXT:    sw s1, 164(sp)
; RV32V-NEXT:    sw zero, 152(sp)
; RV32V-NEXT:    lui a6, 4
; RV32V-NEXT:    sw a6, 156(sp)
; RV32V-NEXT:    sw zero, 144(sp)
; RV32V-NEXT:    sw s0, 148(sp)
; RV32V-NEXT:    sw zero, 136(sp)
; RV32V-NEXT:    sw t5, 140(sp)
; RV32V-NEXT:    sw zero, 128(sp)
; RV32V-NEXT:    sw s10, 132(sp)
; RV32V-NEXT:    sw zero, 120(sp)
; RV32V-NEXT:    lui a3, 64
; RV32V-NEXT:    sw a3, 124(sp)
; RV32V-NEXT:    sw zero, 112(sp)
; RV32V-NEXT:    lui a3, 128
; RV32V-NEXT:    sw a3, 116(sp)
; RV32V-NEXT:    sw zero, 104(sp)
; RV32V-NEXT:    sw s8, 108(sp)
; RV32V-NEXT:    sw zero, 96(sp)
...
; RV32V-NEXT:    sw zero, 64(sp)
; RV32V-NEXT:    sw s2, 68(sp)
; RV32V-NEXT:    sw zero, 56(sp)
; RV32V-NEXT:    sw t6, 60(sp)
; RV32V-NEXT:    sw zero, 48(sp)
; RV32V-NEXT:    sw s6, 52(sp)
; RV32V-NEXT:    sw zero, 40(sp)
; RV32V-NEXT:    sw t4, 44(sp)
...
; RV32V-NEXT:    vmul.vv v0, v8, v0
; RV32V-NEXT:    vxor.vv v4, v4, v0
; RV32V-NEXT:    vand.vx v0, v12, a7
; RV32V-NEXT:    vmul.vv v0, v8, v0
; RV32V-NEXT:    vxor.vv v4, v4, v0
; RV32V-NEXT:    vand.vx v0, v12, a2
; RV32V-NEXT:    vmul.vv v0, v8, v0
; RV32V-NEXT:    vxor.vv v4, v4, v0
...
; RV32V-NEXT:    vmul.vv v0, v8, v0
; RV32V-NEXT:    vxor.vv v4, v4, v0
; RV32V-NEXT:    vand.vx v0, v12, t2
; RV32V-NEXT:    addi s5, sp, 176
; RV32V-NEXT:    vmul.vv v0, v8, v0
; RV32V-NEXT:    vxor.vv v4, v4, v0
; RV32V-NEXT:    vand.vx v0, v12, ra
; RV32V-NEXT:    addi s6, sp, 168
; RV32V-NEXT:    vmul.vv v0, v8, v0
; RV32V-NEXT:    vxor.vv v4, v4, v0
; RV32V-NEXT:    vand.vx v0, v12, a5
; RV32V-NEXT:    addi s4, sp, 160
; RV32V-NEXT:    vmul.vv v0, v8, v0
; RV32V-NEXT:    vxor.vv v4, v4, v0
; RV32V-NEXT:    vand.vx v0, v12, s1
...
; RV32V-NEXT:    vmul.vv v0, v8, v0
; RV32V-NEXT:    vxor.vv v4, v4, v0
; RV32V-NEXT:    vand.vx v0, v12, a6
; RV32V-NEXT:    addi s1, sp, 144
; RV32V-NEXT:    vmul.vv v0, v8, v0
; RV32V-NEXT:    vxor.vv v4, v4, v0
...
; RV32V-NEXT:    addi t6, sp, 128
; RV32V-NEXT:    vmul.vv v0, v8, v0
; RV32V-NEXT:    vxor.vv v4, v4, v0
; RV32V-NEXT:    vand.vx v0, v12, s10
; RV32V-NEXT:    addi t5, sp, 120
; RV32V-NEXT:    vmul.vv v0, v8, v0
; RV32V-NEXT:    vxor.vv v4, v4, v0
; RV32V-NEXT:    lui a2, 64
; RV32V-NEXT:    vand.vx v0, v12, a2
; RV32V-NEXT:    addi t4, sp, 112
; RV32V-NEXT:    vmul.vv v0, v8, v0
; RV32V-NEXT:    vxor.vv v4, v4, v0
...
; RV32V-NEXT:    vand.vx v0, v12, a2
; RV32V-NEXT:    addi a6, sp, 64
; RV32V-NEXT:    vmul.vv v0, v8, v0
; RV32V-NEXT:    vxor.vv v4, v4, v0
; RV32V-NEXT:    lui a2, 8192
; RV32V-NEXT:    vand.vx v0, v12, a2
; RV32V-NEXT:    addi a5, sp, 56
; RV32V-NEXT:    vmul.vv v0, v8, v0
; RV32V-NEXT:    vxor.vv v4, v4, v0
; RV32V-NEXT:    lui a2, 16384
; RV32V-NEXT:    vand.vx v0, v12, a2
...
; RV32V-NEXT:    add s7, sp, s7
; RV32V-NEXT:    addi s7, s7, 288
; RV32V-NEXT:    vs4r.v v4, (s7) # vscale x 32-byte Folded Spill
; RV32V-NEXT:    vlse64.v v4, (a1), zero
; RV32V-NEXT:    addi a1, sp, 16
; RV32V-NEXT:    vand.vv v16, v12, v16
; RV32V-NEXT:    addi s7, sp, 288
...
; RV32V-NEXT:    vlse64.v v4, (s2), zero
...
; RV32V-NEXT:    vs4r.v v16, (s2) # vscale x 32-byte Folded Spill
; RV32V-NEXT:    vand.vv v16, v12, v28
; RV32V-NEXT:    csrr s2, vlenb
; RV32V-NEXT:    slli s2, s2, 4
; RV32V-NEXT:    mv s3, s2
...
; RV32V-NEXT:    vs4r.v v16, (s2) # vscale x 32-byte Folded Spill
; RV32V-NEXT:    vlse64.v v28, (s6), zero
; RV32V-NEXT:    vlse64.v v4, (s4), zero
...
; RV32V-NEXT:    addi a0, a0, 288
; RV32V-NEXT:    vs4r.v v16, (a0) # vscale x 32-byte Folded Spill
; RV32V-NEXT:    vlse64.v v16, (s0), zero
...
; RV32V-NEXT:    vs4r.v v16, (a0) # vscale x 32-byte Folded Spill
; RV32V-NEXT:    vlse64.v v16, (t3), zero
; RV32V-NEXT:    vlse64.v v20, (t2), zero
...
; RV32V-NEXT:    vs4r.v v16, (a0) # vscale x 32-byte Folded Spill
; RV32V-NEXT:    vlse64.v v16, (a3), zero
; RV32V-NEXT:    vlse64.v v20, (ra), zero
...
; RV32V-NEXT:    li s1, 32
; RV32V-NEXT:    li s3, 64
; RV32V-NEXT:    li s7, 128
; RV32V-NEXT:    li s6, 256
; RV32V-NEXT:    li s10, 512
; RV32V-NEXT:    li ra, 1024
; RV32V-NEXT:    lui a3, 1
...
; RV32V-NEXT:    sw zero, 128(sp)
; RV32V-NEXT:    sw s0, 132(sp)
; RV32V-NEXT:    addi s3, sp, 160
; RV32V-NEXT:    vmul.vv v0, v8, v0
; RV32V-NEXT:    vxor.vv v24, v24, v0
; RV32V-NEXT:    vand.vx v0, v16, t5
; RV32V-NEXT:    sw zero, 120(sp)
; RV32V-NEXT:    sw t5, 124(sp)
; RV32V-NEXT:    addi s2, sp, 152
; RV32V-NEXT:    vmul.vv v0, v8, v0
; RV32V-NEXT:    vxor.vv v24, v24, v0
...
; RV32V-NEXT:    mv ra, s10
; RV32V-NEXT:    slli s10, s10, 1
; RV32V-NEXT:    add ra, ra, s10
; RV32V-NEXT:    slli s10, s10, 1
; RV32V-NEXT:    add ra, ra, s10
; RV32V-NEXT:    slli s10, s10, 1
; RV32V-NEXT:    add s10, s10, ra
; RV32V-NEXT:    add s10, sp, s10
; RV32V-NEXT:    addi s10, s10, 288
; RV32V-NEXT:    vs8r.v v24, (s10) # vscale x 64-byte Folded Spill
; RV32V-NEXT:    vlse64.v v24, (s6), zero
; RV32V-NEXT:    csrr s6, vlenb
; RV32V-NEXT:    slli s6, s6, 5
; RV32V-NEXT:    mv s10, s6
; RV32V-NEXT:    slli s6, s6, 1
; RV32V-NEXT:    add s10, s10, s6
; RV32V-NEXT:    slli s6, s6, 1
; RV32V-NEXT:    add s6, s6, s10
; RV32V-NEXT:    add s6, sp, s6
; RV32V-NEXT:    addi s6, s6, 288
; RV32V-NEXT:    vs8r.v v24, (s6) # vscale x 64-byte Folded Spill
...
; RV32V-NEXT:    add s6, sp, s6
; RV32V-NEXT:    addi s6, s6, 288
; RV32V-NEXT:    vs8r.v v0, (s6) # vscale x 64-byte Folded Spill
; RV32V-NEXT:    csrr s6, vlenb
; RV32V-NEXT:    slli s6, s6, 3
; RV32V-NEXT:    mv s10, s6
...
; RV32V-NEXT:    add s6, sp, s6
; RV32V-NEXT:    addi s6, s6, 288
; RV32V-NEXT:    vl8r.v v24, (s6) # vscale x 64-byte Folded Reload
; RV32V-NEXT:    vand.vv v24, v16, v24
; RV32V-NEXT:    csrr s6, vlenb
; RV32V-NEXT:    slli s6, s6, 3
; RV32V-NEXT:    mv s10, s6
...
; RV32V-NEXT:    mv s7, s6
; RV32V-NEXT:    slli s6, s6, 1
; RV32V-NEXT:    add s7, s7, s6
; RV32V-NEXT:    slli s6, s6, 1
; RV32V-NEXT:    add s6, s6, s7
; RV32V-NEXT:    add s6, sp, s6
; RV32V-NEXT:    addi s6, s6, 288
; RV32V-NEXT:    vs8r.v v24, (s6) # vscale x 64-byte Folded Spill
; RV32V-NEXT:    vlse64.v v0, (s11), zero
...
; RV32V-NEXT:    sw zero, 120(sp)
; RV32V-NEXT:    lui s8, 64
; RV32V-NEXT:    sw s8, 124(sp)
; RV32V-NEXT:    sw zero, 112(sp)
; RV32V-NEXT:    sw t3, 116(sp)
; RV32V-NEXT:    sw zero, 104(sp)
; RV32V-NEXT:    lui a1, 256
; RV32V-NEXT:    sw a1, 108(sp)
; RV32V-NEXT:    sw zero, 96(sp)
; RV32V-NEXT:    lui a2, 512
; RV32V-NEXT:    sw a2, 100(sp)
; RV32V-NEXT:    sw zero, 88(sp)
; RV32V-NEXT:    sw t2, 92(sp)
; RV32V-NEXT:    sw zero, 80(sp)
; RV32V-NEXT:    sw t1, 84(sp)
; RV32V-NEXT:    sw zero, 72(sp)
; RV32V-NEXT:    sw s2, 76(sp)
; RV32V-NEXT:    sw zero, 64(sp)
; RV32V-NEXT:    sw t0, 68(sp)
; RV32V-NEXT:    sw zero, 56(sp)
...
; RV32V-NEXT:    mv ra, s2
; RV32V-NEXT:    slli s2, s2, 2
; RV32V-NEXT:    add ra, ra, s2
; RV32V-NEXT:    slli s2, s2, 1
; RV32V-NEXT:    add ra, ra, s2
; RV32V-NEXT:    slli s2, s2, 1
; RV32V-NEXT:    add s2, s2, ra
; RV32V-NEXT:    add s2, sp, s2
; RV32V-NEXT:    addi s2, s2, 288
; RV32V-NEXT:    vs8r.v v24, (s2) # vscale x 64-byte Folded Spill
; RV32V-NEXT:    vlse64.v v24, (s11), zero
; RV32V-NEXT:    csrr s2, vlenb
; RV32V-NEXT:    slli s2, s2, 4
; RV32V-NEXT:    mv s11, s2
; RV32V-NEXT:    slli s2, s2, 1
; RV32V-NEXT:    add s11, s11, s2
; RV32V-NEXT:    slli s2, s2, 1
; RV32V-NEXT:    add s11, s11, s2
; RV32V-NEXT:    slli s2, s2, 1
; RV32V-NEXT:    add s2, s2, s11
; RV32V-NEXT:    add s2, sp, s2
; RV32V-NEXT:    addi s2, s2, 288
; RV32V-NEXT:    vs8r.v v24, (s2) # vscale x 64-byte Folded Spill
; RV32V-NEXT:    vlse64.v v24, (s9), zero
...
; RV32V-NEXT:    mv s9, s2
; RV32V-NEXT:    slli s2, s2, 1
; RV32V-NEXT:    add s9, s9, s2
; RV32V-NEXT:    slli s2, s2, 1
; RV32V-NEXT:    add s2, s2, s9
; RV32V-NEXT:    add s2, sp, s2
; RV32V-NEXT:    addi s2, s2, 288
; RV32V-NEXT:    vs8r.v v24, (s2) # vscale x 64-byte Folded Spill
; RV32V-NEXT:    vand.vv v0, v16, v0
...
; RV32V-NEXT:    mv s6, s2
; RV32V-NEXT:    slli s2, s2, 2
; RV32V-NEXT:    add s6, s6, s2
; RV32V-NEXT:    slli s2, s2, 1
; RV32V-NEXT:    add s6, s6, s2
; RV32V-NEXT:    slli s2, s2, 1
; RV32V-NEXT:    add s2, s2, s6
; RV32V-NEXT:    add s2, sp, s2
; RV32V-NEXT:    addi s2, s2, 288
; RV32V-NEXT:    vs8r.v v24, (s2) # vscale x 64-byte Folded Spill
; RV32V-NEXT:    vlse64.v v24, (s4), zero
