...
; RV32-NEXT:    vand.vi v24, v12, 2
; RV32-NEXT:    vand.vi v28, v12, 1
; RV32-NEXT:    vand.vi v20, v12, 4
; RV32-NEXT:    vand.vi v16, v12, 8
; RV32-NEXT:    csrr a0, vlenb
; RV32-NEXT:    slli a0, a0, 2
; RV32-NEXT:    mv a1, a0
; RV32-NEXT:    slli a0, a0, 2
...
; RV32-NEXT:    sw zero, 232(sp)
; RV32-NEXT:    sw s1, 236(sp)
; RV32-NEXT:    vand.vx v0, v12, s1
; RV32-NEXT:    addi s1, sp, 264
; RV32-NEXT:    sw zero, 224(sp)
; RV32-NEXT:    sw s2, 228(sp)
; RV32-NEXT:    vand.vx v4, v12, s2
; RV32-NEXT:    addi s2, sp, 256
; RV32-NEXT:    sw zero, 216(sp)
; RV32-NEXT:    sw s5, 220(sp)
...
; RV32-NEXT:    addi s5, sp, 248
; RV32-NEXT:    sw zero, 208(sp)
; RV32-NEXT:    sw s6, 212(sp)
; RV32-NEXT:    vmul.vv v20, v8, v20
; RV32-NEXT:    vxor.vv v24, v24, v20
; RV32-NEXT:    vand.vx v20, v12, s6
; RV32-NEXT:    addi s6, sp, 240
; RV32-NEXT:    sw zero, 200(sp)
; RV32-NEXT:    sw s3, 204(sp)
; RV32-NEXT:    csrr a0, vlenb
; RV32-NEXT:    slli a0, a0, 2
; RV32-NEXT:    mv a1, a0
; RV32-NEXT:    slli a0, a0, 2
...
; RV32-NEXT:    vand.vx v24, v12, s3
; RV32-NEXT:    sw zero, 192(sp)
; RV32-NEXT:    sw s8, 196(sp)
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v0, v28, v0
; RV32-NEXT:    vand.vx v28, v12, s8
; RV32-NEXT:    sw zero, 184(sp)
; RV32-NEXT:    sw s10, 188(sp)
; RV32-NEXT:    vmul.vv v4, v8, v4
; RV32-NEXT:    vxor.vv v0, v0, v4
; RV32-NEXT:    vand.vx v4, v12, s10
; RV32-NEXT:    addi s10, sp, 216
; RV32-NEXT:    slli s7, s7, 11
; RV32-NEXT:    vmul.vv v16, v8, v16
; RV32-NEXT:    vxor.vv v0, v0, v16
; RV32-NEXT:    vand.vx v16, v12, a3
; RV32-NEXT:    sw zero, 176(sp)
; RV32-NEXT:    sw s7, 180(sp)
; RV32-NEXT:    sw zero, 168(sp)
; RV32-NEXT:    sw a3, 172(sp)
; RV32-NEXT:    addi s3, sp, 208
; RV32-NEXT:    vmul.vv v20, v8, v20
; RV32-NEXT:    vxor.vv v0, v0, v20
; RV32-NEXT:    vand.vx v20, v12, ra
; RV32-NEXT:    sw zero, 160(sp)
; RV32-NEXT:    sw ra, 164(sp)
; RV32-NEXT:    addi ra, sp, 200
; RV32-NEXT:    vmul.vv v24, v8, v24
; RV32-NEXT:    vxor.vv v0, v0, v24
; RV32-NEXT:    vand.vx v24, v12, s11
; RV32-NEXT:    sw zero, 152(sp)
...
; RV32-NEXT:    vlse64.v v20, (s1), zero
; RV32-NEXT:    addi s1, sp, 40
; RV32-NEXT:    vmul.vv v24, v8, v24
; RV32-NEXT:    vxor.vv v0, v0, v24
; RV32-NEXT:    vlse64.v v24, (s2), zero
; RV32-NEXT:    addi s2, sp, 32
; RV32-NEXT:    vmul.vv v28, v8, v28
; RV32-NEXT:    vxor.vv v0, v0, v28
; RV32-NEXT:    vlse64.v v28, (s5), zero
; RV32-NEXT:    addi s5, sp, 24
; RV32-NEXT:    vmul.vv v4, v8, v4
; RV32-NEXT:    vxor.vv v4, v0, v4
; RV32-NEXT:    csrr a0, vlenb
; RV32-NEXT:    slli a0, a0, 2
...
; RV32-NEXT:    vlse64.v v4, (s6), zero
; RV32-NEXT:    addi s6, sp, 16
...
; RV32-NEXT:    add s8, sp, s8
; RV32-NEXT:    addi s8, s8, 288
; RV32-NEXT:    vs4r.v v16, (s8) # vscale x 32-byte Folded Spill
; RV32-NEXT:    addi s8, sp, 232
; RV32-NEXT:    vlse64.v v20, (s8), zero
; RV32-NEXT:    addi s8, sp, 224
; RV32-NEXT:    vlse64.v v24, (s8), zero
; RV32-NEXT:    vlse64.v v28, (s10), zero
; RV32-NEXT:    vlse64.v v4, (s3), zero
; RV32-NEXT:    vand.vv v16, v12, v20
...
; RV32-NEXT:    vs4r.v v16, (s3) # vscale x 32-byte Folded Spill
; RV32-NEXT:    vand.vv v16, v12, v24
; RV32-NEXT:    csrr s3, vlenb
; RV32-NEXT:    slli s3, s3, 2
; RV32-NEXT:    mv s8, s3
; RV32-NEXT:    slli s3, s3, 2
; RV32-NEXT:    add s8, s8, s3
...
; RV32-NEXT:    addi a0, a0, 288
; RV32-NEXT:    vs4r.v v16, (a0) # vscale x 32-byte Folded Spill
; RV32-NEXT:    vlse64.v v28, (s0), zero
; RV32-NEXT:    vlse64.v v4, (t6), zero
; RV32-NEXT:    vlse64.v v0, (t5), zero
; RV32-NEXT:    vlse64.v v16, (t4), zero
...
; RV32-NEXT:    vs4r.v v16, (a0) # vscale x 32-byte Folded Spill
; RV32-NEXT:    vlse64.v v16, (t3), zero
; RV32-NEXT:    vlse64.v v0, (t2), zero
; RV32-NEXT:    vlse64.v v20, (t1), zero
...
; RV32-NEXT:    vlse64.v v20, (a6), zero
...
; RV32-NEXT:    addi a0, a0, 288
; RV32-NEXT:    vs4r.v v16, (a0) # vscale x 32-byte Folded Spill
; RV32-NEXT:    vlse64.v v16, (s1), zero
...
; RV32-NEXT:    li s7, 128
; RV32-NEXT:    li s6, 256
; RV32-NEXT:    li s10, 512
; RV32-NEXT:    li ra, 1024
; RV32-NEXT:    lui a3, 1
; RV32-NEXT:    lui s11, 2
; RV32-NEXT:    lui s8, 4
; RV32-NEXT:    lui s5, 8
...
; RV32-NEXT:    addi s9, sp, 272
; RV32-NEXT:    sw zero, 232(sp)
; RV32-NEXT:    sw t6, 236(sp)
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
; RV32-NEXT:    vand.vx v0, v16, t6
; RV32-NEXT:    sw zero, 224(sp)
; RV32-NEXT:    sw s1, 228(sp)
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
; RV32-NEXT:    vand.vx v0, v16, s1
; RV32-NEXT:    sw zero, 216(sp)
; RV32-NEXT:    sw s3, 220(sp)
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
; RV32-NEXT:    vand.vx v0, v16, s3
; RV32-NEXT:    sw zero, 208(sp)
; RV32-NEXT:    sw s7, 212(sp)
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
; RV32-NEXT:    vand.vx v0, v16, s7
; RV32-NEXT:    sw zero, 200(sp)
; RV32-NEXT:    sw s6, 204(sp)
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
; RV32-NEXT:    vand.vx v0, v16, s6
; RV32-NEXT:    sw zero, 192(sp)
; RV32-NEXT:    sw s10, 196(sp)
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
...
; RV32-NEXT:    addi ra, sp, 216
; RV32-NEXT:    slli s4, s4, 11
; RV32-NEXT:    sw zero, 176(sp)
; RV32-NEXT:    sw s4, 180(sp)
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
; RV32-NEXT:    vand.vx v0, v16, s4
; RV32-NEXT:    addi s6, sp, 208
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
; RV32-NEXT:    vand.vx v0, v16, a3
; RV32-NEXT:    sw zero, 168(sp)
; RV32-NEXT:    sw a3, 172(sp)
; RV32-NEXT:    addi s7, sp, 200
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
...
; RV32-NEXT:    sw zero, 152(sp)
; RV32-NEXT:    sw s8, 156(sp)
; RV32-NEXT:    addi s8, sp, 184
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
; RV32-NEXT:    vand.vx v0, v16, s5
; RV32-NEXT:    sw zero, 144(sp)
; RV32-NEXT:    sw s5, 148(sp)
; RV32-NEXT:    addi s5, sp, 176
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
...
; RV32-NEXT:    sw zero, 128(sp)
; RV32-NEXT:    sw s0, 132(sp)
; RV32-NEXT:    addi s3, sp, 160
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
; RV32-NEXT:    vand.vx v0, v16, t5
; RV32-NEXT:    sw zero, 120(sp)
; RV32-NEXT:    sw t5, 124(sp)
; RV32-NEXT:    addi s2, sp, 152
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
...
; RV32-NEXT:    sw zero, 104(sp)
; RV32-NEXT:    sw t3, 108(sp)
; RV32-NEXT:    addi s1, sp, 136
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
; RV32-NEXT:    vand.vx v0, v16, t2
; RV32-NEXT:    sw zero, 96(sp)
; RV32-NEXT:    sw t2, 100(sp)
; RV32-NEXT:    addi t6, sp, 128
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
; RV32-NEXT:    vand.vx v0, v16, t1
; RV32-NEXT:    sw zero, 88(sp)
; RV32-NEXT:    sw t1, 92(sp)
; RV32-NEXT:    addi t5, sp, 120
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
...
; RV32-NEXT:    sw zero, 72(sp)
; RV32-NEXT:    sw a7, 76(sp)
; RV32-NEXT:    addi t4, sp, 104
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
; RV32-NEXT:    vand.vx v0, v16, a6
; RV32-NEXT:    sw zero, 64(sp)
; RV32-NEXT:    sw a6, 68(sp)
; RV32-NEXT:    addi t2, sp, 96
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
; RV32-NEXT:    vand.vx v0, v16, a5
; RV32-NEXT:    sw zero, 56(sp)
; RV32-NEXT:    sw a5, 60(sp)
; RV32-NEXT:    addi t1, sp, 88
; RV32-NEXT:    vmul.vv v0, v8, v0
; RV32-NEXT:    vxor.vv v24, v24, v0
...
; RV32-NEXT:    addi a6, sp, 64
; RV32-NEXT:    addi s9, sp, 56
...
; RV32-NEXT:    vlse64.v v0, (s10), zero
; RV32-NEXT:    addi s10, sp, 224
; RV32-NEXT:    vlse64.v v24, (s10), zero
; RV32-NEXT:    csrr s10, vlenb
; RV32-NEXT:    slli s10, s10, 3
; RV32-NEXT:    mv t1, s10
...
; RV32-NEXT:    mv ra, s10
; RV32-NEXT:    slli s10, s10, 1
; RV32-NEXT:    add ra, ra, s10
; RV32-NEXT:    slli s10, s10, 1
; RV32-NEXT:    add ra, ra, s10
; RV32-NEXT:    slli s10, s10, 1
; RV32-NEXT:    add s10, s10, ra
; RV32-NEXT:    add s10, sp, s10
; RV32-NEXT:    addi s10, s10, 288
; RV32-NEXT:    vs8r.v v24, (s10) # vscale x 64-byte Folded Spill
; RV32-NEXT:    vlse64.v v24, (s6), zero
; RV32-NEXT:    csrr s6, vlenb
; RV32-NEXT:    slli s6, s6, 5
; RV32-NEXT:    mv s10, s6
; RV32-NEXT:    slli s6, s6, 1
; RV32-NEXT:    add s10, s10, s6
; RV32-NEXT:    slli s6, s6, 1
; RV32-NEXT:    add s6, s6, s10
; RV32-NEXT:    add s6, sp, s6
; RV32-NEXT:    addi s6, s6, 288
; RV32-NEXT:    vs8r.v v24, (s6) # vscale x 64-byte Folded Spill
...
; RV32-NEXT:    add s6, sp, s6
; RV32-NEXT:    addi s6, s6, 288
; RV32-NEXT:    vs8r.v v0, (s6) # vscale x 64-byte Folded Spill
; RV32-NEXT:    csrr s6, vlenb
; RV32-NEXT:    slli s6, s6, 3
; RV32-NEXT:    mv s10, s6
...
; RV32-NEXT:    add s6, sp, s6
; RV32-NEXT:    addi s6, s6, 288
; RV32-NEXT:    vl8r.v v24, (s6) # vscale x 64-byte Folded Reload
; RV32-NEXT:    vand.vv v24, v16, v24
; RV32-NEXT:    csrr s6, vlenb
; RV32-NEXT:    slli s6, s6, 3
; RV32-NEXT:    mv s10, s6
...
; RV32-NEXT:    mv s7, s6
; RV32-NEXT:    slli s6, s6, 1
; RV32-NEXT:    add s7, s7, s6
; RV32-NEXT:    slli s6, s6, 1
; RV32-NEXT:    add s6, s6, s7
; RV32-NEXT:    add s6, sp, s6
; RV32-NEXT:    addi s6, s6, 288
; RV32-NEXT:    vs8r.v v24, (s6) # vscale x 64-byte Folded Spill
; RV32-NEXT:    vlse64.v v0, (s11), zero
...
; RV32-NEXT:    add s0, sp, s0
; RV32-NEXT:    addi s0, s0, 288
; RV32-NEXT:    vl8r.v v24, (s0) # vscale x 64-byte Folded Reload
; RV32-NEXT:    vand.vv v24, v16, v24
; RV32-NEXT:    csrr s0, vlenb
; RV32-NEXT:    slli s0, s0, 3
; RV32-NEXT:    mv s2, s0
...
; RV32-NEXT:    add t3, sp, t3
; RV32-NEXT:    addi t3, t3, 288
; RV32-NEXT:    vl8r.v v24, (t3) # vscale x 64-byte Folded Reload
; RV32-NEXT:    vand.vv v24, v16, v24
; RV32-NEXT:    csrr t3, vlenb
