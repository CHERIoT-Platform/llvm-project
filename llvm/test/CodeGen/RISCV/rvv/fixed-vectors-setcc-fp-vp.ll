...
; ZVFHMIN32-NEXT:    addi a1, sp, 512
; ZVFHMIN32-NEXT:    vmv.x.s a5, v16
; ZVFHMIN32-NEXT:    vsetvli zero, s2, e16, m8, ta, ma
; ZVFHMIN32-NEXT:    vse16.v v0, (a0)
; ZVFHMIN32-NEXT:    vse16.v v16, (a1)
; ZVFHMIN32-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
...
; ZVFHMIN32-NEXT:    vslidedown.vi v22, v16, 12
; ZVFHMIN32-NEXT:    vslidedown.vi v6, v16, 11
; ZVFHMIN32-NEXT:    vslidedown.vi v20, v16, 10
; ZVFHMIN32-NEXT:    vslidedown.vi v18, v16, 9
; ZVFHMIN32-NEXT:    vslidedown.vi v16, v16, 8
; ZVFHMIN32-NEXT:    vmv.x.s t6, v0
; ZVFHMIN32-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
; ZVFHMIN32-NEXT:    vslidedown.vi v5, v0, 7
; ZVFHMIN32-NEXT:    vslidedown.vi v7, v0, 6
; ZVFHMIN32-NEXT:    vslidedown.vi v17, v0, 5
; ZVFHMIN32-NEXT:    vslidedown.vi v23, v0, 4
; ZVFHMIN32-NEXT:    vslidedown.vi v21, v0, 3
; ZVFHMIN32-NEXT:    vslidedown.vi v19, v0, 2
; ZVFHMIN32-NEXT:    vslidedown.vi v3, v0, 1
; ZVFHMIN32-NEXT:    vsetivli zero, 1, e16, m2, ta, ma
...
; ZVFHMIN32-NEXT:    add a0, sp, a0
; ZVFHMIN32-NEXT:    addi a0, a0, 880
; ZVFHMIN32-NEXT:    vl2r.v v24, (a0) # Unknown-size Folded Reload
; ZVFHMIN32-NEXT:    vmv.x.s a0, v24
; ZVFHMIN32-NEXT:    csrr a1, vlenb
; ZVFHMIN32-NEXT:    li a3, 21
; ZVFHMIN32-NEXT:    mul a1, a1, a3
; ZVFHMIN32-NEXT:    add a1, sp, a1
; ZVFHMIN32-NEXT:    addi a1, a1, 880
; ZVFHMIN32-NEXT:    vl2r.v v24, (a1) # Unknown-size Folded Reload
...
; ZVFHMIN32-NEXT:    vl2r.v v24, (a3) # Unknown-size Folded Reload
; ZVFHMIN32-NEXT:    vmv.x.s t0, v24
; ZVFHMIN32-NEXT:    csrr a3, vlenb
; ZVFHMIN32-NEXT:    slli a4, a3, 4
...
; ZVFHMIN32-NEXT:    addi a3, a3, 880
; ZVFHMIN32-NEXT:    vl2r.v v24, (a3) # Unknown-size Folded Reload
; ZVFHMIN32-NEXT:    vmv.x.s s11, v24
; ZVFHMIN32-NEXT:    csrr a3, vlenb
; ZVFHMIN32-NEXT:    slli a3, a3, 2
; ZVFHMIN32-NEXT:    add a3, sp, a3
; ZVFHMIN32-NEXT:    addi a3, a3, 880
; ZVFHMIN32-NEXT:    vl2r.v v24, (a3) # Unknown-size Folded Reload
; ZVFHMIN32-NEXT:    vmv.x.s s6, v24
; ZVFHMIN32-NEXT:    csrr a3, vlenb
; ZVFHMIN32-NEXT:    slli a3, a3, 1
; ZVFHMIN32-NEXT:    add a3, sp, a3
; ZVFHMIN32-NEXT:    addi a3, a3, 880
; ZVFHMIN32-NEXT:    vl2r.v v24, (a3) # Unknown-size Folded Reload
; ZVFHMIN32-NEXT:    vmv.x.s s8, v24
; ZVFHMIN32-NEXT:    addi a3, sp, 880
; ZVFHMIN32-NEXT:    vl2r.v v24, (a3) # Unknown-size Folded Reload
; ZVFHMIN32-NEXT:    vmv.x.s s10, v24
; ZVFHMIN32-NEXT:    vmv.x.s s9, v4
; ZVFHMIN32-NEXT:    vmv.x.s s7, v2
; ZVFHMIN32-NEXT:    vmv.x.s s5, v22
; ZVFHMIN32-NEXT:    vmv.x.s a3, v6
; ZVFHMIN32-NEXT:    vmv.x.s a4, v20
; ZVFHMIN32-NEXT:    sw a4, 112(sp) # 4-byte Folded Spill
; ZVFHMIN32-NEXT:    vmv.x.s a4, v18
; ZVFHMIN32-NEXT:    sw a4, 120(sp) # 4-byte Folded Spill
; ZVFHMIN32-NEXT:    vmv.x.s a4, v16
; ZVFHMIN32-NEXT:    sw a4, 124(sp) # 4-byte Folded Spill
; ZVFHMIN32-NEXT:    vmv.x.s t1, v8
; ZVFHMIN32-NEXT:    vmv.x.s t2, v10
; ZVFHMIN32-NEXT:    vmv.x.s t3, v12
; ZVFHMIN32-NEXT:    vmv.x.s t4, v14
; ZVFHMIN32-NEXT:    vmv.x.s t5, v26
; ZVFHMIN32-NEXT:    vmv.x.s a7, v28
; ZVFHMIN32-NEXT:    vmv.x.s a6, v30
; ZVFHMIN32-NEXT:    fmv.h.x fs8, a2
; ZVFHMIN32-NEXT:    csrr a2, vlenb
; ZVFHMIN32-NEXT:    slli a4, a2, 5
...
; ZVFHMIN32-NEXT:    lh a5, 880(a4) # 8-byte Folded Reload
; ZVFHMIN32-NEXT:    fmv.h.x fs6, a2
; ZVFHMIN32-NEXT:    csrr a2, vlenb
; ZVFHMIN32-NEXT:    li a4, 29
; ZVFHMIN32-NEXT:    mul a2, a2, a4
; ZVFHMIN32-NEXT:    add a2, sp, a2
; ZVFHMIN32-NEXT:    lh a2, 880(a2) # 8-byte Folded Reload
; ZVFHMIN32-NEXT:    fmv.h.x fs5, a5
; ZVFHMIN32-NEXT:    csrr a4, vlenb
; ZVFHMIN32-NEXT:    li a5, 28
; ZVFHMIN32-NEXT:    mul a4, a4, a5
; ZVFHMIN32-NEXT:    add a4, sp, a4
; ZVFHMIN32-NEXT:    lh a5, 880(a4) # 8-byte Folded Reload
; ZVFHMIN32-NEXT:    fmv.h.x fs4, a2
; ZVFHMIN32-NEXT:    csrr a2, vlenb
; ZVFHMIN32-NEXT:    li a4, 27
; ZVFHMIN32-NEXT:    mul a2, a2, a4
; ZVFHMIN32-NEXT:    add a2, sp, a2
; ZVFHMIN32-NEXT:    lh a2, 880(a2) # 8-byte Folded Reload
...
; ZVFHMIN32-NEXT:    csrr a2, vlenb
; ZVFHMIN32-NEXT:    li a4, 25
; ZVFHMIN32-NEXT:    mul a2, a2, a4
; ZVFHMIN32-NEXT:    add a2, sp, a2
; ZVFHMIN32-NEXT:    lh a2, 880(a2) # 8-byte Folded Reload
; ZVFHMIN32-NEXT:    fmv.h.x fa6, a5
; ZVFHMIN32-NEXT:    csrr a4, vlenb
; ZVFHMIN32-NEXT:    slli a4, a4, 3
; ZVFHMIN32-NEXT:    add a4, sp, a4
; ZVFHMIN32-NEXT:    lh a5, 880(a4) # 8-byte Folded Reload
...
; ZVFHMIN32-NEXT:    add a2, sp, a2
; ZVFHMIN32-NEXT:    lh a2, 880(a2) # 8-byte Folded Reload
; ZVFHMIN32-NEXT:    fmv.h.x ft10, a5
; ZVFHMIN32-NEXT:    csrr a4, vlenb
; ZVFHMIN32-NEXT:    li a5, 12
; ZVFHMIN32-NEXT:    mul a4, a4, a5
; ZVFHMIN32-NEXT:    add a4, sp, a4
; ZVFHMIN32-NEXT:    lh a5, 880(a4) # 8-byte Folded Reload
; ZVFHMIN32-NEXT:    fmv.h.x ft11, a2
; ZVFHMIN32-NEXT:    csrr a2, vlenb
; ZVFHMIN32-NEXT:    li a4, 13
; ZVFHMIN32-NEXT:    mul a2, a2, a4
; ZVFHMIN32-NEXT:    add a2, sp, a2
; ZVFHMIN32-NEXT:    lh a2, 880(a2) # 8-byte Folded Reload
; ZVFHMIN32-NEXT:    fmv.h.x fs0, a5
; ZVFHMIN32-NEXT:    csrr a4, vlenb
...
; ZVFHMIN32-NEXT:    add a2, sp, a2
; ZVFHMIN32-NEXT:    lh a2, 880(a2) # 8-byte Folded Reload
; ZVFHMIN32-NEXT:    fmv.h.x fs2, a5
; ZVFHMIN32-NEXT:    csrr a4, vlenb
; ZVFHMIN32-NEXT:    slli a4, a4, 4
; ZVFHMIN32-NEXT:    add a4, sp, a4
; ZVFHMIN32-NEXT:    lh a5, 880(a4) # 8-byte Folded Reload
; ZVFHMIN32-NEXT:    fmv.h.x fs3, a2
; ZVFHMIN32-NEXT:    fmv.h.x ft2, a5
; ZVFHMIN32-NEXT:    fmv.h.x ft3, a0
; ZVFHMIN32-NEXT:    fmv.h.x ft4, a1
; ZVFHMIN32-NEXT:    fmv.h.x ft5, t0
; ZVFHMIN32-NEXT:    fmv.h.x ft9, s3
; ZVFHMIN32-NEXT:    fmv.h.x fa7, s4
; ZVFHMIN32-NEXT:    fmv.h.x ft7, s11
...
; ZVFHMIN32-NEXT:    vmv.x.s s8, v7
; ZVFHMIN32-NEXT:    fmv.h.x fa3, s10
; ZVFHMIN32-NEXT:    vmv.x.s s10, v17
; ZVFHMIN32-NEXT:    fmv.h.x fa2, s9
; ZVFHMIN32-NEXT:    vmv.x.s s9, v23
; ZVFHMIN32-NEXT:    fmv.h.x fa1, s7
; ZVFHMIN32-NEXT:    vmv.x.s s7, v21
; ZVFHMIN32-NEXT:    fmv.h.x fa0, s5
; ZVFHMIN32-NEXT:    vmv.x.s s11, v19
; ZVFHMIN32-NEXT:    fmv.h.x ft0, a3
; ZVFHMIN32-NEXT:    addi a3, sp, 256
; ZVFHMIN32-NEXT:    vsetvli zero, s2, e16, m8, ta, ma
; ZVFHMIN32-NEXT:    vse16.v v24, (a3)
; ZVFHMIN32-NEXT:    vmv.x.s a3, v24
; ZVFHMIN32-NEXT:    vmv.x.s s2, v3
; ZVFHMIN32-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
; ZVFHMIN32-NEXT:    vslidedown.vi v8, v24, 7
; ZVFHMIN32-NEXT:    fmv.h.x fs9, t6
; ZVFHMIN32-NEXT:    vmv.x.s t6, v8
; ZVFHMIN32-NEXT:    vslidedown.vi v8, v24, 6
; ZVFHMIN32-NEXT:    fmv.h.x fs10, a3
; ZVFHMIN32-NEXT:    vmv.x.s a0, v8
; ZVFHMIN32-NEXT:    vslidedown.vi v8, v24, 5
; ZVFHMIN32-NEXT:    fmv.h.x fs11, s6
; ZVFHMIN32-NEXT:    feq.h a3, fs8, fs9
; ZVFHMIN32-NEXT:    fmv.h.x fs8, s8
; ZVFHMIN32-NEXT:    vmv.x.s s8, v8
; ZVFHMIN32-NEXT:    vslidedown.vi v8, v24, 4
; ZVFHMIN32-NEXT:    fmv.h.x fs9, s10
; ZVFHMIN32-NEXT:    feq.h ra, fs7, fs10
; ZVFHMIN32-NEXT:    fmv.h.x fs7, s9
; ZVFHMIN32-NEXT:    vmv.x.s s9, v8
; ZVFHMIN32-NEXT:    vslidedown.vi v8, v24, 3
; ZVFHMIN32-NEXT:    fmv.h.x fs10, s7
; ZVFHMIN32-NEXT:    feq.h s5, fs6, fs11
; ZVFHMIN32-NEXT:    fmv.h.x fs6, s11
; ZVFHMIN32-NEXT:    vmv.x.s s10, v8
; ZVFHMIN32-NEXT:    vslidedown.vi v8, v24, 2
; ZVFHMIN32-NEXT:    fmv.h.x fs11, s2
; ZVFHMIN32-NEXT:    feq.h s6, fs5, fs8
; ZVFHMIN32-NEXT:    fmv.h.x fs5, t6
; ZVFHMIN32-NEXT:    vmv.x.s t6, v8
; ZVFHMIN32-NEXT:    vslidedown.vi v8, v24, 1
; ZVFHMIN32-NEXT:    fmv.h.x fs8, a0
; ZVFHMIN32-NEXT:    feq.h s7, fs4, fs9
; ZVFHMIN32-NEXT:    fmv.h.x fs4, s8
; ZVFHMIN32-NEXT:    vmv.x.s a0, v8
; ZVFHMIN32-NEXT:    fmv.h.x fs9, s9
; ZVFHMIN32-NEXT:    feq.h s8, ft1, fs7
; ZVFHMIN32-NEXT:    fmv.h.x ft1, s10
; ZVFHMIN32-NEXT:    feq.h s9, ft6, fs10
; ZVFHMIN32-NEXT:    fmv.h.x ft6, t6
; ZVFHMIN32-NEXT:    feq.h s10, fa6, fs6
; ZVFHMIN32-NEXT:    fmv.h.x fs6, a0
; ZVFHMIN32-NEXT:    feq.h s11, ft8, fs11
; ZVFHMIN32-NEXT:    fmv.h.x fs7, t1
; ZVFHMIN32-NEXT:    feq.h t1, ft10, fs5
; ZVFHMIN32-NEXT:    fmv.h.x ft10, t2
; ZVFHMIN32-NEXT:    feq.h t2, ft11, fs8
; ZVFHMIN32-NEXT:    fmv.h.x ft11, t3
; ZVFHMIN32-NEXT:    feq.h t3, fs0, fs4
; ZVFHMIN32-NEXT:    fmv.h.x fs0, t4
; ZVFHMIN32-NEXT:    feq.h t4, fs1, fs9
; ZVFHMIN32-NEXT:    fmv.h.x ft8, t5
; ZVFHMIN32-NEXT:    feq.h t5, fs2, ft1
; ZVFHMIN32-NEXT:    fmv.h.x fa6, a7
; ZVFHMIN32-NEXT:    feq.h t6, fs3, ft6
; ZVFHMIN32-NEXT:    fmv.h.x ft1, a6
; ZVFHMIN32-NEXT:    feq.h s2, ft2, fs6
; ZVFHMIN32-NEXT:    fmv.h.x ft2, a5
; ZVFHMIN32-NEXT:    feq.h a0, ft3, fs7
; ZVFHMIN32-NEXT:    sw a0, 108(sp) # 4-byte Folded Spill
; ZVFHMIN32-NEXT:    fmv.h.x ft3, s3
; ZVFHMIN32-NEXT:    feq.h a5, ft4, ft10
; ZVFHMIN32-NEXT:    fmv.h.x ft4, a4
; ZVFHMIN32-NEXT:    feq.h a6, ft5, ft11
; ZVFHMIN32-NEXT:    fmv.h.x ft5, a1
; ZVFHMIN32-NEXT:    lh a0, 704(sp)
; ZVFHMIN32-NEXT:    fmv.h.x ft6, a2
; ZVFHMIN32-NEXT:    feq.h a7, ft9, fs0
; ZVFHMIN32-NEXT:    fmv.h.x ft9, a0
; ZVFHMIN32-NEXT:    lh a0, 448(sp)
; ZVFHMIN32-NEXT:    fmv.h.x ft10, a0
; ZVFHMIN32-NEXT:    feq.h a0, ft9, ft10
...
; ZVFHMIN32-NEXT:    fmv.h.x ft7, a0
; ZVFHMIN32-NEXT:    lh a0, 466(sp)
; ZVFHMIN32-NEXT:    fmv.h.x fa6, a0
; ZVFHMIN32-NEXT:    feq.h a0, ft7, fa6
; ZVFHMIN32-NEXT:    sb a0, 169(sp)
; ZVFHMIN32-NEXT:    lh a0, 720(sp)
; ZVFHMIN32-NEXT:    fmv.h.x ft7, a0
; ZVFHMIN32-NEXT:    lh a0, 464(sp)
; ZVFHMIN32-NEXT:    fmv.h.x fa6, a0
; ZVFHMIN32-NEXT:    feq.h a0, ft7, fa6
; ZVFHMIN32-NEXT:    sb a0, 168(sp)
; ZVFHMIN32-NEXT:    lh a0, 718(sp)
; ZVFHMIN32-NEXT:    fmv.h.x ft7, a0
; ZVFHMIN32-NEXT:    lh a0, 462(sp)
; ZVFHMIN32-NEXT:    fmv.h.x fa6, a0
; ZVFHMIN32-NEXT:    feq.h a0, ft7, fa6
; ZVFHMIN32-NEXT:    sb a0, 167(sp)
; ZVFHMIN32-NEXT:    lh a0, 716(sp)
; ZVFHMIN32-NEXT:    fmv.h.x ft7, a0
; ZVFHMIN32-NEXT:    lh a0, 460(sp)
; ZVFHMIN32-NEXT:    fmv.h.x fa6, a0
; ZVFHMIN32-NEXT:    feq.h a0, ft7, fa6
; ZVFHMIN32-NEXT:    sb a0, 166(sp)
; ZVFHMIN32-NEXT:    lh a0, 714(sp)
; ZVFHMIN32-NEXT:    fmv.h.x ft7, a0
; ZVFHMIN32-NEXT:    lh a0, 458(sp)
; ZVFHMIN32-NEXT:    fmv.h.x fa6, a0
; ZVFHMIN32-NEXT:    feq.h a0, ft7, fa6
; ZVFHMIN32-NEXT:    sb a0, 165(sp)
; ZVFHMIN32-NEXT:    lh a0, 712(sp)
; ZVFHMIN32-NEXT:    fmv.h.x ft7, a0
; ZVFHMIN32-NEXT:    lh a0, 456(sp)
; ZVFHMIN32-NEXT:    fmv.h.x fa6, a0
; ZVFHMIN32-NEXT:    feq.h a0, ft7, fa6
; ZVFHMIN32-NEXT:    sb a0, 164(sp)
; ZVFHMIN32-NEXT:    lh a0, 710(sp)
; ZVFHMIN32-NEXT:    fmv.h.x ft7, a0
; ZVFHMIN32-NEXT:    lh a0, 454(sp)
; ZVFHMIN32-NEXT:    fmv.h.x fa6, a0
; ZVFHMIN32-NEXT:    feq.h a0, ft7, fa6
; ZVFHMIN32-NEXT:    sb a0, 163(sp)
; ZVFHMIN32-NEXT:    lh a0, 708(sp)
; ZVFHMIN32-NEXT:    fmv.h.x ft7, a0
; ZVFHMIN32-NEXT:    lh a0, 452(sp)
; ZVFHMIN32-NEXT:    fmv.h.x fa6, a0
; ZVFHMIN32-NEXT:    feq.h a0, ft7, fa6
; ZVFHMIN32-NEXT:    fmv.h.x ft7, s4
; ZVFHMIN32-NEXT:    sb a0, 162(sp)
; ZVFHMIN32-NEXT:    lh a1, 706(sp)
; ZVFHMIN32-NEXT:    lh a2, 450(sp)
; ZVFHMIN32-NEXT:    sb s11, 129(sp)
; ZVFHMIN32-NEXT:    feq.h s11, fa5, ft1
; ZVFHMIN32-NEXT:    sb s10, 130(sp)
; ZVFHMIN32-NEXT:    feq.h a0, fa4, ft2
; ZVFHMIN32-NEXT:    sb s9, 131(sp)
; ZVFHMIN32-NEXT:    feq.h s4, fa3, ft3
; ZVFHMIN32-NEXT:    sb s8, 132(sp)
; ZVFHMIN32-NEXT:    feq.h s8, fa2, ft4
; ZVFHMIN32-NEXT:    fmv.h.x fa5, a1
; ZVFHMIN32-NEXT:    feq.h s9, fa1, ft5
; ZVFHMIN32-NEXT:    fmv.h.x fa4, a2
; ZVFHMIN32-NEXT:    feq.h s10, fa0, ft6
; ZVFHMIN32-NEXT:    sb s7, 133(sp)
; ZVFHMIN32-NEXT:    feq.h s7, ft0, ft7
; ZVFHMIN32-NEXT:    sb s6, 134(sp)
...
; ZVFHMIN32-NEXT:    fmv.h.x fa4, a2
; ZVFHMIN32-NEXT:    feq.h a1, fa5, fa4
; ZVFHMIN32-NEXT:    sb t3, 197(sp)
; ZVFHMIN32-NEXT:    sb t2, 198(sp)
; ZVFHMIN32-NEXT:    sb t1, 199(sp)
...
; ZVFHMIN32-NEXT:    sb a7, 140(sp)
; ZVFHMIN32-NEXT:    sb a6, 141(sp)
; ZVFHMIN32-NEXT:    sb a5, 142(sp)
; ZVFHMIN32-NEXT:    lw a3, 108(sp) # 4-byte Folded Reload
; ZVFHMIN32-NEXT:    sb a3, 143(sp)
; ZVFHMIN32-NEXT:    sb a0, 136(sp)
; ZVFHMIN32-NEXT:    sb s11, 137(sp)
; ZVFHMIN32-NEXT:    sb ra, 138(sp)
; ZVFHMIN32-NEXT:    sb s3, 139(sp)
...
; ZVFHMIN32-NEXT:    sb s10, 204(sp)
; ZVFHMIN32-NEXT:    sb s9, 205(sp)
; ZVFHMIN32-NEXT:    sb s8, 206(sp)
; ZVFHMIN32-NEXT:    sb s4, 207(sp)
; ZVFHMIN32-NEXT:    feq.h a3, fa5, fa4
; ZVFHMIN32-NEXT:    sb a3, 200(sp)
; ZVFHMIN32-NEXT:    sb a0, 201(sp)
; ZVFHMIN32-NEXT:    sb a4, 202(sp)
; ZVFHMIN32-NEXT:    sb s7, 203(sp)
...
; ZVFHMIN64-NEXT:    addi a1, sp, 512
; ZVFHMIN64-NEXT:    vmv.x.s a5, v16
; ZVFHMIN64-NEXT:    vsetvli zero, s2, e16, m8, ta, ma
; ZVFHMIN64-NEXT:    vse16.v v0, (a0)
; ZVFHMIN64-NEXT:    vse16.v v16, (a1)
; ZVFHMIN64-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
...
; ZVFHMIN64-NEXT:    vslidedown.vi v22, v16, 12
; ZVFHMIN64-NEXT:    vslidedown.vi v6, v16, 11
; ZVFHMIN64-NEXT:    vslidedown.vi v20, v16, 10
; ZVFHMIN64-NEXT:    vslidedown.vi v18, v16, 9
; ZVFHMIN64-NEXT:    vslidedown.vi v16, v16, 8
; ZVFHMIN64-NEXT:    vmv.x.s t6, v0
; ZVFHMIN64-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
; ZVFHMIN64-NEXT:    vslidedown.vi v5, v0, 7
; ZVFHMIN64-NEXT:    vslidedown.vi v7, v0, 6
; ZVFHMIN64-NEXT:    vslidedown.vi v17, v0, 5
; ZVFHMIN64-NEXT:    vslidedown.vi v23, v0, 4
; ZVFHMIN64-NEXT:    vslidedown.vi v21, v0, 3
; ZVFHMIN64-NEXT:    vslidedown.vi v19, v0, 2
; ZVFHMIN64-NEXT:    vslidedown.vi v3, v0, 1
; ZVFHMIN64-NEXT:    vsetivli zero, 1, e16, m2, ta, ma
...
; ZVFHMIN64-NEXT:    add a0, sp, a0
; ZVFHMIN64-NEXT:    addi a0, a0, 832
; ZVFHMIN64-NEXT:    vl2r.v v24, (a0) # Unknown-size Folded Reload
; ZVFHMIN64-NEXT:    vmv.x.s a0, v24
; ZVFHMIN64-NEXT:    csrr a1, vlenb
; ZVFHMIN64-NEXT:    li a3, 21
; ZVFHMIN64-NEXT:    mul a1, a1, a3
; ZVFHMIN64-NEXT:    add a1, sp, a1
; ZVFHMIN64-NEXT:    addi a1, a1, 832
; ZVFHMIN64-NEXT:    vl2r.v v24, (a1) # Unknown-size Folded Reload
...
; ZVFHMIN64-NEXT:    vl2r.v v24, (a3) # Unknown-size Folded Reload
; ZVFHMIN64-NEXT:    vmv.x.s t0, v24
; ZVFHMIN64-NEXT:    csrr a3, vlenb
; ZVFHMIN64-NEXT:    slli a4, a3, 4
...
; ZVFHMIN64-NEXT:    addi a3, a3, 832
; ZVFHMIN64-NEXT:    vl2r.v v24, (a3) # Unknown-size Folded Reload
; ZVFHMIN64-NEXT:    vmv.x.s s11, v24
; ZVFHMIN64-NEXT:    csrr a3, vlenb
; ZVFHMIN64-NEXT:    slli a3, a3, 2
; ZVFHMIN64-NEXT:    add a3, sp, a3
; ZVFHMIN64-NEXT:    addi a3, a3, 832
; ZVFHMIN64-NEXT:    vl2r.v v24, (a3) # Unknown-size Folded Reload
; ZVFHMIN64-NEXT:    vmv.x.s s6, v24
; ZVFHMIN64-NEXT:    csrr a3, vlenb
; ZVFHMIN64-NEXT:    slli a3, a3, 1
; ZVFHMIN64-NEXT:    add a3, sp, a3
; ZVFHMIN64-NEXT:    addi a3, a3, 832
; ZVFHMIN64-NEXT:    vl2r.v v24, (a3) # Unknown-size Folded Reload
; ZVFHMIN64-NEXT:    vmv.x.s s8, v24
; ZVFHMIN64-NEXT:    addi a3, sp, 832
; ZVFHMIN64-NEXT:    vl2r.v v24, (a3) # Unknown-size Folded Reload
; ZVFHMIN64-NEXT:    vmv.x.s s10, v24
; ZVFHMIN64-NEXT:    vmv.x.s s9, v4
; ZVFHMIN64-NEXT:    vmv.x.s s7, v2
; ZVFHMIN64-NEXT:    vmv.x.s s5, v22
; ZVFHMIN64-NEXT:    vmv.x.s a3, v6
; ZVFHMIN64-NEXT:    vmv.x.s a4, v20
; ZVFHMIN64-NEXT:    sd a4, 96(sp) # 8-byte Folded Spill
; ZVFHMIN64-NEXT:    vmv.x.s a4, v18
; ZVFHMIN64-NEXT:    sd a4, 112(sp) # 8-byte Folded Spill
; ZVFHMIN64-NEXT:    vmv.x.s a4, v16
; ZVFHMIN64-NEXT:    sd a4, 120(sp) # 8-byte Folded Spill
; ZVFHMIN64-NEXT:    vmv.x.s t1, v8
; ZVFHMIN64-NEXT:    vmv.x.s t2, v10
; ZVFHMIN64-NEXT:    vmv.x.s t3, v12
; ZVFHMIN64-NEXT:    vmv.x.s t4, v14
; ZVFHMIN64-NEXT:    vmv.x.s t5, v26
; ZVFHMIN64-NEXT:    vmv.x.s a7, v28
; ZVFHMIN64-NEXT:    vmv.x.s a6, v30
; ZVFHMIN64-NEXT:    fmv.h.x fs8, a2
; ZVFHMIN64-NEXT:    csrr a2, vlenb
; ZVFHMIN64-NEXT:    slli a4, a2, 5
...
; ZVFHMIN64-NEXT:    lh a5, 832(a4) # 8-byte Folded Reload
; ZVFHMIN64-NEXT:    fmv.h.x fs6, a2
; ZVFHMIN64-NEXT:    csrr a2, vlenb
; ZVFHMIN64-NEXT:    li a4, 29
; ZVFHMIN64-NEXT:    mul a2, a2, a4
; ZVFHMIN64-NEXT:    add a2, sp, a2
; ZVFHMIN64-NEXT:    lh a2, 832(a2) # 8-byte Folded Reload
; ZVFHMIN64-NEXT:    fmv.h.x fs5, a5
; ZVFHMIN64-NEXT:    csrr a4, vlenb
; ZVFHMIN64-NEXT:    li a5, 28
; ZVFHMIN64-NEXT:    mul a4, a4, a5
; ZVFHMIN64-NEXT:    add a4, sp, a4
; ZVFHMIN64-NEXT:    lh a5, 832(a4) # 8-byte Folded Reload
; ZVFHMIN64-NEXT:    fmv.h.x fs4, a2
; ZVFHMIN64-NEXT:    csrr a2, vlenb
; ZVFHMIN64-NEXT:    li a4, 27
; ZVFHMIN64-NEXT:    mul a2, a2, a4
; ZVFHMIN64-NEXT:    add a2, sp, a2
; ZVFHMIN64-NEXT:    lh a2, 832(a2) # 8-byte Folded Reload
...
; ZVFHMIN64-NEXT:    csrr a2, vlenb
; ZVFHMIN64-NEXT:    li a4, 25
; ZVFHMIN64-NEXT:    mul a2, a2, a4
; ZVFHMIN64-NEXT:    add a2, sp, a2
; ZVFHMIN64-NEXT:    lh a2, 832(a2) # 8-byte Folded Reload
; ZVFHMIN64-NEXT:    fmv.h.x fa6, a5
; ZVFHMIN64-NEXT:    csrr a4, vlenb
; ZVFHMIN64-NEXT:    slli a4, a4, 3
; ZVFHMIN64-NEXT:    add a4, sp, a4
; ZVFHMIN64-NEXT:    lh a5, 832(a4) # 8-byte Folded Reload
...
; ZVFHMIN64-NEXT:    add a2, sp, a2
; ZVFHMIN64-NEXT:    lh a2, 832(a2) # 8-byte Folded Reload
; ZVFHMIN64-NEXT:    fmv.h.x ft10, a5
; ZVFHMIN64-NEXT:    csrr a4, vlenb
; ZVFHMIN64-NEXT:    li a5, 12
; ZVFHMIN64-NEXT:    mul a4, a4, a5
; ZVFHMIN64-NEXT:    add a4, sp, a4
; ZVFHMIN64-NEXT:    lh a5, 832(a4) # 8-byte Folded Reload
; ZVFHMIN64-NEXT:    fmv.h.x ft11, a2
; ZVFHMIN64-NEXT:    csrr a2, vlenb
; ZVFHMIN64-NEXT:    li a4, 13
; ZVFHMIN64-NEXT:    mul a2, a2, a4
; ZVFHMIN64-NEXT:    add a2, sp, a2
; ZVFHMIN64-NEXT:    lh a2, 832(a2) # 8-byte Folded Reload
; ZVFHMIN64-NEXT:    fmv.h.x fs0, a5
; ZVFHMIN64-NEXT:    csrr a4, vlenb
...
; ZVFHMIN64-NEXT:    add a2, sp, a2
; ZVFHMIN64-NEXT:    lh a2, 832(a2) # 8-byte Folded Reload
; ZVFHMIN64-NEXT:    fmv.h.x fs2, a5
; ZVFHMIN64-NEXT:    csrr a4, vlenb
; ZVFHMIN64-NEXT:    slli a4, a4, 4
; ZVFHMIN64-NEXT:    add a4, sp, a4
; ZVFHMIN64-NEXT:    lh a5, 832(a4) # 8-byte Folded Reload
; ZVFHMIN64-NEXT:    fmv.h.x fs3, a2
; ZVFHMIN64-NEXT:    fmv.h.x ft2, a5
; ZVFHMIN64-NEXT:    fmv.h.x ft3, a0
; ZVFHMIN64-NEXT:    fmv.h.x ft4, a1
; ZVFHMIN64-NEXT:    fmv.h.x ft5, t0
; ZVFHMIN64-NEXT:    fmv.h.x ft9, s3
; ZVFHMIN64-NEXT:    fmv.h.x fa7, s4
; ZVFHMIN64-NEXT:    fmv.h.x ft7, s11
...
; ZVFHMIN64-NEXT:    vmv.x.s s8, v7
; ZVFHMIN64-NEXT:    fmv.h.x fa3, s10
; ZVFHMIN64-NEXT:    vmv.x.s s10, v17
; ZVFHMIN64-NEXT:    fmv.h.x fa2, s9
; ZVFHMIN64-NEXT:    vmv.x.s s9, v23
; ZVFHMIN64-NEXT:    fmv.h.x fa1, s7
; ZVFHMIN64-NEXT:    vmv.x.s s7, v21
; ZVFHMIN64-NEXT:    fmv.h.x fa0, s5
; ZVFHMIN64-NEXT:    vmv.x.s s11, v19
; ZVFHMIN64-NEXT:    fmv.h.x ft0, a3
; ZVFHMIN64-NEXT:    addi a3, sp, 256
; ZVFHMIN64-NEXT:    vsetvli zero, s2, e16, m8, ta, ma
; ZVFHMIN64-NEXT:    vse16.v v24, (a3)
; ZVFHMIN64-NEXT:    vmv.x.s a3, v24
; ZVFHMIN64-NEXT:    vmv.x.s s2, v3
; ZVFHMIN64-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
; ZVFHMIN64-NEXT:    vslidedown.vi v8, v24, 7
; ZVFHMIN64-NEXT:    fmv.h.x fs9, t6
; ZVFHMIN64-NEXT:    vmv.x.s t6, v8
; ZVFHMIN64-NEXT:    vslidedown.vi v8, v24, 6
; ZVFHMIN64-NEXT:    fmv.h.x fs10, a3
; ZVFHMIN64-NEXT:    vmv.x.s a0, v8
; ZVFHMIN64-NEXT:    vslidedown.vi v8, v24, 5
; ZVFHMIN64-NEXT:    fmv.h.x fs11, s6
; ZVFHMIN64-NEXT:    feq.h a3, fs8, fs9
; ZVFHMIN64-NEXT:    fmv.h.x fs8, s8
; ZVFHMIN64-NEXT:    vmv.x.s s8, v8
; ZVFHMIN64-NEXT:    vslidedown.vi v8, v24, 4
; ZVFHMIN64-NEXT:    fmv.h.x fs9, s10
; ZVFHMIN64-NEXT:    feq.h ra, fs7, fs10
; ZVFHMIN64-NEXT:    fmv.h.x fs7, s9
; ZVFHMIN64-NEXT:    vmv.x.s s9, v8
; ZVFHMIN64-NEXT:    vslidedown.vi v8, v24, 3
; ZVFHMIN64-NEXT:    fmv.h.x fs10, s7
; ZVFHMIN64-NEXT:    feq.h s5, fs6, fs11
; ZVFHMIN64-NEXT:    fmv.h.x fs6, s11
; ZVFHMIN64-NEXT:    vmv.x.s s10, v8
; ZVFHMIN64-NEXT:    vslidedown.vi v8, v24, 2
; ZVFHMIN64-NEXT:    fmv.h.x fs11, s2
; ZVFHMIN64-NEXT:    feq.h s6, fs5, fs8
; ZVFHMIN64-NEXT:    fmv.h.x fs5, t6
; ZVFHMIN64-NEXT:    vmv.x.s t6, v8
; ZVFHMIN64-NEXT:    vslidedown.vi v8, v24, 1
; ZVFHMIN64-NEXT:    fmv.h.x fs8, a0
; ZVFHMIN64-NEXT:    feq.h s7, fs4, fs9
; ZVFHMIN64-NEXT:    fmv.h.x fs4, s8
; ZVFHMIN64-NEXT:    vmv.x.s a0, v8
; ZVFHMIN64-NEXT:    fmv.h.x fs9, s9
; ZVFHMIN64-NEXT:    feq.h s8, ft1, fs7
; ZVFHMIN64-NEXT:    fmv.h.x ft1, s10
; ZVFHMIN64-NEXT:    feq.h s9, ft6, fs10
; ZVFHMIN64-NEXT:    fmv.h.x ft6, t6
; ZVFHMIN64-NEXT:    feq.h s10, fa6, fs6
; ZVFHMIN64-NEXT:    fmv.h.x fs6, a0
; ZVFHMIN64-NEXT:    feq.h s11, ft8, fs11
; ZVFHMIN64-NEXT:    fmv.h.x fs7, t1
; ZVFHMIN64-NEXT:    feq.h t1, ft10, fs5
; ZVFHMIN64-NEXT:    fmv.h.x ft10, t2
; ZVFHMIN64-NEXT:    feq.h t2, ft11, fs8
; ZVFHMIN64-NEXT:    fmv.h.x ft11, t3
; ZVFHMIN64-NEXT:    feq.h t3, fs0, fs4
; ZVFHMIN64-NEXT:    fmv.h.x fs0, t4
; ZVFHMIN64-NEXT:    feq.h t4, fs1, fs9
; ZVFHMIN64-NEXT:    fmv.h.x ft8, t5
; ZVFHMIN64-NEXT:    feq.h t5, fs2, ft1
; ZVFHMIN64-NEXT:    fmv.h.x fa6, a7
; ZVFHMIN64-NEXT:    feq.h t6, fs3, ft6
; ZVFHMIN64-NEXT:    fmv.h.x ft1, a6
; ZVFHMIN64-NEXT:    feq.h s2, ft2, fs6
; ZVFHMIN64-NEXT:    fmv.h.x ft2, a5
; ZVFHMIN64-NEXT:    feq.h a0, ft3, fs7
; ZVFHMIN64-NEXT:    sd a0, 88(sp) # 8-byte Folded Spill
; ZVFHMIN64-NEXT:    fmv.h.x ft3, s3
; ZVFHMIN64-NEXT:    feq.h a5, ft4, ft10
; ZVFHMIN64-NEXT:    fmv.h.x ft4, a4
; ZVFHMIN64-NEXT:    feq.h a6, ft5, ft11
; ZVFHMIN64-NEXT:    fmv.h.x ft5, a1
; ZVFHMIN64-NEXT:    lh a0, 704(sp)
; ZVFHMIN64-NEXT:    fmv.h.x ft6, a2
; ZVFHMIN64-NEXT:    feq.h a7, ft9, fs0
; ZVFHMIN64-NEXT:    fmv.h.x ft9, a0
; ZVFHMIN64-NEXT:    lh a0, 448(sp)
; ZVFHMIN64-NEXT:    fmv.h.x ft10, a0
; ZVFHMIN64-NEXT:    feq.h a0, ft9, ft10
...
; ZVFHMIN64-NEXT:    fmv.h.x ft7, a0
; ZVFHMIN64-NEXT:    lh a0, 466(sp)
; ZVFHMIN64-NEXT:    fmv.h.x fa6, a0
; ZVFHMIN64-NEXT:    feq.h a0, ft7, fa6
; ZVFHMIN64-NEXT:    sb a0, 169(sp)
; ZVFHMIN64-NEXT:    lh a0, 720(sp)
; ZVFHMIN64-NEXT:    fmv.h.x ft7, a0
; ZVFHMIN64-NEXT:    lh a0, 464(sp)
; ZVFHMIN64-NEXT:    fmv.h.x fa6, a0
; ZVFHMIN64-NEXT:    feq.h a0, ft7, fa6
; ZVFHMIN64-NEXT:    sb a0, 168(sp)
; ZVFHMIN64-NEXT:    lh a0, 718(sp)
; ZVFHMIN64-NEXT:    fmv.h.x ft7, a0
; ZVFHMIN64-NEXT:    lh a0, 462(sp)
; ZVFHMIN64-NEXT:    fmv.h.x fa6, a0
; ZVFHMIN64-NEXT:    feq.h a0, ft7, fa6
; ZVFHMIN64-NEXT:    sb a0, 167(sp)
; ZVFHMIN64-NEXT:    lh a0, 716(sp)
; ZVFHMIN64-NEXT:    fmv.h.x ft7, a0
; ZVFHMIN64-NEXT:    lh a0, 460(sp)
; ZVFHMIN64-NEXT:    fmv.h.x fa6, a0
; ZVFHMIN64-NEXT:    feq.h a0, ft7, fa6
; ZVFHMIN64-NEXT:    sb a0, 166(sp)
; ZVFHMIN64-NEXT:    lh a0, 714(sp)
; ZVFHMIN64-NEXT:    fmv.h.x ft7, a0
; ZVFHMIN64-NEXT:    lh a0, 458(sp)
; ZVFHMIN64-NEXT:    fmv.h.x fa6, a0
; ZVFHMIN64-NEXT:    feq.h a0, ft7, fa6
; ZVFHMIN64-NEXT:    sb a0, 165(sp)
; ZVFHMIN64-NEXT:    lh a0, 712(sp)
; ZVFHMIN64-NEXT:    fmv.h.x ft7, a0
; ZVFHMIN64-NEXT:    lh a0, 456(sp)
; ZVFHMIN64-NEXT:    fmv.h.x fa6, a0
; ZVFHMIN64-NEXT:    feq.h a0, ft7, fa6
; ZVFHMIN64-NEXT:    sb a0, 164(sp)
; ZVFHMIN64-NEXT:    lh a0, 710(sp)
; ZVFHMIN64-NEXT:    fmv.h.x ft7, a0
; ZVFHMIN64-NEXT:    lh a0, 454(sp)
; ZVFHMIN64-NEXT:    fmv.h.x fa6, a0
; ZVFHMIN64-NEXT:    feq.h a0, ft7, fa6
; ZVFHMIN64-NEXT:    sb a0, 163(sp)
; ZVFHMIN64-NEXT:    lh a0, 708(sp)
; ZVFHMIN64-NEXT:    fmv.h.x ft7, a0
; ZVFHMIN64-NEXT:    lh a0, 452(sp)
; ZVFHMIN64-NEXT:    fmv.h.x fa6, a0
; ZVFHMIN64-NEXT:    feq.h a0, ft7, fa6
; ZVFHMIN64-NEXT:    fmv.h.x ft7, s4
; ZVFHMIN64-NEXT:    sb a0, 162(sp)
; ZVFHMIN64-NEXT:    lh a1, 706(sp)
; ZVFHMIN64-NEXT:    lh a2, 450(sp)
; ZVFHMIN64-NEXT:    sb s11, 129(sp)
; ZVFHMIN64-NEXT:    feq.h s11, fa5, ft1
; ZVFHMIN64-NEXT:    sb s10, 130(sp)
; ZVFHMIN64-NEXT:    feq.h a0, fa4, ft2
; ZVFHMIN64-NEXT:    sb s9, 131(sp)
; ZVFHMIN64-NEXT:    feq.h s4, fa3, ft3
; ZVFHMIN64-NEXT:    sb s8, 132(sp)
; ZVFHMIN64-NEXT:    feq.h s8, fa2, ft4
; ZVFHMIN64-NEXT:    fmv.h.x fa5, a1
; ZVFHMIN64-NEXT:    feq.h s9, fa1, ft5
; ZVFHMIN64-NEXT:    fmv.h.x fa4, a2
; ZVFHMIN64-NEXT:    feq.h s10, fa0, ft6
; ZVFHMIN64-NEXT:    sb s7, 133(sp)
; ZVFHMIN64-NEXT:    feq.h s7, ft0, ft7
; ZVFHMIN64-NEXT:    sb s6, 134(sp)
...
; ZVFHMIN64-NEXT:    fmv.h.x fa4, a2
; ZVFHMIN64-NEXT:    feq.h a1, fa5, fa4
; ZVFHMIN64-NEXT:    sb t3, 197(sp)
; ZVFHMIN64-NEXT:    sb t2, 198(sp)
; ZVFHMIN64-NEXT:    sb t1, 199(sp)
...
; ZVFHMIN64-NEXT:    sb a7, 140(sp)
; ZVFHMIN64-NEXT:    sb a6, 141(sp)
; ZVFHMIN64-NEXT:    sb a5, 142(sp)
; ZVFHMIN64-NEXT:    ld a3, 88(sp) # 8-byte Folded Reload
; ZVFHMIN64-NEXT:    sb a3, 143(sp)
; ZVFHMIN64-NEXT:    sb a0, 136(sp)
; ZVFHMIN64-NEXT:    sb s11, 137(sp)
; ZVFHMIN64-NEXT:    sb ra, 138(sp)
; ZVFHMIN64-NEXT:    sb s3, 139(sp)
...
; ZVFHMIN64-NEXT:    sb s10, 204(sp)
; ZVFHMIN64-NEXT:    sb s9, 205(sp)
; ZVFHMIN64-NEXT:    sb s8, 206(sp)
; ZVFHMIN64-NEXT:    sb s4, 207(sp)
; ZVFHMIN64-NEXT:    feq.h a3, fa5, fa4
; ZVFHMIN64-NEXT:    sb a3, 200(sp)
; ZVFHMIN64-NEXT:    sb a0, 201(sp)
; ZVFHMIN64-NEXT:    sb a4, 202(sp)
; ZVFHMIN64-NEXT:    sb s7, 203(sp)
