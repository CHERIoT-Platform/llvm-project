...
; ZVFHMIN32-NEXT:    vslidedown.vi v6, v8, 13
...
; ZVFHMIN32-NEXT:    vslidedown.vi v27, v16, 6
; ZVFHMIN32-NEXT:    vslidedown.vi v21, v16, 5
...
; ZVFHMIN32-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
; ZVFHMIN32-NEXT:    vslidedown.vi v23, v0, 7
...
; ZVFHMIN32-NEXT:    vslidedown.vi v9, v0, 1
; ZVFHMIN32-NEXT:    vsetivli zero, 1, e16, m2, ta, ma
...
; ZVFHMIN32-NEXT:    vmv.x.s a2, v23
; ZVFHMIN32-NEXT:    vmv.x.s a4, v29
; ZVFHMIN32-NEXT:    fmv.h.x fa5, s10
; ZVFHMIN32-NEXT:    fmv.h.x fa4, s11
; ZVFHMIN32-NEXT:    feq.h s10, fa5, fa4
...
; ZVFHMIN32-NEXT:    vmv.x.s ra, v11
; ZVFHMIN32-NEXT:    vmv.x.s s11, v13
; ZVFHMIN32-NEXT:    fmv.h.x fa5, s10
; ZVFHMIN32-NEXT:    fmv.h.x fa4, a0
; ZVFHMIN32-NEXT:    feq.h a0, fa5, fa4
...
; ZVFHMIN32-NEXT:    lh s6, 848(sp) # 8-byte Folded Reload
; ZVFHMIN32-NEXT:    csrr a2, vlenb
; ZVFHMIN32-NEXT:    li a3, 18
; ZVFHMIN32-NEXT:    mul a2, a2, a3
; ZVFHMIN32-NEXT:    add a2, sp, a2
...
; ZVFHMIN64-NEXT:    vslidedown.vi v6, v8, 13
...
; ZVFHMIN64-NEXT:    vslidedown.vi v27, v16, 6
; ZVFHMIN64-NEXT:    vslidedown.vi v21, v16, 5
...
; ZVFHMIN64-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
; ZVFHMIN64-NEXT:    vslidedown.vi v23, v0, 7
...
; ZVFHMIN64-NEXT:    vslidedown.vi v9, v0, 1
; ZVFHMIN64-NEXT:    vsetivli zero, 1, e16, m2, ta, ma
...
; ZVFHMIN64-NEXT:    vmv.x.s a2, v23
; ZVFHMIN64-NEXT:    vmv.x.s a4, v29
; ZVFHMIN64-NEXT:    fmv.h.x fa5, s10
; ZVFHMIN64-NEXT:    fmv.h.x fa4, s11
; ZVFHMIN64-NEXT:    feq.h s10, fa5, fa4
...
; ZVFHMIN64-NEXT:    vmv.x.s ra, v11
; ZVFHMIN64-NEXT:    vmv.x.s s11, v13
; ZVFHMIN64-NEXT:    fmv.h.x fa5, s10
; ZVFHMIN64-NEXT:    fmv.h.x fa4, a0
; ZVFHMIN64-NEXT:    feq.h a0, fa5, fa4
...
; ZVFHMIN64-NEXT:    lh s6, 800(sp) # 8-byte Folded Reload
; ZVFHMIN64-NEXT:    csrr a2, vlenb
; ZVFHMIN64-NEXT:    li a3, 18
; ZVFHMIN64-NEXT:    mul a2, a2, a3
; ZVFHMIN64-NEXT:    add a2, sp, a2
