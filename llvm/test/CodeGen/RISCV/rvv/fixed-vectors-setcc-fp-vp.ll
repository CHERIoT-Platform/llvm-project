...
; ZVFHMIN32-NEXT:    lh t5, 730(sp)
; ZVFHMIN32-NEXT:    lh s8, 474(sp)
; ZVFHMIN32-NEXT:    csrr a0, vlenb
; ZVFHMIN32-NEXT:    li a1, 22
; ZVFHMIN32-NEXT:    mul a0, a0, a1
; ZVFHMIN32-NEXT:    add a0, sp, a0
; ZVFHMIN32-NEXT:    lh s1, 848(a0) # 8-byte Folded Reload
; ZVFHMIN32-NEXT:    vmv.x.s t6, v21
; ZVFHMIN32-NEXT:    fmv.h.x fa5, t5
; ZVFHMIN32-NEXT:    fmv.h.x fa4, s8
; ZVFHMIN32-NEXT:    feq.h t5, fa5, fa4
; ZVFHMIN32-NEXT:    sb t5, 173(sp)
; ZVFHMIN32-NEXT:    lh s8, 728(sp)
; ZVFHMIN32-NEXT:    lh s9, 472(sp)
; ZVFHMIN32-NEXT:    vmv.x.s t5, v23
; ZVFHMIN32-NEXT:    vmv.x.s s10, v9
; ZVFHMIN32-NEXT:    fmv.h.x fa5, s8
; ZVFHMIN32-NEXT:    fmv.h.x fa4, s9
; ZVFHMIN32-NEXT:    feq.h s8, fa5, fa4
; ZVFHMIN32-NEXT:    sb s8, 172(sp)
; ZVFHMIN32-NEXT:    lh s8, 726(sp)
; ZVFHMIN32-NEXT:    lh s9, 470(sp)
; ZVFHMIN32-NEXT:    vmv.x.s s11, v19
; ZVFHMIN32-NEXT:    vmv.x.s ra, v3
; ZVFHMIN32-NEXT:    fmv.h.x fa5, s8
; ZVFHMIN32-NEXT:    fmv.h.x fa4, s9
; ZVFHMIN32-NEXT:    feq.h s8, fa5, fa4
; ZVFHMIN32-NEXT:    sb s8, 171(sp)
; ZVFHMIN32-NEXT:    lh s8, 724(sp)
; ZVFHMIN32-NEXT:    lh s9, 468(sp)
; ZVFHMIN32-NEXT:    vmv.x.s a1, v13
; ZVFHMIN32-NEXT:    vmv.x.s a2, v15
; ZVFHMIN32-NEXT:    fmv.h.x fa5, s8
; ZVFHMIN32-NEXT:    fmv.h.x fa4, s9
; ZVFHMIN32-NEXT:    feq.h s8, fa5, fa4
; ZVFHMIN32-NEXT:    sb s8, 170(sp)
; ZVFHMIN32-NEXT:    lh s9, 722(sp)
; ZVFHMIN32-NEXT:    lh a0, 466(sp)
; ZVFHMIN32-NEXT:    vmv.x.s a3, v16
; ZVFHMIN32-NEXT:    vmv.x.s s8, v11
; ZVFHMIN32-NEXT:    fmv.h.x fa5, s9
; ZVFHMIN32-NEXT:    fmv.h.x fa4, a0
; ZVFHMIN32-NEXT:    feq.h a0, fa5, fa4
; ZVFHMIN32-NEXT:    sb a0, 169(sp)
; ZVFHMIN32-NEXT:    lh a0, 720(sp)
; ZVFHMIN32-NEXT:    lh s9, 464(sp)
...
; ZVFHMIN32-NEXT:    lh s9, 462(sp)
; ZVFHMIN32-NEXT:    feq.h s6, fa5, fa3
; ZVFHMIN32-NEXT:    fmv.h.x fa5, a0
; ZVFHMIN32-NEXT:    feq.h s7, fa4, fa2
; ZVFHMIN32-NEXT:    fmv.h.x fa4, s9
; ZVFHMIN32-NEXT:    feq.h a0, fa5, fa4
; ZVFHMIN32-NEXT:    fmv.h.x fa5, s5
; ZVFHMIN32-NEXT:    sb a0, 167(sp)
; ZVFHMIN32-NEXT:    lh a0, 716(sp)
; ZVFHMIN32-NEXT:    lh s5, 460(sp)
...
; ZVFHMIN32-NEXT:    lh s1, 450(sp)
; ZVFHMIN32-NEXT:    sb s2, 129(sp)
; ZVFHMIN32-NEXT:    sb a3, 130(sp)
; ZVFHMIN32-NEXT:    sb a2, 131(sp)
; ZVFHMIN32-NEXT:    sb a1, 132(sp)
; ZVFHMIN32-NEXT:    fmv.h.x fa5, a0
; ZVFHMIN32-NEXT:    fmv.h.x fa4, s1
; ZVFHMIN32-NEXT:    feq.h a0, fa5, fa4
; ZVFHMIN32-NEXT:    sb s9, 133(sp)
; ZVFHMIN32-NEXT:    sb s7, 134(sp)
; ZVFHMIN32-NEXT:    sb s6, 135(sp)
; ZVFHMIN32-NEXT:    sb a0, 161(sp)
; ZVFHMIN32-NEXT:    lh a0, 610(sp)
; ZVFHMIN32-NEXT:    lh a1, 354(sp)
; ZVFHMIN32-NEXT:    vmv.x.s s5, v29
...
; ZVFHMIN32-NEXT:    mul a2, a2, a3
; ZVFHMIN32-NEXT:    add a2, sp, a2
; ZVFHMIN32-NEXT:    lh s1, 848(a2) # 8-byte Folded Reload
; ZVFHMIN32-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
...
; ZVFHMIN32-NEXT:    sb s1, 193(sp)
; ZVFHMIN32-NEXT:    sb s2, 194(sp)
; ZVFHMIN32-NEXT:    sb s3, 195(sp)
; ZVFHMIN32-NEXT:    sb a3, 196(sp)
; ZVFHMIN32-NEXT:    fmv.h.x fa5, a0
; ZVFHMIN32-NEXT:    fmv.h.x fa4, a1
; ZVFHMIN32-NEXT:    feq.h a0, fa5, fa4
; ZVFHMIN32-NEXT:    sb a2, 197(sp)
; ZVFHMIN32-NEXT:    sb t5, 198(sp)
; ZVFHMIN32-NEXT:    sb t6, 199(sp)
...
; ZVFHMIN32-NEXT:    slli s2, a3, 3
; ZVFHMIN32-NEXT:    sub a3, s2, a3
...
; ZVFHMIN64-NEXT:    lh t5, 730(sp)
; ZVFHMIN64-NEXT:    lh s8, 474(sp)
; ZVFHMIN64-NEXT:    csrr a0, vlenb
; ZVFHMIN64-NEXT:    li a1, 22
; ZVFHMIN64-NEXT:    mul a0, a0, a1
; ZVFHMIN64-NEXT:    add a0, sp, a0
; ZVFHMIN64-NEXT:    lh s1, 800(a0) # 8-byte Folded Reload
; ZVFHMIN64-NEXT:    vmv.x.s t6, v21
; ZVFHMIN64-NEXT:    fmv.h.x fa5, t5
; ZVFHMIN64-NEXT:    fmv.h.x fa4, s8
; ZVFHMIN64-NEXT:    feq.h t5, fa5, fa4
; ZVFHMIN64-NEXT:    sb t5, 173(sp)
; ZVFHMIN64-NEXT:    lh s8, 728(sp)
; ZVFHMIN64-NEXT:    lh s9, 472(sp)
; ZVFHMIN64-NEXT:    vmv.x.s t5, v23
; ZVFHMIN64-NEXT:    vmv.x.s s10, v9
; ZVFHMIN64-NEXT:    fmv.h.x fa5, s8
; ZVFHMIN64-NEXT:    fmv.h.x fa4, s9
; ZVFHMIN64-NEXT:    feq.h s8, fa5, fa4
; ZVFHMIN64-NEXT:    sb s8, 172(sp)
; ZVFHMIN64-NEXT:    lh s8, 726(sp)
; ZVFHMIN64-NEXT:    lh s9, 470(sp)
; ZVFHMIN64-NEXT:    vmv.x.s s11, v19
; ZVFHMIN64-NEXT:    vmv.x.s ra, v3
; ZVFHMIN64-NEXT:    fmv.h.x fa5, s8
; ZVFHMIN64-NEXT:    fmv.h.x fa4, s9
; ZVFHMIN64-NEXT:    feq.h s8, fa5, fa4
; ZVFHMIN64-NEXT:    sb s8, 171(sp)
; ZVFHMIN64-NEXT:    lh s8, 724(sp)
; ZVFHMIN64-NEXT:    lh s9, 468(sp)
; ZVFHMIN64-NEXT:    vmv.x.s a1, v13
; ZVFHMIN64-NEXT:    vmv.x.s a2, v15
; ZVFHMIN64-NEXT:    fmv.h.x fa5, s8
; ZVFHMIN64-NEXT:    fmv.h.x fa4, s9
; ZVFHMIN64-NEXT:    feq.h s8, fa5, fa4
; ZVFHMIN64-NEXT:    sb s8, 170(sp)
; ZVFHMIN64-NEXT:    lh s9, 722(sp)
; ZVFHMIN64-NEXT:    lh a0, 466(sp)
; ZVFHMIN64-NEXT:    vmv.x.s a3, v16
; ZVFHMIN64-NEXT:    vmv.x.s s8, v11
; ZVFHMIN64-NEXT:    fmv.h.x fa5, s9
; ZVFHMIN64-NEXT:    fmv.h.x fa4, a0
; ZVFHMIN64-NEXT:    feq.h a0, fa5, fa4
; ZVFHMIN64-NEXT:    sb a0, 169(sp)
; ZVFHMIN64-NEXT:    lh a0, 720(sp)
; ZVFHMIN64-NEXT:    lh s9, 464(sp)
...
; ZVFHMIN64-NEXT:    lh s9, 462(sp)
; ZVFHMIN64-NEXT:    feq.h s6, fa5, fa3
; ZVFHMIN64-NEXT:    fmv.h.x fa5, a0
; ZVFHMIN64-NEXT:    feq.h s7, fa4, fa2
; ZVFHMIN64-NEXT:    fmv.h.x fa4, s9
; ZVFHMIN64-NEXT:    feq.h a0, fa5, fa4
; ZVFHMIN64-NEXT:    fmv.h.x fa5, s5
; ZVFHMIN64-NEXT:    sb a0, 167(sp)
; ZVFHMIN64-NEXT:    lh a0, 716(sp)
; ZVFHMIN64-NEXT:    lh s5, 460(sp)
...
; ZVFHMIN64-NEXT:    lh s1, 450(sp)
; ZVFHMIN64-NEXT:    sb s2, 129(sp)
; ZVFHMIN64-NEXT:    sb a3, 130(sp)
; ZVFHMIN64-NEXT:    sb a2, 131(sp)
; ZVFHMIN64-NEXT:    sb a1, 132(sp)
; ZVFHMIN64-NEXT:    fmv.h.x fa5, a0
; ZVFHMIN64-NEXT:    fmv.h.x fa4, s1
; ZVFHMIN64-NEXT:    feq.h a0, fa5, fa4
; ZVFHMIN64-NEXT:    sb s9, 133(sp)
; ZVFHMIN64-NEXT:    sb s7, 134(sp)
; ZVFHMIN64-NEXT:    sb s6, 135(sp)
; ZVFHMIN64-NEXT:    sb a0, 161(sp)
; ZVFHMIN64-NEXT:    lh a0, 610(sp)
; ZVFHMIN64-NEXT:    lh a1, 354(sp)
; ZVFHMIN64-NEXT:    vmv.x.s s5, v29
...
; ZVFHMIN64-NEXT:    mul a2, a2, a3
; ZVFHMIN64-NEXT:    add a2, sp, a2
; ZVFHMIN64-NEXT:    lh s1, 800(a2) # 8-byte Folded Reload
; ZVFHMIN64-NEXT:    vsetivli zero, 1, e16, m1, ta, ma
...
; ZVFHMIN64-NEXT:    sb s1, 193(sp)
; ZVFHMIN64-NEXT:    sb s2, 194(sp)
; ZVFHMIN64-NEXT:    sb s3, 195(sp)
; ZVFHMIN64-NEXT:    sb a3, 196(sp)
; ZVFHMIN64-NEXT:    fmv.h.x fa5, a0
; ZVFHMIN64-NEXT:    fmv.h.x fa4, a1
; ZVFHMIN64-NEXT:    feq.h a0, fa5, fa4
; ZVFHMIN64-NEXT:    sb a2, 197(sp)
; ZVFHMIN64-NEXT:    sb t5, 198(sp)
; ZVFHMIN64-NEXT:    sb t6, 199(sp)
...
; ZVFHMIN64-NEXT:    slli s2, a3, 3
; ZVFHMIN64-NEXT:    sub a3, s2, a3
