...
; RV64ZB-PURECAP:       # %bb.0:
; RV64ZB-PURECAP-NEXT:    cincoffset sp, sp, -256
; RV64ZB-PURECAP-NEXT:    csc ra, 240(sp) # 16-byte Folded Spill
; RV64ZB-PURECAP-NEXT:    csc gp, 224(sp) # 16-byte Folded Spill
; RV64ZB-PURECAP-NEXT:    csc tp, 208(sp) # 16-byte Folded Spill
; RV64ZB-PURECAP-NEXT:    csc s0, 192(sp) # 16-byte Folded Spill
; RV64ZB-PURECAP-NEXT:    csc s1, 176(sp) # 16-byte Folded Spill
; RV64ZB-PURECAP-NEXT:    csc s2, 160(sp) # 16-byte Folded Spill
; RV64ZB-PURECAP-NEXT:    csc s3, 144(sp) # 16-byte Folded Spill
; RV64ZB-PURECAP-NEXT:    csc s4, 128(sp) # 16-byte Folded Spill
; RV64ZB-PURECAP-NEXT:    csc s5, 112(sp) # 16-byte Folded Spill
; RV64ZB-PURECAP-NEXT:    csc s6, 96(sp) # 16-byte Folded Spill
; RV64ZB-PURECAP-NEXT:    csc s7, 80(sp) # 16-byte Folded Spill
; RV64ZB-PURECAP-NEXT:    csc s8, 64(sp) # 16-byte Folded Spill
...
; RV64ZB-PURECAP-NEXT:    cld a0, 0(sp) # 8-byte Folded Reload
; RV64ZB-PURECAP-NEXT:    srliw a0, a0, 31
; RV64ZB-PURECAP-NEXT:  .LBB0_3: # %falsebb
; RV64ZB-PURECAP-NEXT:    clc ra, 240(sp) # 16-byte Folded Reload
; RV64ZB-PURECAP-NEXT:    clc gp, 224(sp) # 16-byte Folded Reload
; RV64ZB-PURECAP-NEXT:    clc tp, 208(sp) # 16-byte Folded Reload
; RV64ZB-PURECAP-NEXT:    clc s0, 192(sp) # 16-byte Folded Reload
; RV64ZB-PURECAP-NEXT:    clc s1, 176(sp) # 16-byte Folded Reload
; RV64ZB-PURECAP-NEXT:    clc s2, 160(sp) # 16-byte Folded Reload
; RV64ZB-PURECAP-NEXT:    clc s3, 144(sp) # 16-byte Folded Reload
; RV64ZB-PURECAP-NEXT:    clc s4, 128(sp) # 16-byte Folded Reload
; RV64ZB-PURECAP-NEXT:    clc s5, 112(sp) # 16-byte Folded Reload
; RV64ZB-PURECAP-NEXT:    clc s6, 96(sp) # 16-byte Folded Reload
; RV64ZB-PURECAP-NEXT:    clc s7, 80(sp) # 16-byte Folded Reload
; RV64ZB-PURECAP-NEXT:    clc s8, 64(sp) # 16-byte Folded Reload
; RV64ZB-PURECAP-NEXT:    clc s9, 48(sp) # 16-byte Folded Reload
; RV64ZB-PURECAP-NEXT:    clc s10, 32(sp) # 16-byte Folded Reload
; RV64ZB-PURECAP-NEXT:    clc s11, 16(sp) # 16-byte Folded Reload
; RV64ZB-PURECAP-NEXT:    cincoffset sp, sp, 256
...
; RV64ZB-PURECAP-NEXT:    clb a0, 0(sp) # 8-byte Folded Reload
...
; RV64ZB-PURECAP-NEXT:    clh a0, 0(sp) # 8-byte Folded Reload
...
; RV64ZB-PURECAP-NEXT:    clbu a0, 0(sp) # 8-byte Folded Reload
...
; RV64ZB-PURECAP-NEXT:    clhu a0, 0(sp) # 8-byte Folded Reload
...
; RV64ZB-PURECAP-NEXT:    clwu a0, 0(sp) # 8-byte Folded Reload
