...
# RUN:     | FileCheck %s
hello:
        cincoffset ca0, cgp, %cheriot_compartment_lo_cincoffset(haha)
        # CHECK: fixup A - offset: 0, value: %cheriot_compartment_lo_cincoffset(haha), kind: fixup_riscv_cheriot_compartment_lo_cincoffset
