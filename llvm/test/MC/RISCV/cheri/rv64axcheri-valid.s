...
lr.d.ddc x1, (x2)
# CHECK-ASM-AND-OBJ: lr.c.ddc ra, (sp)
...
sc.d.ddc x1, (x2)
# CHECK-ASM-AND-OBJ: sc.c.ddc ra, (sp)
# CHECK-ASM: encoding: [0x5b,0x0a,0x11,0xf8]
sc.c.ddc c1, (x2)

# CHECK-ASM-AND-OBJ: lr.d.cap ra, (sp)
# CHECK-ASM: encoding: [0xdb,0x00,0xb1,0xfb]
lr.d.cap x1, (c2)
# CHECK-ASM-AND-OBJ: lr.c.cap ra, (sp)
# CHECK-ASM: encoding: [0xdb,0x00,0xc1,0xfb]
lr.c.cap c1, (c2)

# CHECK-ASM-AND-OBJ: sc.d.cap ra, (sp)
# CHECK-ASM: encoding: [0xdb,0x0d,0x11,0xf8]
sc.d.cap x1, (c2)
# CHECK-ASM-AND-OBJ: sc.c.cap ra, (sp)
