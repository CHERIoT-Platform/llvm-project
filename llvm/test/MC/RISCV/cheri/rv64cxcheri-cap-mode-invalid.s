...
c.clccsp cra, 40(csp)
# CHECK-RV64: <stdin>:[[#@LINE-1]]:1: error: invalid instruction
# CHECK-RV64-NO-C: <stdin>:[[#@LINE-2]]:1: error: instruction requires the following: 'C' (Compressed Instructions) or 'Zca' (part of the C extension, excluding compressed floating point loads/stores), RV32I Base Instruction Set
...
## FIXME: With missing C this should report "instruction requires the following"
# CHECK-RV64-NO-C: <stdin>:[[#@LINE-3]]:1: error: invalid instruction
# CHECK-RV32: <stdin>:[[#@LINE-4]]:1: error: invalid instruction
