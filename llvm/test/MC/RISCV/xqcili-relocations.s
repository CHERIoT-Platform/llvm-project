...
# OBJ-NEXT: R_RISCV_CHERI_CAPTAB_PCREL_HI20 undef{{$}}
...
# OBJ-NEXT: R_RISCV_VENDOR QUALCOMM{{$}}
# OBJ-NEXT: R_RISCV_CHERI_CAPTAB_PCREL_HI20 same_section{{$}}
...
# OBJ-NEXT: R_RISCV_VENDOR QUALCOMM{{$}}
# OBJ-NEXT: R_RISCV_CHERI_CAPTAB_PCREL_HI20 other_section{{$}}
...
# OBJ: qc.li a1, 0x0
# OBJ-NEXT: R_RISCV_VENDOR QUALCOMM{{$}}
# OBJ-NEXT: R_RISCV_CHERI_CAPTAB_PCREL_HI20 *ABS*{{$}}
