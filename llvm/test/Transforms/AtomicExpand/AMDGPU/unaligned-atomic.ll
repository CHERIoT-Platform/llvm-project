...
; GCN-NEXT:    call void @__atomic_load(i64 4, ptr addrspace(5) [[TMP2]], ptr addrspace(5) [[TMP3]], i32 5)
...
; GCN-NEXT:    call void @__atomic_store(i64 4, ptr addrspace(5) [[TMP2]], ptr addrspace(5) [[TMP3]], i32 0)
; GCN-NEXT:    call void @llvm.lifetime.end.p5(i64 4, ptr addrspace(5) [[TMP3]])
; GCN-NEXT:    ret void
;
