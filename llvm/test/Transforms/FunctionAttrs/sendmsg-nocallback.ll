...
; FNATTRS: attributes #[[ATTR2:[0-9]+]] = { hassideeffects nocallback nounwind willreturn }
; FNATTRS: attributes #[[ATTR3:[0-9]+]] = { hassideeffects nocallback nounwind }
;.
; ATTRIBUTOR: attributes #[[ATTR0]] = { mustprogress norecurse nounwind willreturn }
; ATTRIBUTOR: attributes #[[ATTR1]] = { norecurse nounwind }
; ATTRIBUTOR: attributes #[[ATTR2:[0-9]+]] = { hassideeffects nocallback nounwind willreturn }
; ATTRIBUTOR: attributes #[[ATTR3:[0-9]+]] = { hassideeffects nocallback nounwind }
