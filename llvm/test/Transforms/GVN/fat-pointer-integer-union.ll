...
; RUN: %cheri_opt -S -passes=gvn %s | FileCheck %s
; ModuleID = 'union2.c'
...
define i32 @bar(ptr addrspace(200) inreg %u.coerce) addrspace(200) #0 {
; CHECK-LABEL: define {{[^@]+}}@bar
; CHECK-SAME: (ptr addrspace(200) inreg [[U_COERCE:%.*]]) addrspace(200) #[[ATTR0:[0-9]+]] {
; CHECK-NEXT:  entry:
...
;
entry:
  %u.sroa.0.sroa.0 = alloca ptr addrspace(200), align 32, addrspace(200)
