...
;
  %offset = tail call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) %arg)
  %ret = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) %arg, i64 %offset)
...
; CHECK-NEXT:    [[OFFSET:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) [[ARG]])
; CHECK-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) [[ARG2]], i64 [[OFFSET]])
; CHECK-NEXT:    ret ptr addrspace(200) [[RET]]
;
  %offset = tail call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) %arg)
  %ret = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) %arg2, i64 %offset)
  ret ptr addrspace(200) %ret
}
...
;
  ...
  %ret = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) %arg, i64 %new_offset)
  ret ptr addrspace(200) %ret
}
...
; CHECK-NEXT:    ret ptr addrspace(200) [[ARG]]
;
  %addr = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) %arg)
  %ret = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) %arg, i64 %addr)
  ret ptr addrspace(200) %ret
}
...
; CHECK-SAME: (ptr addrspace(200) [[ARG:%.*]], ptr addrspace(200) [[ARG2:%.*]]) addrspace(200) #[[ATTR0]] {
; CHECK-NEXT:    [[ADDR:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) [[ARG]])
; CHECK-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) [[ARG2]], i64 [[ADDR]])
; CHECK-NEXT:    ret ptr addrspace(200) [[RET]]
;
  %addr = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) %arg)
  %ret = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) %arg2, i64 %addr)
  ret ptr addrspace(200) %ret
}
...
; CHECK-NEXT:    ret ptr addrspace(200) [[RET]]
;
  %offset = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) %arg)
  %new_offset = add i64 %offset, 25
  %ret = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) %arg, i64 %new_offset)
  ret ptr addrspace(200) %ret
}
...
;
entry:
  %tmp2 = call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) null, i64 %x)
  %tmp3 = call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) %cap)
  %tmp4 = call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) %tmp2)
  %add = add i64 %tmp3, %tmp4
  %tmp5 = call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) %cap, i64 %add)
  %tmp8 = call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) null, i64 %y)
  %tmp9 = call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) %tmp5)
  %tmp10 = call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) %tmp8)
  %add1 = add i64 %tmp9, %tmp10
  %tmp11 = call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) %tmp5, i64 %add1)
...
;
entry:
  %tmp2 = call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) null, i64 %x)
  %tmp3 = call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) %cap)
  %tmp4 = call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) %tmp2)
  %add = add i64 %tmp3, %tmp4
  %tmp5 = call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) %cap, i64 %add)
  %tmp8 = call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) null, i64 %y)
  %tmp9 = call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) %tmp5)
  %tmp10 = call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) %tmp8)
  %add1 = add i64 %tmp9, %tmp10
  %tmp11 = call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) %tmp5, i64 %add1)
  ret ptr addrspace(200) %tmp11
}
