...
define i64 @null_get_offset() addrspace(200) nounwind {
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) null)
  ret i64 %ret
...
define i64 @null_get_base() addrspace(200) nounwind {
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.base.get.i64(ptr addrspace(200) null)
  ret i64 %ret
...
define i64 @null_get_address() addrspace(200) nounwind {
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) null)
  ret i64 %ret
...
define i64 @null_get_perms() addrspace(200) nounwind {
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.perms.get.i64(ptr addrspace(200) null)
  ret i64 %ret
...
define i64 @null_get_flags() addrspace(200) nounwind {
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.flags.get.i64(ptr addrspace(200) null)
  ret i64 %ret
...
define i64 @null_get_sealed() addrspace(200) nounwind {
  %ret = tail call addrspace(200) i1 @llvm.cheri.cap.sealed.get(ptr addrspace(200) null)
...
define i64 @null_get_tag() addrspace(200) nounwind {
  %ret = tail call addrspace(200) i1 @llvm.cheri.cap.tag.get(ptr addrspace(200) null)
  %ret.ext = zext i1 %ret to i64
  ret i64 %ret.ext
...
define i64 @null_get_tag_temporal() addrspace(200) nounwind {
  %ret = tail call addrspace(200) i1 @llvm.cheri.cap.tag.get.temporal(ptr addrspace(200) null)
  %ret.ext = zext i1 %ret to i64
  ret i64 %ret.ext
...
define i64 @null_get_length() addrspace(200) nounwind {
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.length.get.i64(ptr addrspace(200) null)
  ret i64 %ret
  ; CHECK-LABEL: @null_get_length()
  ; CHECK-NEXT:  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.length.get.i64(ptr addrspace(200) null)
  ; CHECK-NEXT:  ret i64 %ret
}
define i64 @null_get_type() addrspace(200) nounwind {
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.type.get.i64(ptr addrspace(200) null)
  ret i64 %ret
  ; CHECK-LABEL: @null_get_type()
  ; CHECK-NEXT:  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.type.get.i64(ptr addrspace(200) null)
  ; CHECK-NEXT:  ret i64 %ret
}
...
define void @infer_values_from_null_set_offset() addrspace(200) nounwind {
  ...
  %with_offset = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) null, i64 123456)

  %base = tail call addrspace(200) i64 @llvm.cheri.cap.base.get.i64(ptr addrspace(200) nonnull %with_offset)
  %base_check = tail call addrspace(200) i64 @check_fold(i64 %base)
  ; CHECK:  %base_check = tail call addrspace(200) i64 @check_fold(i64 0)

  %offset = tail call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) nonnull %with_offset)
  %offset_check = tail call addrspace(200) i64 @check_fold(i64 %offset)
  ; CHECK:  %offset_check = tail call addrspace(200) i64 @check_fold(i64 123456)

  %address = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) nonnull %with_offset)
  %address_check = tail call addrspace(200) i64 @check_fold(i64 %address)
  ; CHECK:  %address_check = tail call addrspace(200) i64 @check_fold(i64 123456)

  %sealed = tail call addrspace(200) i1 @llvm.cheri.cap.sealed.get(ptr addrspace(200) nonnull %with_offset)
  %sealed.ext = zext i1 %sealed to i64
  %sealed_check = tail call addrspace(200) i64 @check_fold(i64 %sealed.ext)
  ; CHECK:  %sealed_check = tail call addrspace(200) i64 @check_fold(i64 0)

  %perms = tail call addrspace(200) i64 @llvm.cheri.cap.perms.get.i64(ptr addrspace(200) nonnull %with_offset)
  %perms_check = tail call addrspace(200) i64 @check_fold(i64 %perms)
  ; CHECK:  %perms_check = tail call addrspace(200) i64 @check_fold(i64 0)

  %flags = tail call addrspace(200) i64 @llvm.cheri.cap.flags.get.i64(ptr addrspace(200) nonnull %with_offset)
  %flags_check = tail call addrspace(200) i64 @check_fold(i64 %flags)
  ; CHECK:  %flags_check = tail call addrspace(200) i64 @check_fold(i64 0)

  %tag = tail call addrspace(200) i1 @llvm.cheri.cap.tag.get(ptr addrspace(200) nonnull %with_offset)
  %tag.ext = zext i1 %tag to i64
  %tag_check = tail call addrspace(200) i64 @check_fold(i64 %tag.ext)
  ; CHECK:  %tag_check = tail call addrspace(200) i64 @check_fold(i64 0)

  ; Length and type should not be optimized:
  %length = tail call addrspace(200) i64 @llvm.cheri.cap.length.get.i64(ptr addrspace(200) nonnull %with_offset)
  %length_check = tail call addrspace(200) i64 @check_fold(i64 %length)
  ; CHECK: %length = tail call addrspace(200) i64 @llvm.cheri.cap.length.get.i64(ptr addrspace(200) nonnull getelementptr (i8, ptr addrspace(200) null, i64 123456))
  ; CHECK: %length_check = tail call addrspace(200) i64 @check_fold(i64 %length)
  %type = tail call addrspace(200) i64 @llvm.cheri.cap.type.get.i64(ptr addrspace(200) nonnull %with_offset)
  %type_check = tail call addrspace(200) i64 @check_fold(i64 %type)
  ; CHECK:  %type = tail call addrspace(200) i64 @llvm.cheri.cap.type.get.i64(ptr addrspace(200) nonnull getelementptr (i8, ptr addrspace(200) null, i64 123456))
  ; CHECK:  %type_check = tail call addrspace(200) i64 @check_fold(i64 %type)
...
define void @infer_values_from_null_set_address() addrspace(200) nounwind {
  ...
  %with_offset = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) null, i64 123456)
...
define void @infer_values_from_arg_set_address(ptr addrspace(200) %arg) addrspace(200) nounwind {
  ...
  %with_offset = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) %arg, i64 123456)

  %base = tail call addrspace(200) i64 @llvm.cheri.cap.base.get.i64(ptr addrspace(200) nonnull %with_offset)
  %base_check = tail call addrspace(200) i64 @check_fold(i64 %base)
  ; CHECK: %base = tail call addrspace(200) i64 @llvm.cheri.cap.base.get.i64(ptr addrspace(200) nonnull %with_offset)
  ; CHECK: %base_check = tail call addrspace(200) i64 @check_fold(i64 %base)

  %length = tail call addrspace(200) i64 @llvm.cheri.cap.length.get.i64(ptr addrspace(200) nonnull %with_offset)
  %length_check = tail call addrspace(200) i64 @check_fold(i64 %length)
  ; CHECK: %length = tail call addrspace(200) i64 @llvm.cheri.cap.length.get.i64(ptr addrspace(200) nonnull %with_offset)
  ; CHECK: %length_check = tail call addrspace(200) i64 @check_fold(i64 %length)

  %offset = tail call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) nonnull %with_offset)
  %offset_check = tail call addrspace(200) i64 @check_fold(i64 %offset)
  ; CHECK: %offset = tail call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) nonnull %with_offset)
  ; CHECK: %offset_check = tail call addrspace(200) i64 @check_fold(i64 %offset)
  ...
  %type = tail call addrspace(200) i64 @llvm.cheri.cap.type.get.i64(ptr addrspace(200) nonnull %with_offset)
  %type_check = tail call addrspace(200) i64 @check_fold(i64 %type)
  ; CHECK: %type = tail call addrspace(200) i64 @llvm.cheri.cap.type.get.i64(ptr addrspace(200) nonnull %with_offset)
  ; CHECK: %type_check = tail call addrspace(200) i64 @check_fold(i64 %type)

  %sealed = tail call addrspace(200) i1 @llvm.cheri.cap.sealed.get(ptr addrspace(200) nonnull %with_offset)
  %sealed.ext = zext i1 %sealed to i64
  %sealed_check = tail call addrspace(200) i64 @check_fold(i64 %sealed.ext)
  ; CHECK: %sealed = tail call addrspace(200) i1 @llvm.cheri.cap.sealed.get(ptr addrspace(200) nonnull %with_offset)
  ; CHECK: %sealed.ext = zext i1 %sealed to i64
  ; CHECK: %sealed_check = tail call addrspace(200) i64 @check_fold(i64 %sealed.ext)

  %perms = tail call addrspace(200) i64 @llvm.cheri.cap.perms.get.i64(ptr addrspace(200) nonnull %with_offset)
  %perms_check = tail call addrspace(200) i64 @check_fold(i64 %perms)
  ; CHECK: %perms = tail call addrspace(200) i64 @llvm.cheri.cap.perms.get.i64(ptr addrspace(200) nonnull %with_offset)
  ; CHECK: %perms_check = tail call addrspace(200) i64 @check_fold(i64 %perms)

  %flags = tail call addrspace(200) i64 @llvm.cheri.cap.flags.get.i64(ptr addrspace(200) nonnull %with_offset)
  %flags_check = tail call addrspace(200) i64 @check_fold(i64 %flags)
  ; CHECK: %flags = tail call addrspace(200) i64 @llvm.cheri.cap.flags.get.i64(ptr addrspace(200) nonnull %with_offset)
  ; CHECK: %flags_check = tail call addrspace(200) i64 @check_fold(i64 %flags)

  %tag = tail call addrspace(200) i1 @llvm.cheri.cap.tag.get(ptr addrspace(200) nonnull %with_offset)
  %tag.ext = zext i1 %tag to i64
  %tag_check = tail call addrspace(200) i64 @check_fold(i64 %tag.ext)
  ; CHECK: %tag = tail call addrspace(200) i1 @llvm.cheri.cap.tag.get(ptr addrspace(200) nonnull %with_offset)
  ; CHECK: %tag.ext = zext i1 %tag to i64
  ; CHECK: %tag_check = tail call addrspace(200) i64 @check_fold(i64 %tag.ext)
...
define void @infer_values_from_arg_set_offset(ptr addrspace(200) %arg) addrspace(200) nounwind {
  ...
  %with_offset = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) %arg, i64 123456)
  ...
  %address = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) nonnull %with_offset)
  %address_check = tail call addrspace(200) i64 @check_fold(i64 %address)
  ; CHECK: %address = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) nonnull %with_offset)
  ; CHECK: %address_check = tail call addrspace(200) i64 @check_fold(i64 %address)
...
define i64 @fold_set_offset_arg(ptr addrspace(200) %arg) addrspace(200) nounwind {
  ...
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) nonnull %with_offset)
  ret i64 %ret
...
define i64 @no_fold_set_offset_get_address(ptr addrspace(200) %arg) addrspace(200) nounwind {
  %with_offset = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) %arg, i64 42)
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) nonnull %with_offset)
  ret i64 %ret
  ...
  ; CHECK: %with_offset = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) %arg, i64 42)
  ; CHECK: %ret = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) nonnull %with_offset)
  ; CHECK: ret i64 %ret
}
...
define i64 @no_fold_set_offset_get_tag(ptr addrspace(200) %arg) addrspace(200) nounwind {
  %with_offset = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) %arg, i64 42)
  %ret = tail call addrspace(200) i1 @llvm.cheri.cap.tag.get(ptr addrspace(200) nonnull %with_offset)
  %ret.ext = zext i1 %ret to i64
  ret i64 %ret.ext
  ...
  ; CHECK: %with_offset = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) %arg, i64 42)
  ; CHECK: %ret = tail call addrspace(200) i1 @llvm.cheri.cap.tag.get(ptr addrspace(200) nonnull %with_offset)
...
define i64 @fold_null_set_address_get_offset() addrspace(200) nounwind {
  %setaddr = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) null, i64 100)
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) %setaddr)
  ret i64 %ret
...
define i64 @fold_null_set_address_offset_get_address() addrspace(200) nounwind {
  %setaddr = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) null, i64 100)
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) %setaddr)
  ret i64 %ret
...
define i64 @fold_base_get_inttoptr() addrspace(200) nounwind {
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.base.get.i64(ptr addrspace(200) inttoptr (i64 100 to ptr addrspace(200)))
  ret i64 %ret
...
define i64 @fold_tag_get_inttoptr() addrspace(200) nounwind {
  %ret = tail call addrspace(200) i1 @llvm.cheri.cap.tag.get(ptr addrspace(200) inttoptr (i64 100 to ptr addrspace(200)))
  %ret.ext = zext i1 %ret to i64
  ret i64 %ret.ext
...
define i64 @fold_offset_get_inttoptr() addrspace(200) nounwind {
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) inttoptr (i64 100 to ptr addrspace(200)))
  ret i64 %ret
...
define i64 @fold_address_get_inttoptr() addrspace(200) nounwind {
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) inttoptr (i64 100 to ptr addrspace(200)))
  ret i64 %ret
...
define i64 @fold_type_get_inttoptr() addrspace(200) nounwind {
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.type.get.i64(ptr addrspace(200) inttoptr (i64 100 to ptr addrspace(200)))
  ret i64 %ret
  ; CHECK-LABEL: @fold_type_get_inttoptr()
  ; CHECK-NEXT: %ret = tail call addrspace(200) i64 @llvm.cheri.cap.type.get.i64(ptr addrspace(200) nonnull inttoptr (i64 100 to ptr addrspace(200)))
  ; CHECK-NEXT: ret i64 %ret
}

define i64 @fold_length_get_inttoptr() addrspace(200) nounwind {
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.length.get.i64(ptr addrspace(200) inttoptr (i64 100 to ptr addrspace(200)))
  ret i64 %ret
  ; CHECK-LABEL: @fold_length_get_inttoptr()
  ; CHECK-NEXT: %ret = tail call addrspace(200) i64 @llvm.cheri.cap.length.get.i64(ptr addrspace(200) nonnull inttoptr (i64 100 to ptr addrspace(200)))
  ; CHECK-NEXT: ret i64 %ret
}
...
define ptr addrspace(200) @fold_set_offset_inc_offset(ptr addrspace(200) %arg) addrspace(200) nounwind {
  ...
  ; CHECK: call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) %arg, i64 242)
}

define ptr addrspace(200) @fold_set_inc_gep_sequence() local_unnamed_addr addrspace(200) nounwind {
entry:
  %set = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) null, i64 100)
...
entry:
  %set = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) null, i64 100)
  %gep1 = getelementptr inbounds i8, ptr addrspace(200) %set, i64 -4
  %gep2 = getelementptr inbounds i8, ptr addrspace(200) %gep1, i64 -4
  %gep3 = getelementptr inbounds i8, ptr addrspace(200) %gep2, i64 -2
  %inc = getelementptr i8, ptr addrspace(200) %gep3, i64 -10
...
define ptr addrspace(200) @fold_set_inc_gep_sequence_arg(ptr addrspace(200) %arg) local_unnamed_addr addrspace(200) nounwind {
  %set = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) %arg, i64 100)
  %gep1 = getelementptr inbounds i8, ptr addrspace(200) %set, i64 -4
  %gep2 = getelementptr inbounds i8, ptr addrspace(200) %gep1, i64 -4
  %gep3 = getelementptr inbounds i8, ptr addrspace(200) %gep2, i64 -2
  %inc = getelementptr i8, ptr addrspace(200) %gep3, i64 -10
  ...
  ; CHECK-NEXT: tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) %arg, i64 80)
}
...
define ptr addrspace(200) @fold_set_addr_inc_gep_sequence_arg(ptr addrspace(200) %arg) local_unnamed_addr addrspace(200) nounwind {
  %set = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) %arg, i64 100)
  %gep1 = getelementptr inbounds i8, ptr addrspace(200) %set, i64 -4
  %gep2 = getelementptr inbounds i8, ptr addrspace(200) %gep1, i64 -4
  %gep3 = getelementptr inbounds i8, ptr addrspace(200) %gep2, i64 -2
  %inc = getelementptr i8, ptr addrspace(200) %gep3, i64 -10
  ...
  ; CHECK-NEXT: %set = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) %arg, i64 80)
...
define ptr addrspace(200) @fold_gep_incoffset2(ptr addrspace(200) %arg) local_unnamed_addr addrspace(200) nounwind {
  ...
  ; CHECK-NOT: tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.increment.i64(ptr addrspace(200) %arg, i64 96)
...
define ptr addrspace(200) @fold_null_setaddr_zero() addrspace(200) nounwind {
  %arg = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) null, i64 0)
  %ret = call addrspace(200) ptr addrspace(200) @check_fold_i8ptr(ptr addrspace(200) %arg)
  ret ptr addrspace(200) %ret
  ; CHECK-LABEL: @fold_null_setaddr_zero()
  ; CHECK-NEXT: %ret = call addrspace(200) ptr addrspace(200) @check_fold_i8ptr(ptr addrspace(200) null)
  ; CHECK-NEXT: ret ptr addrspace(200) %ret
}

define ptr addrspace(200) @fold_null_setoffest_zero() addrspace(200) nounwind {
  %arg = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) null, i64 0)
  %ret = call addrspace(200) ptr addrspace(200) @check_fold_i8ptr(ptr addrspace(200) %arg)
  ret ptr addrspace(200) %ret
...
define ptr addrspace(200) @fold_incoffset_zero(ptr addrspace(200) %arg) addrspace(200) nounwind {
  ...
  %ret = call addrspace(200) ptr addrspace(200) @check_fold_i8ptr(ptr addrspace(200) %inc0)
  ret ptr addrspace(200) %ret
  ; CHECK-LABEL: @fold_incoffset_zero(ptr addrspace(200) %arg)
  ; CHECK-NEXT: %ret = call addrspace(200) ptr addrspace(200) @check_fold_i8ptr(ptr addrspace(200) %arg)
  ; CHECK-NEXT: ret ptr addrspace(200) %ret
}

define ptr addrspace(200) @fold_setoffset_null_zero_to_null() addrspace(200) nounwind {
  %ret = call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) null, i64 0)
  ret ptr addrspace(200) %ret
...
define ptr addrspace(200) @fold_setaddr_null_zero_to_null() addrspace(200) nounwind {
  %ret = call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) null, i64 0)
  ret ptr addrspace(200) %ret
