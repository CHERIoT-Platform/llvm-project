...
;
  call addrspace(200) void @llvm.memcpy.p200.p200.i32(ptr addrspace(200) align 8 %d, ptr addrspace(200) align 8 %s, i32 8, i1 false) must_preserve_cheri_tags
...
; CHECK-NEXT:    call addrspace(200) void @llvm.memcpy.p200.p200.i32(ptr addrspace(200) noundef nonnull align 1 dereferenceable(8) [[D:%.*]], ptr addrspace(200) noundef nonnull align 1 dereferenceable(8) [[S:%.*]], i32 8, i1 false) #[[ATTR1:[0-9]+]]
; CHECK-NEXT:    ret ptr addrspace(200) [[D]]
;
  call addrspace(200) void @llvm.memcpy.p200.p200.i32(ptr addrspace(200) %d, ptr addrspace(200) %s, i32 8, i1 false) must_preserve_cheri_tags
  ret ptr addrspace(200) %d
}
...
; CHECK-NEXT:    call addrspace(200) void @llvm.memcpy.p200.p200.i32(ptr addrspace(200) noundef nonnull align 4 dereferenceable(8) [[D:%.*]], ptr addrspace(200) noundef nonnull align 4 dereferenceable(8) [[S:%.*]], i32 8, i1 false) #[[ATTR1]]
; CHECK-NEXT:    ret ptr addrspace(200) [[D]]
;
  call addrspace(200) void @llvm.memcpy.p200.p200.i32(ptr addrspace(200) align 4 %d, ptr addrspace(200) align 4 %s, i32 8, i1 false) must_preserve_cheri_tags
  ret ptr addrspace(200) %d
}
...
; CHECK-NEXT:    ret ptr addrspace(200) [[D]]
;
  call addrspace(200) void @llvm.memcpy.p200.p200.i32(ptr addrspace(200) align 8 %d, ptr addrspace(200) align 8 %s, i32 8, i1 false) no_preserve_cheri_tags
  ret ptr addrspace(200) %d
}
...
; CHECK-NEXT:    ret ptr addrspace(200) [[D]]
;
  call addrspace(200) void @llvm.memcpy.p200.p200.i32(ptr addrspace(200) %d, ptr addrspace(200) %s, i32 8, i1 false) no_preserve_cheri_tags
  ret ptr addrspace(200) %d
}
...
; CHECK-NEXT:    ret ptr addrspace(200) [[D]]
;
  call addrspace(200) void @llvm.memcpy.p200.p200.i32(ptr addrspace(200) align 4 %d, ptr addrspace(200) align 4 %s, i32 8, i1 false) no_preserve_cheri_tags
  ret ptr addrspace(200) %d
}
