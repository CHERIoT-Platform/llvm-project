...
define signext i32 @stack_int_inlined() local_unnamed_addr addrspace(200) {
...
define signext i32 @stack_int_inlined_escapes() local_unnamed_addr addrspace(200) {
...
define signext i32 @used_by_smaller_setbounds() local_unnamed_addr addrspace(200) {
...
define signext i32 @used_by_out_of_bounds_load() local_unnamed_addr addrspace(200) {
...
define signext i32 @csetbounds_sequence(ptr addrspace(200) %value) local_unnamed_addr addrspace(200) {
...
define signext i32 @csetbounds_sequence_oob(ptr addrspace(200) %value) local_unnamed_addr addrspace(200) {
