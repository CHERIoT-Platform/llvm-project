...
; CHECK128-NEXT:    [[ADD_PTR:%.*]] = getelementptr inbounds nuw i8, ptr addrspace(200) [[TMP0]], i64 164
...
; CHECK256-NEXT:    [[ADD_PTR:%.*]] = getelementptr inbounds nuw i8, ptr addrspace(200) [[TMP0]], i128 164
