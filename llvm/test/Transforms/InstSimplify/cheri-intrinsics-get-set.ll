...
; FLAGS-NEXT:    [[VALUE:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.flags.get.i64(ptr addrspace(200) [[ARG]])
; FLAGS-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.flags.set.i64(ptr addrspace(200) [[ARG]], i64 [[VALUE]])
...
; HIGH-NEXT:    [[VALUE:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.high.get.i64(ptr addrspace(200) [[ARG]])
; HIGH-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.high.set.i64(ptr addrspace(200) [[ARG]], i64 [[VALUE]])
...
;
  %value = tail call addrspace(200) i64 @llvm.cheri.cap.FIELD.get.i64(ptr addrspace(200) %arg)
  %ret = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.FIELD.set.i64(ptr addrspace(200) %arg, i64 %value)
...
; ADDRESS-NEXT:    [[VALUE:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) [[OTHER]])
; ADDRESS-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) [[ARG]], i64 [[VALUE]])
...
; FLAGS-NEXT:    [[VALUE:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.flags.get.i64(ptr addrspace(200) [[OTHER]])
; FLAGS-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.flags.set.i64(ptr addrspace(200) [[ARG]], i64 [[VALUE]])
; FLAGS-NEXT:    ret ptr addrspace(200) [[RET]]
;
; HIGH-LABEL: define {{[^@]+}}@fold_set_of_get_bad
; HIGH-SAME: (ptr addrspace(200) [[ARG:%.*]], ptr addrspace(200) [[OTHER:%.*]]) addrspace(200) #[[ATTR0]] {
; HIGH-NEXT:    [[VALUE:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.high.get.i64(ptr addrspace(200) [[OTHER]])
; HIGH-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.high.set.i64(ptr addrspace(200) [[ARG]], i64 [[VALUE]])
; HIGH-NEXT:    ret ptr addrspace(200) [[RET]]
;
; OFFSET-LABEL: define {{[^@]+}}@fold_set_of_get_bad
; OFFSET-SAME: (ptr addrspace(200) [[ARG:%.*]], ptr addrspace(200) [[OTHER:%.*]]) addrspace(200) #[[ATTR0]] {
; OFFSET-NEXT:    [[VALUE:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) [[OTHER]])
; OFFSET-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) [[ARG]], i64 [[VALUE]])
; OFFSET-NEXT:    ret ptr addrspace(200) [[RET]]
;
  %value = tail call addrspace(200) i64 @llvm.cheri.cap.FIELD.get.i64(ptr addrspace(200) %other)
  %ret = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.FIELD.set.i64(ptr addrspace(200) %arg, i64 %value)
  ret ptr addrspace(200) %ret
}
...
; FLAGS-NEXT:    [[MODIFIED:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.flags.set.i64(ptr addrspace(200) [[ARG]], i64 [[VALUE]])
; FLAGS-NEXT:    [[RET:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.flags.get.i64(ptr addrspace(200) [[MODIFIED]])
; FLAGS-NEXT:    ret i64 [[RET]]
;
; HIGH-LABEL: define {{[^@]+}}@fold_get_of_set
; HIGH-SAME: (ptr addrspace(200) [[ARG:%.*]], i64 [[VALUE:%.*]]) addrspace(200) #[[ATTR0]] {
; HIGH-NEXT:    [[MODIFIED:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.high.set.i64(ptr addrspace(200) [[ARG]], i64 [[VALUE]])
; HIGH-NEXT:    [[RET:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.high.get.i64(ptr addrspace(200) [[MODIFIED]])
...
;
  %modified = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.FIELD.set.i64(ptr addrspace(200) %arg, i64 %value)
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.FIELD.get.i64(ptr addrspace(200) %modified)
  ret i64 %ret
}
...
; ADDRESS-NEXT:    [[RET:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) [[ARG]])
...
; FLAGS-NEXT:    [[RET:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.flags.get.i64(ptr addrspace(200) [[ARG]])
; FLAGS-NEXT:    ret i64 [[RET]]
;
...
; HIGH-NEXT:    [[RET:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.high.get.i64(ptr addrspace(200) [[ARG]])
; HIGH-NEXT:    ret i64 [[RET]]
;
...
; OFFSET-NEXT:    [[RET:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.offset.get.i64(ptr addrspace(200) [[ARG]])
; OFFSET-NEXT:    ret i64 [[RET]]
;
  %modified = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.FIELD.set.i64(ptr addrspace(200) %other, i64 %value)
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.FIELD.get.i64(ptr addrspace(200) %arg)
  ret i64 %ret
}
...
; HIGH-NEXT:    [[RET:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.high.get.i64(ptr addrspace(200) null)
; HIGH-NEXT:    ret i64 [[RET]]
;
...
;
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.FIELD.get.i64(ptr addrspace(200) null)
  ret i64 %ret
}
...
; HIGH-NEXT:    [[RET:%.*]] = tail call addrspace(200) i64 @llvm.cheri.cap.high.get.i64(ptr addrspace(200) [[TMP]])
; HIGH-NEXT:    ret i64 [[RET]]
;
...
;
  ...
  %ret = tail call addrspace(200) i64 @llvm.cheri.cap.FIELD.get.i64(ptr addrspace(200) %tmp)
  ret i64 %ret
}
...
; ADDRESS-SAME: (ptr addrspace(200) [[ARG:%.*]], i64 [[VALUE:%.*]]) addrspace(200) #[[ATTR0]] {
; ADDRESS-NEXT:    [[MODIFIED:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) [[ARG]], i64 [[VALUE]])
; ADDRESS-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) [[MODIFIED]], i64 [[VALUE]])
; ADDRESS-NEXT:    ret ptr addrspace(200) [[RET]]
;
; FLAGS-LABEL: define {{[^@]+}}@set_idempotent
; FLAGS-SAME: (ptr addrspace(200) [[ARG:%.*]], i64 [[VALUE:%.*]]) addrspace(200) #[[ATTR0]] {
; FLAGS-NEXT:    [[MODIFIED:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.flags.set.i64(ptr addrspace(200) [[ARG]], i64 [[VALUE]])
; FLAGS-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.flags.set.i64(ptr addrspace(200) [[MODIFIED]], i64 [[VALUE]])
; FLAGS-NEXT:    ret ptr addrspace(200) [[RET]]
;
; HIGH-LABEL: define {{[^@]+}}@set_idempotent
; HIGH-SAME: (ptr addrspace(200) [[ARG:%.*]], i64 [[VALUE:%.*]]) addrspace(200) #[[ATTR0]] {
; HIGH-NEXT:    [[MODIFIED:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.high.set.i64(ptr addrspace(200) [[ARG]], i64 [[VALUE]])
; HIGH-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.high.set.i64(ptr addrspace(200) [[MODIFIED]], i64 [[VALUE]])
; HIGH-NEXT:    ret ptr addrspace(200) [[RET]]
;
; OFFSET-LABEL: define {{[^@]+}}@set_idempotent
; OFFSET-SAME: (ptr addrspace(200) [[ARG:%.*]], i64 [[VALUE:%.*]]) addrspace(200) #[[ATTR0]] {
; OFFSET-NEXT:    [[MODIFIED:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) [[ARG]], i64 [[VALUE]])
; OFFSET-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) [[MODIFIED]], i64 [[VALUE]])
; OFFSET-NEXT:    ret ptr addrspace(200) [[RET]]
;
  %modified = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.FIELD.set.i64(ptr addrspace(200) %arg, i64 %value)
  %ret = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.FIELD.set.i64(ptr addrspace(200) %modified, i64 %value)
  ret ptr addrspace(200) %ret
}
...
; ADDRESS-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) null, i64 [[VALUE]])
; ADDRESS-NEXT:    ret ptr addrspace(200) [[RET]]
;
; FLAGS-LABEL: define {{[^@]+}}@fold_set_on_null
; FLAGS-SAME: (i64 [[VALUE:%.*]]) addrspace(200) #[[ATTR0]] {
; FLAGS-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.flags.set.i64(ptr addrspace(200) null, i64 [[VALUE]])
; FLAGS-NEXT:    ret ptr addrspace(200) [[RET]]
;
; HIGH-LABEL: define {{[^@]+}}@fold_set_on_null
; HIGH-SAME: (i64 [[VALUE:%.*]]) addrspace(200) #[[ATTR0]] {
; HIGH-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.high.set.i64(ptr addrspace(200) null, i64 [[VALUE]])
; HIGH-NEXT:    ret ptr addrspace(200) [[RET]]
;
; OFFSET-LABEL: define {{[^@]+}}@fold_set_on_null
; OFFSET-SAME: (i64 [[VALUE:%.*]]) addrspace(200) #[[ATTR0]] {
; OFFSET-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) null, i64 [[VALUE]])
; OFFSET-NEXT:    ret ptr addrspace(200) [[RET]]
;
  %ret = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.FIELD.set.i64(ptr addrspace(200) null, i64 %value)
  ret ptr addrspace(200) %ret
}
...
; ADDRESS-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) [[TMP]], i64 [[VALUE]])
; ADDRESS-NEXT:    ret ptr addrspace(200) [[RET]]
;
; FLAGS-LABEL: define {{[^@]+}}@fold_set_on_null_with_gep
; FLAGS-SAME: (i64 [[VALUE:%.*]], i64 [[GEPOFF:%.*]]) addrspace(200) #[[ATTR0]] {
; FLAGS-NEXT:    [[TMP:%.*]] = getelementptr i8, ptr addrspace(200) null, i64 [[GEPOFF]]
; FLAGS-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.flags.set.i64(ptr addrspace(200) [[TMP]], i64 [[VALUE]])
; FLAGS-NEXT:    ret ptr addrspace(200) [[RET]]
;
; HIGH-LABEL: define {{[^@]+}}@fold_set_on_null_with_gep
; HIGH-SAME: (i64 [[VALUE:%.*]], i64 [[GEPOFF:%.*]]) addrspace(200) #[[ATTR0]] {
; HIGH-NEXT:    [[TMP:%.*]] = getelementptr i8, ptr addrspace(200) null, i64 [[GEPOFF]]
; HIGH-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.high.set.i64(ptr addrspace(200) [[TMP]], i64 [[VALUE]])
; HIGH-NEXT:    ret ptr addrspace(200) [[RET]]
;
; OFFSET-LABEL: define {{[^@]+}}@fold_set_on_null_with_gep
; OFFSET-SAME: (i64 [[VALUE:%.*]], i64 [[GEPOFF:%.*]]) addrspace(200) #[[ATTR0]] {
; OFFSET-NEXT:    [[TMP:%.*]] = getelementptr i8, ptr addrspace(200) null, i64 [[GEPOFF]]
; OFFSET-NEXT:    [[RET:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) [[TMP]], i64 [[VALUE]])
; OFFSET-NEXT:    ret ptr addrspace(200) [[RET]]
;
  %tmp = getelementptr i8, ptr addrspace(200) null, i64 %gepoff
  %ret = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.FIELD.set.i64(ptr addrspace(200) %tmp, i64 %value)
  ret ptr addrspace(200) %ret
}
