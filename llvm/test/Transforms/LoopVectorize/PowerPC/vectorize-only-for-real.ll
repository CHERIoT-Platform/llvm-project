...
entry:
  ...
  call void @llvm.lifetime.start.p0(ptr %a) #3
  br label %for.body

for.cond.cleanup:                                 ; preds = %for.body
  call void @llvm.lifetime.start.p0(ptr %c) #3
...
for.cond.cleanup5:                                ; preds = %for.body6
  call void @llvm.lifetime.end.p0(ptr nonnull %c) #3
  call void @llvm.lifetime.end.p0(ptr %a) #3
  ret i32 %add
