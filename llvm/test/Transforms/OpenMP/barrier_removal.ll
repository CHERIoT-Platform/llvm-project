...
; MODULE: attributes #[[ATTR2:[0-9]+]] = { convergent hassideeffects nocallback nofree nounwind willreturn }
...
; CGSCC: attributes #[[ATTR2:[0-9]+]] = { convergent hassideeffects nocallback nofree nounwind willreturn }
