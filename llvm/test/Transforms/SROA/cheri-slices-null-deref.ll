...
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(ptr [[OPERANDS_SROA_0]])
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(ptr [[OPERANDS_SROA_4]])
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(ptr [[OPERANDS_SROA_6]])
; CHECK-NEXT:    br label [[FOR_BODY:%.*]]
; CHECK:       for.body:
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(ptr [[__T_I]])
...
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(ptr [[__T_I]])
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(ptr [[__T_I]])
...
; CHECK-NEXT:    call void @llvm.memcpy.p0.p0.i64(ptr align 16 [[OPERANDS_SROA_6]], ptr align 8 [[__T_I]], i64 16, i1 false)
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(ptr [[__T_I]])
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(ptr [[OPERANDS_SROA_0]])
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(ptr [[OPERANDS_SROA_4]])
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(ptr [[OPERANDS_SROA_6]])
; CHECK-NEXT:    ret void
;
entry:
  %__t.i = alloca %struct.SDValue, align 8
  %Operands = alloca [3 x %struct.SDValue], align 16
  call void @llvm.lifetime.start.p0(ptr nonnull %Operands) #3
  %arrayidx = getelementptr inbounds [3 x %struct.SDValue], ptr %Operands, i64 0, i64 2
  br label %for.body

for.body:                                         ; preds = %entry
  call void @llvm.lifetime.start.p0(ptr nonnull %__t.i)
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %__t.i)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %arrayidx, ptr noundef nonnull align 8 dereferenceable(16) %__t.i, i64 16, i1 false)
  call void @llvm.lifetime.end.p0(ptr nonnull %__t.i)
  call void @llvm.lifetime.end.p0(ptr nonnull %Operands) #3
  ret void
}
