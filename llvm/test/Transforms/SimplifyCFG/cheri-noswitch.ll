...
; Function Attrs: nounwind
declare void @puts(ptr addrspace(200) nocapture readonly) addrspace(200) #0

; Function Attrs: nounwind willreturn memory(none)
declare ptr addrspace(200) @llvm.cheri.pcc.get() addrspace(200) #1

; Function Attrs: nounwind willreturn memory(none)
declare ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200), i64) addrspace(200) #1
...
;
entry:
  %cmp = icmp eq ptr addrspace(200) %x, null
...
if.end:                                           ; preds = %if.then, %entry
  %cmp1 = icmp eq ptr addrspace(200) %x, null
...
; Function Attrs: nounwind
define signext i32 @issue332(ptr addrspace(200) %e, i32 %value) local_unnamed_addr addrspace(200) #0 {
...
if.end2:                                          ; preds = %entry
  %tobool3.old = icmp eq ptr addrspace(200) %e, null
...
declare signext i32 @func1() local_unnamed_addr addrspace(200) #0
declare signext i32 @func2() local_unnamed_addr addrspace(200) #0
