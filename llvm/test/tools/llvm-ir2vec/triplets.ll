...
; TRIPLETS-NEXT: 12      93      2
; TRIPLETS-NEXT: 12      93      3
; TRIPLETS-NEXT: 12      0       1
; TRIPLETS-NEXT: 0       75      0
; TRIPLETS-NEXT: 0       93      2
; TRIPLETS-NEXT: 16      80      0
; TRIPLETS-NEXT: 16      93      2
; TRIPLETS-NEXT: 16      93      3
; TRIPLETS-NEXT: 16      0       1
; TRIPLETS-NEXT: 0       75      0
; TRIPLETS-NEXT: 0       93      2
; TRIPLETS-NEXT: 30      82      0
; TRIPLETS-NEXT: 30      92      2
; TRIPLETS-NEXT: 30      30      1
; TRIPLETS-NEXT: 30      82      0
; TRIPLETS-NEXT: 30      92      2
; TRIPLETS-NEXT: 30      32      1
; TRIPLETS-NEXT: 32      75      0
; TRIPLETS-NEXT: 32      93      2
; TRIPLETS-NEXT: 32      91      3
