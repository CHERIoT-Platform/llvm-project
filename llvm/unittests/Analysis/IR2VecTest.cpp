...
TEST_F(IR2VecTestFixture, GetInstVecMap_Symbolic) {
  ...
  EXPECT_TRUE(AddEmb.approximatelyEquals(Embedding(2, 28.1)));
  EXPECT_TRUE(RetEmb.approximatelyEquals(Embedding(2, 17.1)));
}
...
TEST_F(IR2VecTestFixture, GetInstVecMap_FlowAware) {
  ...
  EXPECT_TRUE(InstMap.at(AddInst).approximatelyEquals(Embedding(2, 28.1)));
  EXPECT_TRUE(InstMap.at(RetInst).approximatelyEquals(Embedding(2, 35.8)));
}
...
TEST_F(IR2VecTestFixture, GetBBVecMap_Symbolic) {
  ...
  // {44.9, 44.9}
  EXPECT_TRUE(BBMap.at(BB).approximatelyEquals(Embedding(2, 45.2)));
}
...
TEST_F(IR2VecTestFixture, GetBBVecMap_FlowAware) {
  ...
  // {63.5, 63.5}
  EXPECT_TRUE(BBMap.at(BB).approximatelyEquals(Embedding(2, 63.9)));
}
...
TEST_F(IR2VecTestFixture, GetBBVector_Symbolic) {
  ...
  EXPECT_TRUE(BBVec.approximatelyEquals(Embedding(2, 45.2)));
}
...
TEST_F(IR2VecTestFixture, GetBBVector_FlowAware) {
  ...
  EXPECT_EQ(BBVec.size(), 2u);
  EXPECT_TRUE(BBVec.approximatelyEquals(Embedding(2, 63.9)));
}
...
TEST_F(IR2VecTestFixture, GetFunctionVector_Symbolic) {
  ...
  EXPECT_TRUE(FuncVec.approximatelyEquals(Embedding(2, 45.2)));
}
...
TEST_F(IR2VecTestFixture, GetFunctionVector_FlowAware) {
  ...
  EXPECT_TRUE(FuncVec.approximatelyEquals(Embedding(2, 63.9)));
}
