...
TEST(ELFTest, getRISCVVendorRelocationTypeName) {
  ...
  EXPECT_EQ("R_RISCV_CHERIOT1_COMPARTMENT_CODE_HI",
            getRISCVVendorRelocationTypeName(
                R_RISCV_CHERIOT_COMPARTMENT_HI_DEPRECATED, "CHERIOT1"));
  ...
  EXPECT_EQ("R_RISCV_CHERIOT1_COMPARTMENT_DATA_HI",
            getRISCVVendorRelocationTypeName(R_RISCV_CUSTOM225, "CHERIOT1"));
}
