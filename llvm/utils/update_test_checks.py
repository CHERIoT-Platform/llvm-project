...
def update_test(ti: common.TestInfo):
    ...
    for l in ti.run_lines:
        ...
        if tool_cmd.startswith("%"):
            ...
            tool_cmd = tool_cmd.replace("%riscv32_cheri_purecap_opt", "opt -mtriple=riscv32-unknown-freebsd -target-abi il32pc64 -mattr=+xcheri,+xcheripurecap")
            tool_cmd = tool_cmd.replace("%riscv64_cheri_purecap_opt", "opt -mtriple=riscv64-unknown-freebsd -target-abi l64pc128 -mattr=+xcheri,+xcheripurecap")
